...
_CHROMEUSERMETRICSEXTENSION_PRODUCT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANDROID_WEBLAYER', index=3, number=56,
      serialized_options=None,
      type=None),
  ],
...
_CHROMEUSERMETRICSEXTENSION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reporting_info', full_name='metrics.ChromeUserMetricsExtension.reporting_info', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trace_log', full_name='metrics.ChromeUserMetricsExtension.trace_log', index=17,
