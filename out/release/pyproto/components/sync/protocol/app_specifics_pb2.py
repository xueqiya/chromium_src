...
AppNotificationSettings = _reflection.GeneratedProtocolMessageType('AppNotificationSettings', (_message.Message,), {
...
LinkedAppIconInfo = _reflection.GeneratedProtocolMessageType('LinkedAppIconInfo', (_message.Message,), {
...
AppSpecifics = _reflection.GeneratedProtocolMessageType('AppSpecifics', (_message.Message,), {
