...
_PRINTERSPECIFICS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='print_server_uri', full_name='sync_pb.PrinterSpecifics.print_server_uri', index=11,
...
PrinterPPDReference = _reflection.GeneratedProtocolMessageType('PrinterPPDReference', (_message.Message,), {
...
PrinterSpecifics = _reflection.GeneratedProtocolMessageType('PrinterSpecifics', (_message.Message,), {
