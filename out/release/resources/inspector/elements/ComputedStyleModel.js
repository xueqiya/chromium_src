export class ComputedStyleModel extends Common.Object{constructor(){super();this._node=self.UI.context.flavor(SDK.DOMNode);this._cssModel=null;this._eventListeners=[];self.UI.context.addFlavorChangeListener(SDK.DOMNode,this._onNodeChanged,this);}
