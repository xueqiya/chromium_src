...
#include "components/metrics/public/mojom/single_sample_metrics.mojom-forward.h"
#include <string>
#include <vector>
...
class  SingleSampleMetricsProvider
 ...
 public:
  ...
  virtual void AcquireSingleSampleMetric(const std::string& histogram_name, int32_t min, int32_t max, uint32_t bucket_count, int32_t flags, mojo::PendingReceiver<SingleSampleMetric> receiver) = 0;
};
...
class  SingleSampleMetricsProviderProxy
 ...
 public:
  ...
  void AcquireSingleSampleMetric(const std::string& histogram_name, int32_t min, int32_t max, uint32_t bucket_count, int32_t flags, mojo::PendingReceiver<SingleSampleMetric> receiver) final;
