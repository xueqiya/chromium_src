...
static_assert(sizeof(FormFieldData_Data) == 168,
...
class  FormData_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<uint32_t>> username_predictions;

 private:
  FormData_Data();
  ~FormData_Data() = delete;
};
static_assert(sizeof(FormData_Data) == 96,
...
static_assert(sizeof(PasswordAndMetadata_Data) == 32,
...
class  PasswordFormFillData_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Map_Data<mojo::internal::Pointer<::mojo_base::mojom::internal::String16_Data>, mojo::internal::Pointer<internal::PasswordAndMetadata_Data>>> additional_logins;

 private:
  PasswordFormFillData_Data();
  ~PasswordFormFillData_Data() = delete;
};
static_assert(sizeof(PasswordFormFillData_Data) == 64,
...
static_assert(sizeof(PasswordFormGenerationData_Data) == 16,
...
static_assert(sizeof(PasswordGenerationUIData_Data) == 48,
...
static_assert(sizeof(ParsingResult_Data) == 24,
