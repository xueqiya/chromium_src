// components/tracing/common/background_tracing_agent.mojom-params-data.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef COMPONENTS_TRACING_COMMON_BACKGROUND_TRACING_AGENT_MOJOM_PARAMS_DATA_H_
#define COMPONENTS_TRACING_COMMON_BACKGROUND_TRACING_AGENT_MOJOM_PARAMS_DATA_H_
...
namespace mojom {
namespace internal {
class  BackgroundTracingAgentClient_OnInitialized_Params_Data {
 public:
  class BufferWriter {
   public:
...
class  BackgroundTracingAgentClient_OnTriggerBackgroundTrace_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class  BackgroundTracingAgentClient_OnAbortBackgroundTrace_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class  BackgroundTracingAgent_SetUMACallback_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class  BackgroundTracingAgent_ClearUMACallback_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class  BackgroundTracingAgentProvider_Create_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // COMPONENTS_TRACING_COMMON_BACKGROUND_TRACING_AGENT_MOJOM_PARAMS_DATA_H_