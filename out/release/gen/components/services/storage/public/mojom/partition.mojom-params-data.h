  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(Partition_BindOriginContext_Params_Data));
      new (data()) Partition_BindOriginContext_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    Partition_BindOriginContext_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<Partition_BindOriginContext_Params_Data>(index_);
    }
    Partition_BindOriginContext_Params_Data* operator->() { return data(); }
