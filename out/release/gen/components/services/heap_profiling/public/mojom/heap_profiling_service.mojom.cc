...
void ProfilingServiceProxy::AddProfilingClient(
    ::base::ProcessId in_pid, mojo::PendingRemote<::heap_profiling::mojom::ProfilingClient> in_client, ProcessType in_process_type, ::heap_profiling::mojom::ProfilingParamsPtr in_params) {
...
bool ProfilingServiceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kProfilingService_AddProfilingClient_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)heap_profiling::mojom::ProfilingService::AddProfilingClient",
          "message", message->name());
#endif
...
bool ProfilingServiceStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kProfilingService_GetProfiledPids_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)heap_profiling::mojom::ProfilingService::GetProfiledPids",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)heap_profiling::mojom::ProfilingService::GetProfiledPids");
