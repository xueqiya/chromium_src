// components/services/heap_profiling/public/mojom/heap_profiling_service.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ProfilingServiceInterceptorForTesting::AddProfilingClient(::base::ProcessId pid, mojo::PendingRemote<::heap_profiling::mojom::ProfilingClient> client, ProcessType process_type, ::heap_profiling::mojom::ProfilingParamsPtr params) {
