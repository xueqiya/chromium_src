...
class ProfilingClient_StartProfiling_ForwardToCallback
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ProfilingClient_StartProfiling_ForwardToCallback);
};
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "heap_profiling::mojom::ProfilingClient::RetrieveHeapProfile");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
class ProfilingClient_StartProfiling_ProxyToResponder {
 public:
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ProfilingClient_StartProfiling_ProxyToResponder);
};

bool ProfilingClient_StartProfiling_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "heap_profiling::mojom::ProfilingClient::StartProfilingCallback",
  ...
  bool success = true;
  ProfilingClient_StartProfiling_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void ProfilingClient_StartProfiling_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kProfilingClient_StartProfiling_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::heap_profiling::mojom::internal::ProfilingClient_StartProfiling_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  message.AttachHandlesFromSerializationContext(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)heap_profiling::mojom::ProfilingClient::StartProfilingCallback",
               "message", message.name());
#endif
...
bool ProfilingClient_RetrieveHeapProfile_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "heap_profiling::mojom::ProfilingClient::RetrieveHeapProfileCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)heap_profiling::mojom::ProfilingClient::RetrieveHeapProfileCallback",
               "message", message.name());
#endif
