 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ProfilingClient_StartProfiling_ResponseParams_Data));
      new (data()) ProfilingClient_StartProfiling_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ProfilingClient_StartProfiling_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ProfilingClient_StartProfiling_ResponseParams_Data>(index_);
    }
    ProfilingClient_StartProfiling_ResponseParams_Data* operator->() { return data(); }
