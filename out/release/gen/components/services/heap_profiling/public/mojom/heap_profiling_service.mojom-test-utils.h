...
class  ProfilingServiceInterceptorForTesting : public ProfilingService {
  ...
  void AddProfilingClient(::base::ProcessId pid, mojo::PendingRemote<::heap_profiling::mojom::ProfilingClient> client, ProcessType process_type, ::heap_profiling::mojom::ProfilingParamsPtr params) override;
