...
class  Directory
 ...
 public:
  ...
  virtual bool OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, ::base::File::Error* out_error);

  using OpenFileCallback = base::OnceCallback<void(::base::File::Error)>;
  
  virtual void OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, OpenFileCallback callback) = 0;
...
class  DirectoryProxy
 ...
 public:
  ...
  bool OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, ::base::File::Error* out_error) final;
  
  void OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, OpenFileCallback callback) final;
