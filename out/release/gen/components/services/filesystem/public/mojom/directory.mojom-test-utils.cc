// components/services/filesystem/public/mojom/directory.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void DirectoryInterceptorForTesting::OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, OpenFileCallback callback) {
...
void DirectoryAsyncWaiter::OpenFile(
    const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, ::base::File::Error* out_error) {
  base::RunLoop loop;
