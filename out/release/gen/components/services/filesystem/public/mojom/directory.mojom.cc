...
bool Directory::OpenFile(const std::string& path, mojo::PendingReceiver<::filesystem::mojom::File> file, uint32_t open_flags, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
...
bool DirectoryProxy::OpenFile(
    const std::string& param_path, mojo::PendingReceiver<::filesystem::mojom::File> param_file, uint32_t param_open_flags, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DirectoryProxy::OpenFile(
    const std::string& in_path, mojo::PendingReceiver<::filesystem::mojom::File> in_file, uint32_t in_open_flags, OpenFileCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "filesystem::mojom::Directory::OpenFile");
#endif
  const bool kExpectsResponse = true;
...
bool DirectoryStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kDirectory_OpenFile_Name: {
      ...
      bool success = true;
      std::string p_path{};
      mojo::PendingReceiver<::filesystem::mojom::File> p_file{};
