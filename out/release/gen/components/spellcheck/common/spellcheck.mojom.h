...
class  SpellCheckHost
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kDisconnectSessionBridgeMinVersion = 0,
  ...
  virtual void RequestTextCheck(const ::base::string16& text, int32_t route_id, RequestTextCheckCallback callback) = 0;

  
  virtual void DisconnectSessionBridge() = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool CheckSpelling(const ::base::string16& word, int32_t route_id, bool* out_correct);

  using CheckSpellingCallback = base::OnceCallback<void(bool)>;
  
  virtual void CheckSpelling(const ::base::string16& word, int32_t route_id, CheckSpellingCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool FillSuggestionList(const ::base::string16& word, std::vector<::base::string16>* out_suggestions);

  using FillSuggestionListCallback = base::OnceCallback<void(const std::vector<::base::string16>&)>;
  
  virtual void FillSuggestionList(const ::base::string16& word, FillSuggestionListCallback callback) = 0;
};
...
class  SpellCheckHostProxy
 ...
 public:
  ...
  void RequestTextCheck(const ::base::string16& text, int32_t route_id, RequestTextCheckCallback callback) final;
  
  void DisconnectSessionBridge() final;
  
  bool CheckSpelling(const ::base::string16& word, int32_t route_id, bool* out_correct) final;
  
  void CheckSpelling(const ::base::string16& word, int32_t route_id, CheckSpellingCallback callback) final;
  
  bool FillSuggestionList(const ::base::string16& word, std::vector<::base::string16>* out_suggestions) final;
  
  void FillSuggestionList(const ::base::string16& word, FillSuggestionListCallback callback) final;
