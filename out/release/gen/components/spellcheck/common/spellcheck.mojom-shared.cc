...
bool SpellCheckHost_RequestTextCheck_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_RequestTextCheck_Params_Data* object = static_cast<const SpellCheckHost_RequestTextCheck_Params_Data*>(data);
...
bool SpellCheckHost_RequestTextCheck_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_RequestTextCheck_ResponseParams_Data* object = static_cast<const SpellCheckHost_RequestTextCheck_ResponseParams_Data*>(data);
...
bool SpellCheckHost_DisconnectSessionBridge_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_DisconnectSessionBridge_Params_Data* object = static_cast<const SpellCheckHost_DisconnectSessionBridge_Params_Data*>(data);
...
bool SpellCheckHost_CheckSpelling_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_CheckSpelling_Params_Data* object = static_cast<const SpellCheckHost_CheckSpelling_Params_Data*>(data);
...
bool SpellCheckHost_CheckSpelling_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_CheckSpelling_ResponseParams_Data* object = static_cast<const SpellCheckHost_CheckSpelling_ResponseParams_Data*>(data);
...
bool SpellCheckHost_FillSuggestionList_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_FillSuggestionList_Params_Data* object = static_cast<const SpellCheckHost_FillSuggestionList_Params_Data*>(data);
...
bool SpellCheckHost_FillSuggestionList_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SpellCheckHost_FillSuggestionList_ResponseParams_Data* object = static_cast<const SpellCheckHost_FillSuggestionList_ResponseParams_Data*>(data);
