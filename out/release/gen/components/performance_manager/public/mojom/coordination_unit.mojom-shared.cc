...
// static
bool DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params_Data* object = static_cast<const DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params_Data*>(data);
  ...
  if (!::performance_manager::mojom::internal::InterventionPolicy_Data
...
DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params_Data::DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params_Data()
    : header_({sizeof(*this), 0}) {}
