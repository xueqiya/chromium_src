...
static void InitDefaultsscc_info_PriorityPreferenceSpecifics_priority_5fpreference_5fspecifics_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_PriorityPreferenceSpecifics_priority_5fpreference_5fspecifics_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_PriorityPreferenceSpecifics_priority_5fpreference_5fspecifics_2eproto}, {
...
void PriorityPreferenceSpecifics::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PriorityPreferenceSpecifics_priority_5fpreference_5fspecifics_2eproto.base);
  preference_ = nullptr;
}
