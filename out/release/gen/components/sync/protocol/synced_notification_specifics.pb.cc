...
static void InitDefaultsscc_info_SyncedNotificationSpecifics_synced_5fnotification_5fspecifics_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SyncedNotificationSpecifics_synced_5fnotification_5fspecifics_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_SyncedNotificationSpecifics_synced_5fnotification_5fspecifics_2eproto}, {}};
...
const SyncedNotificationSpecifics& SyncedNotificationSpecifics::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SyncedNotificationSpecifics_synced_5fnotification_5fspecifics_2eproto.base);
