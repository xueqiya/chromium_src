...
static void InitDefaultsscc_info_ModelTypeStoreSchemaDescriptor_model_5ftype_5fstore_5fschema_5fdescriptor_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ModelTypeStoreSchemaDescriptor_model_5ftype_5fstore_5fschema_5fdescriptor_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ModelTypeStoreSchemaDescriptor_model_5ftype_5fstore_5fschema_5fdescriptor_2eproto}, {}};
...
const ModelTypeStoreSchemaDescriptor& ModelTypeStoreSchemaDescriptor::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ModelTypeStoreSchemaDescriptor_model_5ftype_5fstore_5fschema_5fdescriptor_2eproto.base);
