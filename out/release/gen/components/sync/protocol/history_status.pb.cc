...
static void InitDefaultsscc_info_HistoryStatusRequest_history_5fstatus_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HistoryStatusRequest_history_5fstatus_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_HistoryStatusRequest_history_5fstatus_2eproto}, {}};

static void InitDefaultsscc_info_HistoryStatusResponse_history_5fstatus_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HistoryStatusResponse_history_5fstatus_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_HistoryStatusResponse_history_5fstatus_2eproto}, {}};
...
const HistoryStatusRequest& HistoryStatusRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HistoryStatusRequest_history_5fstatus_2eproto.base);
...
const HistoryStatusResponse& HistoryStatusResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HistoryStatusResponse_history_5fstatus_2eproto.base);
  return *internal_default_instance();
}
