...
static void InitDefaultsscc_info_DictionarySpecifics_dictionary_5fspecifics_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DictionarySpecifics_dictionary_5fspecifics_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_DictionarySpecifics_dictionary_5fspecifics_2eproto}, {}};
...
void DictionarySpecifics::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_DictionarySpecifics_dictionary_5fspecifics_2eproto.base);
  word_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
