...
static void InitDefaultsscc_info_ManagedUserSharedSettingSpecifics_managed_5fuser_5fshared_5fsetting_5fspecifics_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ManagedUserSharedSettingSpecifics_managed_5fuser_5fshared_5fsetting_5fspecifics_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ManagedUserSharedSettingSpecifics_managed_5fuser_5fshared_5fsetting_5fspecifics_2eproto}, {}};
...
void ManagedUserSharedSettingSpecifics::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ManagedUserSharedSettingSpecifics_managed_5fuser_5fshared_5fsetting_5fspecifics_2eproto.base);
  mu_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  acknowledged_ = false;
