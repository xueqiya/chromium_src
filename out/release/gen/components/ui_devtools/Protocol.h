...
class UI_DEVTOOLS_EXPORT Object : public crdtp::Serializable {
public:
...
public:
    ...
    public:
        Callback(std::unique_ptr<WeakPtr> backendImpl, int callId, const String& method, crdtp::span<uint8_t> message);
        virtual ~Callback();
        void dispose();
    ...
    virtual void dispatch(int callId, const String& method, crdtp::span<uint8_t> rawMessage, std::unique_ptr<protocol::DictionaryValue> messageObject) = 0;
...
public:
    ...
    void dispatch(int callId, const String& method, std::unique_ptr<Value> message, crdtp::span<uint8_t> rawMessage);
    FrontendChannel* channel() { return m_frontendChannel; }
