...
(function() {
  ...
  VulkanPhysicalDeviceInfo.validate = function(messageValidator, offset) {
    ...
    // validate VulkanPhysicalDeviceInfo.layers
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 16, 8, new codec.PointerTo(vulkan_types$.VkLayerProperties), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate VulkanPhysicalDeviceInfo.features
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, vulkan_types$.VkPhysicalDeviceFeatures, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(vulkan_types$.VkQueueFamilyProperties), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VulkanPhysicalDeviceInfo.encodedSize = codec.kStructHeaderSize + 48;
  ...
  VulkanPhysicalDeviceInfo.decode = function(decoder) {
    ...
    val.properties = decoder.decodeStructPointer(vulkan_types$.VkPhysicalDeviceProperties);
    val.extensions = decoder.decodeArrayPointer(new codec.PointerTo(vulkan_types$.VkExtensionProperties));
    val.layers = decoder.decodeArrayPointer(new codec.PointerTo(vulkan_types$.VkLayerProperties));
    val.features = decoder.decodeStructPointer(vulkan_types$.VkPhysicalDeviceFeatures);
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.queueFamilies = decoder.decodeArrayPointer(new codec.PointerTo(vulkan_types$.VkQueueFamilyProperties));
    return val;
  };
  ...
  VulkanPhysicalDeviceInfo.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(vulkan_types$.VkLayerProperties), val.layers);
  ...
  VulkanInfo.decode = function(decoder) {
    ...
    val.usedApiVersion = decoder.decodeStruct(codec.Uint32);
    val.instanceExtensions = decoder.decodeArrayPointer(new codec.PointerTo(vulkan_types$.VkExtensionProperties));
    val.enabledInstanceExtensions = decoder.decodeArrayPointer(codec.String);
    val.instanceLayers = decoder.decodeArrayPointer(new codec.PointerTo(vulkan_types$.VkLayerProperties));
    val.physicalDevices = decoder.decodeArrayPointer(new codec.PointerTo(VulkanPhysicalDeviceInfo));
    return val;
  };
