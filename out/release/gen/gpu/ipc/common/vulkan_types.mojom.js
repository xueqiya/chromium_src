...
(function() {
  ...
  VkExtensionProperties.decode = function(decoder) {
    ...
    val.extensionName = decoder.decodeStruct(codec.String);
    val.specVersion = decoder.decodeStruct(codec.Uint32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  VkLayerProperties.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.layerName = decoder.decodeStruct(codec.String);
    val.specVersion = decoder.decodeStruct(codec.Uint32);
    val.implementationVersion = decoder.decodeStruct(codec.Uint32);
  ...
  VkPhysicalDeviceLimits.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.maxImageDimension1D = decoder.decodeStruct(codec.Uint32);
    val.maxImageDimension2D = decoder.decodeStruct(codec.Uint32);
    val.maxImageDimension3D = decoder.decodeStruct(codec.Uint32);
    val.maxImageDimensionCube = decoder.decodeStruct(codec.Uint32);
    val.maxImageArrayLayers = decoder.decodeStruct(codec.Uint32);
    val.maxTexelBufferElements = decoder.decodeStruct(codec.Uint32);
    val.maxUniformBufferRange = decoder.decodeStruct(codec.Uint32);
    val.maxStorageBufferRange = decoder.decodeStruct(codec.Uint32);
    val.maxPushConstantsSize = decoder.decodeStruct(codec.Uint32);
    val.maxMemoryAllocationCount = decoder.decodeStruct(codec.Uint32);
    val.maxSamplerAllocationCount = decoder.decodeStruct(codec.Uint32);
    val.maxBoundDescriptorSets = decoder.decodeStruct(codec.Uint32);
    val.bufferImageGranularity = decoder.decodeStruct(codec.Uint64);
    val.sparseAddressSpaceSize = decoder.decodeStruct(codec.Uint64);
    val.maxPerStageDescriptorSamplers = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageDescriptorUniformBuffers = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageDescriptorStorageBuffers = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageDescriptorSampledImages = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageDescriptorStorageImages = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageDescriptorInputAttachments = decoder.decodeStruct(codec.Uint32);
    val.maxPerStageResources = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetSamplers = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetUniformBuffers = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetUniformBuffersDynamic = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetStorageBuffers = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetStorageBuffersDynamic = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetSampledImages = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetStorageImages = decoder.decodeStruct(codec.Uint32);
    val.maxDescriptorSetInputAttachments = decoder.decodeStruct(codec.Uint32);
    val.maxVertexInputAttributes = decoder.decodeStruct(codec.Uint32);
    val.maxVertexInputBindings = decoder.decodeStruct(codec.Uint32);
    val.maxVertexInputAttributeOffset = decoder.decodeStruct(codec.Uint32);
    val.maxVertexInputBindingStride = decoder.decodeStruct(codec.Uint32);
    val.maxVertexOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationGenerationLevel = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationPatchSize = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationControlPerVertexInputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationControlPerVertexOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationControlPerPatchOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationControlTotalOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationEvaluationInputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxTessellationEvaluationOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxGeometryShaderInvocations = decoder.decodeStruct(codec.Uint32);
    val.maxGeometryInputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxGeometryOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxGeometryOutputVertices = decoder.decodeStruct(codec.Uint32);
    val.maxGeometryTotalOutputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxFragmentInputComponents = decoder.decodeStruct(codec.Uint32);
    val.maxFragmentOutputAttachments = decoder.decodeStruct(codec.Uint32);
    val.maxFragmentDualSrcAttachments = decoder.decodeStruct(codec.Uint32);
    val.maxFragmentCombinedOutputResources = decoder.decodeStruct(codec.Uint32);
    val.maxComputeSharedMemorySize = decoder.decodeStruct(codec.Uint32);
    val.maxComputeWorkGroupCount = decoder.decodeArrayPointer(codec.Uint32);
    val.maxComputeWorkGroupInvocations = decoder.decodeStruct(codec.Uint32);
    val.subPixelPrecisionBits = decoder.decodeStruct(codec.Uint32);
    val.maxComputeWorkGroupSize = decoder.decodeArrayPointer(codec.Uint32);
    val.subTexelPrecisionBits = decoder.decodeStruct(codec.Uint32);
    val.mipmapPrecisionBits = decoder.decodeStruct(codec.Uint32);
    val.maxDrawIndexedIndexValue = decoder.decodeStruct(codec.Uint32);
    val.maxDrawIndirectCount = decoder.decodeStruct(codec.Uint32);
    val.maxSamplerLodBias = decoder.decodeStruct(codec.Float);
    val.maxSamplerAnisotropy = decoder.decodeStruct(codec.Float);
    val.maxViewports = decoder.decodeStruct(codec.Uint32);
    val.viewportSubPixelBits = decoder.decodeStruct(codec.Uint32);
    val.maxViewportDimensions = decoder.decodeArrayPointer(codec.Uint32);
    val.viewportBoundsRange = decoder.decodeArrayPointer(codec.Float);
    val.minMemoryMapAlignment = decoder.decodeStruct(codec.Uint64);
    val.minTexelBufferOffsetAlignment = decoder.decodeStruct(codec.Uint64);
    val.minUniformBufferOffsetAlignment = decoder.decodeStruct(codec.Uint64);
    val.minStorageBufferOffsetAlignment = decoder.decodeStruct(codec.Uint64);
    val.minTexelOffset = decoder.decodeStruct(codec.Int32);
    val.maxTexelOffset = decoder.decodeStruct(codec.Uint32);
    val.minTexelGatherOffset = decoder.decodeStruct(codec.Int32);
    val.maxTexelGatherOffset = decoder.decodeStruct(codec.Uint32);
    val.minInterpolationOffset = decoder.decodeStruct(codec.Float);
    val.maxInterpolationOffset = decoder.decodeStruct(codec.Float);
    val.subPixelInterpolationOffsetBits = decoder.decodeStruct(codec.Uint32);
    val.maxFramebufferWidth = decoder.decodeStruct(codec.Uint32);
    val.maxFramebufferHeight = decoder.decodeStruct(codec.Uint32);
    val.maxFramebufferLayers = decoder.decodeStruct(codec.Uint32);
    val.framebufferColorSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.framebufferDepthSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.framebufferStencilSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.framebufferNoAttachmentsSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.maxColorAttachments = decoder.decodeStruct(codec.Uint32);
    val.sampledImageColorSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.sampledImageIntegerSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.sampledImageDepthSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.sampledImageStencilSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.storageImageSampleCounts = decoder.decodeStruct(codec.Uint32);
    val.maxSampleMaskWords = decoder.decodeStruct(codec.Uint32);
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.timestampPeriod = decoder.decodeStruct(codec.Float);
    val.maxClipDistances = decoder.decodeStruct(codec.Uint32);
    val.maxCullDistances = decoder.decodeStruct(codec.Uint32);
    val.maxCombinedClipAndCullDistances = decoder.decodeStruct(codec.Uint32);
    val.discreteQueuePriorities = decoder.decodeStruct(codec.Uint32);
    val.pointSizeGranularity = decoder.decodeStruct(codec.Float);
    val.pointSizeRange = decoder.decodeArrayPointer(codec.Float);
    val.lineWidthRange = decoder.decodeArrayPointer(codec.Float);
    val.lineWidthGranularity = decoder.decodeStruct(codec.Float);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.optimalBufferCopyOffsetAlignment = decoder.decodeStruct(codec.Uint64);
    val.optimalBufferCopyRowPitchAlignment = decoder.decodeStruct(codec.Uint64);
    val.nonCoherentAtomSize = decoder.decodeStruct(codec.Uint64);
    return val;
  };
  ...
  VkPhysicalDeviceProperties.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.apiVersion = decoder.decodeStruct(codec.Uint32);
    val.driverVersion = decoder.decodeStruct(codec.Uint32);
    ...
    val.pipelineCacheUUID = decoder.decodeArrayPointer(codec.Uint8);
    val.limits = decoder.decodeStructPointer(VkPhysicalDeviceLimits);
    val.sparseProperties = decoder.decodeStructPointer(VkPhysicalDeviceSparseProperties);
    return val;
  };
  ...
  VkExtent3D.decode = function(decoder) {
    ...
    val.depth = decoder.decodeStruct(codec.Uint32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  VkQueueFamilyProperties.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.queueFlags = decoder.decodeStruct(codec.Uint32);
    val.queueCount = decoder.decodeStruct(codec.Uint32);
    val.timestampValidBits = decoder.decodeStruct(codec.Uint32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.minImageTransferGranularity = decoder.decodeStructPointer(VkExtent3D);
    return val;
  };
