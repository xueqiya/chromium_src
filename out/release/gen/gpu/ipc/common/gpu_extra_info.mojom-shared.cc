// gpu/ipc/common/gpu_extra_info.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool ANGLEFeature_Data::Validate(
  ...
  const ANGLEFeature_Data* object = static_cast<const ANGLEFeature_Data*>(data);
...
bool GpuExtraInfo_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const GpuExtraInfo_Data* object = static_cast<const GpuExtraInfo_Data*>(data);
