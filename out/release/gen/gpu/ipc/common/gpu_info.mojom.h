...
class  GpuInfo {
 public:
  ...
  GpuInfo(
      ...
      const base::Optional<::gpu::VulkanInfo>& vulkan_info);
  ...
  base::Optional<::gpu::VulkanInfo> vulkan_info;
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.can_support_threaded_texture_mailbox < lhs.can_support_threaded_texture_mailbox)
    return false;
  if (lhs.video_decode_accelerator_capabilities < rhs.video_decode_accelerator_capabilities)
    return true;
  if (rhs.video_decode_accelerator_capabilities < lhs.video_decode_accelerator_capabilities)
    return false;
  ...
  if (rhs.image_decode_accelerator_supported_profiles < lhs.image_decode_accelerator_supported_profiles)
    return false;
  if (lhs.oop_rasterization_supported < rhs.oop_rasterization_supported)
    return true;
  if (rhs.oop_rasterization_supported < lhs.oop_rasterization_supported)
    return false;
