...
extern PROTOBUF_INTERNAL_EXPORT_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<14> scc_info_DataSourceConfig_protos_2fperfetto_2fconfig_2fdata_5fsource_5fconfig_2eproto;
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&lockdown_mode_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&flush_period_ms_) -
        reinterpret_cast<char*>(&lockdown_mode_)) + sizeof(flush_period_ms_));
  }
  if (cached_has_bits & 0x003f0000u) {
    ::memset(&flush_timeout_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&trace_uuid_lsb_) -
        reinterpret_cast<char*>(&flush_timeout_ms_)) + sizeof(trace_uuid_lsb_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
