...
// optional int32 tid = 1;
inline bool PerfEventConfig::has_tid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PerfEventConfig::clear_tid() {
  tid_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PerfEventConfig::tid() const {
  // @@protoc_insertion_point(field_get:perfetto.protos.PerfEventConfig.tid)
  return tid_;
}
inline void PerfEventConfig::set_tid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  tid_ = value;
  // @@protoc_insertion_point(field_set:perfetto.protos.PerfEventConfig.tid)
}
