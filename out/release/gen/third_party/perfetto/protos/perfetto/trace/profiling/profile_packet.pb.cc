...
class ProfilePacket_HeapSample::_Internal {
 public:
  ...
  static void set_has_self_idle(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
...
ProfilePacket_HeapSample::ProfilePacket_HeapSample(const ProfilePacket_HeapSample& from)
  ...
  ::memcpy(&callstack_id_, &from.callstack_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&self_max_) -
    reinterpret_cast<char*>(&callstack_id_)) + sizeof(self_max_));
...
void ProfilePacket_HeapSample::SharedCtor() {
  ::memset(&callstack_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&self_max_) -
      reinterpret_cast<char*>(&callstack_id_)) + sizeof(self_max_));
}
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          _Internal::set_has_self_idle(&has_bits);
          self_idle_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (56 & 0xFF)) {
          _Internal::set_has_self_idle(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT64>(
                 input, &self_idle_)));
        } else {
...
void ProfilePacket_HeapSample::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000040u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(7, this->self_idle(), output);
  }
...
void ProfilePacket_HeapSample::InternalSwap(ProfilePacket_HeapSample* other) {
  ...
  swap(self_idle_, other->self_idle_);
...
ProfilePacket_ProcessStats::ProfilePacket_ProcessStats(const ProfilePacket_ProcessStats& from)
  ...
  ::memcpy(&unwinding_errors_, &from.unwinding_errors_,
    static_cast<size_t>(reinterpret_cast<char*>(&total_unwinding_time_us_) -
    reinterpret_cast<char*>(&unwinding_errors_)) + sizeof(total_unwinding_time_us_));
...
void ProfilePacket_ProcessStats::SharedCtor() {
  ...
  ::memset(&unwinding_time_us_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&total_unwinding_time_us_) -
      reinterpret_cast<char*>(&unwinding_time_us_)) + sizeof(total_unwinding_time_us_));
}
...
void ProfilePacket_ProcessHeapSamples::SharedCtor() {
  ...
  ::memset(&stats_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&stats_)) + sizeof(timestamp_));
}
