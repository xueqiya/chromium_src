...
class ProfilePacket_HeapSample :
 ...
 public:
  ...
  bool has_self_idle() const;
  void clear_self_idle();
  ::PROTOBUF_NAMESPACE_ID::uint64 self_idle() const;
  void set_self_idle(::PROTOBUF_NAMESPACE_ID::uint64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 self_idle_;
...
// optional uint64 self_idle = 7;
inline bool ProfilePacket_HeapSample::has_self_idle() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ProfilePacket_HeapSample::clear_self_idle() {
  self_idle_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000040u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ProfilePacket_HeapSample::self_idle() const {
  // @@protoc_insertion_point(field_get:perfetto.protos.ProfilePacket.HeapSample.self_idle)
  return self_idle_;
}
inline void ProfilePacket_HeapSample::set_self_idle(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000040u;
  self_idle_ = value;
  // @@protoc_insertion_point(field_set:perfetto.protos.ProfilePacket.HeapSample.self_idle)
}
