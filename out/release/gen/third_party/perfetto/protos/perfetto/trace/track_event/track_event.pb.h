...
constexpr TrackEvent_Type TrackEvent_Type_Type_MAX = TrackEvent_Type_TYPE_INSTANT;
...
inline void TrackEvent::set_has_thread_instruction_count_delta() {
  _oneof_case_[2] = kThreadInstructionCountDelta;
}
...
inline void TrackEvent::set_has_thread_instruction_count_absolute() {
  _oneof_case_[2] = kThreadInstructionCountAbsolute;
}
...
inline TrackEvent::ThreadInstructionCountCase TrackEvent::thread_instruction_count_case() const {
  return TrackEvent::ThreadInstructionCountCase(_oneof_case_[2]);
}
