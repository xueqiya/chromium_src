...
extern PROTOBUF_INTERNAL_EXPORT_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5flatency_5finfo_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeLatencyInfo_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5flatency_5finfo_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<10> scc_info_TrackEvent_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftrack_5fevent_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 10, InitDefaultsscc_info_TrackEvent_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftrack_5fevent_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> TrackEvent_Type_strings[4] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry TrackEvent_Type_entries[] = {
  { {TrackEvent_Type_names + 0, 12}, 3 },
  { {TrackEvent_Type_names + 12, 16}, 1 },
  { {TrackEvent_Type_names + 28, 14}, 2 },
  { {TrackEvent_Type_names + 42, 16}, 0 },
};

static const int TrackEvent_Type_entries_by_number[] = {
  3, // 0 -> TYPE_UNSPECIFIED
  1, // 1 -> TYPE_SLICE_BEGIN
  2, // 2 -> TYPE_SLICE_END
  0, // 3 -> TYPE_INSTANT
};
...
bool TrackEvent_Type_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      TrackEvent_Type_entries, 4, name, &int_value);
  if (success) {
...
// @@protoc_insertion_point(one_of_clear_start:perfetto.protos.TrackEvent)
  ...
  _oneof_case_[2] = THREAD_INSTRUCTION_COUNT_NOT_SET;
}
