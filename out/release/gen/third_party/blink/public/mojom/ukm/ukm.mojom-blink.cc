// third_party/blink/public/mojom/ukm/ukm.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool UkmSourceIdFrameHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::UkmSourceIdFrameHost::Name_;
