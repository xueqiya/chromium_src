// third_party/blink/public/mojom/insecure_input/insecure_input_service.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool InsecureInputServiceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kInsecureInputService_DidEditFieldInInsecureContext_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::InsecureInputService::DidEditFieldInInsecureContext",
...
static const mojo::internal::GenericValidationInfo kInsecureInputServiceValidationInfo[] = {
    {&internal::InsecureInputService_DidEditFieldInInsecureContext_Params_Data::Validate,
     nullptr /* no response */},
};

bool InsecureInputServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::InsecureInputService::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kInsecureInputServiceValidationInfo);
}
