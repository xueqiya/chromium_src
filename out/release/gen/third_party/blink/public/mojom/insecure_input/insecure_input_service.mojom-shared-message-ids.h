// third_party/blink/public/mojom/insecure_input/insecure_input_service.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
constexpr uint32_t kInsecureInputService_DidEditFieldInInsecureContext_Name = 0;
