// third_party/blink/public/mojom/insecure_input/insecure_input_service.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool InsecureInputServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::InsecureInputService::Name_;
