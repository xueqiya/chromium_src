// third_party/blink/public/mojom/bluetooth/web_bluetooth.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void WebBluetoothServiceInterceptorForTesting::RemoteServerConnect(const ::WTF::String& device_id, mojo::PendingAssociatedRemote<WebBluetoothServerClient> client, RemoteServerConnectCallback callback) {
