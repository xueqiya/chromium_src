  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_GetAvailability_Params_Data));
      new (data()) WebBluetoothService_GetAvailability_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_GetAvailability_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_GetAvailability_Params_Data>(index_);
    }
    WebBluetoothService_GetAvailability_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebBluetoothService_GetAvailability_ResponseParams_Data));
      new (data()) WebBluetoothService_GetAvailability_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebBluetoothService_GetAvailability_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebBluetoothService_GetAvailability_ResponseParams_Data>(index_);
    }
    WebBluetoothService_GetAvailability_ResponseParams_Data* operator->() { return data(); }
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) WebBluetoothScanClient_ScanEvent_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
