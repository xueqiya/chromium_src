...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) RequestScanningStartResult_Data {
 public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) WebBluetoothScanResult_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
