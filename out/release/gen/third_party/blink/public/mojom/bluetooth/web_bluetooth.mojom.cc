...
WebBluetoothLeScanFilter::WebBluetoothLeScanFilter(
    base::Optional<std::vector<::device::BluetoothUUID>> services_in,
...
void WebBluetoothServiceProxy::RemoteServerGetPrimaryServices(
    const ::blink::WebBluetoothDeviceId& in_device_id, WebBluetoothGATTQueryQuantity in_quantity, const base::Optional<::device::BluetoothUUID>& in_services_uuid, RemoteServerGetPrimaryServicesCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WebBluetoothServiceProxy::RequestScanningStart(
    mojo::PendingAssociatedRemote<WebBluetoothScanClient> in_client, WebBluetoothRequestLEScanOptionsPtr in_options, RequestScanningStartCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_value), std::move(callback));
    ...
    case internal::kWebBluetoothService_RequestScanningStart_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingAssociatedRemote<WebBluetoothScanClient> p_client{};
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebBluetoothScanClient::ScanEvent");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool WebBluetoothScanClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kWebBluetoothScanClient_ScanEvent_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::WebBluetoothScanClient::ScanEvent",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::WebBluetoothScanClient::ScanEvent");
...
static const mojo::internal::GenericValidationInfo kWebBluetoothScanClientValidationInfo[] = {
    {&internal::WebBluetoothScanClient_ScanEvent_Params_Data::Validate,
     nullptr /* no response */},
};

bool WebBluetoothScanClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::WebBluetoothScanClient::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kWebBluetoothScanClientValidationInfo);
}
