...
class BLINK_COMMON_EXPORT WebBluetoothServiceInterceptorForTesting : public WebBluetoothService {
  ...
  void RequestScanningStart(mojo::PendingAssociatedRemote<WebBluetoothScanClient> client, WebBluetoothRequestLEScanOptionsPtr options, RequestScanningStartCallback callback) override;
};
...
class BLINK_COMMON_EXPORT WebBluetoothScanClientInterceptorForTesting : public WebBluetoothScanClient {
  virtual WebBluetoothScanClient* GetForwardingInterface() = 0;
  void ScanEvent(WebBluetoothScanResultPtr result) override;
};
class BLINK_COMMON_EXPORT WebBluetoothScanClientAsyncWaiter {
 public:
