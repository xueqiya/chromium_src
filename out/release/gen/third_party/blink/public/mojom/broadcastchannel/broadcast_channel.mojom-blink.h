...
class CORE_EXPORT BroadcastChannelProvider
 ...
 public:
  ...
  virtual void ConnectToChannel(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::String& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) = 0;
};
...
class CORE_EXPORT BroadcastChannelProviderProxy
 ...
 public:
  ...
  void ConnectToChannel(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::String& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) final;
