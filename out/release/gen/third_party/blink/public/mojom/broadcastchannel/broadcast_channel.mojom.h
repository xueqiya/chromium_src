...
class CONTENT_EXPORT BroadcastChannelProvider
 ...
 public:
  ...
  virtual void ConnectToChannel(const ::url::Origin& origin, const std::string& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) = 0;
};
...
class CONTENT_EXPORT BroadcastChannelProviderProxy
 ...
 public:
  ...
  void ConnectToChannel(const ::url::Origin& origin, const std::string& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) final;
