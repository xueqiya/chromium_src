...
class CORE_EXPORT BroadcastChannelProviderInterceptorForTesting : public BroadcastChannelProvider {
  ...
  void ConnectToChannel(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::String& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) override;
};
