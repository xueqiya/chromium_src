...
class CONTENT_EXPORT BroadcastChannelProviderInterceptorForTesting : public BroadcastChannelProvider {
  ...
  void ConnectToChannel(const ::url::Origin& origin, const std::string& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) override;
};
