// third_party/blink/public/mojom/broadcastchannel/broadcast_channel.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void BroadcastChannelProviderInterceptorForTesting::ConnectToChannel(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::String& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) {
