...
void BroadcastChannelProviderProxy::ConnectToChannel(
    const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, const WTF::String& in_name, mojo::PendingAssociatedRemote<BroadcastChannelClient> in_receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> in_sender) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
