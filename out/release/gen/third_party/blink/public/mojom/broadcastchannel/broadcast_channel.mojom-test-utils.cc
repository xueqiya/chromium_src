// third_party/blink/public/mojom/broadcastchannel/broadcast_channel.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void BroadcastChannelProviderInterceptorForTesting::ConnectToChannel(const ::url::Origin& origin, const std::string& name, mojo::PendingAssociatedRemote<BroadcastChannelClient> receiver, mojo::PendingAssociatedReceiver<BroadcastChannelClient> sender) {
