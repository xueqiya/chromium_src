// third_party/blink/public/mojom/contacts/contacts_manager.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ContactsManagerAsyncWaiter::Select(
    bool multiple, bool include_names, bool include_emails, bool include_tel, bool include_addresses, bool include_icons, base::Optional<WTF::Vector<ContactInfoPtr>>* out_contacts) {
  base::RunLoop loop;
