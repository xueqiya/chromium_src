...
ContactInfo::ContactInfo(
    base::Optional<WTF::Vector<WTF::String>> name_in,
    base::Optional<WTF::Vector<WTF::String>> email_in,
    base::Optional<WTF::Vector<WTF::String>> tel_in,
    base::Optional<WTF::Vector<::payments::mojom::blink::PaymentAddressPtr>> address_in,
    base::Optional<WTF::Vector<ContactIconBlobPtr>> icon_in)
