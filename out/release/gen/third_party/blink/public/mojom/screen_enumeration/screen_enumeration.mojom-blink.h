// third_party/blink/public/mojom/screen_enumeration/screen_enumeration.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_SCREEN_ENUMERATION_SCREEN_ENUMERATION_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_SCREEN_ENUMERATION_SCREEN_ENUMERATION_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/screen_enumeration/screen_enumeration.mojom-blink-forward.h"
...
class PLATFORM_EXPORT ScreenEnumeration
 ...
 public:
  ...
  using GetDisplaysCallback = base::OnceCallback<void(WTF::Vector<::display::mojom::blink::DisplayPtr>, int64_t, int64_t, bool)>;
...
class PLATFORM_EXPORT ScreenEnumerationProxy
...
class PLATFORM_EXPORT ScreenEnumerationStubDispatch {
 public:
...
class PLATFORM_EXPORT ScreenEnumerationRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT ScreenEnumerationResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_SCREEN_ENUMERATION_SCREEN_ENUMERATION_MOJOM_BLINK_H_