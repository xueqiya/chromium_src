...
class WorkerContentSettingsProxy_AllowWebLocks_HandleSyncResponse
 ...
 private:
  bool* result_;
  bool* out_result_;DISALLOW_COPY_AND_ASSIGN(WorkerContentSettingsProxy_AllowWebLocks_HandleSyncResponse);
};
...
class WorkerContentSettingsProxy_AllowWebLocks_ForwardToCallback
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(WorkerContentSettingsProxy_AllowWebLocks_ForwardToCallback);
};
...
bool WorkerContentSettingsProxyProxy::AllowCacheStorage(
    bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WorkerContentSettingsProxy::AllowCacheStorage");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
bool WorkerContentSettingsProxyProxy::AllowWebLocks(
    bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WorkerContentSettingsProxy::AllowWebLocks");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
  ...
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::WorkerContentSettingsProxy_AllowWebLocks_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  message.AttachHandlesFromSerializationContext(
...
bool WorkerContentSettingsProxy_AllowCacheStorage_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::WorkerContentSettingsProxy::AllowCacheStorageCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WorkerContentSettingsProxy::AllowCacheStorageCallback",
               "message", message.name());
#endif
...
class WorkerContentSettingsProxy_AllowWebLocks_ProxyToResponder {
 public:
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(WorkerContentSettingsProxy_AllowWebLocks_ProxyToResponder);
};

bool WorkerContentSettingsProxy_AllowWebLocks_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::WorkerContentSettingsProxy::AllowWebLocksCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  bool success = true;
  bool p_result{};
  WorkerContentSettingsProxy_AllowWebLocks_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void WorkerContentSettingsProxy_AllowWebLocks_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kWorkerContentSettingsProxy_AllowWebLocks_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->result = in_result;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WorkerContentSettingsProxy::AllowWebLocksCallback",
               "message", message.name());
#endif
...
bool WorkerContentSettingsProxyStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kWorkerContentSettingsProxy_AllowWebLocks_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      WorkerContentSettingsProxy_AllowWebLocks_ParamsDataView input_data_view(params, &serialization_context);
