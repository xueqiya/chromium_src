 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WorkerContentSettingsProxy_AllowWebLocks_Params_Data));
      new (data()) WorkerContentSettingsProxy_AllowWebLocks_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WorkerContentSettingsProxy_AllowWebLocks_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WorkerContentSettingsProxy_AllowWebLocks_Params_Data>(index_);
    }
    WorkerContentSettingsProxy_AllowWebLocks_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data));
      new (data()) WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data>(index_);
    }
    WorkerContentSettingsProxy_AllowWebLocks_ResponseParams_Data* operator->() { return data(); }
