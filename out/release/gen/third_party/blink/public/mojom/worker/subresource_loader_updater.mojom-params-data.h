  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data));
      new (data()) SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data>(index_);
    }
    SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data* operator->() { return data(); }
