...
class BLINK_COMMON_EXPORT SharedWorkerFactoryProxy
 ...
 public:
  ...
  void CreateSharedWorker(::blink::mojom::SharedWorkerInfoPtr info, const std::string& user_agent, bool pause_on_start, const ::base::UnguessableToken& devtools_worker_token, ::blink::mojom::RendererPreferencesPtr renderer_preferences, mojo::PendingReceiver<::blink::mojom::RendererPreferenceWatcher> preference_watcher_receiver, mojo::PendingRemote<::blink::mojom::WorkerContentSettingsProxy> content_settings, ::blink::mojom::ServiceWorkerProviderInfoForClientPtr service_worker_provider_info, const base::Optional<::base::UnguessableToken>& appcache_host_id, ::blink::mojom::WorkerMainScriptLoadParamsPtr main_script_load_params, ::std::unique_ptr<::blink::PendingURLLoaderFactoryBundle> subresource_loader_factories, ::blink::mojom::ControllerServiceWorkerInfoPtr controller_info, mojo::PendingRemote<::blink::mojom::SharedWorkerHost> host, mojo::PendingReceiver<::blink::mojom::SharedWorker> shared_worker, mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker) final;
