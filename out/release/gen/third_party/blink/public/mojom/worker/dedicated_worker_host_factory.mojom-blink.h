...
class CORE_EXPORT DedicatedWorkerHostFactoryClient
 ...
 public:
  ...
  virtual void OnWorkerHostCreated(mojo::PendingRemote<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker) = 0;

  
  virtual void OnScriptLoadStarted(::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr service_worker_provider_info, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr main_script_load_params, ::blink::mojom::blink::URLLoaderFactoryBundlePtr subresource_loader_factories, mojo::PendingReceiver<::blink::mojom::blink::SubresourceLoaderUpdater> subresource_loader_updater, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr controller_info) = 0;
...
class CORE_EXPORT DedicatedWorkerHostFactory
 ...
 public:
  ...
  virtual void CreateWorkerHost(mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host) = 0;

  
  virtual void CreateWorkerHostAndStartScriptLoad(const ::blink::KURL& script_url, ::network::mojom::blink::CredentialsMode credentials_mode, ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token, mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client, mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host) = 0;
};
...
class CORE_EXPORT DedicatedWorkerHostFactoryClientProxy
 ...
 public:
  ...
  void OnWorkerHostCreated(mojo::PendingRemote<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker) final;
  
  void OnScriptLoadStarted(::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr service_worker_provider_info, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr main_script_load_params, ::blink::mojom::blink::URLLoaderFactoryBundlePtr subresource_loader_factories, mojo::PendingReceiver<::blink::mojom::blink::SubresourceLoaderUpdater> subresource_loader_updater, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr controller_info) final;
...
class CORE_EXPORT DedicatedWorkerHostFactoryProxy
 ...
 public:
  ...
  void CreateWorkerHost(mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host) final;
  
  void CreateWorkerHostAndStartScriptLoad(const ::blink::KURL& script_url, ::network::mojom::blink::CredentialsMode credentials_mode, ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token, mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client, mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host) final;
