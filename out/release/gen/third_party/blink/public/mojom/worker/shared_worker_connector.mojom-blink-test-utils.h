...
class PLATFORM_EXPORT SharedWorkerConnectorInterceptorForTesting : public SharedWorkerConnector {
  ...
  void Connect(::blink::mojom::blink::SharedWorkerInfoPtr info, ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::blink::SharedWorkerClient> client, ::blink::mojom::blink::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token) override;
};
