// third_party/blink/public/mojom/worker/shared_worker_connector.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void SharedWorkerConnectorInterceptorForTesting::Connect(::blink::mojom::blink::SharedWorkerInfoPtr info, ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::blink::SharedWorkerClient> client, ::blink::mojom::blink::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token) {
  GetForwardingInterface()->Connect(std::move(info), std::move(outside_fetch_client_settings_object), std::move(client), std::move(creation_context_type), std::move(message_port), std::move(blob_url_token));
}
