...
bool SharedWorkerFactory_CreateSharedWorker_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->devtools_worker_token, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->renderer_preferences, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->preference_watcher_receiver, 6, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->content_settings, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->main_script_load_params, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->subresource_loader_factories, 11, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->browser_interface_broker, 15, validation_context)) {
    return false;
  }
