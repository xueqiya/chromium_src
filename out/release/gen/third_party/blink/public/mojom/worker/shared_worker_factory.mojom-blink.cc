...
void SharedWorkerFactoryProxy::CreateSharedWorker(
    ::blink::mojom::blink::SharedWorkerInfoPtr in_info, const WTF::String& in_user_agent, bool in_pause_on_start, const ::base::UnguessableToken& in_devtools_worker_token, ::blink::mojom::blink::RendererPreferencesPtr in_renderer_preferences, mojo::PendingReceiver<::blink::mojom::blink::RendererPreferenceWatcher> in_preference_watcher_receiver, mojo::PendingRemote<::blink::mojom::blink::WorkerContentSettingsProxy> in_content_settings, ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr in_service_worker_provider_info, const base::Optional<::base::UnguessableToken>& in_appcache_host_id, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr in_main_script_load_params, ::blink::mojom::blink::URLLoaderFactoryBundlePtr in_subresource_loader_factories, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr in_controller_info, mojo::PendingRemote<::blink::mojom::blink::SharedWorkerHost> in_host, mojo::PendingReceiver<::blink::mojom::blink::SharedWorker> in_shared_worker, mojo::PendingRemote<::blink::mojom::blink::BrowserInterfaceBroker> in_browser_interface_broker) {
...
bool SharedWorkerFactoryStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kSharedWorkerFactory_CreateSharedWorker_Name: {
      ...
      ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr p_service_worker_provider_info{};
