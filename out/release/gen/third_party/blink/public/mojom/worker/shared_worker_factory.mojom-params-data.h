...
static_assert(sizeof(SharedWorkerFactory_CreateSharedWorker_Params_Data) == 120,
...
inline void SharedWorkerFactory_CreateSharedWorker_ParamsDataView::GetAppcacheHostIdDataView(
    ::mojo_base::mojom::UnguessableTokenDataView* output) {
  auto pointer = data_->appcache_host_id.Get();
  *output = ::mojo_base::mojom::UnguessableTokenDataView(pointer, context_);
}
