...
class BLINK_COMMON_EXPORT SharedWorkerConnector
 ...
 public:
  ...
  virtual void Connect(::blink::mojom::SharedWorkerInfoPtr info, ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::SharedWorkerClient> client, ::blink::mojom::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token) = 0;
};
...
class BLINK_COMMON_EXPORT SharedWorkerConnectorProxy
 ...
 public:
  ...
  void Connect(::blink::mojom::SharedWorkerInfoPtr info, ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::SharedWorkerClient> client, ::blink::mojom::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token) final;
