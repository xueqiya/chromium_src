...
void SharedWorkerConnectorProxy::Connect(
    ::blink::mojom::SharedWorkerInfoPtr in_info, ::blink::mojom::FetchClientSettingsObjectPtr in_outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::SharedWorkerClient> in_client, ::blink::mojom::SharedWorkerCreationContextType in_creation_context_type, mojo::ScopedMessagePipeHandle in_message_port, mojo::PendingRemote<::blink::mojom::BlobURLToken> in_blob_url_token) {
