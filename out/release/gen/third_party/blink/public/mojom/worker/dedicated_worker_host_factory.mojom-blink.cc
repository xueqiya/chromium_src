...
void DedicatedWorkerHostFactoryClientProxy::OnScriptLoadStarted(
    ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr in_service_worker_provider_info, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr in_main_script_load_params, ::blink::mojom::blink::URLLoaderFactoryBundlePtr in_subresource_loader_factories, mojo::PendingReceiver<::blink::mojom::blink::SubresourceLoaderUpdater> in_subresource_loader_updater, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr in_controller_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DedicatedWorkerHostFactoryProxy::CreateWorkerHostAndStartScriptLoad(
    const ::blink::KURL& in_script_url, ::network::mojom::blink::CredentialsMode in_credentials_mode, ::blink::mojom::blink::FetchClientSettingsObjectPtr in_outside_fetch_client_settings_object, mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> in_blob_url_token, mojo::PendingRemote<DedicatedWorkerHostFactoryClient> in_client, mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> in_host) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
