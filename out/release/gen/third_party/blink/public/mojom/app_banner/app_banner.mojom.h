...
class BLINK_COMMON_EXPORT AppBannerController
 ...
 public:
  ...
  virtual void BannerPromptRequest(mojo::PendingRemote<AppBannerService> service, mojo::PendingReceiver<AppBannerEvent> event_receiver, const std::vector<std::string>& platform, BannerPromptRequestCallback callback) = 0;
};
...
class BLINK_COMMON_EXPORT AppBannerControllerProxy
 ...
 public:
  ...
  void BannerPromptRequest(mojo::PendingRemote<AppBannerService> service, mojo::PendingReceiver<AppBannerEvent> event_receiver, const std::vector<std::string>& platform, BannerPromptRequestCallback callback) final;
