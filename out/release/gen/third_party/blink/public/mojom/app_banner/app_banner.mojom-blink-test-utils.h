...
class PLATFORM_EXPORT AppBannerControllerInterceptorForTesting : public AppBannerController {
  ...
  void BannerPromptRequest(mojo::PendingRemote<AppBannerService> service, mojo::PendingReceiver<AppBannerEvent> event_receiver, const WTF::Vector<WTF::String>& platform, BannerPromptRequestCallback callback) override;
};
