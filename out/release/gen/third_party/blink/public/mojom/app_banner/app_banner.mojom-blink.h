...
class PLATFORM_EXPORT AppBannerController
 ...
 public:
  ...
  virtual void BannerPromptRequest(mojo::PendingRemote<AppBannerService> service, mojo::PendingReceiver<AppBannerEvent> event_receiver, const WTF::Vector<WTF::String>& platform, BannerPromptRequestCallback callback) = 0;
};
...
class PLATFORM_EXPORT AppBannerControllerProxy
 ...
 public:
  ...
  void BannerPromptRequest(mojo::PendingRemote<AppBannerService> service, mojo::PendingReceiver<AppBannerEvent> event_receiver, const WTF::Vector<WTF::String>& platform, BannerPromptRequestCallback callback) final;
