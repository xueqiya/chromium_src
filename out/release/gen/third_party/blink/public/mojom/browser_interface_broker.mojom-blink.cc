...
void BrowserInterfaceBrokerProxy::GetInterface(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::BrowserInterfaceBroker::GetInterface");
#endif
  ...
  ::blink::mojom::internal::BrowserInterfaceBroker_GetInterface_Params_Data::BufferWriter
      params;
...
bool BrowserInterfaceBrokerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kBrowserInterfaceBroker_GetInterface_Name: {
      ...
      BrowserInterfaceBroker_GetInterface_ParamsDataView input_data_view(params, &serialization_context);
