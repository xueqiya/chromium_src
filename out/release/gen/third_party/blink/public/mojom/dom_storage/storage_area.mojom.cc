...
bool StorageAreaGetAllCallbackRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::StorageAreaGetAllCallback::Name_;
...
bool StorageArea::GetAll(mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, bool* out_success, std::vector<KeyValuePtr>* out_data) {
  NOTREACHED();
  return false;
}
...
bool StorageAreaProxy::GetAll(
    mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> param_complete_callback, bool* out_param_success, std::vector<KeyValuePtr>* out_param_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
