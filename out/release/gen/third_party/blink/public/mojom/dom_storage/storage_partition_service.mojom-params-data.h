// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom-params-data.h is auto generated by mojom_bindings_generator.py, do not edit
...
namespace mojom {
namespace internal {
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM_SHARED) StoragePartitionService_OpenLocalStorage_Params_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM_SHARED) StoragePartitionService_OpenSessionStorage_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
