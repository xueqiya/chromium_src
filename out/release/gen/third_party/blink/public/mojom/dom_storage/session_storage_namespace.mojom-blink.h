...
class PLATFORM_EXPORT SessionStorageNamespace
 ...
 public:
  ...
  virtual void OpenArea(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::StorageArea> area) = 0;
...
class PLATFORM_EXPORT SessionStorageNamespaceProxy
 ...
 public:
  ...
  void OpenArea(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::StorageArea> area) final;
