...
void StorageAreaObserverProxy::KeyAdded(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaObserver::KeyAdded");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaObserver::KeyChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaObserver::KeyDeleted");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaObserver::AllDeleted");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void StorageAreaObserverProxy::ShouldSendOldValueOnMutations(
    bool in_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaObserver::ShouldSendOldValueOnMutations");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool StorageAreaObserverStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kStorageAreaObserver_KeyAdded_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::StorageAreaObserver::KeyAdded",
...
static const mojo::internal::GenericValidationInfo kStorageAreaObserverValidationInfo[] = {
    {&internal::StorageAreaObserver_KeyAdded_Params_Data::Validate,
     nullptr /* no response */},
...
void StorageAreaGetAllCallbackProxy::Complete(
    bool in_success) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageAreaGetAllCallback::Complete");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool StorageAreaGetAllCallbackStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kStorageAreaGetAllCallback_Complete_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::StorageAreaGetAllCallback::Complete",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::StorageAreaGetAllCallback::Complete");
...
static const mojo::internal::GenericValidationInfo kStorageAreaGetAllCallbackValidationInfo[] = {
    {&internal::StorageAreaGetAllCallback_Complete_Params_Data::Validate,
     nullptr /* no response */},
};

bool StorageAreaGetAllCallbackRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::StorageAreaGetAllCallback::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kStorageAreaGetAllCallbackValidationInfo);
}
...
bool StorageArea::GetAll(mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, bool* out_success, WTF::Vector<KeyValuePtr>* out_data) {
  NOTREACHED();
  return false;
}
...
void StorageAreaProxy::AddObserver(
    mojo::PendingAssociatedRemote<StorageAreaObserver> in_observer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::AddObserver");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::Put");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::Delete");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::DeleteAll");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::Get");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool StorageAreaProxy::GetAll(
    mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> param_complete_callback, bool* out_param_success, WTF::Vector<KeyValuePtr>* out_param_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::GetAll");
#endif
  const bool kExpectsResponse = true;
...
void StorageAreaProxy::GetAll(
    mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> in_complete_callback, GetAllCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StorageArea::GetAll");
#endif
  const bool kExpectsResponse = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::StorageArea::PutCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::StorageArea::DeleteCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::StorageArea::DeleteAllCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::StorageArea::GetCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::StorageArea::GetAllCallback",
               "message", message.name());
#endif
...
bool StorageAreaStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kStorageArea_AddObserver_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingAssociatedRemote<StorageAreaObserver> p_observer{};
...
std::move(p_key), std::move(callback));
    ...
    case internal::kStorageArea_GetAll_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> p_complete_callback{};
