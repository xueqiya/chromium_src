// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StoragePartitionServiceProxy::OpenLocalStorage(
    const ::url::Origin& in_origin, mojo::PendingReceiver<::blink::mojom::StorageArea> in_area) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StoragePartitionService::OpenLocalStorage");
#endif
...
void StoragePartitionServiceProxy::OpenSessionStorage(
    const std::string& in_namespace_id, mojo::PendingReceiver<::blink::mojom::SessionStorageNamespace> in_session_namespace) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::StoragePartitionService::OpenSessionStorage");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool StoragePartitionServiceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kStoragePartitionService_OpenLocalStorage_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::StoragePartitionService::OpenLocalStorage",
...
std::move(p_area));
    ...
    case internal::kStoragePartitionService_OpenSessionStorage_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::StoragePartitionService::OpenSessionStorage",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::StoragePartitionService::OpenSessionStorage");
      ...
      mojo::PendingReceiver<::blink::mojom::SessionStorageNamespace> p_session_namespace{};
...
static const mojo::internal::GenericValidationInfo kStoragePartitionServiceValidationInfo[] = {
    {&internal::StoragePartitionService_OpenLocalStorage_Params_Data::Validate,
     nullptr /* no response */},
    {&internal::StoragePartitionService_OpenSessionStorage_Params_Data::Validate,
     nullptr /* no response */},
};

bool StoragePartitionServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::StoragePartitionService::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kStoragePartitionServiceValidationInfo);
}
