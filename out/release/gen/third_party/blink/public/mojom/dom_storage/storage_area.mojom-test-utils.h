...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaObserverInterceptorForTesting : public StorageAreaObserver {
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaObserverAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaGetAllCallbackInterceptorForTesting : public StorageAreaGetAllCallback {
  virtual StorageAreaGetAllCallback* GetForwardingInterface() = 0;
  void Complete(bool success) override;
};
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaGetAllCallbackAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaInterceptorForTesting : public StorageArea {
  virtual StorageArea* GetForwardingInterface() = 0;
  void AddObserver(mojo::PendingAssociatedRemote<StorageAreaObserver> observer) override;
  ...
  void GetAll(mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, GetAllCallback callback) override;
};
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StorageAreaAsyncWaiter {
 public:
  ...
  void GetAll(
      mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, bool* out_success, std::vector<KeyValuePtr>* out_data);
