// third_party/blink/public/mojom/dom_storage/session_storage_namespace.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void SessionStorageNamespaceInterceptorForTesting::OpenArea(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::StorageArea> area) {
