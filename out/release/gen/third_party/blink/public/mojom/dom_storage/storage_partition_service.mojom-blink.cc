// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StoragePartitionServiceProxy::OpenSessionStorage(
    const WTF::String& in_namespace_id, mojo::PendingReceiver<::blink::mojom::blink::SessionStorageNamespace> in_session_namespace) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_area));
    ...
    case internal::kStoragePartitionService_OpenSessionStorage_Name: {
      ...
      mojo::PendingReceiver<::blink::mojom::blink::SessionStorageNamespace> p_session_namespace{};
...
bool StoragePartitionServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::StoragePartitionService::Name_;
