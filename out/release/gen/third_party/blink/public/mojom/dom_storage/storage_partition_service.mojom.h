// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StoragePartitionService
 ...
 public:
  ...
  virtual void OpenLocalStorage(const ::url::Origin& origin, mojo::PendingReceiver<::blink::mojom::StorageArea> area) = 0;

  
  virtual void OpenSessionStorage(const std::string& namespace_id, mojo::PendingReceiver<::blink::mojom::SessionStorageNamespace> session_namespace) = 0;
};



class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StoragePartitionServiceProxy
 ...
 public:
  ...
  void OpenLocalStorage(const ::url::Origin& origin, mojo::PendingReceiver<::blink::mojom::StorageArea> area) final;
  
  void OpenSessionStorage(const std::string& namespace_id, mojo::PendingReceiver<::blink::mojom::SessionStorageNamespace> session_namespace) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StoragePartitionServiceStubDispatch {
 public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) StoragePartitionServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
