...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) SessionStorageNamespace
 ...
 public:
  ...
  virtual void OpenArea(const ::url::Origin& origin, mojo::PendingAssociatedReceiver<::blink::mojom::StorageArea> area) = 0;
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) SessionStorageNamespaceProxy
 ...
 public:
  ...
  void OpenArea(const ::url::Origin& origin, mojo::PendingAssociatedReceiver<::blink::mojom::StorageArea> area) final;
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) SessionStorageNamespaceStubDispatch {
 public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM) SessionStorageNamespaceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
