...
void SessionStorageNamespaceProxy::OpenArea(
    const ::url::Origin& in_origin, mojo::PendingAssociatedReceiver<::blink::mojom::StorageArea> in_area) {
...
bool SessionStorageNamespaceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kSessionStorageNamespace_OpenArea_Name: {
      ...
      bool success = true;
      ::url::Origin p_origin{};
      mojo::PendingAssociatedReceiver<::blink::mojom::StorageArea> p_area{};
