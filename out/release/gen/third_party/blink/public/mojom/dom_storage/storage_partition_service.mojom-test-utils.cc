// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StoragePartitionServiceInterceptorForTesting::OpenLocalStorage(const ::url::Origin& origin, mojo::PendingReceiver<::blink::mojom::StorageArea> area) {
  GetForwardingInterface()->OpenLocalStorage(std::move(origin), std::move(area));
}
void StoragePartitionServiceInterceptorForTesting::OpenSessionStorage(const std::string& namespace_id, mojo::PendingReceiver<::blink::mojom::SessionStorageNamespace> session_namespace) {
