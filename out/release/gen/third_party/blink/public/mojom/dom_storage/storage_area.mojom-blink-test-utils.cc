// third_party/blink/public/mojom/dom_storage/storage_area.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StorageAreaInterceptorForTesting::AddObserver(mojo::PendingAssociatedRemote<StorageAreaObserver> observer) {
...
void StorageAreaInterceptorForTesting::GetAll(mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, GetAllCallback callback) {
...
void StorageAreaAsyncWaiter::GetAll(
    mojo::PendingAssociatedRemote<StorageAreaGetAllCallback> complete_callback, bool* out_success, WTF::Vector<KeyValuePtr>* out_data) {
  base::RunLoop loop;
