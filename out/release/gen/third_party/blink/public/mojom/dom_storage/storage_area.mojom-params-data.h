...
namespace mojom {
namespace internal {
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM_SHARED) StorageAreaObserver_KeyAdded_Params_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(DOM_STORAGE_MOJOM_SHARED) StorageAreaGetAllCallback_Complete_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
