// third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StoragePartitionServiceInterceptorForTesting::OpenLocalStorage(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingReceiver<::blink::mojom::blink::StorageArea> area) {
  GetForwardingInterface()->OpenLocalStorage(std::move(origin), std::move(area));
}
void StoragePartitionServiceInterceptorForTesting::OpenSessionStorage(const WTF::String& namespace_id, mojo::PendingReceiver<::blink::mojom::blink::SessionStorageNamespace> session_namespace) {
