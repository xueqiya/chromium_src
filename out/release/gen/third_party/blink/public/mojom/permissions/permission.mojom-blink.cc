...
size_t PermissionDescriptorExtension::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::WAKE_LOCK:
      return mojo::internal::WTFHash(seed, data_.wake_lock);
    default:
      NOTREACHED();
      return seed;
  }
...
// static
bool StructTraits<::blink::mojom::blink::WakeLockPermissionDescriptor::DataView, ::blink::mojom::blink::WakeLockPermissionDescriptorPtr>::Read(
    ::blink::mojom::blink::WakeLockPermissionDescriptor::DataView input,
    ::blink::mojom::blink::WakeLockPermissionDescriptorPtr* output) {
  bool success = true;
  ::blink::mojom::blink::WakeLockPermissionDescriptorPtr result(::blink::mojom::blink::WakeLockPermissionDescriptor::New());
...
bool UnionTraits<::blink::mojom::blink::PermissionDescriptorExtension::DataView, ::blink::mojom::blink::PermissionDescriptorExtensionPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::WAKE_LOCK: {
      ::blink::mojom::blink::WakeLockPermissionDescriptorPtr result_wake_lock;
