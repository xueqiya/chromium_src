...
size_t ClipboardPermissionDescriptor::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->allowWithoutSanitization);
  return seed;
}
...
WakeLockPermissionDescriptor::WakeLockPermissionDescriptor(
    WakeLockType type_in)
    : type(std::move(type_in)) {}

WakeLockPermissionDescriptor::~WakeLockPermissionDescriptor() = default;
size_t WakeLockPermissionDescriptor::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->type);
  return seed;
}

bool WakeLockPermissionDescriptor::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
void PermissionDescriptorExtension::set_wake_lock(
    WakeLockPermissionDescriptorPtr wake_lock) {
  if (tag_ == Tag::WAKE_LOCK) {
    *(data_.wake_lock) = std::move(wake_lock);
  } else {
    DestroyActive();
    tag_ = Tag::WAKE_LOCK;
    data_.wake_lock = new WakeLockPermissionDescriptorPtr(
        std::move(wake_lock));
  }
}
...
size_t PermissionDescriptorExtension::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::WAKE_LOCK:
      return mojo::internal::Hash(seed, data_.wake_lock);
    default:
      NOTREACHED();
      return seed;
  }
...
// static
bool StructTraits<::blink::mojom::WakeLockPermissionDescriptor::DataView, ::blink::mojom::WakeLockPermissionDescriptorPtr>::Read(
    ::blink::mojom::WakeLockPermissionDescriptor::DataView input,
    ::blink::mojom::WakeLockPermissionDescriptorPtr* output) {
  bool success = true;
  ::blink::mojom::WakeLockPermissionDescriptorPtr result(::blink::mojom::WakeLockPermissionDescriptor::New());
...
bool UnionTraits<::blink::mojom::PermissionDescriptorExtension::DataView, ::blink::mojom::PermissionDescriptorExtensionPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::WAKE_LOCK: {
      ::blink::mojom::WakeLockPermissionDescriptorPtr result_wake_lock;
      if (!input.ReadWakeLock(&result_wake_lock))
        return false;

      *output = UnionType::NewWakeLock(
          std::move(result_wake_lock));
      break;
    }
    default:
      return false;
