...
class WakeLockPermissionDescriptor_Data;
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) PermissionDescriptorExtension_Data {
 public:
  ...
  union MOJO_ALIGNAS(8) Union_ {
    ...
    mojo::internal::Pointer<internal::WakeLockPermissionDescriptor_Data> f_wake_lock;
    uint64_t unknown;
  };
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) WakeLockPermissionDescriptor_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WakeLockPermissionDescriptor_Data));
      new (data()) WakeLockPermissionDescriptor_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WakeLockPermissionDescriptor_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WakeLockPermissionDescriptor_Data>(index_);
    }
    WakeLockPermissionDescriptor_Data* operator->() { return data(); }
 ...
 private:
  WakeLockPermissionDescriptor_Data();
  ~WakeLockPermissionDescriptor_Data() = delete;
};
static_assert(sizeof(WakeLockPermissionDescriptor_Data) == 16,
              "Bad sizeof(WakeLockPermissionDescriptor_Data)");
// Used by WakeLockPermissionDescriptor::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct WakeLockPermissionDescriptor_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  WakeLockPermissionDescriptor_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~WakeLockPermissionDescriptor_UnserializedMessageContext() override = default;
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    WakeLockPermissionDescriptor_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    WakeLockPermissionDescriptor_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
