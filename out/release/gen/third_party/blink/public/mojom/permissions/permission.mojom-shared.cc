...
std::ostream& operator<<(std::ostream& os, PermissionName value) {
  switch(value) {
    ...
    case PermissionName::WAKE_LOCK:
      return os << "PermissionName::WAKE_LOCK";
    case PermissionName::NFC:
      return os << "PermissionName::NFC";
    default:
...
std::ostream& operator<<(std::ostream& os, WakeLockType value) {
  switch(value) {
    case WakeLockType::kScreen:
      return os << "WakeLockType::kScreen";
    case WakeLockType::kSystem:
      return os << "WakeLockType::kSystem";
    default:
...
bool PermissionDescriptorExtension_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case PermissionDescriptorExtension_Tag::WAKE_LOCK: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_wake_lock, 3, validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_wake_lock, validation_context))
        return false;
      return true;
    }
    default: {
...
// static
bool WakeLockPermissionDescriptor_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const WakeLockPermissionDescriptor_Data* object = static_cast<const WakeLockPermissionDescriptor_Data*>(data);
  ...
  if (!::blink::mojom::internal::WakeLockType_Data
...
WakeLockPermissionDescriptor_Data::WakeLockPermissionDescriptor_Data()
    : header_({sizeof(*this), 0}) {}
