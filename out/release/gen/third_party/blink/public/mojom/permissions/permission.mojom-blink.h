...
struct blink_mojom_internal_WakeLockType_DataHashFn {
  static unsigned GetHash(const ::blink::mojom::WakeLockType& value) {
    using utype = std::underlying_type<::blink::mojom::WakeLockType>::type;
    return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
  }
  static bool Equal(const ::blink::mojom::WakeLockType& left, const ::blink::mojom::WakeLockType& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
template <>
struct HashTraits<::blink::mojom::WakeLockType>
    : public GenericHashTraits<::blink::mojom::WakeLockType> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::blink::mojom::WakeLockType& value) {
    return value == static_cast<::blink::mojom::WakeLockType>(-1000000);
  }
  static void ConstructDeletedValue(::blink::mojom::WakeLockType& slot, bool) {
    slot = static_cast<::blink::mojom::WakeLockType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::WakeLockType& value) {
    return value == static_cast<::blink::mojom::WakeLockType>(-1000001);
  }
};
}  // namespace WTF
...
class PLATFORM_EXPORT WakeLockPermissionDescriptor {
 public:
  template <typename T>
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        WakeLockPermissionDescriptor::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WakeLockPermissionDescriptor::DataView,
                                         ::blink::mojom::blink::WakeLockPermissionDescriptorPtr> {
  static bool IsNull(const ::blink::mojom::blink::WakeLockPermissionDescriptorPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::WakeLockPermissionDescriptorPtr* output) { output->reset(); }

  static decltype(::blink::mojom::blink::WakeLockPermissionDescriptor::type) type(
      const ::blink::mojom::blink::WakeLockPermissionDescriptorPtr& input) {
    return input->type;
  }

  static bool Read(::blink::mojom::blink::WakeLockPermissionDescriptor::DataView input, ::blink::mojom::blink::WakeLockPermissionDescriptorPtr* output);
};
...
struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::PermissionDescriptorExtension::DataView,
  ...
  static const ::blink::mojom::blink::WakeLockPermissionDescriptorPtr& wake_lock(const ::blink::mojom::blink::PermissionDescriptorExtensionPtr& input) {
