// third_party/blink/public/mojom/credentialmanager/credential_manager.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CredentialManagerProxy::Store(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::CredentialManager::Store");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::CredentialManager::Get");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CredentialManager::StoreCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CredentialManager::PreventSilentAccessCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CredentialManager::GetCallback",
               "message", message.name());
#endif
