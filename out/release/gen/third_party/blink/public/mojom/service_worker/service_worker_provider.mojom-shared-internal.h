...
namespace mojom {
namespace internal {
class ServiceWorkerProviderInfoForClient_Data;
class ServiceWorkerProviderInfoForStartWorker_Data;

#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) ServiceWorkerProviderInfoForClient_Data {
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(ServiceWorkerProviderInfoForClient_Data));
      new (data()) ServiceWorkerProviderInfoForClient_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ServiceWorkerProviderInfoForClient_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ServiceWorkerProviderInfoForClient_Data>(index_);
    }
    ServiceWorkerProviderInfoForClient_Data* operator->() { return data(); }
 ...
 private:
  ServiceWorkerProviderInfoForClient_Data();
  ~ServiceWorkerProviderInfoForClient_Data() = delete;
};
static_assert(sizeof(ServiceWorkerProviderInfoForClient_Data) == 24,
              "Bad sizeof(ServiceWorkerProviderInfoForClient_Data)");
// Used by ServiceWorkerProviderInfoForClient::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ServiceWorkerProviderInfoForClient_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  ServiceWorkerProviderInfoForClient_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~ServiceWorkerProviderInfoForClient_UnserializedMessageContext() override = default;
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    ServiceWorkerProviderInfoForClient_Data::BufferWriter writer;
...
const mojo::internal::UnserializedMessageContext::Tag
    ServiceWorkerProviderInfoForClient_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
