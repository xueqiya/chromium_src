...
bool FetchEventPreloadHandle_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->url_loader_client_receiver, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->url_loader_client_receiver,
                                                 validation_context)) {
    return false;
  }
...
bool DispatchFetchEventParams_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterface(object->worker_timing_remote,
                                                 validation_context)) {
    return false;
  }
