...
class BLINK_COMMON_EXPORT ServiceWorkerProviderInfoForClient {
 public:
  template <typename T>
  ...
  ServiceWorkerProviderInfoForClient(
      ...
      mojo::PendingAssociatedReceiver<::blink::mojom::ServiceWorkerContainer> client_receiver);
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ServiceWorkerProviderInfoForClient::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerProviderInfoForClient::DataView,
                                         ::blink::mojom::ServiceWorkerProviderInfoForClientPtr> {
  static bool IsNull(const ::blink::mojom::ServiceWorkerProviderInfoForClientPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::ServiceWorkerProviderInfoForClientPtr* output) { output->reset(); }

  static  decltype(::blink::mojom::ServiceWorkerProviderInfoForClient::host_remote)& host_remote(
       ::blink::mojom::ServiceWorkerProviderInfoForClientPtr& input) {
    return input->host_remote;
  }

  static  decltype(::blink::mojom::ServiceWorkerProviderInfoForClient::client_receiver)& client_receiver(
       ::blink::mojom::ServiceWorkerProviderInfoForClientPtr& input) {
    return input->client_receiver;
  }

  static bool Read(::blink::mojom::ServiceWorkerProviderInfoForClient::DataView input, ::blink::mojom::ServiceWorkerProviderInfoForClientPtr* output);
};
