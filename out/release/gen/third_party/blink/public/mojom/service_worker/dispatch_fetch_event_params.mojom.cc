...
FetchEventPreloadHandle::FetchEventPreloadHandle(
    ...
    mojo::PendingReceiver<::network::mojom::URLLoaderClient> url_loader_client_receiver_in)
...
DispatchFetchEventParams::DispatchFetchEventParams(
    ...
    mojo::PendingRemote<::blink::mojom::WorkerTimingContainer> worker_timing_remote_in,
