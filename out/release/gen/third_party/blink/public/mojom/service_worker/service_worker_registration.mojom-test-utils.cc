// third_party/blink/public/mojom/service_worker/service_worker_registration.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ServiceWorkerRegistrationObjectHostAsyncWaiter::Update(
    ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::blink::mojom::ServiceWorkerErrorType* out_error, base::Optional<std::string>* out_error_msg) {
  base::RunLoop loop;
