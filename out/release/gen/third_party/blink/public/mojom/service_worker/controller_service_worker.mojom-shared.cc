...
bool ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data* object = static_cast<const ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data*>(data);
...
bool ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data* object = static_cast<const ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data*>(data);
