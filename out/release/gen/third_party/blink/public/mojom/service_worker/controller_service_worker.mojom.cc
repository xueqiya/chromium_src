...
void ControllerServiceWorkerProxy::Clone(
    mojo::PendingReceiver<ControllerServiceWorker> in_receiver, ::network::mojom::CrossOriginEmbedderPolicy in_cross_origin_embedder_policy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool ControllerServiceWorkerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kControllerServiceWorker_Clone_Name: {
      ...
      ::network::mojom::CrossOriginEmbedderPolicy p_cross_origin_embedder_policy{};
