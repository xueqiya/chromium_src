...
class DispatchFetchEventParamsDataView {
 public:
  ...
  template <typename UserType>
  UserType TakeWorkerTimingRemote() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::WorkerTimingContainerInterfaceBase>>(
            &data_->worker_timing_remote, &result, context_);
    DCHECK(ret);
    return result;
  }
...
struct Serializer<::blink::mojom::FetchEventPreloadHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(Traits::url_loader_client_receiver(input)) in_url_loader_client_receiver = Traits::url_loader_client_receiver(input);
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::network::mojom::URLLoaderClientInterfaceBase>>(
        in_url_loader_client_receiver, &(*output)->url_loader_client_receiver, context);
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        !mojo::internal::IsHandleOrInterfaceValid((*output)->url_loader_client_receiver),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
        "invalid url_loader_client_receiver in FetchEventPreloadHandle struct");
  }
...
struct Serializer<::blink::mojom::DispatchFetchEventParamsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(Traits::worker_timing_remote(input)) in_worker_timing_remote = Traits::worker_timing_remote(input);
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::WorkerTimingContainerInterfaceBase>>(
        in_worker_timing_remote, &(*output)->worker_timing_remote, context);
    (*output)->is_offline_capability_check = Traits::is_offline_capability_check(input);
  }
