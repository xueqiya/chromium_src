// third_party/blink/public/mojom/service_worker/controller_service_worker.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ControllerServiceWorkerInterceptorForTesting::DispatchFetchEventForSubresource(::blink::mojom::blink::DispatchFetchEventParamsPtr params, mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> response_callback, DispatchFetchEventForSubresourceCallback callback) {
  GetForwardingInterface()->DispatchFetchEventForSubresource(std::move(params), std::move(response_callback), std::move(callback));
}
void ControllerServiceWorkerInterceptorForTesting::Clone(mojo::PendingReceiver<ControllerServiceWorker> receiver, ::network::mojom::blink::CrossOriginEmbedderPolicy cross_origin_embedder_policy) {
