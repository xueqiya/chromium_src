...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerObjectInfo::DataView,
  ...
  static  decltype(::blink::mojom::blink::ServiceWorkerObjectInfo::host_remote)& host_remote(
       ::blink::mojom::blink::ServiceWorkerObjectInfoPtr& input) {
    return input->host_remote;
  }

  static  decltype(::blink::mojom::blink::ServiceWorkerObjectInfo::receiver)& receiver(
       ::blink::mojom::blink::ServiceWorkerObjectInfoPtr& input) {
