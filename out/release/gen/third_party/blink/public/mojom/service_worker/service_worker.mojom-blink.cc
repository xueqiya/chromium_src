...
void ServiceWorkerProxy::InitializeGlobalScope(
    mojo::PendingAssociatedRemote<ServiceWorkerHost> in_service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr in_registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr in_service_worker_info, FetchHandlerExistence in_fetch_handler_existence) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchSyncEvent(
    const WTF::String& in_tag, bool in_last_chance, ::base::TimeDelta in_timeout, DispatchSyncEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchPeriodicSyncEvent(
    const WTF::String& in_tag, ::base::TimeDelta in_timeout, DispatchPeriodicSyncEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchContentDeleteEvent(
    const WTF::String& in_id, DispatchContentDeleteEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
