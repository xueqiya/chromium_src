...
void ControllerServiceWorkerProxy::DispatchFetchEventForSubresource(
    ::blink::mojom::blink::DispatchFetchEventParamsPtr in_params, mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> in_response_callback, DispatchFetchEventForSubresourceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ControllerServiceWorker::DispatchFetchEventForSubresource");
#endif
  ...
  ::blink::mojom::internal::ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data::BufferWriter
      params;
...
void ControllerServiceWorkerProxy::Clone(
    mojo::PendingReceiver<ControllerServiceWorker> in_receiver, ::network::mojom::blink::CrossOriginEmbedderPolicy in_cross_origin_embedder_policy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ControllerServiceWorker::Clone");
#endif
  ...
  mojo::internal::Serialize<::network::mojom::CrossOriginEmbedderPolicy>(
      in_cross_origin_embedder_policy, &params->cross_origin_embedder_policy);
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
...
bool ControllerServiceWorker_DispatchFetchEventForSubresource_ForwardToCallback::Accept(
  ...
  ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void ControllerServiceWorker_DispatchFetchEventForSubresource_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kControllerServiceWorker_DispatchFetchEventForSubresource_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ControllerServiceWorker::DispatchFetchEventForSubresourceCallback",
               "message", message.name());
#endif
...
bool ControllerServiceWorkerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kControllerServiceWorker_Clone_Name: {
      ...
      ::network::mojom::blink::CrossOriginEmbedderPolicy p_cross_origin_embedder_policy{};
...
bool ControllerServiceWorkerStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kControllerServiceWorker_DispatchFetchEventForSubresource_Name: {
      ...
      ControllerServiceWorker_DispatchFetchEventForSubresource_ParamsDataView input_data_view(params, &serialization_context);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ControllerServiceWorkerConnector::UpdateController");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
