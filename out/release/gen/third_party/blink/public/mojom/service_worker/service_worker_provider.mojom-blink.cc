...
ServiceWorkerProviderInfoForClient::ServiceWorkerProviderInfoForClient(
    ...
    mojo::PendingAssociatedReceiver<::blink::mojom::blink::ServiceWorkerContainer> client_receiver_in)
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerProviderInfoForClient::DataView, ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerProviderInfoForClient::DataView input,
    ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr* output) {
  bool success = true;
  ::blink::mojom::blink::ServiceWorkerProviderInfoForClientPtr result(::blink::mojom::blink::ServiceWorkerProviderInfoForClient::New());
