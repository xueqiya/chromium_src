...
FetchEventPreloadHandle::FetchEventPreloadHandle(
    mojo::PendingRemote<::network::mojom::blink::URLLoader> url_loader_in,
    mojo::PendingReceiver<::network::mojom::blink::URLLoaderClient> url_loader_client_receiver_in)
    : url_loader(std::move(url_loader_in)),
      url_loader_client_receiver(std::move(url_loader_client_receiver_in)) {}
...
DispatchFetchEventParams::DispatchFetchEventParams(
    ...
    mojo::PendingRemote<::blink::mojom::blink::WorkerTimingContainer> worker_timing_remote_in,
    bool is_offline_capability_check_in)
    : request(std::move(request_in)),
      client_id(std::move(client_id_in)),
      preload_handle(std::move(preload_handle_in)),
      worker_timing_remote(std::move(worker_timing_remote_in)),
...
bool StructTraits<::blink::mojom::blink::FetchEventPreloadHandle::DataView, ::blink::mojom::blink::FetchEventPreloadHandlePtr>::Read(
  ...
  ::blink::mojom::blink::FetchEventPreloadHandlePtr result(::blink::mojom::blink::FetchEventPreloadHandle::New());
      ...
      if (success) {
        result->url_loader_client_receiver =
            input.TakeUrlLoaderClientReceiver<decltype(result->url_loader_client_receiver)>();
      }
...
bool StructTraits<::blink::mojom::blink::DispatchFetchEventParams::DataView, ::blink::mojom::blink::DispatchFetchEventParamsPtr>::Read(
  ...
  ::blink::mojom::blink::DispatchFetchEventParamsPtr result(::blink::mojom::blink::DispatchFetchEventParams::New());
      ...
      if (success && !input.ReadClientId(&result->client_id))
        success = false;
      if (success && !input.ReadPreloadHandle(&result->preload_handle))
        success = false;
      if (success) {
        result->worker_timing_remote =
            input.TakeWorkerTimingRemote<decltype(result->worker_timing_remote)>();
      }
      if (success)
