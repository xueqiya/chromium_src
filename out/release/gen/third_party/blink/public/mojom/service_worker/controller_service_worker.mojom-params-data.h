  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data));
      new (data()) ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data>(index_);
    }
    ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data));
      new (data()) ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data>(index_);
    }
    ControllerServiceWorker_DispatchFetchEventForSubresource_ResponseParams_Data* operator->() { return data(); }
