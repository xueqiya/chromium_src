...
void AudioContextManagerProxy::AudioContextAudiblePlaybackStarted(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::AudioContextManager::AudioContextAudiblePlaybackStarted");
#endif
...
void AudioContextManagerProxy::AudioContextAudiblePlaybackStopped(
    int32_t in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::AudioContextManager::AudioContextAudiblePlaybackStopped");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool AudioContextManagerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kAudioContextManager_AudioContextAudiblePlaybackStarted_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::AudioContextManager::AudioContextAudiblePlaybackStarted",
...
std::move(p_id));
    ...
    case internal::kAudioContextManager_AudioContextAudiblePlaybackStopped_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::AudioContextManager::AudioContextAudiblePlaybackStopped",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::AudioContextManager::AudioContextAudiblePlaybackStopped");
