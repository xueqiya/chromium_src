...
class BLINK_COMMON_EXPORT WebLaunchService
 ...
 public:
  ...
  virtual void SetLaunchFiles(std::vector<::blink::mojom::NativeFileSystemEntryPtr> files) = 0;
};
...
class BLINK_COMMON_EXPORT WebLaunchServiceProxy
 ...
 public:
  ...
  void SetLaunchFiles(std::vector<::blink::mojom::NativeFileSystemEntryPtr> files) final;
