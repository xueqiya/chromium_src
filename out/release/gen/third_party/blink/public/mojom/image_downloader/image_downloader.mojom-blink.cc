...
void ImageDownloaderProxy::DownloadImage(
    const ::blink::KURL& in_url, bool in_is_favicon, uint32_t in_preferred_size, uint32_t in_max_bitmap_size, bool in_bypass_cache, DownloadImageCallback callback) {
...
class ImageDownloader_DownloadImage_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_http_status_code, const WTF::Vector<::SkBitmap>& in_images, const WTF::Vector<::blink::WebSize>& in_original_image_sizes);
...
bool ImageDownloader_DownloadImage_ForwardToCallback::Accept(
  ...
  WTF::Vector<::blink::WebSize> p_original_image_sizes{};
