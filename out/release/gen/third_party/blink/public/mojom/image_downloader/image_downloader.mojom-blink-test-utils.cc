...
,
             WTF::Vector<::blink::WebSize>* out_original_image_sizes
,
             int32_t http_status_code,
             const WTF::Vector<::SkBitmap>& images,
             const WTF::Vector<::blink::WebSize>& original_image_sizes) {*out_http_status_code = std::move(http_status_code);*out_images = std::move(images);*out_original_image_sizes = std::move(original_image_sizes);
            loop->Quit();
          },
          &loop,
