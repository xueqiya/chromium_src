...
std::ostream& operator<<(std::ostream& os, InsecureRequestsPolicy value) {
  switch(value) {
    case InsecureRequestsPolicy::kDoNotUpgrade:
      return os << "InsecureRequestsPolicy::kDoNotUpgrade";
    case InsecureRequestsPolicy::kUpgrade:
      return os << "InsecureRequestsPolicy::kUpgrade";
    default:
      return os << "Unknown InsecureRequestsPolicy value: " << static_cast<int32_t>(value);
  }
}
