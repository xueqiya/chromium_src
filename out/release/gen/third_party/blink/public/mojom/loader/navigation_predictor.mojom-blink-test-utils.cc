// third_party/blink/public/mojom/loader/navigation_predictor.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void AnchorElementMetricsHostInterceptorForTesting::ReportAnchorElementMetricsOnLoad(WTF::Vector<AnchorElementMetricsPtr> metrics, const ::blink::WebSize& viewport_size) {
  GetForwardingInterface()->ReportAnchorElementMetricsOnLoad(std::move(metrics), std::move(viewport_size));
}
