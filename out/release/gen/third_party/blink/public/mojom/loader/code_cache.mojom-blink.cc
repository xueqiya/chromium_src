...
void CodeCacheHostProxy::DidGenerateCacheableMetadata(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::CodeCacheHost::DidGenerateCacheableMetadata");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::CodeCacheHost::FetchCachedCode");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::CodeCacheHost::ClearCodeCacheEntry");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::CodeCacheHost::DidGenerateCacheableMetadataInCacheStorage");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CodeCacheHost::FetchCachedCodeCallback",
               "message", message.name());
#endif
