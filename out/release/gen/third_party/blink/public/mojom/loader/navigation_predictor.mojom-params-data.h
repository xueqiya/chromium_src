...
static_assert(sizeof(AnchorElementMetricsHost_ReportAnchorElementMetricsOnLoad_Params_Data) == 24,
...
inline void AnchorElementMetricsHost_ReportAnchorElementMetricsOnLoad_ParamsDataView::GetViewportSizeDataView(
    ::gfx::mojom::SizeDataView* output) {
  auto pointer = data_->viewport_size.Get();
