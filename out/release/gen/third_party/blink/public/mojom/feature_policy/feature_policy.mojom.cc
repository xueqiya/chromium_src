// third_party/blink/public/mojom/feature_policy/feature_policy.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
ParsedFeaturePolicyDeclaration::ParsedFeaturePolicyDeclaration(
    ::blink::mojom::FeaturePolicyFeature feature_in,
    const base::flat_map<::url::Origin, ::blink::PolicyValue>& values_in,
    const ::blink::PolicyValue& fallback_value_in,
    const ::blink::PolicyValue& opaque_value_in)
