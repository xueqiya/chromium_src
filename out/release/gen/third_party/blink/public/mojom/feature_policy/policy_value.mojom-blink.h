// third_party/blink/public/mojom/feature_policy/policy_value.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_FEATURE_POLICY_POLICY_VALUE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_FEATURE_POLICY_POLICY_VALUE_MOJOM_BLINK_H_
...
class PLATFORM_EXPORT PolicyValue {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<PolicyValue, T>::value>;
  ...
  // bindings generator does not need to know whether Equals() or == operator
  // are available for members.
  template <typename T, PolicyValue::EnableIfSame<T>* = nullptr>
  bool Equals(const T& other) const;
  size_t Hash(size_t seed) const;
...
template <typename T, PolicyValue::EnableIfSame<T>*>
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_FEATURE_POLICY_POLICY_VALUE_MOJOM_BLINK_H_