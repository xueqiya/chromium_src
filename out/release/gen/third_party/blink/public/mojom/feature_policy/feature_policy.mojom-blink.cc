// third_party/blink/public/mojom/feature_policy/feature_policy.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
ParsedFeaturePolicyDeclaration::ParsedFeaturePolicyDeclaration(
    ::blink::mojom::blink::FeaturePolicyFeature feature_in,
    WTF::HashMap<::scoped_refptr<const ::blink::SecurityOrigin>, ::blink::mojom::blink::PolicyValuePtr> values_in,
    ::blink::mojom::blink::PolicyValuePtr fallback_value_in,
    ::blink::mojom::blink::PolicyValuePtr opaque_value_in)
...
bool StructTraits<::blink::mojom::blink::ParsedFeaturePolicyDeclaration::DataView, ::blink::mojom::blink::ParsedFeaturePolicyDeclarationPtr>::Read(
  ...
  ::blink::mojom::blink::ParsedFeaturePolicyDeclarationPtr result(::blink::mojom::blink::ParsedFeaturePolicyDeclaration::New());
      ...
      if (success && !input.ReadValues(&result->values))
        success = false;
      if (success && !input.ReadFallbackValue(&result->fallback_value))
        success = false;
      if (success && !input.ReadOpaqueValue(&result->opaque_value))
        success = false;
