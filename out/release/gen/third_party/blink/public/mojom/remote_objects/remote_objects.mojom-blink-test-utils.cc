// third_party/blink/public/mojom/remote_objects/remote_objects.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void RemoteObjectGatewayInterceptorForTesting::AddNamedObject(const WTF::String& name, int32_t object_id) {
  GetForwardingInterface()->AddNamedObject(std::move(name), std::move(object_id));
}
void RemoteObjectGatewayInterceptorForTesting::RemoveNamedObject(const WTF::String& name) {
