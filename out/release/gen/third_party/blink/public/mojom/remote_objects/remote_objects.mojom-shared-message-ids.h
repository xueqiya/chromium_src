// third_party/blink/public/mojom/remote_objects/remote_objects.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
constexpr uint32_t kRemoteObjectGatewayFactory_CreateRemoteObjectGateway_Name = 0;
constexpr uint32_t kRemoteObjectGateway_AddNamedObject_Name = 0;
constexpr uint32_t kRemoteObjectGateway_RemoveNamedObject_Name = 1;
