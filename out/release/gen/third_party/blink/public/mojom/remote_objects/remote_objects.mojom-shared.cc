...
bool RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data* object = static_cast<const RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data*>(data);
...
bool RemoteObjectGateway_AddNamedObject_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RemoteObjectGateway_AddNamedObject_Params_Data* object = static_cast<const RemoteObjectGateway_AddNamedObject_Params_Data*>(data);
...
bool RemoteObjectGateway_RemoveNamedObject_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RemoteObjectGateway_RemoveNamedObject_Params_Data* object = static_cast<const RemoteObjectGateway_RemoveNamedObject_Params_Data*>(data);
