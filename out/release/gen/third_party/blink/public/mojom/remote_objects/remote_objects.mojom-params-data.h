 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data));
      new (data()) RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data>(index_);
    }
    RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(RemoteObjectGateway_AddNamedObject_Params_Data));
      new (data()) RemoteObjectGateway_AddNamedObject_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    RemoteObjectGateway_AddNamedObject_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<RemoteObjectGateway_AddNamedObject_Params_Data>(index_);
    }
    RemoteObjectGateway_AddNamedObject_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(RemoteObjectGateway_RemoveNamedObject_Params_Data));
      new (data()) RemoteObjectGateway_RemoveNamedObject_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    RemoteObjectGateway_RemoveNamedObject_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<RemoteObjectGateway_RemoveNamedObject_Params_Data>(index_);
    }
    RemoteObjectGateway_RemoveNamedObject_Params_Data* operator->() { return data(); }
