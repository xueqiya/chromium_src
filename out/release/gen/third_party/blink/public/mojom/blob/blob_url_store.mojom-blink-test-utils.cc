// third_party/blink/public/mojom/blob/blob_url_store.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void BlobURLStoreInterceptorForTesting::ResolveForNavigation(const ::blink::KURL& url, mojo::PendingReceiver<BlobURLToken> token) {
...
void BlobURLStoreAsyncWaiter::Resolve(
    const ::blink::KURL& url, mojo::PendingRemote<::blink::mojom::blink::Blob>* out_blob) {
  base::RunLoop loop;
...
,
             mojo::PendingRemote<::blink::mojom::blink::Blob> blob) {*out_blob = std::move(blob);
            loop->Quit();
          },
          &loop,
          out_blob));
