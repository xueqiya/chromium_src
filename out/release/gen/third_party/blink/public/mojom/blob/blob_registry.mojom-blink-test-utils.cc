// third_party/blink/public/mojom/blob/blob_registry.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void BlobRegistryInterceptorForTesting::URLStoreForOrigin(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::BlobURLStore> url_store) {
