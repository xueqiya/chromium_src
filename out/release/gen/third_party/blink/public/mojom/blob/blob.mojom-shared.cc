...
bool Blob_CaptureSnapshot_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Blob_CaptureSnapshot_Params_Data* object = static_cast<const Blob_CaptureSnapshot_Params_Data*>(data);
...
bool Blob_CaptureSnapshot_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Blob_CaptureSnapshot_ResponseParams_Data* object = static_cast<const Blob_CaptureSnapshot_ResponseParams_Data*>(data);
