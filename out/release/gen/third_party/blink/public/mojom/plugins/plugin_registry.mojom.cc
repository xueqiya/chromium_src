...
PluginMimeType::PluginMimeType(
    ...
    std::vector<std::string> file_extensions_in)
...
bool PluginRegistryProxy::GetPlugins(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::PluginRegistry::GetPlugins");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::PluginRegistry::GetPluginsCallback",
               "message", message.name());
#endif
