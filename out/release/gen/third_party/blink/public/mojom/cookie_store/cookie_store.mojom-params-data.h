  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(CookieStore_AddSubscriptions_Params_Data));
      new (data()) CookieStore_AddSubscriptions_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    CookieStore_AddSubscriptions_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<CookieStore_AddSubscriptions_Params_Data>(index_);
    }
    CookieStore_AddSubscriptions_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(CookieStore_AddSubscriptions_ResponseParams_Data));
      new (data()) CookieStore_AddSubscriptions_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    CookieStore_AddSubscriptions_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<CookieStore_AddSubscriptions_ResponseParams_Data>(index_);
    }
    CookieStore_AddSubscriptions_ResponseParams_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(CookieStore_RemoveSubscriptions_Params_Data));
      new (data()) CookieStore_RemoveSubscriptions_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    CookieStore_RemoveSubscriptions_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<CookieStore_RemoveSubscriptions_Params_Data>(index_);
    }
    CookieStore_RemoveSubscriptions_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(CookieStore_RemoveSubscriptions_ResponseParams_Data));
      new (data()) CookieStore_RemoveSubscriptions_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    CookieStore_RemoveSubscriptions_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<CookieStore_RemoveSubscriptions_ResponseParams_Data>(index_);
    }
    CookieStore_RemoveSubscriptions_ResponseParams_Data* operator->() { return data(); }
