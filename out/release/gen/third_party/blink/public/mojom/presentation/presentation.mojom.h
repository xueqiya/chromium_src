...
class BLINK_COMMON_EXPORT PresentationReceiver
 ...
 public:
  ...
  virtual void OnReceiverConnectionAvailable(PresentationInfoPtr info, mojo::PendingRemote<PresentationConnection> controller_connection, mojo::PendingReceiver<PresentationConnection> receiver_connection_receiver) = 0;
};
...
class BLINK_COMMON_EXPORT PresentationReceiverProxy
 ...
 public:
  ...
  void OnReceiverConnectionAvailable(PresentationInfoPtr info, mojo::PendingRemote<PresentationConnection> controller_connection, mojo::PendingReceiver<PresentationConnection> receiver_connection_receiver) final;
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationConnectionResult::DataView,
  ...
  static  decltype(::blink::mojom::PresentationConnectionResult::connection_remote)& connection_remote(
