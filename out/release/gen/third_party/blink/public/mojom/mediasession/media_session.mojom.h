...
class BLINK_COMMON_EXPORT MediaSessionService
 ...
 public:
  ...
  virtual void SetPositionState(const base::Optional<::media_session::MediaPosition>& position) = 0;
...
class BLINK_COMMON_EXPORT MediaSessionServiceProxy
 ...
 public:
  ...
  void SetPositionState(const base::Optional<::media_session::MediaPosition>& position) final;
