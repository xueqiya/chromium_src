// third_party/blink/public/mojom/quota/quota_dispatcher_host.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool QuotaDispatcherHostStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kQuotaDispatcherHost_QueryStorageUsageAndQuota_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::QuotaDispatcherHost::QueryStorageUsageAndQuota",
          "message", message->name());
#endif
...
std::move(p_storage_type), std::move(callback));
    ...
    case internal::kQuotaDispatcherHost_RequestStorageQuota_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::QuotaDispatcherHost::RequestStorageQuota",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::QuotaDispatcherHost::RequestStorageQuota");
...
static const mojo::internal::GenericValidationInfo kQuotaDispatcherHostValidationInfo[] = {
    {&internal::QuotaDispatcherHost_QueryStorageUsageAndQuota_Params_Data::Validate,
     &internal::QuotaDispatcherHost_QueryStorageUsageAndQuota_ResponseParams_Data::Validate},
    {&internal::QuotaDispatcherHost_RequestStorageQuota_Params_Data::Validate,
     &internal::QuotaDispatcherHost_RequestStorageQuota_ResponseParams_Data::Validate},
};

bool QuotaDispatcherHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::QuotaDispatcherHost::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kQuotaDispatcherHostValidationInfo);
}

bool QuotaDispatcherHostResponseValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::QuotaDispatcherHost::Name_;
  return mojo::internal::ValidateResponseGenericPacked(message, name, kQuotaDispatcherHostValidationInfo);
}
}  // namespace blink
}  // namespace mojom
}  // namespace blink
