// third_party/blink/public/mojom/quota/quota_dispatcher_host.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool QuotaDispatcherHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::QuotaDispatcherHost::Name_;
