...
class BLINK_COMMON_EXPORT WakeLockServiceInterceptorForTesting : public WakeLockService {
  ...
  void GetWakeLock(::device::mojom::WakeLockType type, ::device::mojom::WakeLockReason reason, const std::string& description, mojo::PendingReceiver<::device::mojom::WakeLock> wake_lock) override;
};
