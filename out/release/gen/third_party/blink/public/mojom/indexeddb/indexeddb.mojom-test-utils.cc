// third_party/blink/public/mojom/indexeddb/indexeddb.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void IDBCallbacksInterceptorForTesting::Error(IDBException code, const ::base::string16& message) {
...
void IDBCallbacksInterceptorForTesting::UpgradeNeeded(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const std::string& data_loss_message, const ::blink::IndexedDBDatabaseMetadata& db_metadata) {
...
void IDBDatabaseCallbacksInterceptorForTesting::Abort(int64_t transaction_id, IDBException code, const ::base::string16& message) {
...
void IDBTransactionInterceptorForTesting::Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode, const std::vector<::blink::IndexedDBIndexKeys>& index_keys, PutCallback callback) {
...
void IDBDatabaseInterceptorForTesting::Get(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, GetCallback callback) {
...
void IDBDatabaseInterceptorForTesting::GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, int64_t max_count, GetAllCallback callback) {
...
void IDBDatabaseInterceptorForTesting::OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) {
...
void IDBDatabaseInterceptorForTesting::Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) {
...
void IDBDatabaseInterceptorForTesting::DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) {
...
void IDBDatabaseAsyncWaiter::GetAll(
  ...
  proxy_->GetAll(std::move(transaction_id),std::move(object_store_id),std::move(index_id),std::move(key_range),std::move(key_only),std::move(max_count),
      base::BindOnce(
          [](base::RunLoop* loop,
             IDBDatabaseGetAllResultPtr* out_result
,
             IDBDatabaseGetAllResultPtr result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
...
void IDBFactoryInterceptorForTesting::GetDatabaseNames(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) {
  GetForwardingInterface()->GetDatabaseNames(std::move(pending_callbacks));
}
void IDBFactoryInterceptorForTesting::Open(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::base::string16& name, int64_t version, mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) {
...
void IDBFactoryInterceptorForTesting::DeleteDatabase(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, const ::base::string16& name, bool force_close) {
