...
class IDBCallbacks_Error_ParamsDataView {
 public:
  ...
  IDBException code() const {
    return static_cast<IDBException>(data_->code);
  }
...
class IDBDatabase_CreateTransaction_ParamsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadDurability(UserType* output) const {
  ...
  IDBTransactionDurability durability() const {
    return static_cast<IDBTransactionDurability>(data_->durability);
  }
 private:
