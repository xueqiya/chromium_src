...
void IDBDatabaseGetAllResult::set_values(
  ...
  if (tag_ == Tag::VALUES) {
    *(data_.values) = std::move(values);
    ...
    DestroyActive();
    tag_ = Tag::VALUES;
    data_.values = new WTF::Vector<IDBReturnValuePtr>(
        std::move(values));
  }
}
...
// static
bool UnionTraits<::blink::mojom::blink::IDBDatabaseGetAllResult::DataView, ::blink::mojom::blink::IDBDatabaseGetAllResultPtr>::Read(
    ::blink::mojom::blink::IDBDatabaseGetAllResult::DataView input,
    ::blink::mojom::blink::IDBDatabaseGetAllResultPtr* output) {
  using UnionType = ::blink::mojom::blink::IDBDatabaseGetAllResult;
  using Tag = UnionType::Tag;
  ...
  switch (input.tag()) {
    ...
    case Tag::VALUES: {
      WTF::Vector<::blink::mojom::blink::IDBReturnValuePtr> result_values;
      if (!input.ReadValues(&result_values))
        return false;
