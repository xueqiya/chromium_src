...
struct blink_mojom_internal_IDBTransactionDurability_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::IDBTransactionDurability& left, const ::blink::mojom::IDBTransactionDurability& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::blink::mojom::IDBTransactionDurability>
    : public GenericHashTraits<::blink::mojom::IDBTransactionDurability> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::blink::mojom::IDBTransactionDurability& value) {
    return value == static_cast<::blink::mojom::IDBTransactionDurability>(-1000000);
  }
  static void ConstructDeletedValue(::blink::mojom::IDBTransactionDurability& slot, bool) {
    slot = static_cast<::blink::mojom::IDBTransactionDurability>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::IDBTransactionDurability& value) {
    return value == static_cast<::blink::mojom::IDBTransactionDurability>(-1000001);
  }
};
}  // namespace WTF
...
struct blink_mojom_internal_IDBException_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::IDBException& left, const ::blink::mojom::IDBException& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::blink::mojom::IDBException>
    : public GenericHashTraits<::blink::mojom::IDBException> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::blink::mojom::IDBException& value) {
    return value == static_cast<::blink::mojom::IDBException>(-1000000);
  }
  static void ConstructDeletedValue(::blink::mojom::IDBException& slot, bool) {
    slot = static_cast<::blink::mojom::IDBException>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::IDBException& value) {
    return value == static_cast<::blink::mojom::IDBException>(-1000001);
  }
};
}  // namespace WTF
...
class MODULES_EXPORT IDBExternalObject {
 public:
  ...
  static IDBExternalObjectPtr New() {
    return IDBExternalObjectPtr(base::in_place);
  }
  // Construct an instance holding |blob_or_file|.
  static IDBExternalObjectPtr
  NewBlobOrFile(
      IDBBlobInfoPtr blob_or_file) {
    auto result = IDBExternalObjectPtr(base::in_place);
  ...
  bool is_blob_or_file() const { return tag_ == Tag::BLOB_OR_FILE; }

  
  IDBBlobInfoPtr& get_blob_or_file() const {
    DCHECK(tag_ == Tag::BLOB_OR_FILE);
...
IDBExternalObjectPtr IDBExternalObject::Clone() const {
  ...
  switch (tag_) {
    case Tag::BLOB_OR_FILE:
      rv->set_blob_or_file(mojo::Clone(*data_.blob_or_file));
      break;
  }
  return rv;
}
...
struct MODULES_EXPORT StructTraits<::blink::mojom::blink::IDBValue::DataView,
  ...
  static  decltype(::blink::mojom::blink::IDBValue::external_objects)& external_objects(
