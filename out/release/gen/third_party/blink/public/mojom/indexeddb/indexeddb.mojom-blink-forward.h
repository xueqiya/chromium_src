...
template <>
struct DefaultHash<::blink::mojom::IDBTransactionDurability> {
  using Hash = blink_mojom_internal_IDBTransactionDurability_DataHashFn;
};
}  // namespace WTF
...
template <>
struct DefaultHash<::blink::mojom::IDBException> {
  using Hash = blink_mojom_internal_IDBException_DataHashFn;
};
}  // namespace WTF
...
using IDBTransactionDurability = IDBTransactionDurability;  // Alias for definition in the parent namespace.
...
using IDBException = IDBException;  // Alias for definition in the parent namespace.
...
typedef mojo::StructPtr<IDBExternalObject> IDBExternalObjectPtr;
