 ...
 public:
  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IDBExternalObject_Data));
      new (data()) IDBExternalObject_Data();
    }
    ...
    bool is_null() const { return !serialization_buffer_; }
    IDBExternalObject_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IDBExternalObject_Data>(index_);
    }
    IDBExternalObject_Data* operator->() { return data(); }
