...
class BLINK_COMMON_EXPORT CacheStorageCacheInterceptorForTesting : public CacheStorageCache {
  ...
  void Match(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) override;
...
class BLINK_COMMON_EXPORT CacheStorageInterceptorForTesting : public CacheStorage {
  ...
  void Match(::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) override;
