// third_party/blink/public/mojom/cache_storage/cache_storage.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CacheStorageCacheInterceptorForTesting::Match(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) {
...
void CacheStorageCacheAsyncWaiter::Match(
    ::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchResultPtr* out_result) {
  base::RunLoop loop;
...
void CacheStorageInterceptorForTesting::Match(::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) {
...
void CacheStorageAsyncWaiter::Match(
    ::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchResultPtr* out_result) {
  base::RunLoop loop;
