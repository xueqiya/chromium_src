...
class PLATFORM_EXPORT CacheStorageCacheInterceptorForTesting : public CacheStorageCache {
  ...
  void Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) override;
...
class PLATFORM_EXPORT CacheStorageInterceptorForTesting : public CacheStorage {
  ...
  void Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) override;
