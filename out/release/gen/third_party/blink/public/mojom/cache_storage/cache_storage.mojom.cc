...
void CacheStorageCacheProxy::Match(
    ::blink::mojom::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, bool in_in_related_fetch_event, int64_t in_trace_id, MatchCallback callback) {
...
void CacheStorageProxy::Match(
    ::blink::mojom::FetchAPIRequestPtr in_request, MultiCacheQueryOptionsPtr in_match_options, bool in_in_related_fetch_event, int64_t in_trace_id, MatchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  switch (input.tag()) {
    ...
    case Tag::CACHE: {
      *output = UnionType::NewCache(
          input.TakeCache<mojo::PendingAssociatedRemote<::blink::mojom::CacheStorageCache>>());
      break;
    }
    default:
      return false;
