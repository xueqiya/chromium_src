...
class PLATFORM_EXPORT CacheStorageCache
 ...
 public:
  ...
  virtual void Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) = 0;
...
class PLATFORM_EXPORT CacheStorage
 ...
 public:
  ...
  virtual void Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) = 0;
...
class PLATFORM_EXPORT CacheStorageCacheProxy
 ...
 public:
  ...
  void Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) final;
...
class PLATFORM_EXPORT CacheStorageProxy
 ...
 public:
  ...
  void Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) final;
...
class PLATFORM_EXPORT MatchResult {
 public:
  ...
  bool is_eager_response() const { return tag_ == Tag::EAGER_RESPONSE; }

  
  EagerResponsePtr& get_eager_response() const {
    DCHECK(tag_ == Tag::EAGER_RESPONSE);
...
class PLATFORM_EXPORT EagerResponse {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EagerResponse::DataView, WTF::Vector<uint8_t>>(input);
  }
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(EagerResponse);
};
...
MatchResultPtr MatchResult::Clone() const {
  ...
  switch (tag_) {
    ...
    case Tag::EAGER_RESPONSE:
      rv->set_eager_response(mojo::Clone(*data_.eager_response));
      break;
  }
  return rv;
}
