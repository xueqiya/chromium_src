// third_party/blink/public/mojom/cache_storage/cache_storage.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CacheStorageCacheInterceptorForTesting::Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) {
  GetForwardingInterface()->Match(std::move(request), std::move(query_options), std::move(in_related_fetch_event), std::move(trace_id), std::move(callback));
}
...
void CacheStorageCacheAsyncWaiter::Match(
    ::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchResultPtr* out_result) {
  base::RunLoop loop;
  proxy_->Match(std::move(request),std::move(query_options),std::move(in_related_fetch_event),std::move(trace_id),
      base::BindOnce(
          [](base::RunLoop* loop,
...
void CacheStorageInterceptorForTesting::Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) {
  GetForwardingInterface()->Match(std::move(request), std::move(match_options), std::move(in_related_fetch_event), std::move(trace_id), std::move(callback));
}
...
void CacheStorageAsyncWaiter::Match(
    ::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchResultPtr* out_result) {
  base::RunLoop loop;
  proxy_->Match(std::move(request),std::move(match_options),std::move(in_related_fetch_event),std::move(trace_id),
      base::BindOnce(
          [](base::RunLoop* loop,
             MatchResultPtr* out_result
,
