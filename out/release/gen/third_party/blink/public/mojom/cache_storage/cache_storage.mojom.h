...
class BLINK_COMMON_EXPORT CacheStorageCache
 ...
 public:
  ...
  virtual void Match(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) = 0;
...
class BLINK_COMMON_EXPORT CacheStorage
 ...
 public:
  ...
  virtual void Match(::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) = 0;
...
class BLINK_COMMON_EXPORT CacheStorageCacheProxy
 ...
 public:
  ...
  void Match(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) final;
...
class BLINK_COMMON_EXPORT CacheStorageProxy
 ...
 public:
  ...
  void Match(::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, int64_t trace_id, MatchCallback callback) final;
...
class BLINK_COMMON_EXPORT EagerResponse {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EagerResponse::DataView, std::vector<uint8_t>>(input);
  }
