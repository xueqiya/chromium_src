// third_party/blink/public/mojom/manifest/manifest_manager.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ManifestManagerAsyncWaiter::RequestManifestDebugInfo(
    ::GURL* out_url, ::blink::Manifest* out_parsed_manifest, ::blink::mojom::ManifestDebugInfoPtr* out_debug_info) {
  base::RunLoop loop;
  proxy_->RequestManifestDebugInfo(
      base::BindOnce(
          [](base::RunLoop* loop,
             ::GURL* out_url
,
             ::blink::Manifest* out_parsed_manifest
,
