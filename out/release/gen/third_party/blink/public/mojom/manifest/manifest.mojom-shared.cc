...
std::ostream& operator<<(std::ostream& os, ManifestShareTarget_Enctype value) {
  switch(value) {
    case ManifestShareTarget_Enctype::kFormUrlEncoded:
      return os << "ManifestShareTarget_Enctype::kFormUrlEncoded";
    case ManifestShareTarget_Enctype::kMultipartFormData:
      return os << "ManifestShareTarget_Enctype::kMultipartFormData";
    default:
...
bool Manifest_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->icons, 6, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->shortcuts, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->file_handlers, 9, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->related_applications, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->scope, 17, validation_context)) {
    return false;
  }
