...
void ManifestManager_RequestManifestDebugInfo_ProxyToResponder::Run(
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null url in ");
  typename decltype(params->parsed_manifest)::BaseType::BufferWriter
      parsed_manifest_writer;
  mojo::internal::Serialize<::blink::mojom::ManifestDataView>(
      in_parsed_manifest, buffer, &parsed_manifest_writer, &serialization_context);
  params->parsed_manifest.Set(
      parsed_manifest_writer.is_null() ? nullptr : parsed_manifest_writer.data());
