...
class PLATFORM_EXPORT NotificationServiceInterceptorForTesting : public NotificationService {
  ...
  void DisplayNonPersistentNotification(const WTF::String& token, ::blink::mojom::blink::NotificationDataPtr notification_data, ::blink::mojom::blink::NotificationResourcesPtr notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) override;
