...
class BLINK_COMMON_EXPORT NotificationService
 ...
 public:
  ...
  virtual void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data, const ::blink::NotificationResources& notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) = 0;
...
class BLINK_COMMON_EXPORT NotificationServiceProxy
 ...
 public:
  ...
  void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data, const ::blink::NotificationResources& notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) final;
