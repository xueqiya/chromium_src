...
class PLATFORM_EXPORT NotificationService
 ...
 public:
  ...
  virtual void DisplayNonPersistentNotification(const WTF::String& token, ::blink::mojom::blink::NotificationDataPtr notification_data, ::blink::mojom::blink::NotificationResourcesPtr notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) = 0;
...
class PLATFORM_EXPORT NotificationServiceProxy
 ...
 public:
  ...
  void DisplayNonPersistentNotification(const WTF::String& token, ::blink::mojom::blink::NotificationDataPtr notification_data, ::blink::mojom::blink::NotificationResourcesPtr notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) final;
