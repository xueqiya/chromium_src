...
class BLINK_COMMON_EXPORT NotificationServiceInterceptorForTesting : public NotificationService {
  ...
  void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data, const ::blink::NotificationResources& notification_resources, mojo::PendingRemote<NonPersistentNotificationListener> event_listener) override;
