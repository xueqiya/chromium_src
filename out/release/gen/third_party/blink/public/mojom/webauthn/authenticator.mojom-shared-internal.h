 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(UvmEntry_Data));
      new (data()) UvmEntry_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    UvmEntry_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<UvmEntry_Data>(index_);
    }
    UvmEntry_Data* operator->() { return data(); }
...
struct UvmEntry_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    UvmEntry_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
...
static_assert(sizeof(MakeCredentialAuthenticatorResponse_Data) == 48,
...
static_assert(sizeof(GetAssertionAuthenticatorResponse_Data) == 56,
...
static_assert(sizeof(PublicKeyCredentialCreationOptions_Data) == 96,
