// third_party/blink/public/mojom/webauthn/internal_authenticator.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/webauthn/internal_authenticator.mojom-import-headers.h"
...
void InternalAuthenticatorProxy::MakeCredential(
    ::blink::mojom::PublicKeyCredentialCreationOptionsPtr in_options, MakeCredentialCallback callback) {
...
void InternalAuthenticatorProxy::GetAssertion(
    ::blink::mojom::PublicKeyCredentialRequestOptionsPtr in_options, GetAssertionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class InternalAuthenticator_MakeCredential_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::AuthenticatorStatus in_status, ::blink::mojom::MakeCredentialAuthenticatorResponsePtr in_credential);
...
bool InternalAuthenticator_MakeCredential_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::AuthenticatorStatus p_status{};
  ::blink::mojom::MakeCredentialAuthenticatorResponsePtr p_credential{};
...
class InternalAuthenticator_GetAssertion_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::AuthenticatorStatus in_status, ::blink::mojom::GetAssertionAuthenticatorResponsePtr in_credential);
...
bool InternalAuthenticator_GetAssertion_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::AuthenticatorStatus p_status{};
  ::blink::mojom::GetAssertionAuthenticatorResponsePtr p_credential{};
...
bool InternalAuthenticatorStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kInternalAuthenticator_MakeCredential_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::PublicKeyCredentialCreationOptionsPtr p_options{};
...
std::move(p_options), std::move(callback));
    ...
    case internal::kInternalAuthenticator_GetAssertion_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::PublicKeyCredentialRequestOptionsPtr p_options{};
...
bool InternalAuthenticatorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::InternalAuthenticator::Name_;
