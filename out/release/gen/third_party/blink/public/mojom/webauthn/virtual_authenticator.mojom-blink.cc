...
RegisteredKey::RegisteredKey(
    WTF::Vector<uint8_t> key_handle_in,
    const WTF::String& rp_id_in,
    WTF::Vector<uint8_t> private_key_in,
    int32_t counter_in)
...
void VirtualAuthenticatorProxy::RemoveRegistration(
    const WTF::Vector<uint8_t>& in_key_handle, RemoveRegistrationCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class VirtualAuthenticatorManager_GetAuthenticators_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<mojo::PendingRemote<VirtualAuthenticator>> in_authenticators);
