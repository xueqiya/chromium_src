...
size_t UvmEntry::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->user_verification_method);
  seed = mojo::internal::WTFHash(seed, this->key_protection_type);
  seed = mojo::internal::WTFHash(seed, this->matcher_protection_type);
  return seed;
}
...
MakeCredentialAuthenticatorResponse::MakeCredentialAuthenticatorResponse(
    ...
    base::Optional<WTF::Vector<UvmEntryPtr>> user_verification_methods_in)
...
GetAssertionAuthenticatorResponse::GetAssertionAuthenticatorResponse(
    ...
    base::Optional<WTF::Vector<uint8_t>> user_handle_in,
...
CableAuthentication::CableAuthentication(
    uint8_t version_in,
    WTF::Vector<uint8_t> client_eid_in,
    WTF::Vector<uint8_t> authenticator_eid_in,
    WTF::Vector<uint8_t> session_pre_key_in)
...
// static
bool StructTraits<::blink::mojom::blink::UvmEntry::DataView, ::blink::mojom::blink::UvmEntryPtr>::Read(
    ::blink::mojom::blink::UvmEntry::DataView input,
    ::blink::mojom::blink::UvmEntryPtr* output) {
  bool success = true;
  ::blink::mojom::blink::UvmEntryPtr result(::blink::mojom::blink::UvmEntry::New());
