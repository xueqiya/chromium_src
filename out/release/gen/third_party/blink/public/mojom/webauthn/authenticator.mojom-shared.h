...
class MakeCredentialAuthenticatorResponseDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadUserVerificationMethods(UserType* output) {
...
class PublicKeyCredentialCreationOptionsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadAppidExclude(UserType* output) {
...
struct Serializer<::blink::mojom::UvmEntryDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::blink::mojom::internal::UvmEntry_Data::BufferWriter* output,
                        SerializationContext* context) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    (*output).Allocate(buffer);
    (*output)->user_verification_method = Traits::user_verification_method(input);
    (*output)->key_protection_type = Traits::key_protection_type(input);
    (*output)->matcher_protection_type = Traits::matcher_protection_type(input);
  }
  ...
  static bool Deserialize(::blink::mojom::internal::UvmEntry_Data* input,
    ...
    ::blink::mojom::UvmEntryDataView data_view(input, context);
    return Traits::Read(data_view, output);
  }
};
...
struct Serializer<::blink::mojom::MakeCredentialAuthenticatorResponseDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->echo_user_verification_methods = Traits::echo_user_verification_methods(input);
    decltype(Traits::user_verification_methods(input)) in_user_verification_methods = Traits::user_verification_methods(input);
    typename decltype((*output)->user_verification_methods)::BaseType::BufferWriter
        user_verification_methods_writer;
    ...
    mojo::internal::Serialize<mojo::ArrayDataView<::blink::mojom::UvmEntryDataView>>(
        in_user_verification_methods, buffer, &user_verification_methods_writer, &user_verification_methods_validate_params,
        context);
    (*output)->user_verification_methods.Set(
        user_verification_methods_writer.is_null() ? nullptr : user_verification_methods_writer.data());
  }
...
struct Serializer<::blink::mojom::PublicKeyCredentialRequestOptionsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->user_verification_methods = Traits::user_verification_methods(input);
  }
...
struct Serializer<::blink::mojom::PublicKeyCredentialCreationOptionsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    typename decltype((*output)->appid_exclude)::BaseType::BufferWriter
        appid_exclude_writer;
    mojo::internal::Serialize<mojo::StringDataView>(
        in_appid_exclude, buffer, &appid_exclude_writer, context);
    (*output)->appid_exclude.Set(
        appid_exclude_writer.is_null() ? nullptr : appid_exclude_writer.data());
  }
...
inline void MakeCredentialAuthenticatorResponseDataView::GetUserVerificationMethodsDataView(
    mojo::ArrayDataView<UvmEntryDataView>* output) {
  auto pointer = data_->user_verification_methods.Get();
  *output = mojo::ArrayDataView<UvmEntryDataView>(pointer, context_);
}
