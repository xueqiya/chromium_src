// third_party/blink/public/mojom/mediastream/media_stream.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MediaStreamDispatcherHostInterceptorForTesting::StopStreamDevice(const std::string& device_id, const base::Optional<::base::UnguessableToken>& session_id) {
