...
template <>
struct DefaultHash<::blink::mojom::StreamSelectionStrategy> {
  using Hash = blink_mojom_internal_StreamSelectionStrategy_DataHashFn;
};
}  // namespace WTF
...
using StreamSelectionStrategy = StreamSelectionStrategy;  // Alias for definition in the parent namespace.
