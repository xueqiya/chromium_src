...
class PLATFORM_EXPORT MediaStreamDispatcherHostInterceptorForTesting : public MediaStreamDispatcherHost {
  ...
  void StopStreamDevice(const WTF::String& device_id, const base::Optional<::base::UnguessableToken>& session_id) override;
...
class PLATFORM_EXPORT MediaStreamDispatcherHostAsyncWaiter {
 public:
  ...
  void GenerateStream(
      int32_t request_id, const ::blink::StreamControls& controls, bool user_gesture, StreamSelectionInfoPtr audio_stream_selection_info, MediaStreamRequestResult* out_result, WTF::String* out_label, WTF::Vector<::blink::MediaStreamDevice>* out_audio_devices, WTF::Vector<::blink::MediaStreamDevice>* out_video_devices);
  void OpenDevice(
