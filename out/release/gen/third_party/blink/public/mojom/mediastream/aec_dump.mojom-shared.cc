...
bool AecDumpAgent_Start_Params_Data::Validate(
  ...
  const AecDumpAgent_Start_Params_Data* object = static_cast<const AecDumpAgent_Start_Params_Data*>(data);
...
bool AecDumpAgent_Stop_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AecDumpAgent_Stop_Params_Data* object = static_cast<const AecDumpAgent_Stop_Params_Data*>(data);
...
bool AecDumpManager_Add_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AecDumpManager_Add_Params_Data* object = static_cast<const AecDumpManager_Add_Params_Data*>(data);
