  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(StreamSelectionInfo_Data));
      new (data()) StreamSelectionInfo_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    StreamSelectionInfo_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<StreamSelectionInfo_Data>(index_);
    }
    StreamSelectionInfo_Data* operator->() { return data(); }
...
struct StreamSelectionInfo_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    StreamSelectionInfo_Data::BufferWriter writer;
