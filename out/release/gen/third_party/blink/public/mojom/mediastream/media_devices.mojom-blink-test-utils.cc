// third_party/blink/public/mojom/mediastream/media_devices.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MediaDevicesDispatcherHostAsyncWaiter::GetAllVideoInputDeviceFormats(
  ...
  proxy_->GetAllVideoInputDeviceFormats(std::move(device_id),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<::media::VideoCaptureFormat>* out_formats
,
             const WTF::Vector<::media::VideoCaptureFormat>& formats) {*out_formats = std::move(formats);
            loop->Quit();
          },
          &loop,
          out_formats));
