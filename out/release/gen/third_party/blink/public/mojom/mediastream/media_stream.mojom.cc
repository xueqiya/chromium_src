...
void MediaStreamDispatcherHostProxy::StopStreamDevice(
    const std::string& in_device_id, const base::Optional<::base::UnguessableToken>& in_session_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class MediaStreamDispatcherHost_GenerateStream_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      MediaStreamRequestResult in_result, const std::string& in_label, const std::vector<::blink::MediaStreamDevice>& in_audio_devices, const std::vector<::blink::MediaStreamDevice>& in_video_devices);
