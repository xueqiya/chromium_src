...
StreamSelectionInfo::StreamSelectionInfo(
    ...
    const base::Optional<::base::UnguessableToken>& session_id_in)
...
void MediaStreamDeviceObserverProxy::OnDeviceStopped(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDeviceObserver::OnDeviceStopped");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDeviceObserver::OnDeviceChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void MediaStreamDispatcherHostProxy::GenerateStream(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::GenerateStream");
#endif
  ...
  typename decltype(params->audio_stream_selection_info)::BaseType::BufferWriter
      audio_stream_selection_info_writer;
  mojo::internal::Serialize<::blink::mojom::StreamSelectionInfoDataView>(
      in_audio_stream_selection_info, buffer, &audio_stream_selection_info_writer, &serialization_context);
  params->audio_stream_selection_info.Set(
      audio_stream_selection_info_writer.is_null() ? nullptr : audio_stream_selection_info_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::CancelRequest");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void MediaStreamDispatcherHostProxy::StopStreamDevice(
    const WTF::String& in_device_id, const base::Optional<::base::UnguessableToken>& in_session_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::StopStreamDevice");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::OpenDevice");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::CloseDevice");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void MediaStreamDispatcherHostProxy::SetCapturingLinkSecured(
    const base::Optional<::base::UnguessableToken>& in_session_id, MediaStreamType in_type, bool in_is_secure) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::SetCapturingLinkSecured");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void MediaStreamDispatcherHostProxy::OnStreamStarted(
    const WTF::String& in_label) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamDispatcherHost::OnStreamStarted");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
class MediaStreamDispatcherHost_GenerateStream_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      MediaStreamRequestResult in_result, const WTF::String& in_label, const WTF::Vector<::blink::MediaStreamDevice>& in_audio_devices, const WTF::Vector<::blink::MediaStreamDevice>& in_video_devices);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaStreamDispatcherHost::GenerateStreamCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaStreamDispatcherHost::OpenDeviceCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamTrackMetricsHost::AddTrack");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void MediaStreamTrackMetricsHostProxy::RemoveTrack(
    uint64_t in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaStreamTrackMetricsHost::RemoveTrack");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
