// third_party/blink/public/mojom/use_counter/css_property_id.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
template <>
struct EnumTraits<::blink::mojom::CSSSampleId, ::blink::mojom::CSSSampleId> {
  static ::blink::mojom::CSSSampleId ToMojom(::blink::mojom::CSSSampleId input) { return input; }
  static bool FromMojom(::blink::mojom::CSSSampleId input, ::blink::mojom::CSSSampleId* output) {
    *output = input;
    return true;
  }
};
...
struct Serializer<::blink::mojom::CSSSampleId, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(static_cast<::blink::mojom::CSSSampleId>(input), output);
  }
};
