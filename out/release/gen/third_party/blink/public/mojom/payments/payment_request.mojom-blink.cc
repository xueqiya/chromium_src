...
size_t GooglePaymentMethodData::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->phone_requested);
  seed = mojo::internal::WTFHash(seed, this->name_requested);
  seed = mojo::internal::WTFHash(seed, this->email_requested);
  seed = mojo::internal::WTFHash(seed, this->shipping_requested);
  return seed;
}
...
void PaymentRequestProxy::Init(
    mojo::PendingRemote<PaymentRequestClient> in_client, WTF::Vector<PaymentMethodDataPtr> in_method_data, PaymentDetailsPtr in_details, PaymentOptionsPtr in_options, bool in_google_pay_bridge_eligible) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
// static
bool StructTraits<::payments::mojom::blink::GooglePaymentMethodData::DataView, ::payments::mojom::blink::GooglePaymentMethodDataPtr>::Read(
    ::payments::mojom::blink::GooglePaymentMethodData::DataView input,
    ::payments::mojom::blink::GooglePaymentMethodDataPtr* output) {
  bool success = true;
  ::payments::mojom::blink::GooglePaymentMethodDataPtr result(::payments::mojom::blink::GooglePaymentMethodData::New());
