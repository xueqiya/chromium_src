...
class PLATFORM_EXPORT PaymentRequestInterceptorForTesting : public PaymentRequest {
  ...
  void Init(mojo::PendingRemote<PaymentRequestClient> client, WTF::Vector<PaymentMethodDataPtr> method_data, PaymentDetailsPtr details, PaymentOptionsPtr options, bool google_pay_bridge_eligible) override;
