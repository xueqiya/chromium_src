...
template <>
struct MojomTypeTraits<::payments::mojom::GooglePaymentMethodDataDataView> {
  using Data = ::payments::mojom::internal::GooglePaymentMethodData_Data;
  using DataAsArrayElement = Pointer<Data>;
  static constexpr MojomTypeCategory category = MojomTypeCategory::kStruct;
};
...
class GooglePaymentMethodDataDataView {
 public:
  GooglePaymentMethodDataDataView() {}

  GooglePaymentMethodDataDataView(
      internal::GooglePaymentMethodData_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
  ...
  bool phone_requested() const {
    return data_->phone_requested;
  }
  bool name_requested() const {
    return data_->name_requested;
  }
  bool email_requested() const {
    return data_->email_requested;
  }
  bool shipping_requested() const {
    return data_->shipping_requested;
  }
 private:
  internal::GooglePaymentMethodData_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
...
class PaymentMethodDataDataView {
 public:
  ...
  inline void GetGpayBridgeDataDataView(
      GooglePaymentMethodDataDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadGpayBridgeData(UserType* output) {
    auto* pointer = data_->gpay_bridge_data.Get();
    return mojo::internal::Deserialize<::payments::mojom::GooglePaymentMethodDataDataView>(
        pointer, output, context_);
  }
  template <typename UserType>
...
template <typename MaybeConstUserType>
struct Serializer<::payments::mojom::GooglePaymentMethodDataDataView, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::payments::mojom::GooglePaymentMethodDataDataView, UserType>;

  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::payments::mojom::internal::GooglePaymentMethodData_Data::BufferWriter* output,
                        SerializationContext* context) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    (*output).Allocate(buffer);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        ...
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        "null stringified_data in GooglePaymentMethodData struct");
    (*output)->phone_requested = Traits::phone_requested(input);
    (*output)->name_requested = Traits::name_requested(input);
    (*output)->email_requested = Traits::email_requested(input);
    (*output)->shipping_requested = Traits::shipping_requested(input);
  }

  static bool Deserialize(::payments::mojom::internal::GooglePaymentMethodData_Data* input,
                          UserType* output,
                          SerializationContext* context) {
    if (!input)
      return CallSetToNullIfExists<Traits>(output);

    ::payments::mojom::GooglePaymentMethodDataDataView data_view(input, context);
    return Traits::Read(data_view, output);
  }
};
...
struct Serializer<::payments::mojom::PaymentMethodDataDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(Traits::gpay_bridge_data(input)) in_gpay_bridge_data = Traits::gpay_bridge_data(input);
    typename decltype((*output)->gpay_bridge_data)::BaseType::BufferWriter
        gpay_bridge_data_writer;
    mojo::internal::Serialize<::payments::mojom::GooglePaymentMethodDataDataView>(
        in_gpay_bridge_data, buffer, &gpay_bridge_data_writer, context);
    (*output)->gpay_bridge_data.Set(
        gpay_bridge_data_writer.is_null() ? nullptr : gpay_bridge_data_writer.data());
...
inline void GooglePaymentMethodDataDataView::GetStringifiedDataDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->stringified_data.Get();
  *output = mojo::StringDataView(pointer, context_);
}
...
inline void PaymentMethodDataDataView::GetGpayBridgeDataDataView(
    GooglePaymentMethodDataDataView* output) {
  auto pointer = data_->gpay_bridge_data.Get();
  *output = GooglePaymentMethodDataDataView(pointer, context_);
}
