// third_party/blink/public/mojom/payments/payment_request.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void PaymentRequestInterceptorForTesting::Init(mojo::PendingRemote<PaymentRequestClient> client, std::vector<PaymentMethodDataPtr> method_data, PaymentDetailsPtr details, PaymentOptionsPtr options, bool google_pay_bridge_eligible) {
