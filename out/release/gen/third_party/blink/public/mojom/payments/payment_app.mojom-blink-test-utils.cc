// third_party/blink/public/mojom/payments/payment_app.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void PaymentManagerAsyncWaiter::EnableDelegations(
    const WTF::Vector<PaymentDelegation>& delegations, PaymentHandlerStatus* out_status) {
  base::RunLoop loop;
