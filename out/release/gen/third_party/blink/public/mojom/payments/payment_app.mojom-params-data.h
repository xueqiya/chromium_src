 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(PaymentManager_EnableDelegations_Params_Data));
      new (data()) PaymentManager_EnableDelegations_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    PaymentManager_EnableDelegations_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<PaymentManager_EnableDelegations_Params_Data>(index_);
    }
    PaymentManager_EnableDelegations_Params_Data* operator->() { return data(); }
...
static_assert(sizeof(PaymentManager_EnableDelegations_Params_Data) == 16,
              "Bad sizeof(PaymentManager_EnableDelegations_Params_Data)");
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(PaymentManager_EnableDelegations_ResponseParams_Data));
      new (data()) PaymentManager_EnableDelegations_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    PaymentManager_EnableDelegations_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<PaymentManager_EnableDelegations_ResponseParams_Data>(index_);
    }
    PaymentManager_EnableDelegations_ResponseParams_Data* operator->() { return data(); }
...
static_assert(sizeof(PaymentManager_EnableDelegations_ResponseParams_Data) == 16,
              "Bad sizeof(PaymentManager_EnableDelegations_ResponseParams_Data)");
...
class PaymentManager_EnableDelegations_ParamsDataView {
 public:
  PaymentManager_EnableDelegations_ParamsDataView() {}

  PaymentManager_EnableDelegations_ParamsDataView(
      internal::PaymentManager_EnableDelegations_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}

  bool is_null() const { return !data_; }
  inline void GetDelegationsDataView(
      mojo::ArrayDataView<PaymentDelegation>* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadDelegations(UserType* output) {
    auto* pointer = data_->delegations.Get();
    return mojo::internal::Deserialize<mojo::ArrayDataView<::payments::mojom::PaymentDelegation>>(
        pointer, output, context_);
  }
 private:
...
class PaymentManager_EnableDelegations_ResponseParamsDataView {
 public:
  PaymentManager_EnableDelegations_ResponseParamsDataView() {}

  PaymentManager_EnableDelegations_ResponseParamsDataView(
      internal::PaymentManager_EnableDelegations_ResponseParams_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
...
inline void PaymentManager_EnableDelegations_ParamsDataView::GetDelegationsDataView(
    mojo::ArrayDataView<PaymentDelegation>* output) {
  auto pointer = data_->delegations.Get();
  *output = mojo::ArrayDataView<PaymentDelegation>(pointer, context_);
}
