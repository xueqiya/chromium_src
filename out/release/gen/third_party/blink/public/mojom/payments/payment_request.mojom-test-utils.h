...
class BLINK_COMMON_EXPORT PaymentRequestInterceptorForTesting : public PaymentRequest {
  ...
  void Init(mojo::PendingRemote<PaymentRequestClient> client, std::vector<PaymentMethodDataPtr> method_data, PaymentDetailsPtr details, PaymentOptionsPtr options, bool google_pay_bridge_eligible) override;
