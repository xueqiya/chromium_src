...
bool PaymentRequestDetailsUpdate_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentRequestDetailsUpdate_Data* object = static_cast<const PaymentRequestDetailsUpdate_Data*>(data);
...
bool PaymentHandlerHost_ChangeShippingOption_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentHandlerHost_ChangeShippingOption_Params_Data* object = static_cast<const PaymentHandlerHost_ChangeShippingOption_Params_Data*>(data);
...
bool PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data* object = static_cast<const PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data*>(data);
...
bool PaymentHandlerHost_ChangeShippingAddress_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentHandlerHost_ChangeShippingAddress_Params_Data* object = static_cast<const PaymentHandlerHost_ChangeShippingAddress_Params_Data*>(data);
...
bool PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data* object = static_cast<const PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data*>(data);
