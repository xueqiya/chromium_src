// third_party/blink/public/mojom/agents/agent_metrics.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/agents/agent_metrics.mojom-import-headers.h"
...
AgentMetricsData::AgentMetricsData(
    std::vector<std::string> agents_in)
...
bool AgentMetricsCollectorHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::AgentMetricsCollectorHost::Name_;
...
// static
bool StructTraits<::blink::mojom::AgentMetricsData::DataView, ::blink::mojom::AgentMetricsDataPtr>::Read(
    ::blink::mojom::AgentMetricsData::DataView input,
    ::blink::mojom::AgentMetricsDataPtr* output) {
  bool success = true;
  ::blink::mojom::AgentMetricsDataPtr result(::blink::mojom::AgentMetricsData::New());
