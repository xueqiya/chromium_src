// third_party/blink/public/mojom/clipboard/clipboard.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ClipboardHostInterceptorForTesting::ReadAvailablePlatformSpecificFormatNames(ClipboardBuffer buffer, ReadAvailablePlatformSpecificFormatNamesCallback callback) {
...
void ClipboardHostInterceptorForTesting::WriteRawData(const ::WTF::String& format, ::mojo_base::BigBuffer data) {
...
void ClipboardHostAsyncWaiter::ReadAvailablePlatformSpecificFormatNames(
    ClipboardBuffer buffer, WTF::Vector<::WTF::String>* out_raw_types) {
  base::RunLoop loop;
  proxy_->ReadAvailablePlatformSpecificFormatNames(std::move(buffer),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<::WTF::String>* out_raw_types
,
             const WTF::Vector<::WTF::String>& raw_types) {*out_raw_types = std::move(raw_types);
            loop->Quit();
          },
          &loop,
          out_raw_types));
