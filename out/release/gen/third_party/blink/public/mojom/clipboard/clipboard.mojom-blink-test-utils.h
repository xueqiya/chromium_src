...
class PLATFORM_EXPORT ClipboardHostInterceptorForTesting : public ClipboardHost {
  ...
  void ReadAvailablePlatformSpecificFormatNames(ClipboardBuffer buffer, ReadAvailablePlatformSpecificFormatNamesCallback callback) override;
  ...
  void WriteRawData(const ::WTF::String& format, ::mojo_base::BigBuffer data) override;
