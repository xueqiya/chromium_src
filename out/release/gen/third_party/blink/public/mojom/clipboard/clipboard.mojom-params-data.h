...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data));
      new (data()) ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data>(index_);
    }
    ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* operator->() { return data(); }
 ...
 private:
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data();
  ~ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data() = delete;
};
static_assert(sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data) == 16,
              "Bad sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data)");
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data));
      new (data()) ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data>(index_);
    }
    ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* operator->() { return data(); }
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::mojo_base::mojom::internal::String16_Data>>> raw_types;

 private:
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data();
  ~ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data() = delete;
};
static_assert(sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data) == 16,
              "Bad sizeof(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data)");
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) ClipboardHost_WriteRawData_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ClipboardHost_WriteRawData_Params_Data));
      new (data()) ClipboardHost_WriteRawData_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ClipboardHost_WriteRawData_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ClipboardHost_WriteRawData_Params_Data>(index_);
    }
    ClipboardHost_WriteRawData_Params_Data* operator->() { return data(); }
 ...
 private:
  ClipboardHost_WriteRawData_Params_Data();
  ~ClipboardHost_WriteRawData_Params_Data() = delete;
};
static_assert(sizeof(ClipboardHost_WriteRawData_Params_Data) == 32,
              "Bad sizeof(ClipboardHost_WriteRawData_Params_Data)");
...
class ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ParamsDataView {
 public:
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ParamsDataView() {}

  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ParamsDataView(
      internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
 ...
 private:
  internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* data_ = nullptr;
};

class ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParamsDataView {
 public:
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParamsDataView() {}

  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParamsDataView(
      internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}

  bool is_null() const { return !data_; }
  inline void GetRawTypesDataView(
      mojo::ArrayDataView<::mojo_base::mojom::String16DataView>* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadRawTypes(UserType* output) {
    auto* pointer = data_->raw_types.Get();
    return mojo::internal::Deserialize<mojo::ArrayDataView<::mojo_base::mojom::String16DataView>>(
        pointer, output, context_);
  }
 private:
  internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
...
class ClipboardHost_WriteRawData_ParamsDataView {
 public:
  ClipboardHost_WriteRawData_ParamsDataView() {}

  ClipboardHost_WriteRawData_ParamsDataView(
      internal::ClipboardHost_WriteRawData_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
 ...
 private:
  internal::ClipboardHost_WriteRawData_Params_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
...
inline void ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParamsDataView::GetRawTypesDataView(
    mojo::ArrayDataView<::mojo_base::mojom::String16DataView>* output) {
  auto pointer = data_->raw_types.Get();
  *output = mojo::ArrayDataView<::mojo_base::mojom::String16DataView>(pointer, context_);
}
...
inline void ClipboardHost_WriteRawData_ParamsDataView::GetFormatDataView(
    ::mojo_base::mojom::String16DataView* output) {
  auto pointer = data_->format.Get();
  *output = ::mojo_base::mojom::String16DataView(pointer, context_);
}
inline void ClipboardHost_WriteRawData_ParamsDataView::GetDataDataView(
    ::mojo_base::mojom::BigBufferDataView* output) {
