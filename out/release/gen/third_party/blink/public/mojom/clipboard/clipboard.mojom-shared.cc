...
// static
bool ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* object = static_cast<const ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data*>(data);
...
ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* object = static_cast<const ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->raw_types, 1, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams raw_types_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->raw_types, validation_context,
                                         &raw_types_validate_params)) {
    return false;
  }
...
ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
bool ClipboardHost_WriteRawData_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClipboardHost_WriteRawData_Params_Data* object = static_cast<const ClipboardHost_WriteRawData_Params_Data*>(data);
...
ClipboardHost_WriteRawData_Params_Data::ClipboardHost_WriteRawData_Params_Data()
    : header_({sizeof(*this), 0}) {}
