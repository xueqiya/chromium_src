...
class PLATFORM_EXPORT ClipboardHost
 ...
 public:
  ...
  using ReadAvailablePlatformSpecificFormatNamesCallback = base::OnceCallback<void(const WTF::Vector<::WTF::String>&)>;
  
  virtual void ReadAvailablePlatformSpecificFormatNames(ClipboardBuffer buffer, ReadAvailablePlatformSpecificFormatNamesCallback callback) = 0;
  ...
  virtual void WriteRawData(const ::WTF::String& format, ::mojo_base::BigBuffer data) = 0;
...
class PLATFORM_EXPORT ClipboardHostProxy
 ...
 public:
  ...
  void ReadAvailablePlatformSpecificFormatNames(ClipboardBuffer buffer, ReadAvailablePlatformSpecificFormatNamesCallback callback) final;
  ...
  void WriteRawData(const ::WTF::String& format, ::mojo_base::BigBuffer data) final;
