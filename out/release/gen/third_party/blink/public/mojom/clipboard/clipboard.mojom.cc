...
bool ClipboardHost::ReadAvailableTypes(ui::ClipboardBuffer buffer, std::vector<::base::string16>* out_types, bool* out_result) {
  NOTREACHED();
  return false;
}
...
class ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ForwardToCallback(
      ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback callback
      ) : callback_(std::move(callback)) {
  }
  bool Accept(mojo::Message* message) override;
 private:
  ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback callback_;
  DISALLOW_COPY_AND_ASSIGN(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ForwardToCallback);
};
...
bool ClipboardHostProxy::ReadAvailableTypes(
    ui::ClipboardBuffer param_buffer, std::vector<::base::string16>* out_param_types, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadAvailablePlatformSpecificFormatNames(
    ui::ClipboardBuffer in_buffer, ReadAvailablePlatformSpecificFormatNamesCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadAvailablePlatformSpecificFormatNames");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kClipboardHost_ReadAvailablePlatformSpecificFormatNames_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  mojo::internal::Serialize<::blink::mojom::ClipboardBuffer>(
...
#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(ClipboardHost::Name_);
  message.set_method_name("ReadAvailablePlatformSpecificFormatNames");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ForwardToCallback(
          std::move(callback)));
  ignore_result(receiver_->AcceptWithResponder(&message, std::move(responder)));
}
...
void ClipboardHostProxy::WriteRawData(
    const ::base::string16& in_format, ::mojo_base::BigBuffer in_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::WriteRawData");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kClipboardHost_WriteRawData_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::ClipboardHost_WriteRawData_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null format in ClipboardHost.WriteRawData request");
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->data.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null data in ClipboardHost.WriteRawData request");
  message.AttachHandlesFromSerializationContext(
      &serialization_context);

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(ClipboardHost::Name_);
  message.set_method_name("WriteRawData");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ignore_result(receiver_->Accept(&message));
...
class ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder {
 public:
  static ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback CreateCallback(
      uint64_t request_id,
      bool is_sync,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder> proxy(
        new ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder(
            request_id, is_sync, std::move(responder)));
    return base::BindOnce(&ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
  ...
  void Run(
      const std::vector<::base::string16>& in_raw_types);

  uint64_t request_id_;
  bool is_sync_;
  std::unique_ptr<mojo::MessageReceiverWithStatus> responder_;

  DISALLOW_COPY_AND_ASSIGN(ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder);
};

bool ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);

  DCHECK(message->is_serialized());
  internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data* params =
      reinterpret_cast<
          internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data*>(
              message->mutable_payload());
  
  mojo::internal::SerializationContext serialization_context;
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  std::vector<::base::string16> p_raw_types{};
  ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder::Run(
    const std::vector<::base::string16>& in_raw_types) {
  ...
  mojo::Message message(
      internal::kClipboardHost_ReadAvailablePlatformSpecificFormatNames_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::blink::mojom::internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->raw_types)::BaseType::BufferWriter
      raw_types_writer;
  const mojo::internal::ContainerValidateParams raw_types_validate_params(
      0, false, nullptr);
  mojo::internal::Serialize<mojo::ArrayDataView<::mojo_base::mojom::String16DataView>>(
      in_raw_types, buffer, &raw_types_writer, &raw_types_validate_params,
      &serialization_context);
  params->raw_types.Set(
      raw_types_writer.is_null() ? nullptr : raw_types_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback",
               "message", message.name());
#endif
...
bool ClipboardHostStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kClipboardHost_ReadAvailablePlatformSpecificFormatNames_Name: {
      break;
    }
...
std::move(p_data));
    ...
    case internal::kClipboardHost_WriteRawData_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::ClipboardHost::WriteRawData",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::ClipboardHost::WriteRawData");
      ...
      DCHECK(message->is_serialized());
      internal::ClipboardHost_WriteRawData_Params_Data* params =
          reinterpret_cast<internal::ClipboardHost_WriteRawData_Params_Data*>(
              message->mutable_payload());
      
      mojo::internal::SerializationContext serialization_context;
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::base::string16 p_format{};
      ::mojo_base::BigBuffer p_data{};
      ClipboardHost_WriteRawData_ParamsDataView input_data_view(params, &serialization_context);
...
std::move(p_buffer), std::move(callback));
    ...
    case internal::kClipboardHost_ReadAvailablePlatformSpecificFormatNames_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::ClipboardHost::ReadAvailablePlatformSpecificFormatNames",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)blink::mojom::ClipboardHost::ReadAvailablePlatformSpecificFormatNames");
      ...
      internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data* params =
          reinterpret_cast<
              internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data*>(
                  message->mutable_payload());
      ...
      bool success = true;
      ui::ClipboardBuffer p_buffer{};
      ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ParamsDataView input_data_view(params, &serialization_context);
      ...
      ClipboardHost::ReadAvailablePlatformSpecificFormatNamesCallback callback =
          ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ProxyToResponder::CreateCallback(
              message->request_id(),
              message->has_flag(mojo::Message::kFlagIsSync),
              std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->ReadAvailablePlatformSpecificFormatNames(
std::move(p_buffer), std::move(callback));
      return true;
    }
    case internal::kClipboardHost_ReadText_Name: {
...
static const mojo::internal::GenericValidationInfo kClipboardHostValidationInfo[] = {
    ...
    {&internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_Params_Data::Validate,
     &internal::ClipboardHost_ReadAvailablePlatformSpecificFormatNames_ResponseParams_Data::Validate},
    ...
    {&internal::ClipboardHost_WriteCustomData_Params_Data::Validate,
     nullptr /* no response */},
    {&internal::ClipboardHost_WriteRawData_Params_Data::Validate,
     nullptr /* no response */},
