// third_party/blink/public/mojom/idle/idle_manager.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void IdleManagerInterceptorForTesting::AddMonitor(::base::TimeDelta threshold, mojo::PendingRemote<IdleMonitor> monitor, AddMonitorCallback callback) {
...
void IdleManagerAsyncWaiter::AddMonitor(
    ::base::TimeDelta threshold, mojo::PendingRemote<IdleMonitor> monitor, IdleStatePtr* out_state) {
  base::RunLoop loop;
