// third_party/blink/public/mojom/appcache/appcache_info.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) AppCacheInfo_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> manifest_scope;

 private:
  AppCacheInfo_Data();
  ~AppCacheInfo_Data() = delete;
};
static_assert(sizeof(AppCacheInfo_Data) == 96,
