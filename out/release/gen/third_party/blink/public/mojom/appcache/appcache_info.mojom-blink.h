// third_party/blink/public/mojom/appcache/appcache_info.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT AppCacheInfo {
 public:
  ...
  AppCacheInfo(
      ...
      const WTF::String& manifest_scope);
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.last_access_time < lhs.last_access_time)
    return false;
  if (lhs.cache_id < rhs.cache_id)
    return true;
  if (rhs.cache_id < lhs.cache_id)
    return false;
  ...
  if (rhs.status < lhs.status)
    return false;
  if (lhs.response_sizes < rhs.response_sizes)
    return true;
  if (rhs.response_sizes < lhs.response_sizes)
    return false;
  if (lhs.padding_sizes < rhs.padding_sizes)
    return true;
  if (rhs.padding_sizes < lhs.padding_sizes)
    return false;
  if (lhs.is_complete < rhs.is_complete)
    return true;
  if (rhs.is_complete < lhs.is_complete)
    return false;
  if (lhs.manifest_parser_version < rhs.manifest_parser_version)
    return true;
  if (rhs.manifest_parser_version < lhs.manifest_parser_version)
    return false;
  if (lhs.manifest_scope < rhs.manifest_scope)
    return true;
  if (rhs.manifest_scope < lhs.manifest_scope)
    return false;
  return false;
}
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AppCacheInfo::DataView,
  ...
  static decltype(::blink::mojom::blink::AppCacheInfo::manifest_parser_version) manifest_parser_version(
      const ::blink::mojom::blink::AppCacheInfoPtr& input) {
    return input->manifest_parser_version;
  }

  static const decltype(::blink::mojom::blink::AppCacheInfo::manifest_scope)& manifest_scope(
      const ::blink::mojom::blink::AppCacheInfoPtr& input) {
