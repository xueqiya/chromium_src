// third_party/blink/public/mojom/appcache/appcache.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_COMMON_EXPORT AppCacheFrontendInterceptorForTesting : public AppCacheFrontend {
  ...
  void SetSubresourceFactory(mojo::PendingRemote<::network::mojom::URLLoaderFactory> url_loader_factory) override;
};
