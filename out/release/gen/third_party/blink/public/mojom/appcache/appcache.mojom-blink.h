// third_party/blink/public/mojom/appcache/appcache.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT AppCacheBackend
 ...
 public:
  ...
  virtual void RegisterHost(mojo::PendingReceiver<AppCacheHost> host_receiver, mojo::PendingRemote<AppCacheFrontend> frontend, const ::base::UnguessableToken& host_id) = 0;
};
...
class PLATFORM_EXPORT AppCacheHost
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kSelectCacheForWorkerMinVersion = 0,
  ...
  virtual void SetSpawningHostId(const ::base::UnguessableToken& spawning_host_id) = 0;
  ...
  virtual void SelectCacheForWorker(int64_t appcache_id) = 0;
...
class PLATFORM_EXPORT AppCacheFrontend
 ...
 public:
  ...
  virtual void SetSubresourceFactory(mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory> url_loader_factory) = 0;
};
...
class PLATFORM_EXPORT AppCacheBackendProxy
 ...
 public:
  ...
  void RegisterHost(mojo::PendingReceiver<AppCacheHost> host_receiver, mojo::PendingRemote<AppCacheFrontend> frontend, const ::base::UnguessableToken& host_id) final;
...
class PLATFORM_EXPORT AppCacheHostProxy
 ...
 public:
  ...
  void SetSpawningHostId(const ::base::UnguessableToken& spawning_host_id) final;
  ...
  void SelectCacheForWorker(int64_t appcache_id) final;
...
class PLATFORM_EXPORT AppCacheFrontendProxy
 ...
 public:
  ...
  void SetSubresourceFactory(mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory> url_loader_factory) final;
...
class PLATFORM_EXPORT AppCacheResourceInfo {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<AppCacheResourceInfo, T>::value>;
  ...
  template <typename T, AppCacheResourceInfo::EnableIfSame<T>* = nullptr>
...
class PLATFORM_EXPORT AppCacheErrorDetails {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<AppCacheErrorDetails, T>::value>;
  ...
  // bindings generator does not need to know whether Equals() or == operator
  // are available for members.
  template <typename T, AppCacheErrorDetails::EnableIfSame<T>* = nullptr>
  bool Equals(const T& other) const;
...
template <typename T, AppCacheResourceInfo::EnableIfSame<T>*>
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.url < lhs.url)
    return false;
  if (lhs.response_size < rhs.response_size)
    return true;
  if (rhs.response_size < lhs.response_size)
    return false;
  if (lhs.padding_size < rhs.padding_size)
    return true;
  if (rhs.padding_size < lhs.padding_size)
    return false;
  if (lhs.is_master < rhs.is_master)
    return true;
  if (rhs.is_master < lhs.is_master)
    return false;
  if (lhs.is_manifest < rhs.is_manifest)
    return true;
  if (rhs.is_manifest < lhs.is_manifest)
    return false;
  if (lhs.is_intercept < rhs.is_intercept)
    return true;
  if (rhs.is_intercept < lhs.is_intercept)
    return false;
  if (lhs.is_fallback < rhs.is_fallback)
    return true;
  if (rhs.is_fallback < lhs.is_fallback)
    return false;
  if (lhs.is_foreign < rhs.is_foreign)
    return true;
  if (rhs.is_foreign < lhs.is_foreign)
    return false;
  if (lhs.is_explicit < rhs.is_explicit)
    return true;
  if (rhs.is_explicit < lhs.is_explicit)
    return false;
  if (lhs.response_id < rhs.response_id)
    return true;
  if (rhs.response_id < lhs.response_id)
    return false;
  return false;
}
template <typename StructPtrType>
...
template <typename T, AppCacheErrorDetails::EnableIfSame<T>*>
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.status < lhs.status)
    return false;
  if (lhs.is_cross_origin < rhs.is_cross_origin)
    return true;
  if (rhs.is_cross_origin < lhs.is_cross_origin)
    return false;
  return false;
}
