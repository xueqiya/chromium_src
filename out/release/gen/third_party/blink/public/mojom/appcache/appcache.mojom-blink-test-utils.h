// third_party/blink/public/mojom/appcache/appcache.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT AppCacheBackendInterceptorForTesting : public AppCacheBackend {
  ...
  void RegisterHost(mojo::PendingReceiver<AppCacheHost> host_receiver, mojo::PendingRemote<AppCacheFrontend> frontend, const ::base::UnguessableToken& host_id) override;
};
...
class PLATFORM_EXPORT AppCacheHostInterceptorForTesting : public AppCacheHost {
  ...
  void SetSpawningHostId(const ::base::UnguessableToken& spawning_host_id) override;
...
class PLATFORM_EXPORT AppCacheFrontendInterceptorForTesting : public AppCacheFrontend {
  ...
  void SetSubresourceFactory(mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory> url_loader_factory) override;
};
