// third_party/blink/public/mojom/appcache/appcache_info.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
AppCacheInfo::AppCacheInfo(
    ...
    const WTF::String& manifest_scope_in)
