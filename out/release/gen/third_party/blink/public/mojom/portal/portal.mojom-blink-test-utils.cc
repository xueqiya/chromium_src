// third_party/blink/public/mojom/portal/portal.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void PortalAsyncWaiter::Activate(
    ::blink::BlinkTransferableMessage data, PortalActivateResult* out_result) {
  base::RunLoop loop;
