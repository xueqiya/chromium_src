...
void PortalProxy::Navigate(
    const ::GURL& in_url, ::blink::mojom::ReferrerPtr in_referrer, NavigateCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::Portal::Navigate");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::Portal::Activate");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::Portal::PostMessageToGuest");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Portal::NavigateCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Portal::ActivateCallback",
               "message", message.name());
#endif
...
bool PortalStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kPortal_Navigate_Name: {
      ...
      bool success = true;
      ::GURL p_url{};
      ::blink::mojom::ReferrerPtr p_referrer{};
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::PortalClient::ForwardMessageFromGuest");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void PortalHostProxy::PostMessageToHost(
    ::blink::TransferableMessage in_message, const base::Optional<::url::Origin>& in_target_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::PortalHost::PostMessageToHost");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
