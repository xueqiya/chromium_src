// third_party/blink/public/mojom/filesystem/file_system.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void FileSystemManagerInterceptorForTesting::Write(const ::GURL& file_path, const std::string& blob_uuid, int64_t position, mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, mojo::PendingRemote<FileSystemOperationListener> listener) {
