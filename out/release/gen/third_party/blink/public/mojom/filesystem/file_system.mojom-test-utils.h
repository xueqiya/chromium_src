...
class BLINK_COMMON_EXPORT FileSystemManagerInterceptorForTesting : public FileSystemManager {
  ...
  void Write(const ::GURL& file_path, const std::string& blob_uuid, int64_t position, mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, mojo::PendingRemote<FileSystemOperationListener> listener) override;
