...
class PLATFORM_EXPORT FileSystemManager
 ...
 public:
  ...
  virtual void Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position, mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, mojo::PendingRemote<FileSystemOperationListener> listener) = 0;
  ...
  virtual bool CreateSnapshotFile(const ::blink::KURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code, mojo::PendingRemote<ReceivedSnapshotListener>* out_snapshot_listener);
...
class PLATFORM_EXPORT FileSystemManagerProxy
 ...
 public:
  ...
  void Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position, mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, mojo::PendingRemote<FileSystemOperationListener> listener) final;
  ...
  bool CreateSnapshotFile(const ::blink::KURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code, mojo::PendingRemote<ReceivedSnapshotListener>* out_snapshot_listener) final;
