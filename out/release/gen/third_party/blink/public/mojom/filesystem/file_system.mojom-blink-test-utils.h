...
class PLATFORM_EXPORT FileSystemManagerInterceptorForTesting : public FileSystemManager {
  ...
  void Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position, mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, mojo::PendingRemote<FileSystemOperationListener> listener) override;
