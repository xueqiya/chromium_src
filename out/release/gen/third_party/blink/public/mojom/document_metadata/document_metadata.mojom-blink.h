...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::Property::DataView,
                                         ::blink::mojom::blink::PropertyPtr> {
  static bool IsNull(const ::blink::mojom::blink::PropertyPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::PropertyPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::Property::name)& name(
      const ::blink::mojom::blink::PropertyPtr& input) {
    return input->name;
  }

  static const decltype(::blink::mojom::blink::Property::values)& values(
      const ::blink::mojom::blink::PropertyPtr& input) {
    return input->values;
  }

  static bool Read(::blink::mojom::blink::Property::DataView input, ::blink::mojom::blink::PropertyPtr* output);
};


template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::Entity::DataView,
                                         ::blink::mojom::blink::EntityPtr> {
  static bool IsNull(const ::blink::mojom::blink::EntityPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::EntityPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::Entity::type)& type(
      const ::blink::mojom::blink::EntityPtr& input) {
    return input->type;
  }

  static const decltype(::blink::mojom::blink::Entity::properties)& properties(
      const ::blink::mojom::blink::EntityPtr& input) {
    return input->properties;
  }

  static bool Read(::blink::mojom::blink::Entity::DataView input, ::blink::mojom::blink::EntityPtr* output);
};
...
template <>
struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::Values::DataView,
                                        ::blink::mojom::blink::ValuesPtr> {
  static bool IsNull(const ::blink::mojom::blink::ValuesPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::ValuesPtr* output) { output->reset(); }

  static ::blink::mojom::blink::Values::Tag GetTag(const ::blink::mojom::blink::ValuesPtr& input) {
    return input->which();
  }

  static const WTF::Vector<bool>& bool_values(const ::blink::mojom::blink::ValuesPtr& input) {
    return input->get_bool_values();
  }

  static const WTF::Vector<int64_t>& long_values(const ::blink::mojom::blink::ValuesPtr& input) {
    return input->get_long_values();
  }

  static const WTF::Vector<WTF::String>& string_values(const ::blink::mojom::blink::ValuesPtr& input) {
    return input->get_string_values();
  }

  static const WTF::Vector<::blink::mojom::blink::EntityPtr>& entity_values(const ::blink::mojom::blink::ValuesPtr& input) {
    return input->get_entity_values();
  }

  static bool Read(::blink::mojom::blink::Values::DataView input, ::blink::mojom::blink::ValuesPtr* output);
};
