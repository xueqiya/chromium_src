...
// static
bool StructTraits<::blink::mojom::Property::DataView, ::blink::mojom::PropertyPtr>::Read(
    ::blink::mojom::Property::DataView input,
    ::blink::mojom::PropertyPtr* output) {
  bool success = true;
  ::blink::mojom::PropertyPtr result(::blink::mojom::Property::New());
...
// static
bool StructTraits<::blink::mojom::Entity::DataView, ::blink::mojom::EntityPtr>::Read(
    ::blink::mojom::Entity::DataView input,
    ::blink::mojom::EntityPtr* output) {
  bool success = true;
  ::blink::mojom::EntityPtr result(::blink::mojom::Entity::New());
...
// static
bool UnionTraits<::blink::mojom::Values::DataView, ::blink::mojom::ValuesPtr>::Read(
    ::blink::mojom::Values::DataView input,
    ::blink::mojom::ValuesPtr* output) {
  using UnionType = ::blink::mojom::Values;
  ...
  switch (input.tag()) {
    ...
    case Tag::ENTITY_VALUES: {
      std::vector<::blink::mojom::EntityPtr> result_entity_values;
