...
bool PictureInPictureSessionObserver_OnWindowSizeChanged_Params_Data::Validate(
  ...
  const PictureInPictureSessionObserver_OnWindowSizeChanged_Params_Data* object = static_cast<const PictureInPictureSessionObserver_OnWindowSizeChanged_Params_Data*>(data);
...
bool PictureInPictureSessionObserver_OnStopped_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PictureInPictureSessionObserver_OnStopped_Params_Data* object = static_cast<const PictureInPictureSessionObserver_OnStopped_Params_Data*>(data);
...
bool PictureInPictureSession_Update_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PictureInPictureSession_Update_Params_Data* object = static_cast<const PictureInPictureSession_Update_Params_Data*>(data);
...
bool PictureInPictureSession_Stop_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PictureInPictureSession_Stop_Params_Data* object = static_cast<const PictureInPictureSession_Stop_Params_Data*>(data);
...
bool PictureInPictureSession_Stop_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PictureInPictureSession_Stop_ResponseParams_Data* object = static_cast<const PictureInPictureSession_Stop_ResponseParams_Data*>(data);
...
bool PictureInPictureService_StartSession_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->observer, 5, validation_context)) {
    return false;
  }
