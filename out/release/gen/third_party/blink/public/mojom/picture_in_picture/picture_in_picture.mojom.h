...
class BLINK_COMMON_EXPORT PictureInPictureSession
 ...
 public:
  ...
  virtual void Update(uint32_t player_id, const base::Optional<::viz::SurfaceId>& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button) = 0;
...
class BLINK_COMMON_EXPORT PictureInPictureService
 ...
 public:
  ...
  virtual void StartSession(uint32_t player_id, const base::Optional<::viz::SurfaceId>& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button, mojo::PendingRemote<PictureInPictureSessionObserver> observer, StartSessionCallback callback) = 0;
};
...
class BLINK_COMMON_EXPORT PictureInPictureSessionProxy
 ...
 public:
  ...
  void Update(uint32_t player_id, const base::Optional<::viz::SurfaceId>& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button) final;
...
class BLINK_COMMON_EXPORT PictureInPictureServiceProxy
 ...
 public:
  ...
  void StartSession(uint32_t player_id, const base::Optional<::viz::SurfaceId>& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button, mojo::PendingRemote<PictureInPictureSessionObserver> observer, StartSessionCallback callback) final;
