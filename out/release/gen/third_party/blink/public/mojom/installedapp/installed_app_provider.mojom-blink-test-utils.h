...
class PLATFORM_EXPORT InstalledAppProviderInterceptorForTesting : public InstalledAppProvider {
  ...
  void FilterInstalledApps(WTF::Vector<::blink::mojom::blink::RelatedApplicationPtr> related_apps, const ::blink::KURL& manifest_url, FilterInstalledAppsCallback callback) override;
};
