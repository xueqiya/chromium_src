// third_party/blink/public/mojom/native_file_system/native_file_system_file_handle.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
class NativeFileSystemFileHandle_AsBlob_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::NativeFileSystemErrorPtr in_result, const ::base::File::Info& in_info, ::blink::mojom::SerializedBlobPtr in_blob);
...
class NativeFileSystemFileHandle_CreateFileWriter_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::NativeFileSystemErrorPtr in_result, mojo::PendingRemote<::blink::mojom::NativeFileSystemFileWriter> in_writer);
...
bool NativeFileSystemFileHandle_CreateFileWriter_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::NativeFileSystemErrorPtr p_result{};
  mojo::PendingRemote<::blink::mojom::NativeFileSystemFileWriter> p_writer{};
...
bool NativeFileSystemFileHandleRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::NativeFileSystemFileHandle::Name_;
