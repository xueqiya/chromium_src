// third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT NativeFileSystemManagerInterceptorForTesting : public NativeFileSystemManager {
  ...
  void GetFileHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemFileHandle> file_handle) override;
  void GetDirectoryHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemDirectoryHandle> directory_handle) override;
};
