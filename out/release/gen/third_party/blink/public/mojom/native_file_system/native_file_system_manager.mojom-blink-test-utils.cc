// third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void NativeFileSystemManagerInterceptorForTesting::GetFileHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemFileHandle> file_handle) {
  GetForwardingInterface()->GetFileHandleFromToken(std::move(token), std::move(file_handle));
}
void NativeFileSystemManagerInterceptorForTesting::GetDirectoryHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemDirectoryHandle> directory_handle) {
...
void NativeFileSystemManagerAsyncWaiter::GetSandboxedFileSystem(
    ::blink::mojom::blink::NativeFileSystemErrorPtr* out_result, mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle>* out_directory) {
  base::RunLoop loop;
...
,
             mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle>* out_directory
,
             ::blink::mojom::blink::NativeFileSystemErrorPtr result,
             mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle> directory) {*out_result = std::move(result);*out_directory = std::move(directory);
            loop->Quit();
          },
          &loop,
          out_result,
