// third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool NativeFileSystemManager_GetFileHandleFromToken_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NativeFileSystemManager_GetFileHandleFromToken_Params_Data* object = static_cast<const NativeFileSystemManager_GetFileHandleFromToken_Params_Data*>(data);
...
NativeFileSystemManager_GetFileHandleFromToken_Params_Data::NativeFileSystemManager_GetFileHandleFromToken_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NativeFileSystemManager_GetDirectoryHandleFromToken_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NativeFileSystemManager_GetDirectoryHandleFromToken_Params_Data* object = static_cast<const NativeFileSystemManager_GetDirectoryHandleFromToken_Params_Data*>(data);
...
NativeFileSystemManager_GetDirectoryHandleFromToken_Params_Data::NativeFileSystemManager_GetDirectoryHandleFromToken_Params_Data()
    : header_({sizeof(*this), 0}) {}
