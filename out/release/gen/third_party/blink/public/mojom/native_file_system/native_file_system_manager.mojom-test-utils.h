// third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_COMMON_EXPORT NativeFileSystemManagerInterceptorForTesting : public NativeFileSystemManager {
  ...
  void GetFileHandleFromToken(mojo::PendingRemote<::blink::mojom::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::NativeFileSystemFileHandle> file_handle) override;
  void GetDirectoryHandleFromToken(mojo::PendingRemote<::blink::mojom::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::NativeFileSystemDirectoryHandle> directory_handle) override;
};
