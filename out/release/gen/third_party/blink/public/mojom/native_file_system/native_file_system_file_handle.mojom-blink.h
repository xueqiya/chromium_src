// third_party/blink/public/mojom/native_file_system/native_file_system_file_handle.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT NativeFileSystemFileHandle
 ...
 public:
  ...
  using AsBlobCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, const ::base::File::Info&, const ::scoped_refptr<::blink::BlobDataHandle>&)>;
  
  virtual void AsBlob(AsBlobCallback callback) = 0;


  using CreateFileWriterCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileWriter>)>;
