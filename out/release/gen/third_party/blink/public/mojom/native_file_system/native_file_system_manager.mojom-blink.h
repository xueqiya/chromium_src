// third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT NativeFileSystemManager
 ...
 public:
  ...
  using GetSandboxedFileSystemCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle>)>;
  ...
  virtual void GetFileHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemFileHandle> file_handle) = 0;

  
  virtual void GetDirectoryHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemDirectoryHandle> directory_handle) = 0;
};
...
class PLATFORM_EXPORT NativeFileSystemManagerProxy
 ...
 public:
  ...
  void GetFileHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemFileHandle> file_handle) final;
  
  void GetDirectoryHandleFromToken(mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken> token, mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemDirectoryHandle> directory_handle) final;
