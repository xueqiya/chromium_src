// third_party/blink/public/mojom/native_file_system/native_file_system_directory_handle.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT NativeFileSystemDirectoryEntriesListener
 ...
 public:
  ...
  virtual void DidReadDirectory(::blink::mojom::blink::NativeFileSystemErrorPtr result, WTF::Vector<NativeFileSystemEntryPtr> entries, bool has_more_entries) = 0;
};
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandle
 ...
 public:
  ...
  using RequestPermissionCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, ::blink::mojom::blink::PermissionStatus)>;
  
  virtual void RequestPermission(bool writable, RequestPermissionCallback callback) = 0;


  using GetFileCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle>)>;
  
  virtual void GetFile(const WTF::String& basename, bool create, GetFileCallback callback) = 0;


  using GetDirectoryCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, mojo::PendingRemote<NativeFileSystemDirectoryHandle>)>;
  ...
  using RemoveEntryCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr)>;
  
  virtual void RemoveEntry(const WTF::String& basename, bool recurse, RemoveEntryCallback callback) = 0;

  
  virtual void Transfer(mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemTransferToken> token) = 0;
};



class PLATFORM_EXPORT NativeFileSystemDirectoryEntriesListenerProxy
 ...
 public:
  ...
  void DidReadDirectory(::blink::mojom::blink::NativeFileSystemErrorPtr result, WTF::Vector<NativeFileSystemEntryPtr> entries, bool has_more_entries) final;
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandleProxy
 ...
 public:
  ...
  void Transfer(mojo::PendingReceiver<::blink::mojom::blink::NativeFileSystemTransferToken> token) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class PLATFORM_EXPORT NativeFileSystemDirectoryEntriesListenerStubDispatch {
 public:
...
class PLATFORM_EXPORT NativeFileSystemDirectoryEntriesListenerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class PLATFORM_EXPORT NativeFileSystemHandle {
 public:
  ...
  NewFile(
      mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle> file) {
  ...
  mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle>& get_file() const {
...
struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::NativeFileSystemHandle::DataView,
  ...
  static  mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle>& file( ::blink::mojom::blink::NativeFileSystemHandlePtr& input) {
    return input->get_file();
  }

  static  mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle>& directory( ::blink::mojom::blink::NativeFileSystemHandlePtr& input) {
