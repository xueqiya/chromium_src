// third_party/blink/public/mojom/native_file_system/native_file_system_directory_handle.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
NativeFileSystemHandle::NativeFileSystemHandle() : tag_(Tag::FILE) {
  data_.file = new mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle>;
}
...
void NativeFileSystemDirectoryEntriesListenerProxy::DidReadDirectory(
    ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, WTF::Vector<NativeFileSystemEntryPtr> in_entries, bool in_has_more_entries) {
...
bool NativeFileSystemDirectoryEntriesListenerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::NativeFileSystemDirectoryEntriesListener::Name_;
...
class NativeFileSystemDirectoryHandle_GetFile_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle> in_file);
...
bool NativeFileSystemDirectoryHandle_GetFile_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::blink::NativeFileSystemErrorPtr p_result{};
  mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle> p_file{};
...
class NativeFileSystemDirectoryHandle_GetDirectory_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, mojo::PendingRemote<NativeFileSystemDirectoryHandle> in_directory);
...
bool NativeFileSystemDirectoryHandleRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::NativeFileSystemDirectoryHandle::Name_;
  ...
  switch (input.tag()) {
    case Tag::FILE: {
      *output = UnionType::NewFile(
          input.TakeFile<mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemFileHandle>>());
      break;
    }
    case Tag::DIRECTORY: {
      *output = UnionType::NewDirectory(
          input.TakeDirectory<mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemDirectoryHandle>>());
      break;
    }
    default:
      return false;
