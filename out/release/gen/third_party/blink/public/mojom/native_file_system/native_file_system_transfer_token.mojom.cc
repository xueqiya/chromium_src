// third_party/blink/public/mojom/native_file_system/native_file_system_transfer_token.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::NativeFileSystemTransferToken::Clone");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::NativeFileSystemTransferToken::GetInternalIDCallback",
               "message", message.name());
#endif
...
bool NativeFileSystemTransferTokenRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::NativeFileSystemTransferToken::Name_;
