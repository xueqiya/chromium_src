// third_party/blink/public/mojom/native_file_system/native_file_system_file_writer.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void NativeFileSystemFileWriterProxy::Write(
    uint64_t in_offset, mojo::PendingRemote<::blink::mojom::Blob> in_data, WriteCallback callback) {
...
bool NativeFileSystemFileWriterStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kNativeFileSystemFileWriter_Write_Name: {
      ...
      bool success = true;
      uint64_t p_offset{};
      mojo::PendingRemote<::blink::mojom::Blob> p_data{};
...
bool NativeFileSystemFileWriterRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::NativeFileSystemFileWriter::Name_;
