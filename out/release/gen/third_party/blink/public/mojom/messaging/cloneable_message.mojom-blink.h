...
class CORE_EXPORT CloneableMessage {
 public:
  ...
  CloneableMessage(
      ...
      const ::scoped_refptr<const ::blink::SecurityOrigin>& sender_origin,
      ...
      WTF::Vector<mojo::PendingRemote<::blink::mojom::blink::NativeFileSystemTransferToken>> native_file_system_tokens);
...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::CloneableMessage::DataView,
  ...
  static  decltype(::blink::mojom::blink::CloneableMessage::native_file_system_tokens)& native_file_system_tokens(
       ::blink::mojom::blink::CloneableMessagePtr& input) {
