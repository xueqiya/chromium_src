...
bool TransferableMessage::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->transfer_user_activation, other_struct.transfer_user_activation))
    return false;
  if (!mojo::Equals(this->allow_autoplay, other_struct.allow_autoplay))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.user_activation < lhs.user_activation)
    return false;
  if (lhs.transfer_user_activation < rhs.transfer_user_activation)
    return true;
  if (rhs.transfer_user_activation < lhs.transfer_user_activation)
    return false;
  if (lhs.allow_autoplay < rhs.allow_autoplay)
    return true;
  if (rhs.allow_autoplay < lhs.allow_autoplay)
    return false;
  return false;
}
...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::TransferableMessage::DataView,
  ...
  static decltype(::blink::mojom::blink::TransferableMessage::allow_autoplay) allow_autoplay(
      const ::blink::mojom::blink::TransferableMessagePtr& input) {
