...
bool CloneableMessage_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->native_file_system_tokens, 9, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams native_file_system_tokens_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->native_file_system_tokens, validation_context,
                                         &native_file_system_tokens_validate_params)) {
    return false;
  }
