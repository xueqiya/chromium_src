...
class BLINK_COMMON_EXPORT ColorChooserFactory
 ...
 public:
  ...
  virtual void OpenColorChooser(mojo::PendingReceiver<ColorChooser> chooser, mojo::PendingRemote<ColorChooserClient> client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) = 0;
};
...
class BLINK_COMMON_EXPORT ColorChooserFactoryProxy
 ...
 public:
  ...
  void OpenColorChooser(mojo::PendingReceiver<ColorChooser> chooser, mojo::PendingRemote<ColorChooserClient> client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) final;
