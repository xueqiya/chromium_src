...
class PLATFORM_EXPORT ColorChooserFactoryInterceptorForTesting : public ColorChooserFactory {
  ...
  void OpenColorChooser(mojo::PendingReceiver<ColorChooser> chooser, mojo::PendingRemote<ColorChooserClient> client, uint32_t color, WTF::Vector<ColorSuggestionPtr> suggestions) override;
};
