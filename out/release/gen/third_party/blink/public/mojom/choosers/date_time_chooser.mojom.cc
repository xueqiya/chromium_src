...
void DateTimeChooserProxy::OpenDateTimeDialog(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::DateTimeChooser::OpenDateTimeDialog");
#endif
...
bool DateTimeChooser_OpenDateTimeDialog_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::DateTimeChooser::OpenDateTimeDialogCallback",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::DateTimeChooser::OpenDateTimeDialogCallback",
               "message", message.name());
#endif
