...
class BLINK_COMMON_EXPORT ColorChooserFactoryInterceptorForTesting : public ColorChooserFactory {
  ...
  void OpenColorChooser(mojo::PendingReceiver<ColorChooser> chooser, mojo::PendingRemote<ColorChooserClient> client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) override;
};
