// third_party/blink/public/mojom/choosers/color_chooser.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ColorChooserFactoryInterceptorForTesting::OpenColorChooser(mojo::PendingReceiver<ColorChooser> chooser, mojo::PendingRemote<ColorChooserClient> client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) {
