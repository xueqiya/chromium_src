...
void DevToolsAgentProxy::AttachDevToolsSession(
    mojo::PendingAssociatedRemote<DevToolsSessionHost> in_host, mojo::PendingAssociatedReceiver<DevToolsSession> in_session, mojo::PendingReceiver<DevToolsSession> in_io_session, DevToolsSessionStatePtr in_reattach_session_state, bool in_client_expects_binary_responses, const std::string& in_session_id) {
...
void DevToolsAgentHostProxy::ChildWorkerCreated(
    mojo::PendingRemote<DevToolsAgent> in_worker_devtools_agent, mojo::PendingReceiver<DevToolsAgentHost> in_worker_devtools_agent_host, const ::GURL& in_url, const std::string& in_name, const ::base::UnguessableToken& in_devtools_worker_token, bool in_waiting_for_debugger) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
