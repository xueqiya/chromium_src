// third_party/blink/public/mojom/devtools/devtools_agent.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void DevToolsAgentHostInterceptorForTesting::ChildWorkerCreated(mojo::PendingRemote<DevToolsAgent> worker_devtools_agent, mojo::PendingReceiver<DevToolsAgentHost> worker_devtools_agent_host, const ::blink::KURL& url, const WTF::String& name, const ::base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger) {
