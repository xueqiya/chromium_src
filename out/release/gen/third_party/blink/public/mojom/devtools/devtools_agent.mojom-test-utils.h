...
class BLINK_COMMON_EXPORT DevToolsAgentHostInterceptorForTesting : public DevToolsAgentHost {
  ...
  void ChildWorkerCreated(mojo::PendingRemote<DevToolsAgent> worker_devtools_agent, mojo::PendingReceiver<DevToolsAgentHost> worker_devtools_agent_host, const ::GURL& url, const std::string& name, const ::base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger) override;
};
