// third_party/blink/public/mojom/page/spatial_navigation.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
class SpatialNavigationStateDataView {
 public:
  ...
  bool is_form_focused() const {
    return data_->is_form_focused;
  }
...
struct Serializer<::blink::mojom::SpatialNavigationStateDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->is_form_focused = Traits::is_form_focused(input);
