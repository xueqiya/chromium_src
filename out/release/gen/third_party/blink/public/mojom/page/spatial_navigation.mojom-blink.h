// third_party/blink/public/mojom/page/spatial_navigation.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT SpatialNavigationState {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<SpatialNavigationState, T>::value>;
  ...
  template <typename T, SpatialNavigationState::EnableIfSame<T>* = nullptr>
...
SpatialNavigationStatePtr SpatialNavigationState::Clone() const {
  return New(
      ...
      mojo::Clone(is_form_focused),
      mojo::Clone(has_next_form_element),
      mojo::Clone(has_default_video_controls)
  );
}

template <typename T, SpatialNavigationState::EnableIfSame<T>*>
bool SpatialNavigationState::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->can_select_element, other_struct.can_select_element))
    return false;
  if (!mojo::Equals(this->is_form_focused, other_struct.is_form_focused))
    return false;
...
template <typename T, SpatialNavigationState::EnableIfSame<T>*>
bool operator<(const T& lhs, const T& rhs) {
  if (lhs.can_exit_focus < rhs.can_exit_focus)
    return true;
  if (rhs.can_exit_focus < lhs.can_exit_focus)
    return false;
  if (lhs.can_select_element < rhs.can_select_element)
    return true;
  if (rhs.can_select_element < lhs.can_select_element)
    return false;
  if (lhs.is_form_focused < rhs.is_form_focused)
    return true;
  if (rhs.is_form_focused < lhs.is_form_focused)
    return false;
  if (lhs.has_next_form_element < rhs.has_next_form_element)
    return true;
  if (rhs.has_next_form_element < lhs.has_next_form_element)
    return false;
  if (lhs.has_default_video_controls < rhs.has_default_video_controls)
    return true;
  if (rhs.has_default_video_controls < lhs.has_default_video_controls)
    return false;
  return false;
}
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SpatialNavigationState::DataView,
  ...
  static decltype(::blink::mojom::blink::SpatialNavigationState::is_form_focused) is_form_focused(
      const ::blink::mojom::blink::SpatialNavigationStatePtr& input) {
    return input->is_form_focused;
  }
