// third_party/blink/public/mojom/page/spatial_navigation.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
SpatialNavigationState::SpatialNavigationState(
    ...
    : can_exit_focus(std::move(can_exit_focus_in)),
      ...
      is_form_focused(std::move(is_form_focused_in)),
...
size_t SpatialNavigationState::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->is_form_focused);
...
void SpatialNavigationHostProxy::SpatialNavigationStateChanged(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::SpatialNavigationHost::SpatialNavigationStateChanged");
#endif
...
bool SpatialNavigationHostStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kSpatialNavigationHost_SpatialNavigationStateChanged_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)blink::mojom::SpatialNavigationHost::SpatialNavigationStateChanged",
...
static const mojo::internal::GenericValidationInfo kSpatialNavigationHostValidationInfo[] = {
    {&internal::SpatialNavigationHost_SpatialNavigationStateChanged_Params_Data::Validate,
     nullptr /* no response */},
};

bool SpatialNavigationHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::SpatialNavigationHost::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kSpatialNavigationHostValidationInfo);
}
...
bool StructTraits<::blink::mojom::blink::SpatialNavigationState::DataView, ::blink::mojom::blink::SpatialNavigationStatePtr>::Read(
  ...
  ::blink::mojom::blink::SpatialNavigationStatePtr result(::blink::mojom::blink::SpatialNavigationState::New());
      ...
      if (success)
        result->is_form_focused = input.is_form_focused();
      if (success)
