// third_party/blink/public/mojom/page/spatial_navigation.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
size_t SpatialNavigationState::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->is_form_focused);
...
bool SpatialNavigationHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::SpatialNavigationHost::Name_;
