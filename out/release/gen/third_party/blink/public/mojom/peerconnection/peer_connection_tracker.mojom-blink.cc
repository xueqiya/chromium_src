...
size_t PeerConnectionInfo::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->lid);
  seed = mojo::internal::WTFHash(seed, this->rtc_configuration);
  seed = mojo::internal::WTFHash(seed, this->constraints);
...
void PeerConnectionTrackerHostProxy::GetUserMedia(
    const WTF::String& in_origin, bool in_audio, bool in_video, const WTF::String& in_audio_constraints, const WTF::String& in_video_constraints) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
