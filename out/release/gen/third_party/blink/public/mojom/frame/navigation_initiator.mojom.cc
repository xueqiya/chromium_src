// third_party/blink/public/mojom/frame/navigation_initiator.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
CSPViolationParams::CSPViolationParams(
    ...
    ::network::mojom::ContentSecurityPolicyType disposition_in,
...
void NavigationInitiatorProxy::SendViolationReport(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::NavigationInitiator::SendViolationReport");
#endif
...
static const mojo::internal::GenericValidationInfo kNavigationInitiatorValidationInfo[] = {
...
bool NavigationInitiatorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::NavigationInitiator::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kNavigationInitiatorValidationInfo);
}
