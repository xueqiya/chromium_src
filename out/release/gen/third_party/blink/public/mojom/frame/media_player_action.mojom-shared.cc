...
std::ostream& operator<<(std::ostream& os, MediaPlayerActionType value) {
  switch(value) {
    case MediaPlayerActionType::kPlay:
      return os << "MediaPlayerActionType::kPlay";
    case MediaPlayerActionType::kMute:
      return os << "MediaPlayerActionType::kMute";
    case MediaPlayerActionType::kLoop:
      return os << "MediaPlayerActionType::kLoop";
    case MediaPlayerActionType::kControls:
      return os << "MediaPlayerActionType::kControls";
    case MediaPlayerActionType::kPictureInPicture:
      return os << "MediaPlayerActionType::{kPictureInPicture, kDefaultActionType}";
    default:
      return os << "Unknown MediaPlayerActionType value: " << static_cast<int32_t>(value);
  }
}
...
bool MediaPlayerAction_Data::Validate(
  ...
  const MediaPlayerAction_Data* object = static_cast<const MediaPlayerAction_Data*>(data);
