...
class PLATFORM_EXPORT LocalFrameHost
 ...
 public:
  ...
  virtual void EnterFullscreen(::blink::mojom::blink::FullscreenOptionsPtr options) = 0;
  ...
  virtual void RegisterProtocolHandler(const WTF::String& scheme, const ::blink::KURL& url, const ::WTF::String& title, bool user_gesture) = 0;
  ...
  virtual void LifecycleStateChanged(::blink::mojom::blink::FrameLifecycleState state) = 0;
  ...
  virtual void ScrollRectToVisibleInParentFrame(const ::blink::WebRect& rect_to_scroll, ::blink::mojom::blink::ScrollIntoViewParamsPtr params) = 0;

  
  virtual void BubbleLogicalScrollInParentFrame(::blink::mojom::blink::ScrollDirection direction, ::ui::input_types::ScrollGranularity granularity) = 0;
  ...
  virtual bool RunModalAlertDialog(const ::WTF::String& alert_message);

  using RunModalAlertDialogCallback = base::OnceCallback<void()>;
  
  virtual void RunModalAlertDialog(const ::WTF::String& alert_message, RunModalAlertDialogCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool RunModalConfirmDialog(const ::WTF::String& alert_message, bool* out_success);

  using RunModalConfirmDialogCallback = base::OnceCallback<void(bool)>;
  
  virtual void RunModalConfirmDialog(const ::WTF::String& alert_message, RunModalConfirmDialogCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool RunModalPromptDialog(const ::WTF::String& alert_message, const ::WTF::String& default_value, bool* out_success, ::WTF::String* out_result);

  using RunModalPromptDialogCallback = base::OnceCallback<void(bool, const ::WTF::String&)>;
  
  virtual void RunModalPromptDialog(const ::WTF::String& alert_message, const ::WTF::String& default_value, RunModalPromptDialogCallback callback) = 0;
...
class PLATFORM_EXPORT LocalFrame
 ...
 public:
  ...
  virtual void AdvanceFocusInForm(::blink::mojom::blink::FocusType focus_type) = 0;
};
...
class PLATFORM_EXPORT RemoteFrameHost
...
class PLATFORM_EXPORT RemoteFrame
 ...
 public:
  ...
  virtual void AddReplicatedContentSecurityPolicies(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyHeaderPtr> headers) = 0;
  ...
  virtual void SetReplicatedAdFrameType(::blink::mojom::blink::AdFrameType ad_frame_type) = 0;
  ...
  virtual void BubbleLogicalScroll(::blink::mojom::blink::ScrollDirection direction, ::ui::input_types::ScrollGranularity granularity) = 0;

  
  virtual void UpdateUserActivationState(::blink::mojom::blink::UserActivationUpdateType state_update_type) = 0;
  ...
  virtual void ScrollRectToVisible(const ::blink::WebRect& rect, ::blink::mojom::blink::ScrollIntoViewParamsPtr params) = 0;
...
class PLATFORM_EXPORT LocalFrameHostProxy
 ...
 public:
  ...
  void EnterFullscreen(::blink::mojom::blink::FullscreenOptionsPtr options) final;
  
  void ExitFullscreen() final;
  
  void FullscreenStateChanged(bool is_fullscreen) final;
  
  void RegisterProtocolHandler(const WTF::String& scheme, const ::blink::KURL& url, const ::WTF::String& title, bool user_gesture) final;
  ...
  void LifecycleStateChanged(::blink::mojom::blink::FrameLifecycleState state) final;
  ...
  void ScrollRectToVisibleInParentFrame(const ::blink::WebRect& rect_to_scroll, ::blink::mojom::blink::ScrollIntoViewParamsPtr params) final;
  
  void BubbleLogicalScrollInParentFrame(::blink::mojom::blink::ScrollDirection direction, ::ui::input_types::ScrollGranularity granularity) final;
  ...
  bool RunModalAlertDialog(const ::WTF::String& alert_message) final;
  
  void RunModalAlertDialog(const ::WTF::String& alert_message, RunModalAlertDialogCallback callback) final;
  
  bool RunModalConfirmDialog(const ::WTF::String& alert_message, bool* out_success) final;
  
  void RunModalConfirmDialog(const ::WTF::String& alert_message, RunModalConfirmDialogCallback callback) final;
  
  bool RunModalPromptDialog(const ::WTF::String& alert_message, const ::WTF::String& default_value, bool* out_success, ::WTF::String* out_result) final;
  
  void RunModalPromptDialog(const ::WTF::String& alert_message, const ::WTF::String& default_value, RunModalPromptDialogCallback callback) final;
...
class PLATFORM_EXPORT LocalFrameProxy
    : public LocalFrame {
 public:
  ...
  void AdvanceFocusInForm(::blink::mojom::blink::FocusType focus_type) final;
...
class PLATFORM_EXPORT RemoteFrameHostProxy
...
class PLATFORM_EXPORT RemoteFrameProxy
    : public RemoteFrame {
 public:
  ...
  void AddReplicatedContentSecurityPolicies(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyHeaderPtr> headers) final;
  ...
  void SetReplicatedAdFrameType(::blink::mojom::blink::AdFrameType ad_frame_type) final;
  ...
  void BubbleLogicalScroll(::blink::mojom::blink::ScrollDirection direction, ::ui::input_types::ScrollGranularity granularity) final;
  
  void UpdateUserActivationState(::blink::mojom::blink::UserActivationUpdateType state_update_type) final;
  ...
  void ScrollRectToVisible(const ::blink::WebRect& rect, ::blink::mojom::blink::ScrollIntoViewParamsPtr params) final;
...
class PLATFORM_EXPORT LocalFrameHostStubDispatch {
 public:
...
class PLATFORM_EXPORT LocalFrameStubDispatch {
 public:
...
class PLATFORM_EXPORT RemoteFrameHostStubDispatch {
 public:
...
class PLATFORM_EXPORT RemoteFrameStubDispatch {
 public:
...
class PLATFORM_EXPORT LocalFrameHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT LocalFrameRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT RemoteFrameHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT RemoteFrameRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT LocalFrameHostResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT LocalFrameResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class PLATFORM_EXPORT FindInPageResultAXParams {
 public:
  template <typename T>
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FindInPageResultAXParams::DataView,
