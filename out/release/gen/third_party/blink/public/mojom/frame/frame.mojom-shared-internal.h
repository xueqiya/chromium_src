  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(FindInPageResultAXParams_Data));
      new (data()) FindInPageResultAXParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    FindInPageResultAXParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<FindInPageResultAXParams_Data>(index_);
    }
    FindInPageResultAXParams_Data* operator->() { return data(); }
...
struct FindInPageResultAXParams_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    FindInPageResultAXParams_Data::BufferWriter writer;
