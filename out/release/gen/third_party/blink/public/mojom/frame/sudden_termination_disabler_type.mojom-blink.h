...
struct HashTraits<::blink::mojom::SuddenTerminationDisablerType>
  ...
  static bool IsEmptyValue(const ::blink::mojom::SuddenTerminationDisablerType& value) {
    return value == static_cast<::blink::mojom::SuddenTerminationDisablerType>(-1000000);
  }
