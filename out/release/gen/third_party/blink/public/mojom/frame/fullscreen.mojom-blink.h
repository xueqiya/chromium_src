...
class PLATFORM_EXPORT FullscreenOptions {
 public:
  template <typename T>
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FullscreenOptions::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FullscreenOptions::DataView,
