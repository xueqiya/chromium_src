...
void FindInPageProxy::Find(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::FindInPage::Find");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::FindInPage::SetClient");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::FindInPageClient::SetNumberOfMatches");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::FindInPageClient::SetActiveMatch");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
