...
bool LocalFrameHost::RunModalAlertDialog(const ::base::string16& alert_message) {
  NOTREACHED();
  return false;
}
bool LocalFrameHost::RunModalConfirmDialog(const ::base::string16& alert_message, bool* out_success) {
  NOTREACHED();
  return false;
}
bool LocalFrameHost::RunModalPromptDialog(const ::base::string16& alert_message, const ::base::string16& default_value, bool* out_success, ::base::string16* out_result) {
  NOTREACHED();
  return false;
}
...
class LocalFrameHost_RunModalPromptDialog_HandleSyncResponse
 ...
 public:
  LocalFrameHost_RunModalPromptDialog_HandleSyncResponse(
      bool* result, bool* out_success, ::base::string16* out_result)
 ...
 private:
  bool* result_;
  bool* out_success_;
  ::base::string16* out_result_;DISALLOW_COPY_AND_ASSIGN(LocalFrameHost_RunModalPromptDialog_HandleSyncResponse);
};
...
void LocalFrameHostProxy::RegisterProtocolHandler(
    const std::string& in_scheme, const ::GURL& in_url, const ::base::string16& in_title, bool in_user_gesture) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LocalFrameHostProxy::BubbleLogicalScrollInParentFrame(
    ::blink::mojom::ScrollDirection in_direction, ::ui::input_types::ScrollGranularity in_granularity) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool LocalFrameHostProxy::RunModalAlertDialog(
    const ::base::string16& param_alert_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LocalFrameHostProxy::RunModalAlertDialog(
    const ::base::string16& in_alert_message, RunModalAlertDialogCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::LocalFrameHost::RunModalAlertDialog");
#endif
  const bool kExpectsResponse = true;
...
bool LocalFrameHostProxy::RunModalConfirmDialog(
    const ::base::string16& param_alert_message, bool* out_param_success) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LocalFrameHostProxy::RunModalConfirmDialog(
    const ::base::string16& in_alert_message, RunModalConfirmDialogCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::LocalFrameHost::RunModalConfirmDialog");
#endif
  const bool kExpectsResponse = true;
...
bool LocalFrameHostProxy::RunModalPromptDialog(
    const ::base::string16& param_alert_message, const ::base::string16& param_default_value, bool* out_param_success, ::base::string16* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LocalFrameHostProxy::RunModalPromptDialog(
    const ::base::string16& in_alert_message, const ::base::string16& in_default_value, RunModalPromptDialogCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::LocalFrameHost::RunModalPromptDialog");
#endif
  const bool kExpectsResponse = true;
...
class LocalFrameHost_RunModalPromptDialog_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_success, const ::base::string16& in_result);
...
class LocalFrame_GetTextSurroundingSelection_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const ::base::string16& in_content, uint32_t in_start_offset, uint32_t in_end_offset);
...
void RemoteFrameProxy::AddReplicatedContentSecurityPolicies(
    std::vector<::network::mojom::ContentSecurityPolicyHeaderPtr> in_headers) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RemoteFrameProxy::SetReplicatedAdFrameType(
    ::blink::mojom::AdFrameType in_ad_frame_type) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RemoteFrameProxy::UpdateUserActivationState(
    ::blink::mojom::UserActivationUpdateType in_state_update_type) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool RemoteFrameStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kRemoteFrame_AddReplicatedContentSecurityPolicies_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      std::vector<::network::mojom::ContentSecurityPolicyHeaderPtr> p_headers{};
...
std::move(p_is_potentially_trustworthy_unique_origin));
    ...
    case internal::kRemoteFrame_SetReplicatedAdFrameType_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::AdFrameType p_ad_frame_type{};
