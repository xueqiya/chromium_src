...
class BLINK_COMMON_EXPORT FramePolicy {
 public:
  ...
  FramePolicy(
      ...
      const base::flat_map<::blink::mojom::FeaturePolicyFeature, ::blink::PolicyValue>& required_document_policy,
  ...
  base::flat_map<::blink::mojom::FeaturePolicyFeature, ::blink::PolicyValue> required_document_policy;
