...
class MODULES_EXPORT AuthenticationExtensionsClientInputs : public IDLDictionaryBase {
 public:
  ...
  bool hasAppidExclude() const { return !appid_exclude_.IsNull(); }
  const String& appidExclude() const {
    return appid_exclude_;
  }
  inline void setAppidExclude(const String&);
