...
void MediaTrackConstraintSet::setPan(const DoubleOrConstrainDoubleRange& value) {
  pan_ = value;
}
...
void MediaTrackConstraintSet::setTilt(const DoubleOrConstrainDoubleRange& value) {
  tilt_ = value;
}
