...
void MediaTrackSupportedConstraints::setPan(bool value) {
  pan_ = value;
  has_pan_ = true;
}
...
void MediaTrackSupportedConstraints::setTilt(bool value) {
  tilt_ = value;
  has_tilt_ = true;
}
