...
class MODULES_EXPORT MediaTrackConstraintSet : public IDLDictionaryBase {
 public:
  ...
  bool hasPan() const { return !pan_.IsNull(); }
  const DoubleOrConstrainDoubleRange& pan() const {
    return pan_;
  }
  void setPan(const DoubleOrConstrainDoubleRange&);
  ...
  bool hasTilt() const { return !tilt_.IsNull(); }
  const DoubleOrConstrainDoubleRange& tilt() const {
    return tilt_;
  }
  void setTilt(const DoubleOrConstrainDoubleRange&);
 ...
 private:
  ...
  DoubleOrConstrainDoubleRange pan_;
  ...
  DoubleOrConstrainDoubleRange tilt_;
