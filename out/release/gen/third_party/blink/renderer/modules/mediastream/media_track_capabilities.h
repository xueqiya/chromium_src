...
class MODULES_EXPORT MediaTrackCapabilities : public IDLDictionaryBase {
 public:
  ...
  bool hasPan() const { return pan_; }
  MediaSettingsRange* pan() const {
    return pan_;
  }
  inline void setPan(MediaSettingsRange*);
  ...
  bool hasTilt() const { return tilt_; }
  MediaSettingsRange* tilt() const {
    return tilt_;
  }
  inline void setTilt(MediaSettingsRange*);
 ...
 private:
  ...
  Member<MediaSettingsRange> pan_;
  ...
  Member<MediaSettingsRange> tilt_;
  bool torch_;
...
void MediaTrackCapabilities::setPan(MediaSettingsRange* value) {
  pan_ = value;
}
...
void MediaTrackCapabilities::setTilt(MediaSettingsRange* value) {
  tilt_ = value;
}
