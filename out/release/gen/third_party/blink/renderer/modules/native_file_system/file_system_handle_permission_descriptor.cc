...
FileSystemHandlePermissionDescriptor::~FileSystemHandlePermissionDescriptor() = default;

void FileSystemHandlePermissionDescriptor::Trace(blink::Visitor* visitor) {
