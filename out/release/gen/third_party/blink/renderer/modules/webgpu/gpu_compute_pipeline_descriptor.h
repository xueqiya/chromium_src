...
class MODULES_EXPORT GPUComputePipelineDescriptor : public GPUPipelineDescriptorBase {
 public:
  ...
  GPUProgrammableStageDescriptor* computeStage() const {
    return compute_stage_;
  }
  void setComputeStage(GPUProgrammableStageDescriptor*);
 ...
 private:
  ...
  Member<GPUProgrammableStageDescriptor> compute_stage_;
