...
GPUVertexBufferLayoutDescriptor::~GPUVertexBufferLayoutDescriptor() = default;

void GPUVertexBufferLayoutDescriptor::setAttributes(const HeapVector<Member<GPUVertexAttributeDescriptor>>& value) {
  attributes_ = value;
  has_attributes_ = true;
}

void GPUVertexBufferLayoutDescriptor::Trace(blink::Visitor* visitor) {
