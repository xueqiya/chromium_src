...
class MODULES_EXPORT GPUImageBitmapCopyView : public IDLDictionaryBase {
 public:
  ...
  const UnsignedLongSequenceOrGPUOrigin2DDict& origin() const {
    return origin_;
  }
  void setOrigin(const UnsignedLongSequenceOrGPUOrigin2DDict&);
 ...
 private:
  ...
  UnsignedLongSequenceOrGPUOrigin2DDict origin_;
