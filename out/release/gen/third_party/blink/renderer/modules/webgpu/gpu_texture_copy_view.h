...
class MODULES_EXPORT GPUTextureCopyView : public IDLDictionaryBase {
 public:
  ...
  const UnsignedLongSequenceOrGPUOrigin3DDict& origin() const {
    return origin_;
  }
  void setOrigin(const UnsignedLongSequenceOrGPUOrigin3DDict&);
 ...
 private:
  ...
  uint32_t mip_level_;
  UnsignedLongSequenceOrGPUOrigin3DDict origin_;
