...
GPUTextureCopyView::GPUTextureCopyView() {
  setArrayLayer(0u);
  setMipLevel(0u);
  setOrigin(UnsignedLongSequenceOrGPUOrigin3DDict::FromGPUOrigin3DDict(MakeGarbageCollected<GPUOrigin3DDict>()));
}

GPUTextureCopyView::~GPUTextureCopyView() = default;

void GPUTextureCopyView::setOrigin(const UnsignedLongSequenceOrGPUOrigin3DDict& value) {
  origin_ = value;
}
