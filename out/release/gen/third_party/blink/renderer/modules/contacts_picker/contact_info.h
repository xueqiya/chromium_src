...
class MODULES_EXPORT ContactInfo : public IDLDictionaryBase {
 public:
  ...
  void setAddress(const HeapVector<Member<ContactAddress>>&);
  ...
  void setIcon(const HeapVector<Member<Blob>>&);
 ...
 private:
  ...
  HeapVector<Member<ContactAddress>> address_;
  Vector<String> email_;
  HeapVector<Member<Blob>> icon_;
  Vector<String> name_;
  Vector<String> tel_;
