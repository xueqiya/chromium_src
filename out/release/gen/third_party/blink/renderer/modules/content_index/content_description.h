...
class MODULES_EXPORT ContentDescription : public IDLDictionaryBase {
 public:
  ...
  bool hasLaunchUrl() const { return !launch_url_.IsNull(); }
  const String& launchUrl() const {
    return launch_url_;
  }
  inline void setLaunchUrl(const String&);
...
void ContentDescription::setLaunchUrl(const String& value) {
  launch_url_ = value;
}
