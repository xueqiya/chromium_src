...
class MODULES_EXPORT AudioConfiguration : public IDLDictionaryBase {
 public:
  ...
  bool spatialRendering() const {
    DCHECK(has_spatial_rendering_);
    return spatial_rendering_;
  }
  inline void setSpatialRendering(bool);
...
void AudioConfiguration::setSpatialRendering(bool value) {
  spatial_rendering_ = value;
