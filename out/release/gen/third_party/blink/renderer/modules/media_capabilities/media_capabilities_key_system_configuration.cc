...
void MediaCapabilitiesKeySystemConfiguration::setAudio(KeySystemTrackConfiguration* value) {
  audio_ = value;
}
...
void MediaCapabilitiesKeySystemConfiguration::setVideo(KeySystemTrackConfiguration* value) {
  video_ = value;
}
