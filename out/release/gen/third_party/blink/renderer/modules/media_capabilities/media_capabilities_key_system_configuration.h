...
class MODULES_EXPORT MediaCapabilitiesKeySystemConfiguration : public IDLDictionaryBase {
 public:
  ...
  void setAudio(KeySystemTrackConfiguration*);
  ...
  void setVideo(KeySystemTrackConfiguration*);
