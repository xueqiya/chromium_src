...
void PushSubscriptionOptionsInit::setApplicationServerKey(const ArrayBufferOrArrayBufferViewOrString& value) {
  application_server_key_ = value;
}

void PushSubscriptionOptionsInit::setApplicationServerKeyToNull() {
  application_server_key_ = ArrayBufferOrArrayBufferViewOrString();
}
