...
static void IntrinsicSizesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "LayoutChild", "intrinsicSizes");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);

  // V8DOMConfiguration::kDoNotCheckHolder
  // Make sure that info.Holder() really points to an instance of the type.
  if (!V8LayoutChild::HasInstance(info.Holder(), info.GetIsolate())) {
  ...
  ScriptPromise result = impl->intrinsicSizes(script_state, exception_state);
...
static void LayoutNextFragmentMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->layoutNextFragment(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
void V8LayoutChild::IntrinsicSizesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  custom_layout_child_v8_internal::IntrinsicSizesMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8LayoutChildMethods[] = {
    {"intrinsicSizes", V8LayoutChild::IntrinsicSizesMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"layoutNextFragment", V8LayoutChild::LayoutNextFragmentMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
