...
void V8TrustedTypePolicyFactory::GetPolicyNamesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("TrustedTypePolicyFactory.getPolicyNames");
...
static void InstallV8TrustedTypePolicyFactoryTemplate(
  ...
  kAccessorConfigurations[] = {
      { "defaultPolicy", V8TrustedTypePolicyFactory::DefaultPolicyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
