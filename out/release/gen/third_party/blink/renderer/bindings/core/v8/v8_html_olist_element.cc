...
void V8HTMLOListElement::ReversedAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLOListElement", "reversed", html_names::kReversedAttr);
}
...
void V8HTMLOListElement::CompactAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLOListElement", "compact", html_names::kCompactAttr);
}
