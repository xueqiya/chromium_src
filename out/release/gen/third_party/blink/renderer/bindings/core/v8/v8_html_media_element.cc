...
static void LatencyHintAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  HTMLMediaElement* impl = V8HTMLMediaElement::ToImpl(holder);

  V8SetReturnValue(info, impl->latencyHint());
}

static void LatencyHintAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "HTMLMediaElement", "latencyHint");
  CEReactionsScope ce_reactions_scope;
...
static void AddTextTrackMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!kind.Prepare())
    return;
  const char* const kValidKindValues[] = {
      "subtitles",
      "captions",
      "descriptions",
      "chapters",
...
void V8HTMLMediaElement::AutoplayAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLMediaElement", "autoplay", html_names::kAutoplayAttr);
}
...
void V8HTMLMediaElement::LoopAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLMediaElement", "loop", html_names::kLoopAttr);
}

void V8HTMLMediaElement::LatencyHintAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLMediaElement_latencyHint_Getter");

  html_media_element_v8_internal::LatencyHintAttributeGetter(info);
}

void V8HTMLMediaElement::LatencyHintAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLMediaElement_latencyHint_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_media_element_v8_internal::LatencyHintAttributeSetter(v8_value, info);
}
...
void V8HTMLMediaElement::ControlsAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLMediaElement", "controls", html_names::kControlsAttr);
}
...
void V8HTMLMediaElement::DefaultMutedAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLMediaElement", "defaultMuted", html_names::kMutedAttr);
}
...
void V8HTMLMediaElement::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::MediaLatencyHintEnabled()) {
    static constexpr V8DOMConfiguration::AccessorConfiguration
    kAccessorConfigurations[] = {
        { "latencyHint", V8HTMLMediaElement::LatencyHintAttributeGetterCallback, V8HTMLMediaElement::LatencyHintAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
