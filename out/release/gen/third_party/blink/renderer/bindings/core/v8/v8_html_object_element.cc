...
void V8HTMLObjectElement::ArchiveAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kArchiveAttr);
}
...
void V8HTMLObjectElement::CodeAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kCodeAttr);
}
...
void V8HTMLObjectElement::DeclareAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLObjectElement", "declare", html_names::kDeclareAttr);
}
...
void V8HTMLObjectElement::StandbyAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kStandbyAttr);
}
...
void V8HTMLObjectElement::CodeTypeAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kCodetypeAttr);
}
