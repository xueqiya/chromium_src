...
static const v8::Eternal<v8::Name>* eternalV8PropertyDefinitionKeys(v8::Isolate* isolate) {
...
void V8PropertyDefinition::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PropertyDefinition* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PropertyDefinitionKeys(isolate);
...
v8::Local<v8::Value> PropertyDefinition::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8PropertyDefinition(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8PropertyDefinition(const PropertyDefinition* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8PropertyDefinitionKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
PropertyDefinition* NativeValueTraits<PropertyDefinition>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PropertyDefinition* impl = MakeGarbageCollected<PropertyDefinition>();
  V8PropertyDefinition::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
