...
static void BaselineAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  double cpp_value(impl->baseline(is_null));
...
void V8LayoutFragment::BaselineAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CustomLayoutFragment_baseline_Getter");

  custom_layout_fragment_v8_internal::BaselineAttributeGetter(info);
}
...
static void InstallV8LayoutFragmentTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "baseline", V8LayoutFragment::BaselineAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
