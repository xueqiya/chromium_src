...
class V8Screen {
 ...
 public:
  ...
  CORE_EXPORT static void InternalAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void PrimaryAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ScaleFactorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
