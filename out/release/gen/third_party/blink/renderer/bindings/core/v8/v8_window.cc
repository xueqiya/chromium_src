...
#include "third_party/blink/renderer/bindings/core/v8/v8_render_subtree_activation_event.h"
...
static void PostMessage1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  message = ScriptValue(info.GetIsolate(), info[0]);
...
static void CreateImageBitmap1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = WindowOrWorkerGlobalScope::createImageBitmap(script_state, *impl, image_bitmap, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void CreateImageBitmap2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = WindowOrWorkerGlobalScope::createImageBitmap(script_state, *impl, image_bitmap, sx, sy, sw, sh, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static const struct {
  ...
  {"close", &dom_window_v8_internal::CloseOriginSafeMethodGetter},
  {"focus", &dom_window_v8_internal::FocusOriginSafeMethodGetter},
  {"blur", &dom_window_v8_internal::BlurOriginSafeMethodGetter},
  {"postMessage", &dom_window_v8_internal::PostMessageOriginSafeMethodGetter},
};
}  // namespace dom_window_v8_internal
...
void V8Window::CSSPropertyRuleConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_CSSPropertyRule_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8CSSPropertyRule::GetWrapperTypeInfo());
}
...
void V8Window::RenderSubtreeActivationEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_RenderSubtreeActivationEvent_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8RenderSubtreeActivationEvent::GetWrapperTypeInfo());
}

void V8Window::EditContextConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_EditContext_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8EditContext::GetWrapperTypeInfo());
}

void V8Window::TextFormatUpdateEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8TextFormatUpdateEvent::GetWrapperTypeInfo());
}

void V8Window::TextUpdateEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_TextUpdateEvent_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8TextUpdateEvent::GetWrapperTypeInfo());
}
...
void V8Window::ProfilerConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8Window::FeaturePolicyConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_FeaturePolicy_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8FeaturePolicy::GetWrapperTypeInfo());
}
...
void V8Window::MathMLElementConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_MathMLElement_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8MathMLElement::GetWrapperTypeInfo());
}
...
void V8Window::ResizeObserverSizeConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8ResizeObserverSize::GetWrapperTypeInfo());
}
...
void V8Window::FragmentDirectiveConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_FragmentDirective_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8FragmentDirective::GetWrapperTypeInfo());
}
...
void V8Window::CSSAnimationConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_CSSAnimation_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8CSSAnimation::GetWrapperTypeInfo());
}

void V8Window::CSSTransitionConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_CSSTransition_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8CSSTransition::GetWrapperTypeInfo());
}
...
void V8Window::ByteLengthQueuingStrategyConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8Window::CountQueuingStrategyConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8Window::LargestContentfulPaintConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8LargestContentfulPaint::GetWrapperTypeInfo());
}

void V8Window::LayoutShiftConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_LayoutShift_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8LayoutShift::GetWrapperTypeInfo());
}
...
void V8Window::SubmitEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_SubmitEvent_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8SubmitEvent::GetWrapperTypeInfo());
}
...
void V8Window::OnrendersubtreeactivationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_onrendersubtreeactivation_Getter");

  dom_window_v8_internal::OnrendersubtreeactivationAttributeGetter(info);
}

void V8Window::OnrendersubtreeactivationAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_onrendersubtreeactivation_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_window_v8_internal::OnrendersubtreeactivationAttributeSetter(v8_value, info);
}
...
void V8Window::PortalHostAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Window_PortalHost_AttributeGetter);
...
void V8Window::RequestPostAnimationFrameMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("Window.requestPostAnimationFrame");
...
void V8Window::CancelPostAnimationFrameMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("Window.cancelPostAnimationFrame");
...
void V8Window::MoveToMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kWindowMove);
...
void V8Window::ResizeToMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kWindowResize);
...
void V8Window::CrossOriginNamedGetter(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  for (const auto& operation : dom_window_v8_internal::kCrossOriginOperationTable) {
...
void V8Window::InstallV8WindowTemplate(
  ...
  kAttributeConfigurations[] = {
      ...
      { "CountQueuingStrategy", V8Window::CountQueuingStrategyConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      { "LargestContentfulPaint", V8Window::LargestContentfulPaintConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "LayoutShift", V8Window::LayoutShiftConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      { "SubmitEvent", V8Window::SubmitEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  ...
  // Custom signature
  static const V8DOMConfiguration::MethodConfiguration kCloseOriginSafeMethodConfiguration[] = {
      {
          "close",
          V8Window::CloseMethodCallback,
          0,
  ...
  for (const auto& method_config : kCloseOriginSafeMethodConfiguration)
  ...
  static const V8DOMConfiguration::MethodConfiguration kFocusOriginSafeMethodConfiguration[] = {
      {
          "focus",
          V8Window::FocusMethodCallback,
          0,
  ...
  for (const auto& method_config : kFocusOriginSafeMethodConfiguration)
    V8DOMConfiguration::InstallMethod(isolate, world, instance_template, prototype_template, interface_template, signature, method_config);
  static const V8DOMConfiguration::MethodConfiguration kBlurOriginSafeMethodConfiguration[] = {
      {
          "blur",
          V8Window::BlurMethodCallback,
          0,
  ...
  for (const auto& method_config : kBlurOriginSafeMethodConfiguration)
    V8DOMConfiguration::InstallMethod(isolate, world, instance_template, prototype_template, interface_template, signature, method_config);
  static const V8DOMConfiguration::MethodConfiguration kPostMessageOriginSafeMethodConfiguration[] = {
      {
          "postMessage",
          V8Window::PostMessageMethodCallback,
          1,
  ...
  for (const auto& method_config : kPostMessageOriginSafeMethodConfiguration)
    V8DOMConfiguration::InstallMethod(isolate, world, instance_template, prototype_template, interface_template, signature, method_config);
}
...
void V8Window::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::CSSVariables2AtPropertyEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "CSSPropertyRule", V8Window::CSSPropertyRuleConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::EditContextEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "EditContext", V8Window::EditContextConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "TextFormatUpdateEvent", V8Window::TextFormatUpdateEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "TextUpdateEvent", V8Window::TextUpdateEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::FeaturePolicyJavaScriptInterfaceEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "FeaturePolicy", V8Window::FeaturePolicyConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::MathMLCoreEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "MathMLElement", V8Window::MathMLElementConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::ResizeObserverUpdatesEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "ResizeObserverSize", V8Window::ResizeObserverSizeConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    ...
    kAttributeConfigurations[] = {
        ...
        { "CSSAnimation", V8Window::CSSAnimationConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "CSSTransition", V8Window::CSSTransitionConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
...
void V8Window::InstallTextFragmentIdentifiers(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "FragmentDirective", V8Window::FragmentDirectiveConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8Window::InstallExperimentalJSProfiler(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "Profiler", V8Window::ProfilerConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8Window::InstallDisplayLocking(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "RenderSubtreeActivationEvent", V8Window::RenderSubtreeActivationEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
  static constexpr V8DOMConfiguration::AccessorConfiguration
  kAccessorConfigurations[] = {
      { "onrendersubtreeactivation", V8Window::OnrendersubtreeactivationAttributeGetterCallback, V8Window::OnrendersubtreeactivationAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAccessors(
      isolate, world, instance, prototype, interface,
      signature, kAccessorConfigurations,
...
void V8Window::InstallScrollTimeline(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
...
void V8Window::InstallScrollTimeline(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallScrollTimeline(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}
