...
static const v8::Eternal<v8::Name>* eternalV8GetAnimationsOptionsKeys(v8::Isolate* isolate) {
...
void V8GetAnimationsOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GetAnimationsOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GetAnimationsOptionsKeys(isolate);
