...
static const v8::Eternal<v8::Name>* eternalV8ProfilerInitOptionsKeys(v8::Isolate* isolate) {
...
void V8ProfilerInitOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ProfilerInitOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8ProfilerInitOptionsKeys(isolate);
