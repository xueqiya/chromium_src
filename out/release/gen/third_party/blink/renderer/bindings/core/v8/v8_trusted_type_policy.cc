...
static void CreateHTMLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  args = ToImplArguments<ScriptValue>(info, 1, exception_state);
  if (exception_state.HadException())
    return;

  TrustedHTML* result = impl->createHTML(script_state, input, args, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void CreateScriptMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TrustedScript* result = impl->createScript(script_state, input, args, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result);
...
static void CreateScriptURLMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TrustedScriptURL* result = impl->createScriptURL(script_state, input, args, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result);
