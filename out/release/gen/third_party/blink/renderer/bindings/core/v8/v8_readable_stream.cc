...
static void GetReaderMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(num_args_passed <= 0)) {
    ReadableStreamDefaultReader* result = impl->getReader(script_state, exception_state);
    if (exception_state.HadException()) {
      return;
    }
  ...
  mode = ScriptValue(info.GetIsolate(), info[0]);

  ReadableStreamDefaultReader* result = impl->getReader(script_state, mode, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result);
...
static void PipeThroughMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  transform_stream = ScriptValue(info.GetIsolate(), info[0]);
  ...
  options = ScriptValue(info.GetIsolate(), info[1]);
...
static void PipeToMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  destination = ScriptValue(info.GetIsolate(), info[0]);
  ...
  option = ScriptValue(info.GetIsolate(), info[1]);
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ReadableStream_ConstructorCallback");

  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "ReadableStream");
  ...
  if (UNLIKELY(num_args_passed <= 0)) {
    ReadableStream* impl = ReadableStream::Create(script_state, exception_state);
    if (exception_state.HadException()) {
      return;
    }
    v8::Local<v8::Object> wrapper = info.Holder();
    wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8ReadableStream::GetWrapperTypeInfo(), wrapper);
  ...
  if (UNLIKELY(num_args_passed <= 1)) {
    ReadableStream* impl = ReadableStream::Create(script_state, underlying_source, exception_state);
    if (exception_state.HadException()) {
      return;
    }
    v8::Local<v8::Object> wrapper = info.Holder();
  ...
  ReadableStream* impl = ReadableStream::Create(script_state, underlying_source, strategy, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  v8::Local<v8::Object> wrapper = info.Holder();
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  readable_stream_v8_internal::Constructor(info);
}
