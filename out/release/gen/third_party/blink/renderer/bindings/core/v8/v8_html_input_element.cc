...
static void ValueAsDateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValue(info, impl->valueAsDate(script_state).V8Value());
}
...
static void ValueAsDateAttributeSetter(
  ...
  impl->setValueAsDate(script_state, cpp_value, exception_state);
}
...
static void SelectionStartAttributeSetter(
  ...
  // Prepare the value to be set.
  uint32_t cpp_value = is_null ? uint32_t() : NativeValueTraits<IDLUnsignedLong>::NativeValue(info.GetIsolate(), v8_value, exception_state);
  if (exception_state.HadException())
    return;
...
static void SetRangeText2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info[3]->IsUndefined()) {
    ...
    if (!selection_mode.Prepare())
      return;
    const char* const kValidSelectionModeValues[] = {
        "select",
        "start",
        "end",
        "preserve",
...
void V8HTMLInputElement::AcceptAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kAcceptAttr);
}
...
void V8HTMLInputElement::DefaultCheckedAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "defaultChecked", html_names::kCheckedAttr);
}
...
void V8HTMLInputElement::DirNameAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kDirnameAttr);
}
...
void V8HTMLInputElement::DisabledAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "disabled", html_names::kDisabledAttr);
}
...
void V8HTMLInputElement::FormNoValidateAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "formNoValidate", html_names::kFormnovalidateAttr);
}
...
void V8HTMLInputElement::FormTargetAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kFormtargetAttr);
}
...
void V8HTMLInputElement::MaxAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kMaxAttr);
}
...
void V8HTMLInputElement::MinAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kMinAttr);
}
...
void V8HTMLInputElement::MultipleAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "multiple", html_names::kMultipleAttr);
}
...
void V8HTMLInputElement::PatternAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kPatternAttr);
}
...
void V8HTMLInputElement::PlaceholderAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kPlaceholderAttr);
}
...
void V8HTMLInputElement::ReadOnlyAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "readOnly", html_names::kReadonlyAttr);
}
...
void V8HTMLInputElement::RequiredAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLInputElement", "required", html_names::kRequiredAttr);
}
...
void V8HTMLInputElement::StepAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kStepAttr);
}
