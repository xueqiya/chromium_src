...
static void WorkerTimingAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  PerformanceResourceTiming* impl = V8PerformanceResourceTiming::ToImpl(holder);

  V8SetReturnValue(info, FreezeV8Object(ToV8(impl->workerTiming(), info.Holder(), info.GetIsolate()), info.GetIsolate()));
}
...
void V8PerformanceResourceTiming::WorkerTimingAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PerformanceResourceTiming_workerTiming_Getter");

  performance_resource_timing_v8_internal::WorkerTimingAttributeGetter(info);
}
...
void V8PerformanceResourceTiming::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::ServiceWorkerFetchEventWorkerTimingEnabled()) {
    static constexpr V8DOMConfiguration::AccessorConfiguration
    kAccessorConfigurations[] = {
        { "workerTiming", V8PerformanceResourceTiming::WorkerTimingAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
