...
static void GetIntersectionListMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!rect) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("getIntersectionList", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(0, "SVGRect")));
    return;
  }

  reference_element = V8SVGElement::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!reference_element && !IsUndefinedOrNull(info[1])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("getIntersectionList", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(1, "SVGElement")));
    return;
  }
...
static void GetEnclosureListMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  rect = V8SVGRect::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!rect) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("getEnclosureList", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(0, "SVGRect")));
    return;
  }

  reference_element = V8SVGElement::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!reference_element && !IsUndefinedOrNull(info[1])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("getEnclosureList", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(1, "SVGElement")));
    return;
  }
...
static void CheckIntersectionMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!element) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("checkIntersection", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(0, "SVGElement")));
    return;
  }

  rect = V8SVGRect::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!rect) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("checkIntersection", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(1, "SVGRect")));
    return;
  }
...
static void CheckEnclosureMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  element = V8SVGElement::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!element) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("checkEnclosure", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(0, "SVGElement")));
    return;
  }

  rect = V8SVGRect::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!rect) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("checkEnclosure", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(1, "SVGRect")));
    return;
  }
...
static void CreateSVGTransformFromMatrixMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!matrix) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("createSVGTransformFromMatrix", "SVGSVGElement", ExceptionMessages::ArgumentNotOfType(0, "SVGMatrix")));
    return;
  }
