...
static void EnterKeyHintAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  String cpp_value(impl->FastGetAttribute(html_names::kEnterkeyhintAttr));

  AtomicString atomic_cpp_value(cpp_value.LowerASCII());
  if (cpp_value.IsEmpty()) {
    ;
  } else if (atomic_cpp_value == keywords::kEnter) {
    cpp_value = keywords::kEnter;
  } else if (atomic_cpp_value == keywords::kDone) {
    cpp_value = keywords::kDone;
  } else if (atomic_cpp_value == keywords::kGo) {
    cpp_value = keywords::kGo;
  } else if (atomic_cpp_value == keywords::kNext) {
    cpp_value = keywords::kNext;
  } else if (atomic_cpp_value == keywords::kPrevious) {
    cpp_value = keywords::kPrevious;
  } else if (atomic_cpp_value == keywords::kSearch) {
    cpp_value = keywords::kSearch;
  } else if (atomic_cpp_value == keywords::kSend) {
    cpp_value = keywords::kSend;
  } else {
...
static void EnterKeyHintAttributeSetter(
  ...
  impl->setAttribute(html_names::kEnterkeyhintAttr, cpp_value);
}
...
static void InputModeAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (cpp_value.IsEmpty()) {
    ;
  } else if (atomic_cpp_value == keywords::kNone) {
    cpp_value = keywords::kNone;
  } else if (atomic_cpp_value == keywords::kText) {
    cpp_value = keywords::kText;
  } else if (atomic_cpp_value == keywords::kTel) {
    cpp_value = keywords::kTel;
  } else if (atomic_cpp_value == keywords::kUrl) {
    cpp_value = keywords::kUrl;
  } else if (atomic_cpp_value == keywords::kEmail) {
    cpp_value = keywords::kEmail;
  } else if (atomic_cpp_value == keywords::kNumeric) {
    cpp_value = keywords::kNumeric;
  } else if (atomic_cpp_value == keywords::kDecimal) {
    cpp_value = keywords::kDecimal;
  } else if (atomic_cpp_value == keywords::kSearch) {
    cpp_value = keywords::kSearch;
  } else {
    cpp_value = g_empty_atom;
...
void V8HTMLElement::TitleAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kTitleAttr);
}
...
void V8HTMLElement::LangAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kLangAttr);
}
...
void V8HTMLElement::InertAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLElement", "inert", html_names::kInertAttr);
}
...
void V8HTMLElement::AccessKeyAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kAccesskeyAttr);
}
...
void V8HTMLElement::EnterKeyHintAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_enterKeyHint_Getter");

  html_element_v8_internal::EnterKeyHintAttributeGetter(info);
}

void V8HTMLElement::EnterKeyHintAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_enterKeyHint_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::EnterKeyHintAttributeSetter(v8_value, info);
}
...
void V8HTMLElement::OnrendersubtreeactivationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onrendersubtreeactivation_Getter");

  html_element_v8_internal::OnrendersubtreeactivationAttributeGetter(info);
}

void V8HTMLElement::OnrendersubtreeactivationAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onrendersubtreeactivation_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnrendersubtreeactivationAttributeSetter(v8_value, info);
}
...
void V8HTMLElement::OnwebkitanimationendAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationend_Getter");

  html_element_v8_internal::OnwebkitanimationendAttributeGetter(info);
}

void V8HTMLElement::OnwebkitanimationendAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationend_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnwebkitanimationendAttributeSetter(v8_value, info);
}

void V8HTMLElement::OnwebkitanimationiterationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationiteration_Getter");

  html_element_v8_internal::OnwebkitanimationiterationAttributeGetter(info);
}

void V8HTMLElement::OnwebkitanimationiterationAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationiteration_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnwebkitanimationiterationAttributeSetter(v8_value, info);
}

void V8HTMLElement::OnwebkitanimationstartAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationstart_Getter");

  html_element_v8_internal::OnwebkitanimationstartAttributeGetter(info);
}

void V8HTMLElement::OnwebkitanimationstartAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkitanimationstart_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnwebkitanimationstartAttributeSetter(v8_value, info);
}

void V8HTMLElement::OnwebkittransitionendAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkittransitionend_Getter");

  html_element_v8_internal::OnwebkittransitionendAttributeGetter(info);
}

void V8HTMLElement::OnwebkittransitionendAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onwebkittransitionend_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnwebkittransitionendAttributeSetter(v8_value, info);
}
...
void V8HTMLElement::OnanimationendAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationend_Getter");

  html_element_v8_internal::OnanimationendAttributeGetter(info);
}

void V8HTMLElement::OnanimationendAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationend_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnanimationendAttributeSetter(v8_value, info);
}

void V8HTMLElement::OnanimationiterationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationiteration_Getter");

  html_element_v8_internal::OnanimationiterationAttributeGetter(info);
}

void V8HTMLElement::OnanimationiterationAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationiteration_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnanimationiterationAttributeSetter(v8_value, info);
}

void V8HTMLElement::OnanimationstartAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationstart_Getter");

  html_element_v8_internal::OnanimationstartAttributeGetter(info);
}

void V8HTMLElement::OnanimationstartAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_onanimationstart_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OnanimationstartAttributeSetter(v8_value, info);
}

void V8HTMLElement::OntransitionendAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_ontransitionend_Getter");

  html_element_v8_internal::OntransitionendAttributeGetter(info);
}

void V8HTMLElement::OntransitionendAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_ontransitionend_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_element_v8_internal::OntransitionendAttributeSetter(v8_value, info);
}
...
void V8HTMLElement::AutofocusAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_autofocus_Getter");

  html_element_v8_internal::AutofocusAttributeGetter(info);
}

void V8HTMLElement::AutofocusAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLElement_autofocus_Setter");

  V8SetReflectedBooleanAttribute(info, "HTMLElement", "autofocus", html_names::kAutofocusAttr);
}
...
void V8HTMLElement::InstallV8HTMLElementTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "onwebkitanimationend", V8HTMLElement::OnwebkitanimationendAttributeGetterCallback, V8HTMLElement::OnwebkitanimationendAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "onwebkitanimationiteration", V8HTMLElement::OnwebkitanimationiterationAttributeGetterCallback, V8HTMLElement::OnwebkitanimationiterationAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "onwebkitanimationstart", V8HTMLElement::OnwebkitanimationstartAttributeGetterCallback, V8HTMLElement::OnwebkitanimationstartAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "onwebkittransitionend", V8HTMLElement::OnwebkittransitionendAttributeGetterCallback, V8HTMLElement::OnwebkittransitionendAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      ...
      { "onanimationend", V8HTMLElement::OnanimationendAttributeGetterCallback, V8HTMLElement::OnanimationendAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "onanimationiteration", V8HTMLElement::OnanimationiterationAttributeGetterCallback, V8HTMLElement::OnanimationiterationAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "onanimationstart", V8HTMLElement::OnanimationstartAttributeGetterCallback, V8HTMLElement::OnanimationstartAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      { "ontransitionend", V8HTMLElement::OntransitionendAttributeGetterCallback, V8HTMLElement::OntransitionendAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      ...
      { "autofocus", V8HTMLElement::AutofocusAttributeGetterCallback, V8HTMLElement::AutofocusAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
...
void V8HTMLElement::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::EnterKeyHintAttributeEnabled()) {
    static constexpr V8DOMConfiguration::AccessorConfiguration
    kAccessorConfigurations[] = {
        { "enterKeyHint", V8HTMLElement::EnterKeyHintAttributeGetterCallback, V8HTMLElement::EnterKeyHintAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
...
void V8HTMLElement::InstallDisplayLocking(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
  ...
  static constexpr V8DOMConfiguration::AccessorConfiguration
  kAccessorConfigurations[] = {
      { "onrendersubtreeactivation", V8HTMLElement::OnrendersubtreeactivationAttributeGetterCallback, V8HTMLElement::OnrendersubtreeactivationAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAccessors(
...
void V8HTMLElement::InstallDisplayLocking(ScriptState* script_state) {
