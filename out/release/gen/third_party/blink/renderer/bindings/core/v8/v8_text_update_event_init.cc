...
static const v8::Eternal<v8::Name>* eternalV8TextUpdateEventInitKeys(v8::Isolate* isolate) {
...
void V8TextUpdateEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, TextUpdateEventInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8TextUpdateEventInitKeys(isolate);
