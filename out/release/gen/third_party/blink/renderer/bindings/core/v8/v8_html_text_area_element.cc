...
void V8HTMLTextAreaElement::DisabledAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLTextAreaElement", "disabled", html_names::kDisabledAttr);
}
...
void V8HTMLTextAreaElement::ReadOnlyAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLTextAreaElement", "readOnly", html_names::kReadonlyAttr);
}
...
void V8HTMLTextAreaElement::RequiredAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLTextAreaElement", "required", html_names::kRequiredAttr);
}
...
void V8HTMLTextAreaElement::WrapAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kWrapAttr);
}
