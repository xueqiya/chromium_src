...
static void ActivateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->activate(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  ...
  switch (std::min(3, info.Length())) {
    case 1:
      if (true) {
        ...
        UseCounter::Count(execution_context_for_measurement, WebFeature::kV8HTMLPortalElement_PostMessage_Method);
...
void V8HTMLPortalElement::ReferrerPolicyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLPortalElement_referrerPolicy_Getter");

  html_portal_element_v8_internal::ReferrerPolicyAttributeGetter(info);
}

void V8HTMLPortalElement::ReferrerPolicyAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLPortalElement_referrerPolicy_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_portal_element_v8_internal::ReferrerPolicyAttributeSetter(v8_value, info);
}
...
void V8HTMLPortalElement::ActivateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8HTMLPortalElement_Activate_Method);
...
static void InstallV8HTMLPortalElementTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "referrerPolicy", V8HTMLPortalElement::ReferrerPolicyAttributeGetterCallback, V8HTMLPortalElement::ReferrerPolicyAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
