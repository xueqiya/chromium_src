...
static void InstallV8CSSRuleTemplate(
  ...
  static_assert(18 == CSSRule::kPropertyRule, "the value of CSSRule_kPropertyRule does not match with implementation");
...
void V8CSSRule::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::CSSVariables2AtPropertyEnabled()) {
    static constexpr V8DOMConfiguration::ConstantConfiguration kConfigurations[] = {
        {"PROPERTY_RULE", V8DOMConfiguration::kConstantTypeUnsignedShort, static_cast<int>(18)},
    };
    V8DOMConfiguration::InstallConstants(
        isolate, interface_template, prototype_template,
