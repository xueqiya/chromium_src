...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  transformer = ScriptValue(info.GetIsolate(), info[0]);
  ...
  writable_strategy = ScriptValue(info.GetIsolate(), info[1]);
  ...
  readable_strategy = ScriptValue(info.GetIsolate(), info[2]);
