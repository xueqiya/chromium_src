...
CORE_EXPORT extern const WrapperTypeInfo v8_mathml_element_wrapper_type_info;

class V8MathMLElement {
  STATIC_ONLY(V8MathMLElement);
 public:
  CORE_EXPORT static bool HasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> FindInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> DomTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static MathMLElement* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<MathMLElement>();
  }
  CORE_EXPORT static MathMLElement* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  CORE_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_mathml_element_wrapper_type_info;
  }
  ...
  CORE_EXPORT static void OnrendersubtreeactivationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void OnrendersubtreeactivationAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct V8TypeOf<MathMLElement> {
  typedef V8MathMLElement Type;
};
