...
void V8HTMLTrackElement::SrclangAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kSrclangAttr);
}
...
void V8HTMLTrackElement::LabelAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kLabelAttr);
}
...
void V8HTMLTrackElement::DefaultAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLTrackElement", "default", html_names::kDefaultAttr);
}
