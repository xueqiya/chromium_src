...
class V8Document {
 ...
 public:
  ...
  CORE_EXPORT static void HasStorageAccessMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void RequestStorageAccessMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
