...
static void StartTimeAttributeSetter(
  ...
  // Prepare the value to be set.
  double cpp_value = is_null ? double() : NativeValueTraits<IDLDouble>::NativeValue(info.GetIsolate(), v8_value, exception_state);
  if (exception_state.HadException())
    return;

  impl->setStartTime(cpp_value, is_null, exception_state);
}
...
static void ReplaceStateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  Animation* impl = V8Animation::ToImpl(holder);

  V8SetReturnValueString(info, impl->replaceState(), info.GetIsolate());
}
...
static void OnremoveAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  Animation* impl = V8Animation::ToImpl(holder);

  EventListener* cpp_value(WTF::GetPtr(impl->onremove()));

  V8SetReturnValue(info, JSEventHandler::AsV8Value(info.GetIsolate(), impl, cpp_value));
}

static void OnremoveAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setOnremove(JSEventHandler::CreateOrNull(v8_value, JSEventHandler::HandlerType::kEventHandler));
}
...
static void CommitStylesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "Animation", "commitStyles");

  Animation* impl = V8Animation::ToImpl(info.Holder());

  impl->commitStyles(exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
static void UpdatePlaybackRateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "Animation", "updatePlaybackRate");
  ...
  playback_rate = NativeValueTraits<IDLDouble>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  impl->updatePlaybackRate(playback_rate, exception_state);
  if (exception_state.HadException()) {
    return;
  }
}
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info[0]->IsUndefined()) {
    ...
    if (!effect && !IsUndefinedOrNull(info[0])) {
      exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "AnimationEffect"));
      return;
    }
  } else {
    effect = nullptr;
  ...
  if (!timeline && !IsUndefinedOrNull(info[1])) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(1, "AnimationTimeline"));
    return;
  }
...
void V8Animation::ReplaceStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Animation_replaceState_Getter");

  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Animation_ReplaceState_AttributeGetter);

  animation_v8_internal::ReplaceStateAttributeGetter(info);
}
...
void V8Animation::OnremoveAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Animation_onremove_Getter");

  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Animation_Onremove_AttributeGetter);

  animation_v8_internal::OnremoveAttributeGetter(info);
}

void V8Animation::OnremoveAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Animation_onremove_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8Animation_Onremove_AttributeSetter);

  animation_v8_internal::OnremoveAttributeSetter(v8_value, info);
}
...
void V8Animation::CommitStylesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Animation_CommitStyles_Method);
  animation_v8_internal::CommitStylesMethod(info);
}
...
void V8Animation::UpdatePlaybackRateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Animation_UpdatePlaybackRate_Method);
  animation_v8_internal::UpdatePlaybackRateMethod(info);
}

void V8Animation::PersistMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Animation_Persist_Method);
  animation_v8_internal::PersistMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8AnimationMethods[] = {
    ...
    {"updatePlaybackRate", V8Animation::UpdatePlaybackRateMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
...
void V8Animation::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    ...
    kAccessorConfigurations[] = {
        ...
        { "replaceState", V8Animation::ReplaceStateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
        { "timeline", V8Animation::TimelineAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
        { "onremove", V8Animation::OnremoveAttributeGetterCallback, V8Animation::OnremoveAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    {
      // Install commitStyles configuration
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"commitStyles", V8Animation::CommitStylesMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"persist", V8Animation::PersistMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
