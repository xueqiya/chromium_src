...
static void IsPointInFillMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!point) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isPointInFill", "SVGGeometryElement", ExceptionMessages::ArgumentNotOfType(0, "SVGPoint")));
    return;
  }
...
static void IsPointInStrokeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  point = V8SVGPoint::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!point) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isPointInStroke", "SVGGeometryElement", ExceptionMessages::ArgumentNotOfType(0, "SVGPoint")));
    return;
  }
...
static void GetTotalLengthMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "SVGGeometryElement", "getTotalLength");

  SVGGeometryElement* impl = V8SVGGeometryElement::ToImpl(info.Holder());

  float result = impl->getTotalLength(exception_state);
