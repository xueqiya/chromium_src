...
static void SetApplyScrollMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!native_scroll_behavior.Prepare())
    return;
  const char* const kValidNativeScrollBehaviorValues[] = {
...
static void IsEqualNodeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!other_node && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isEqualNode", "Node", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
...
static void IsSameNodeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  other_node = V8Node::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!other_node && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isSameNode", "Node", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
...
static void CompareDocumentPositionMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!other) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("compareDocumentPosition", "Node", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
...
static void ContainsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!other && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("contains", "Node", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
