...
static const v8::Eternal<v8::Name>* eternalV8TextFormatUpdateEventInitKeys(v8::Isolate* isolate) {
...
void V8TextFormatUpdateEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, TextFormatUpdateEventInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8TextFormatUpdateEventInitKeys(isolate);
