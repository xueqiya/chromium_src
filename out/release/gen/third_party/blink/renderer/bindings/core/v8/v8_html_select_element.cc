...
void V8HTMLSelectElement::DisabledAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLSelectElement", "disabled", html_names::kDisabledAttr);
}
...
void V8HTMLSelectElement::MultipleAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLSelectElement", "multiple", html_names::kMultipleAttr);
}
...
void V8HTMLSelectElement::RequiredAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLSelectElement", "required", html_names::kRequiredAttr);
}
