...
void V8HTMLOptionElement::DisabledAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLOptionElement", "disabled", html_names::kDisabledAttr);
}
...
void V8HTMLOptionElement::DefaultSelectedAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLOptionElement", "defaultSelected", html_names::kSelectedAttr);
}
