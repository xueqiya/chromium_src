...
static void ReferrerPolicyAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  } else if (atomic_cpp_value == keywords::kSameOrigin) {
    cpp_value = keywords::kSameOrigin;
  } else if (atomic_cpp_value == keywords::kOrigin) {
    cpp_value = keywords::kOrigin;
  } else if (atomic_cpp_value == keywords::kStrictOrigin) {
    cpp_value = keywords::kStrictOrigin;
  } else if (atomic_cpp_value == keywords::kOriginWhenCrossOrigin) {
    cpp_value = keywords::kOriginWhenCrossOrigin;
  } else if (atomic_cpp_value == keywords::kStrictOriginWhenCrossOrigin) {
    cpp_value = keywords::kStrictOriginWhenCrossOrigin;
...
void V8HTMLScriptElement::NoModuleAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLScriptElement", "noModule", html_names::kNomoduleAttr);
}
...
void V8HTMLScriptElement::DeferAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLScriptElement", "defer", html_names::kDeferAttr);
}
...
void V8HTMLScriptElement::EventAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kEventAttr);
}
...
void V8HTMLScriptElement::HTMLForAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kForAttr);
}
