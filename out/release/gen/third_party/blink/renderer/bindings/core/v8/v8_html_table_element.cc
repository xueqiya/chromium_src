...
void V8HTMLTableElement::BorderAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kBorderAttr);
}
...
void V8HTMLTableElement::FrameAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kFrameAttr);
}
...
void V8HTMLTableElement::RulesAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kRulesAttr);
}
...
void V8HTMLTableElement::SummaryAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kSummaryAttr);
}
