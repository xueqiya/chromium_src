...
static void ToJSONMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  CSPViolationReportBody* impl = V8CSPViolationReportBody::ToImpl(info.Holder());
...
void V8CSPViolationReportBody::ToJSONMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  csp_violation_report_body_v8_internal::ToJSONMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8CSPViolationReportBodyMethods[] = {
    {"toJSON", V8CSPViolationReportBody::ToJSONMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
...
static void InstallV8CSPViolationReportBodyTemplate(
  ...
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8CSPViolationReportBodyMethods, base::size(kV8CSPViolationReportBodyMethods));
