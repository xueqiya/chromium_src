...
static void PseudoElementAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueStringOrNull(info, impl->pseudoElement(), info.GetIsolate());
}

static void PseudoElementAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "KeyframeEffect", "pseudoElement");
  ...
  impl->setPseudoElement(cpp_value, exception_state);
}
...
static void GetKeyframesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  HeapVector<ScriptValue> result = impl->getKeyframes(script_state);
...
static void Constructor1(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (info[1]->IsObject()) {
    keyframes = ScriptValue(info.GetIsolate(), info[1]);
...
static void Constructor2(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!source) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "KeyframeEffect"));
    return;
  }
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8KeyframeEffect_Constructor);
...
void V8KeyframeEffect::PseudoElementAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_KeyframeEffect_pseudoElement_Getter");

  keyframe_effect_v8_internal::PseudoElementAttributeGetter(info);
}

void V8KeyframeEffect::PseudoElementAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_KeyframeEffect_pseudoElement_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  keyframe_effect_v8_internal::PseudoElementAttributeSetter(v8_value, info);
}
...
void V8KeyframeEffect::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::WebAnimationsAPIEnabled()) {
    ...
    kAccessorConfigurations[] = {
        ...
        { "pseudoElement", V8KeyframeEffect::PseudoElementAttributeGetterCallback, V8KeyframeEffect::PseudoElementAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
