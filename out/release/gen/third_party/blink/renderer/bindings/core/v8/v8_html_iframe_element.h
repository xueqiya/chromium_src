...
class V8HTMLIFrameElement {
 ...
 public:
  ...
  CORE_EXPORT static void DisallowDocumentAccessAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void DisallowDocumentAccessAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void PolicyAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
