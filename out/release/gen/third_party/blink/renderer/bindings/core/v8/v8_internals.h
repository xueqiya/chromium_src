...
class V8Internals {
 ...
 public:
  ...
  static void IsFormControlsRefreshEnabledAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void SetPseudoClassStateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void GetParsedImportMapMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDeviceEmulationScaleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void GetDocumentAgentIdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void UseMockOverlayScrollbarsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void GetInternalResponseURLListMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void CollectSampleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
