...
static const v8::Eternal<v8::Name>* eternalV8PointerLockOptionsKeys(v8::Isolate* isolate) {
...
void V8PointerLockOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PointerLockOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PointerLockOptionsKeys(isolate);
