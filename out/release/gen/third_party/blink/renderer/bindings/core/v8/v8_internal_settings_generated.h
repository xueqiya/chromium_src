...
class V8InternalSettingsGenerated {
 ...
 public:
  ...
  static void SetCaretBrowsingEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetCookieEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDarkModeBackgroundBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDarkModeContrastMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDarkModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDarkModeGrayscaleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetDarkModeTextBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void SetLazyImageFirstKFullyLoad2GMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetLazyImageFirstKFullyLoad3GMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetLazyImageFirstKFullyLoad4GMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetLazyImageFirstKFullyLoadSlow2GMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetLazyImageFirstKFullyLoadUnknownMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  static void SetTextTrackWindowColorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetTextTrackWindowPaddingMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void SetTextTrackWindowRadiusMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
