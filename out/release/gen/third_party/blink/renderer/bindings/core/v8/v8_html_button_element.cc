...
void V8HTMLButtonElement::DisabledAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLButtonElement", "disabled", html_names::kDisabledAttr);
}
...
void V8HTMLButtonElement::FormNoValidateAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLButtonElement", "formNoValidate", html_names::kFormnovalidateAttr);
}
...
void V8HTMLButtonElement::ValueAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kValueAttr);
}
