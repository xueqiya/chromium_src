...
static void ToJSONMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  FeaturePolicyViolationReportBody* impl = V8FeaturePolicyViolationReportBody::ToImpl(info.Holder());
...
void V8FeaturePolicyViolationReportBody::ToJSONMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("FeaturePolicyViolationReportBody.toJSON");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_FeaturePolicyViolationReportBody_toJSON");

  feature_policy_violation_report_body_v8_internal::ToJSONMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8FeaturePolicyViolationReportBodyMethods[] = {
    {"toJSON", V8FeaturePolicyViolationReportBody::ToJSONMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
...
static void InstallV8FeaturePolicyViolationReportBodyTemplate(
  ...
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8FeaturePolicyViolationReportBodyMethods, base::size(kV8FeaturePolicyViolationReportBodyMethods));
