...
CORE_EXPORT extern WrapperTypeInfo v8_element_wrapper_type_info;
...
class V8Element {
 ...
 public:
  ...
  CORE_EXPORT static void InstallV8ElementTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
  ...
  static void InstallDisplayLocking(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallDisplayLocking(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallDisplayLocking(ScriptState*);
  ...
  CORE_EXPORT static void RenderSubtreeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void RenderSubtreeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ElementTimingAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ElementTimingAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void UpdateRenderingMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ResetSubtreeRenderedMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
 ...
 private:
  static InstallTemplateFunction install_v8_element_template_function_;
};
