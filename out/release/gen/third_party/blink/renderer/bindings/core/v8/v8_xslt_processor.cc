...
static void ImportStylesheetMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!style) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("importStylesheet", "XSLTProcessor", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
...
static void TransformToFragmentMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!source) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("transformToFragment", "XSLTProcessor", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }

  output = V8Document::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!output) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("transformToFragment", "XSLTProcessor", ExceptionMessages::ArgumentNotOfType(1, "Document")));
    return;
  }
...
static void TransformToDocumentMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  source = V8Node::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!source) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("transformToDocument", "XSLTProcessor", ExceptionMessages::ArgumentNotOfType(0, "Node")));
    return;
  }
