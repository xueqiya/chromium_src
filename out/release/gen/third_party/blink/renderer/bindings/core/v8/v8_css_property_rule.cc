...
void V8CSSPropertyRule::StyleAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSPropertyRule_style_Getter");

  css_property_rule_v8_internal::StyleAttributeGetter(info);
}
...
static void InstallV8CSSPropertyRuleTemplate(
  ...
  kAccessorConfigurations[] = {
      { "style", V8CSSPropertyRule::StyleAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
  };
