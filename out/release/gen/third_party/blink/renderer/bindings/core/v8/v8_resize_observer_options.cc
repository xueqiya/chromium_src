...
static const v8::Eternal<v8::Name>* eternalV8ResizeObserverOptionsKeys(v8::Isolate* isolate) {
...
void V8ResizeObserverOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ResizeObserverOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8ResizeObserverOptionsKeys(isolate);
