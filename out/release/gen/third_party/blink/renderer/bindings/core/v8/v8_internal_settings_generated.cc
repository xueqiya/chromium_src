...
static void SetDarkModeBackgroundBrightnessThresholdMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setDarkModeBackgroundBrightnessThreshold");
  ...
  int32_t dark_mode_background_brightness_threshold;
  dark_mode_background_brightness_threshold = NativeValueTraits<IDLLong>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  impl->setDarkModeBackgroundBrightnessThreshold(dark_mode_background_brightness_threshold);
}
...
static void SetDarkModeEnabledMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setDarkModeEnabled");
  ...
  dark_mode_enabled = NativeValueTraits<IDLBoolean>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  impl->setDarkModeEnabled(dark_mode_enabled);
}
...
static void SetDarkModeTextBrightnessThresholdMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setDarkModeTextBrightnessThreshold");
  ...
  int32_t dark_mode_text_brightness_threshold;
  dark_mode_text_brightness_threshold = NativeValueTraits<IDLLong>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  impl->setDarkModeTextBrightnessThreshold(dark_mode_text_brightness_threshold);
}
...
void V8InternalSettingsGenerated::SetDarkModeBackgroundBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettingsGenerated.setDarkModeBackgroundBrightnessThreshold");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setDarkModeBackgroundBrightnessThreshold");

  internal_settings_generated_v8_internal::SetDarkModeBackgroundBrightnessThresholdMethod(info);
}

void V8InternalSettingsGenerated::SetDarkModeContrastMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettingsGenerated.setDarkModeContrast");
...
void V8InternalSettingsGenerated::SetDarkModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettingsGenerated.setDarkModeEnabled");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setDarkModeEnabled");

  internal_settings_generated_v8_internal::SetDarkModeEnabledMethod(info);
}

void V8InternalSettingsGenerated::SetDarkModeGrayscaleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettingsGenerated.setDarkModeGrayscale");
...
void V8InternalSettingsGenerated::SetDarkModeTextBrightnessThresholdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("InternalSettingsGenerated.setDarkModeTextBrightnessThreshold");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setDarkModeTextBrightnessThreshold");

  internal_settings_generated_v8_internal::SetDarkModeTextBrightnessThresholdMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8InternalSettingsGeneratedMethods[] = {
    ...
    {"setDarkModeBackgroundBrightnessThreshold", V8InternalSettingsGenerated::SetDarkModeBackgroundBrightnessThresholdMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    ...
    {"setDarkModeEnabled", V8InternalSettingsGenerated::SetDarkModeEnabledMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    ...
    {"setDarkModeTextBrightnessThreshold", V8InternalSettingsGenerated::SetDarkModeTextBrightnessThresholdMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
