...
class V8Performance {
 ...
 public:
  ...
  static void InstallExperimentalJSProfiler(ScriptState*);
  ...
  CORE_EXPORT static void MeasureMemoryMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void ProfileMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
