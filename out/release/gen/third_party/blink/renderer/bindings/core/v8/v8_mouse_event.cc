...
static void InitMouseEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!view && !IsUndefinedOrNull(info[3])) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(3, "Window"));
    return;
  }
  ...
  if (!related_target && !IsUndefinedOrNull(info[14])) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(14, "EventTarget"));
    return;
  }
...
void V8MouseEvent::ScreenXAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kMouseEventScreenX);
  Dactyloscoper::Record(execution_context_for_measurement, WebFeature::kMouseEventScreenX);
...
void V8MouseEvent::ScreenYAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kMouseEventScreenY);
  Dactyloscoper::Record(execution_context_for_measurement, WebFeature::kMouseEventScreenY);
