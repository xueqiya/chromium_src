...
class V8DedicatedWorkerGlobalScope {
 ...
 public:
  ...
  CORE_EXPORT static void ProfilerConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void ByteLengthQueuingStrategyConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void CountQueuingStrategyConstructorGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
