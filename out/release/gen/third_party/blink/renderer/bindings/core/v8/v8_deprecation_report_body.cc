...
static void AnticipatedRemovalAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValue(info, impl->anticipatedRemoval(script_state).V8Value());
}
...
static void ToJSONMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  DeprecationReportBody* impl = V8DeprecationReportBody::ToImpl(info.Holder());
...
void V8DeprecationReportBody::ToJSONMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  deprecation_report_body_v8_internal::ToJSONMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8DeprecationReportBodyMethods[] = {
    {"toJSON", V8DeprecationReportBody::ToJSONMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
...
static void InstallV8DeprecationReportBodyTemplate(
  ...
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8DeprecationReportBodyMethods, base::size(kV8DeprecationReportBodyMethods));
