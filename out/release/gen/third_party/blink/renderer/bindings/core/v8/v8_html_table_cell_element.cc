...
static void ScopeAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (cpp_value.IsEmpty()) {
    ;
  } else if (atomic_cpp_value == keywords::kRow) {
    cpp_value = keywords::kRow;
  } else if (atomic_cpp_value == keywords::kCol) {
    cpp_value = keywords::kCol;
  } else if (atomic_cpp_value == keywords::kRowgroup) {
    cpp_value = keywords::kRowgroup;
  } else if (atomic_cpp_value == keywords::kColgroup) {
    cpp_value = keywords::kColgroup;
  } else {
...
void V8HTMLTableCellElement::HeadersAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kHeadersAttr);
}
...
void V8HTMLTableCellElement::AxisAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kAxisAttr);
}
...
void V8HTMLTableCellElement::NoWrapAttributeSetterCallback(
  ...
  V8SetReflectedBooleanAttribute(info, "HTMLTableCellElement", "noWrap", html_names::kNowrapAttr);
}
...
void V8HTMLTableCellElement::AbbrAttributeSetterCallback(
  ...
  V8SetReflectedDOMStringAttribute(info, html_names::kAbbrAttr);
}
