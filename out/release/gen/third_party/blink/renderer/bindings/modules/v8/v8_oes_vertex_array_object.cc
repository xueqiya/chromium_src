...
static void DeleteVertexArrayOESMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!array_object && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("deleteVertexArrayOES", "OESVertexArrayObject", ExceptionMessages::ArgumentNotOfType(0, "WebGLVertexArrayObjectOES")));
    return;
  }
...
static void IsVertexArrayOESMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  array_object = V8WebGLVertexArrayObjectOES::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!array_object && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("isVertexArrayOES", "OESVertexArrayObject", ExceptionMessages::ArgumentNotOfType(0, "WebGLVertexArrayObjectOES")));
    return;
  }
...
static void BindVertexArrayOESMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  array_object = V8WebGLVertexArrayObjectOES::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!array_object && !IsUndefinedOrNull(info[0])) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("bindVertexArrayOES", "OESVertexArrayObject", ExceptionMessages::ArgumentNotOfType(0, "WebGLVertexArrayObjectOES")));
    return;
  }
