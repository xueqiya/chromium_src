...
void V8MediaTrackConstraintSet::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaTrackConstraintSet* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&torch_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&video_kind_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&pan_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (pan_value.IsEmpty() || pan_value->IsUndefined()) {
      ...
      DoubleOrConstrainDoubleRange pan_cpp_value;
      V8DoubleOrConstrainDoubleRange::ToImpl(isolate, pan_value, pan_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
      if (exception_state.HadException())
        return;
    ...
    if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&tilt_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (tilt_value.IsEmpty() || tilt_value->IsUndefined()) {
      ...
      DoubleOrConstrainDoubleRange tilt_cpp_value;
      V8DoubleOrConstrainDoubleRange::ToImpl(isolate, tilt_value, tilt_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
      if (exception_state.HadException())
        return;
...
bool toV8MediaTrackConstraintSet(const MediaTrackConstraintSet* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (torch_has_value_or_default &&
      !create_property(30, torch_value)) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (video_kind_has_value_or_default &&
        !create_property(31, video_kind_value)) {
      return false;
    }
  }
...
MediaTrackConstraintSet* NativeValueTraits<MediaTrackConstraintSet>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaTrackConstraintSet* impl = MakeGarbageCollected<MediaTrackConstraintSet>();
