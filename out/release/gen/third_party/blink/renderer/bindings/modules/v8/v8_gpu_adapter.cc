...
static void ExtensionsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValue(info, impl->extensions(script_state).V8Value());
}
...
void V8GPUAdapter::ExtensionsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUAdapter_extensions_Getter");

  gpu_adapter_v8_internal::ExtensionsAttributeGetter(info);
}
...
static void InstallV8GPUAdapterTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "extensions", V8GPUAdapter::ExtensionsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
  };
