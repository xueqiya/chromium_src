...
static void GetContextMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!context_type.Prepare())
    return;
  const char* const kValidContextTypeValues[] = {
      "2d",
      "webgl",
      "webgl2",
      "webgl2-compute",
  ...
  OffscreenCanvasRenderingContext2DOrWebGLRenderingContextOrWebGL2RenderingContextOrImageBitmapRenderingContext result;
