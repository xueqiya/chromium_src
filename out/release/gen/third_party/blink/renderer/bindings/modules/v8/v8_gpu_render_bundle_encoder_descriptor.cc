...
static const v8::Eternal<v8::Name>* eternalV8GPURenderBundleEncoderDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPURenderBundleEncoderDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPURenderBundleEncoderDescriptor* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPURenderBundleEncoderDescriptorKeys(isolate);
