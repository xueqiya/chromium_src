...
static void PaymentOptionsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  V8SetReturnValue(info, impl->paymentOptions(script_state).V8Value());
}

static void ShippingOptionsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  HeapVector<Member<PaymentShippingOption>> cpp_value(impl->shippingOptions(is_null));
...
static void ChangePaymentMethodMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info[1]->IsUndefined()) {
    if (info[1]->IsObject()) {
      method_details = ScriptValue(info.GetIsolate(), info[1]);
    } else if (info[1]->IsNullOrUndefined()) {
      method_details = ScriptValue(info.GetIsolate(), v8::Null(info.GetIsolate()));
    } else {
      exception_state.ThrowTypeError("parameter 2 ('methodDetails') is not an object.");
      return;
    }
  } else {
    method_details = ScriptValue::CreateNull(script_state->GetIsolate());
  }
...
static void ChangeShippingAddressMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "PaymentRequestEvent", "changeShippingAddress");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
  ...
  if (!info[0]->IsNullOrUndefined() && !info[0]->IsObject()) {
    exception_state.ThrowTypeError("parameter 1 ('shippingAddress') is not an object.");
    return;
  }
  shipping_address = NativeValueTraits<PaymentAddressInit>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  ScriptPromise result = impl->changeShippingAddress(script_state, shipping_address, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void ChangeShippingOptionMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "PaymentRequestEvent", "changeShippingOption");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
  ...
  V8StringResource<> shipping_option;
  shipping_option = info[0];
  if (!shipping_option.Prepare(exception_state))
    return;

  ScriptPromise result = impl->changeShippingOption(script_state, shipping_option, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
void V8PaymentRequestEvent::PaymentOptionsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentRequestEvent_paymentOptions_Getter");

  payment_request_event_v8_internal::PaymentOptionsAttributeGetter(info);
}

void V8PaymentRequestEvent::ShippingOptionsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentRequestEvent_shippingOptions_Getter");

  payment_request_event_v8_internal::ShippingOptionsAttributeGetter(info);
}
...
void V8PaymentRequestEvent::ChangeShippingAddressMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  payment_request_event_v8_internal::ChangeShippingAddressMethod(info);
}

void V8PaymentRequestEvent::ChangeShippingOptionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  payment_request_event_v8_internal::ChangeShippingOptionMethod(info);
}
...
void V8PaymentRequestEvent::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::PaymentHandlerHandlesShippingAndContactEnabled()) {
    static constexpr V8DOMConfiguration::AccessorConfiguration
    kAccessorConfigurations[] = {
        { "paymentOptions", V8PaymentRequestEvent::PaymentOptionsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
        { "shippingOptions", V8PaymentRequestEvent::ShippingOptionsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
  ...
  if (RuntimeEnabledFeatures::PaymentHandlerHandlesShippingAndContactEnabled()) {
    {
      // Install changeShippingAddress configuration
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"changeShippingAddress", V8PaymentRequestEvent::ChangeShippingAddressMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
  ...
  if (RuntimeEnabledFeatures::PaymentHandlerHandlesShippingAndContactEnabled()) {
    {
      // Install changeShippingOption configuration
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"changeShippingOption", V8PaymentRequestEvent::ChangeShippingOptionMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
