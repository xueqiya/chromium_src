...
static const v8::Eternal<v8::Name>* eternalV8GPUOrigin3DDictKeys(v8::Isolate* isolate) {
...
void V8GPUOrigin3DDict::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUOrigin3DDict* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUOrigin3DDictKeys(isolate);
...
v8::Local<v8::Value> GPUOrigin3DDict::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GPUOrigin3DDict(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GPUOrigin3DDict(const GPUOrigin3DDict* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8GPUOrigin3DDictKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  ...
  if (impl->hasX()) {
    ...
    x_value = v8::Integer::NewFromUnsigned(isolate, 0u);
    x_has_value_or_default = true;
  }
  ...
  if (impl->hasY()) {
    ...
    y_value = v8::Integer::NewFromUnsigned(isolate, 0u);
    y_has_value_or_default = true;
  }
  ...
  if (impl->hasZ()) {
    ...
    z_value = v8::Integer::NewFromUnsigned(isolate, 0u);
    z_has_value_or_default = true;
  }
...
GPUOrigin3DDict* NativeValueTraits<GPUOrigin3DDict>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUOrigin3DDict* impl = MakeGarbageCollected<GPUOrigin3DDict>();
  V8GPUOrigin3DDict::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
