...
static void CreateObjectURL2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!source) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("createObjectURL", "URL", ExceptionMessages::ArgumentNotOfType(0, "MediaSource")));
    return;
  }
