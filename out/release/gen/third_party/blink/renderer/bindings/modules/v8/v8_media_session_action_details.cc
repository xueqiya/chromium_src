...
static const v8::Eternal<v8::Name>* eternalV8MediaSessionActionDetailsKeys(v8::Isolate* isolate) {
...
void V8MediaSessionActionDetails::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaSessionActionDetails* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8MediaSessionActionDetailsKeys(isolate);
