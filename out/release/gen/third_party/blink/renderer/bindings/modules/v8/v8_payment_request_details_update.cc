...
static const v8::Eternal<v8::Name>* eternalV8PaymentRequestDetailsUpdateKeys(v8::Isolate* isolate) {
...
void V8PaymentRequestDetailsUpdate::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PaymentRequestDetailsUpdate* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PaymentRequestDetailsUpdateKeys(isolate);
  ...
  if (payment_method_errors_value.IsEmpty() || payment_method_errors_value->IsUndefined()) {
    ...
    ScriptValue payment_method_errors_cpp_value = ScriptValue(isolate, payment_method_errors_value);
