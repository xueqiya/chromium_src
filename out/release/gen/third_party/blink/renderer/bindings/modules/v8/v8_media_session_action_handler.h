...
class MODULES_EXPORT V8MediaSessionActionHandler final : public CallbackFunctionBase {
 public:
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const MediaSessionActionDetails*& details) WARN_UNUSED_RESULT;

  // Performs "invoke", and then reports an exception, if any, to the global
  // error handler such as DevTools' console.
  void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const MediaSessionActionDetails*& details);
};
