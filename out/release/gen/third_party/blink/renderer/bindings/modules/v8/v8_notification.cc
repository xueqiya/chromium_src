...
void V8Notification::InstallNotificationTriggers(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
  ...
  v8::Local<v8::FunctionTemplate> interface_template =
      V8Notification::GetWrapperTypeInfo()->DomTemplate(isolate, world);
  v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_template);
  ALLOW_UNUSED_LOCAL(signature);
  static constexpr V8DOMConfiguration::AccessorConfiguration
  kAccessorConfigurations[] = {
...
void V8Notification::InstallNotificationTriggers(ScriptState* script_state) {
  InstallNotificationTriggers(script_state, v8::Local<v8::Object>());
}
