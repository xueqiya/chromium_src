...
static void MaxPacketLifeTimeAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  uint16_t cpp_value(impl->maxPacketLifeTime(is_null));
...
static void MaxRetransmitsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  uint16_t cpp_value(impl->maxRetransmits(is_null));
...
static void OnclosingAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  RTCDataChannel* impl = V8RTCDataChannel::ToImpl(holder);

  EventListener* cpp_value(WTF::GetPtr(impl->onclosing()));

  V8SetReturnValue(info, JSEventHandler::AsV8Value(info.GetIsolate(), impl, cpp_value));
}

static void OnclosingAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setOnclosing(JSEventHandler::CreateOrNull(v8_value, JSEventHandler::HandlerType::kEventHandler));
}
...
static void Send2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!data) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "Blob"));
    return;
  }
...
static void Send3Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!data) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "ArrayBuffer"));
    return;
  }
...
void V8RTCDataChannel::MaxPacketLifeTimeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannel_maxPacketLifeTime_Getter");

  rtc_data_channel_v8_internal::MaxPacketLifeTimeAttributeGetter(info);
}
...
void V8RTCDataChannel::OnclosingAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannel_onclosing_Getter");

  rtc_data_channel_v8_internal::OnclosingAttributeGetter(info);
}

void V8RTCDataChannel::OnclosingAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannel_onclosing_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  rtc_data_channel_v8_internal::OnclosingAttributeSetter(v8_value, info);
}
...
static void InstallV8RTCDataChannelTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "maxPacketLifeTime", V8RTCDataChannel::MaxPacketLifeTimeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      ...
      { "onclosing", V8RTCDataChannel::OnclosingAttributeGetterCallback, V8RTCDataChannel::OnclosingAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
