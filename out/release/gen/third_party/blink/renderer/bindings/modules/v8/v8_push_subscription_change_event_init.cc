...
static const v8::Eternal<v8::Name>* eternalV8PushSubscriptionChangeEventInitKeys(v8::Isolate* isolate) {
...
void V8PushSubscriptionChangeEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PushSubscriptionChangeEventInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PushSubscriptionChangeEventInitKeys(isolate);
