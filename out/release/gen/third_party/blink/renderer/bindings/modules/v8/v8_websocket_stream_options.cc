...
static const v8::Eternal<v8::Name>* eternalV8WebSocketStreamOptionsKeys(v8::Isolate* isolate) {
...
void V8WebSocketStreamOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, WebSocketStreamOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8WebSocketStreamOptionsKeys(isolate);
