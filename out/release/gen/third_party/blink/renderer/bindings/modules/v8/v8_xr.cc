...
static void IsSessionSupportedMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "XR", "isSessionSupported");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
...
void V8XR::SupportsSessionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("XR.supportsSession");
...
void V8XR::IsSessionSupportedMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("XR.isSessionSupported");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XR_isSessionSupported");

  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kXRIsSessionSupported);
  xr_v8_internal::IsSessionSupportedMethod(info);
}

void V8XR::RequestSessionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("XR.requestSession");
    ...
    if (is_secure_context) {
      {
        ...
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"isSessionSupported", V8XR::IsSessionSupportedMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
