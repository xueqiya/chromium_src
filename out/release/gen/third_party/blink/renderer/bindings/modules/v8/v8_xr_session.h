...
class V8XRSession {
 ...
 public:
  ...
  MODULES_EXPORT static void InputSourcesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void DOMOverlayStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void OnvisibilitychangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnvisibilitychangeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void WorldTrackingStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void TrackedAnchorsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void CreateAnchorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void EndMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void RequestHitTestSourceMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void RequestHitTestSourceForTransientInputMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
