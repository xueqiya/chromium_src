...
static void UpdateUIMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->updateUI(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8BackgroundFetchUpdateUIEventMethods[] = {
    {"updateUI", V8BackgroundFetchUpdateUIEvent::UpdateUIMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
