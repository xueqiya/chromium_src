...
class V8RTCRtpReceiver {
 ...
 public:
  ...
  MODULES_EXPORT static void PlayoutDelayHintAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void PlayoutDelayHintAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
