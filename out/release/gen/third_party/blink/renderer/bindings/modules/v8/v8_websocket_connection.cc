...
static const v8::Eternal<v8::Name>* eternalV8WebSocketConnectionKeys(v8::Isolate* isolate) {
...
void V8WebSocketConnection::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, WebSocketConnection* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8WebSocketConnectionKeys(isolate);
