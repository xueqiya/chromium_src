...
void V8MediaCapabilitiesKeySystemConfiguration::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaCapabilitiesKeySystemConfiguration* impl, ExceptionState& exception_state) {
  ...
  if (audio_value.IsEmpty() || audio_value->IsUndefined()) {
    ...
    KeySystemTrackConfiguration* audio_cpp_value = NativeValueTraits<KeySystemTrackConfiguration>::NativeValue(isolate, audio_value, exception_state);
  ...
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&video_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (video_value.IsEmpty() || video_value->IsUndefined()) {
    ...
    KeySystemTrackConfiguration* video_cpp_value = NativeValueTraits<KeySystemTrackConfiguration>::NativeValue(isolate, video_value, exception_state);
    if (exception_state.HadException())
      return;
...
MediaCapabilitiesKeySystemConfiguration* NativeValueTraits<MediaCapabilitiesKeySystemConfiguration>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaCapabilitiesKeySystemConfiguration* impl = MakeGarbageCollected<MediaCapabilitiesKeySystemConfiguration>();
