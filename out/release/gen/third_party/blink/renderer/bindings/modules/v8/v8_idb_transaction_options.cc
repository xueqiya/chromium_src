...
static const v8::Eternal<v8::Name>* eternalV8IDBTransactionOptionsKeys(v8::Isolate* isolate) {
...
void V8IDBTransactionOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, IDBTransactionOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8IDBTransactionOptionsKeys(isolate);
