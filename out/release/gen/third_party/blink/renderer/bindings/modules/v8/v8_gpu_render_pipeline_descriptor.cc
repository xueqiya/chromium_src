...
void V8GPURenderPipelineDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPURenderPipelineDescriptor* impl, ExceptionState& exception_state) {
  if (IsUndefinedOrNull(v8_value)) {
    exception_state.ThrowTypeError("Missing required member(s): colorStates, primitiveTopology, vertexStage.");
    return;
  }
  ...
  v8::Local<v8::Value> alpha_to_coverage_enabled_value;
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&alpha_to_coverage_enabled_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (alpha_to_coverage_enabled_value.IsEmpty() || alpha_to_coverage_enabled_value->IsUndefined()) {
    // Do nothing.
  } else {
    bool alpha_to_coverage_enabled_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, alpha_to_coverage_enabled_value, exception_state);
    if (exception_state.HadException())
      return;
    impl->setAlphaToCoverageEnabled(alpha_to_coverage_enabled_cpp_value);
  }

  v8::Local<v8::Value> color_states_value;
  if (!v8Object->Get(context, keys[1].Get(isolate)).ToLocal(&color_states_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&depth_stencil_state_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&fragment_stage_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (fragment_stage_value.IsEmpty() || fragment_stage_value->IsUndefined()) {
    ...
    GPUProgrammableStageDescriptor* fragment_stage_cpp_value = NativeValueTraits<GPUProgrammableStageDescriptor>::NativeValue(isolate, fragment_stage_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&primitive_topology_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&rasterization_state_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&sample_count_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  v8::Local<v8::Value> sample_mask_value;
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&sample_mask_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (sample_mask_value.IsEmpty() || sample_mask_value->IsUndefined()) {
    // Do nothing.
  } else {
    uint32_t sample_mask_cpp_value = NativeValueTraits<IDLUnsignedLong>::NativeValue(isolate, sample_mask_value, exception_state);
    if (exception_state.HadException())
      return;
    impl->setSampleMask(sample_mask_cpp_value);
  }

  v8::Local<v8::Value> vertex_stage_value;
  if (!v8Object->Get(context, keys[8].Get(isolate)).ToLocal(&vertex_stage_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (vertex_stage_value.IsEmpty() || vertex_stage_value->IsUndefined()) {
    ...
    GPUProgrammableStageDescriptor* vertex_stage_cpp_value = NativeValueTraits<GPUProgrammableStageDescriptor>::NativeValue(isolate, vertex_stage_value, exception_state);
    if (exception_state.HadException())
      return;
    impl->setVertexStage(vertex_stage_cpp_value);
  }

  v8::Local<v8::Value> vertex_state_value;
  if (!v8Object->Get(context, keys[9].Get(isolate)).ToLocal(&vertex_state_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (vertex_state_value.IsEmpty() || vertex_state_value->IsUndefined()) {
    // Do nothing.
  } else {
    GPUVertexStateDescriptor* vertex_state_cpp_value = NativeValueTraits<GPUVertexStateDescriptor>::NativeValue(isolate, vertex_state_value, exception_state);
    if (exception_state.HadException())
      return;
    impl->setVertexState(vertex_state_cpp_value);
  }
}
...
bool toV8GPURenderPipelineDescriptor(const GPURenderPipelineDescriptor* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  v8::Local<v8::Value> alpha_to_coverage_enabled_value;
  bool alpha_to_coverage_enabled_has_value_or_default = false;
  if (impl->hasAlphaToCoverageEnabled()) {
    alpha_to_coverage_enabled_value = v8::Boolean::New(isolate, impl->alphaToCoverageEnabled());
    alpha_to_coverage_enabled_has_value_or_default = true;
  } else {
    alpha_to_coverage_enabled_value = v8::Boolean::New(isolate, false);
    alpha_to_coverage_enabled_has_value_or_default = true;
  }
  if (alpha_to_coverage_enabled_has_value_or_default &&
      !create_property(0, alpha_to_coverage_enabled_value)) {
    return false;
  }
  ...
  if (color_states_has_value_or_default &&
      !create_property(1, color_states_value)) {
    return false;
  }
  ...
  if (depth_stencil_state_has_value_or_default &&
      !create_property(2, depth_stencil_state_value)) {
    return false;
  }
  ...
  if (fragment_stage_has_value_or_default &&
      !create_property(3, fragment_stage_value)) {
    return false;
  }
  ...
  if (primitive_topology_has_value_or_default &&
      !create_property(4, primitive_topology_value)) {
    return false;
  }
  ...
  if (impl->hasRasterizationState()) {
    ...
    rasterization_state_value = ToV8(MakeGarbageCollected<GPURasterizationStateDescriptor>(), creationContext, isolate);
    rasterization_state_has_value_or_default = true;
  }
  if (rasterization_state_has_value_or_default &&
      !create_property(5, rasterization_state_value)) {
    return false;
  }
  ...
  if (sample_count_has_value_or_default &&
      !create_property(6, sample_count_value)) {
    return false;
  }

  v8::Local<v8::Value> sample_mask_value;
  bool sample_mask_has_value_or_default = false;
  if (impl->hasSampleMask()) {
    sample_mask_value = v8::Integer::NewFromUnsigned(isolate, impl->sampleMask());
    sample_mask_has_value_or_default = true;
  } else {
    sample_mask_value = v8::Integer::NewFromUnsigned(isolate, 4294967295u);
    sample_mask_has_value_or_default = true;
  }
  if (sample_mask_has_value_or_default &&
      !create_property(7, sample_mask_value)) {
    return false;
  }
  ...
  if (vertex_stage_has_value_or_default &&
      !create_property(8, vertex_stage_value)) {
    return false;
  }

  v8::Local<v8::Value> vertex_state_value;
  bool vertex_state_has_value_or_default = false;
  if (impl->hasVertexState()) {
    vertex_state_value = ToV8(impl->vertexState(), creationContext, isolate);
    vertex_state_has_value_or_default = true;
  } else {
    vertex_state_value = ToV8(MakeGarbageCollected<GPUVertexStateDescriptor>(), creationContext, isolate);
    vertex_state_has_value_or_default = true;
  }
  if (vertex_state_has_value_or_default &&
      !create_property(9, vertex_state_value)) {
    return false;
  }
...
GPURenderPipelineDescriptor* NativeValueTraits<GPURenderPipelineDescriptor>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPURenderPipelineDescriptor* impl = MakeGarbageCollected<GPURenderPipelineDescriptor>();
