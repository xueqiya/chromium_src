...
static const v8::Eternal<v8::Name>* eternalV8XRHitTestOptionsInitKeys(v8::Isolate* isolate) {
...
void V8XRHitTestOptionsInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, XRHitTestOptionsInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8XRHitTestOptionsInitKeys(isolate);
