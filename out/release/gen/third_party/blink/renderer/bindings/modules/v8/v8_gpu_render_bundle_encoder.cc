...
static void PushDebugGroupMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(info.Length() < 1)) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("pushDebugGroup", "GPURenderBundleEncoder", ExceptionMessages::NotEnoughArguments(1, info.Length())));
    return;
  }
...
static void InsertDebugMarkerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(info.Length() < 1)) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("insertDebugMarker", "GPURenderBundleEncoder", ExceptionMessages::NotEnoughArguments(1, info.Length())));
    return;
  }
  ...
  if (RuntimeEnabledFeatures::WebGPUEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"draw", V8GPURenderBundleEncoder::DrawMethodCallback, 4, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
  ...
  if (RuntimeEnabledFeatures::WebGPUEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"drawIndexed", V8GPURenderBundleEncoder::DrawIndexedMethodCallback, 5, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
