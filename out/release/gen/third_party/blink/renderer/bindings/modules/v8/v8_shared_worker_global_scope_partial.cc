...
void V8SharedWorkerGlobalScopePartial::MediaSourceConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedWorkerGlobalScope_MediaSource_ConstructorGetterCallback");
...
void V8SharedWorkerGlobalScopePartial::FileSystemWriterConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedWorkerGlobalScope_FileSystemWriter_ConstructorGetterCallback");
...
void V8SharedWorkerGlobalScopePartial::DetectedBarcodeConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedWorkerGlobalScope_DetectedBarcode_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8DetectedBarcode::GetWrapperTypeInfo());
}

void V8SharedWorkerGlobalScopePartial::DetectedFaceConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedWorkerGlobalScope_DetectedFace_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8DetectedFace::GetWrapperTypeInfo());
}

void V8SharedWorkerGlobalScopePartial::DetectedTextConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedWorkerGlobalScope_DetectedText_ConstructorGetterCallback");
...
void V8SharedWorkerGlobalScopePartial::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::MediaSourceInWorkersEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "MediaSource", V8SharedWorkerGlobalScopePartial::MediaSourceConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8SharedWorkerGlobalScopePartial::InstallContentIndex(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
void V8SharedWorkerGlobalScopePartial::InstallNativeFileSystem(
  ...
  if (is_secure_context) {
    ...
    kAttributeConfigurations[] = {
        ...
        { "FileSystemWriter", V8SharedWorkerGlobalScopePartial::FileSystemWriterConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance, prototype,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8SharedWorkerGlobalScopePartial::InstallWebSocketStream(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
    ...
    if (is_secure_context) {
      ...
      if (RuntimeEnabledFeatures::ShapeDetectionEnabled()) {
        ...
        kAttributeConfigurations[] = {
            ...
            { "DetectedBarcode", V8SharedWorkerGlobalScopePartial::DetectedBarcodeConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "DetectedFace", V8SharedWorkerGlobalScopePartial::DetectedFaceConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "DetectedText", V8SharedWorkerGlobalScopePartial::DetectedTextConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
