...
static void RequestPictureInPictureMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = HTMLElementPictureInPicture::requestPictureInPicture(script_state, *impl, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
void V8HTMLElementPartial::RequestPictureInPictureMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("HTMLElement.requestPictureInPicture");
  ...
  if (RuntimeEnabledFeatures::PictureInPictureV2Enabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"requestPictureInPicture", V8HTMLElementPartial::RequestPictureInPictureMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
