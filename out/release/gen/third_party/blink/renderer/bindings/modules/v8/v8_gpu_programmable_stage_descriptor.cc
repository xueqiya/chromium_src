...
static const v8::Eternal<v8::Name>* eternalV8GPUProgrammableStageDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPUProgrammableStageDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUProgrammableStageDescriptor* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUProgrammableStageDescriptorKeys(isolate);
...
v8::Local<v8::Value> GPUProgrammableStageDescriptor::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GPUProgrammableStageDescriptor(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GPUProgrammableStageDescriptor(const GPUProgrammableStageDescriptor* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8GPUProgrammableStageDescriptorKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
GPUProgrammableStageDescriptor* NativeValueTraits<GPUProgrammableStageDescriptor>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUProgrammableStageDescriptor* impl = MakeGarbageCollected<GPUProgrammableStageDescriptor>();
  V8GPUProgrammableStageDescriptor::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
