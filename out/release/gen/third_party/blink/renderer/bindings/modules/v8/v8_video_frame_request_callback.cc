...
v8::Maybe<void> V8VideoFrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, const VideoFrameMetadata*& metadata) {
  ...
  v8::Local<v8::Value> argv[] = { v8_time, v8_metadata };
...
void V8VideoFrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, const VideoFrameMetadata*& metadata) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, time, metadata);
