...
static void GetAvailabilityMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "Bluetooth", "getAvailability");
  ...
  ScriptPromise result = impl->getAvailability(script_state, exception_state);
...
void V8Bluetooth::GetAvailabilityMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  bluetooth_v8_internal::GetAvailabilityMethod(info);
}
    ...
    if (is_secure_context) {
      {
        ...
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"getAvailability", V8Bluetooth::GetAvailabilityMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
