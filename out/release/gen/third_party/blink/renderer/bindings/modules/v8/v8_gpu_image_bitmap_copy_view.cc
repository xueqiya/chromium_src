...
static const v8::Eternal<v8::Name>* eternalV8GPUImageBitmapCopyViewKeys(v8::Isolate* isolate) {
...
void V8GPUImageBitmapCopyView::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUImageBitmapCopyView* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUImageBitmapCopyViewKeys(isolate);
  ...
  if (origin_value.IsEmpty() || origin_value->IsUndefined()) {
    ...
    UnsignedLongSequenceOrGPUOrigin2DDict origin_cpp_value;
    V8UnsignedLongSequenceOrGPUOrigin2DDict::ToImpl(isolate, origin_value, origin_cpp_value, UnionTypeConversionMode::kNotNullable, exception_state);
...
bool toV8GPUImageBitmapCopyView(const GPUImageBitmapCopyView* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasOrigin()) {
    ...
    origin_value = ToV8(UnsignedLongSequenceOrGPUOrigin2DDict::FromGPUOrigin2DDict(MakeGarbageCollected<GPUOrigin2DDict>()), creationContext, isolate);
    origin_has_value_or_default = true;
  }
