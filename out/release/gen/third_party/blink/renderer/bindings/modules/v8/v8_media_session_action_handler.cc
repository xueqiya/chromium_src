...
v8::Maybe<void> V8MediaSessionActionHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const MediaSessionActionDetails*& details) {
  ...
  v8::Local<v8::Value> v8_details = ToV8(details, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_details };
...
void V8MediaSessionActionHandler::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const MediaSessionActionDetails*& details) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, details);
