...
static void Fill1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!winding.Prepare())
    return;
  const char* const kValidWindingValues[] = {
      "nonzero",
      "evenodd",
  };
...
static void Fill2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!path) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "Path2D"));
    return;
  }
...
static void Stroke2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  path = V8Path2D::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!path) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("stroke", "CanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(0, "Path2D")));
    return;
  }
...
static void DrawFocusIfNeeded1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!element) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("drawFocusIfNeeded", "CanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(0, "Element")));
    return;
  }
...
static void DrawFocusIfNeeded2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  path = V8Path2D::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!path) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("drawFocusIfNeeded", "CanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(0, "Path2D")));
    return;
  }

  element = V8Element::ToImplWithTypeCheck(info.GetIsolate(), info[1]);
  if (!element) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("drawFocusIfNeeded", "CanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(1, "Element")));
    return;
  }
...
static void ScrollPathIntoViewMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  path = V8Path2D::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!path) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("scrollPathIntoView", "CanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(0, "Path2D")));
    return;
  }
...
static void CreateImageData1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!imagedata) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "ImageData"));
    return;
  }
...
void V8CanvasRenderingContext2D::AddHitRegionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("CanvasRenderingContext2D.addHitRegion");
...
void V8CanvasRenderingContext2D::RemoveHitRegionMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("CanvasRenderingContext2D.removeHitRegion");
...
void V8CanvasRenderingContext2D::ClearHitRegionsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("CanvasRenderingContext2D.clearHitRegions");
