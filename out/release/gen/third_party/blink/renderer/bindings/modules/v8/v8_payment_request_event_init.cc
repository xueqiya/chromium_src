...
void V8PaymentRequestEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PaymentRequestEventInit* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&payment_request_id_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&payment_request_origin_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&top_origin_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[8].Get(isolate)).ToLocal(&total_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::PaymentHandlerHandlesShippingAndContactEnabled()) {
    v8::Local<v8::Value> payment_options_value;
    if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&payment_options_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (payment_options_value.IsEmpty() || payment_options_value->IsUndefined()) {
      // Do nothing.
    } else {
      PaymentOptions* payment_options_cpp_value = NativeValueTraits<PaymentOptions>::NativeValue(isolate, payment_options_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setPaymentOptions(payment_options_cpp_value);
    }

    v8::Local<v8::Value> shipping_options_value;
    if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&shipping_options_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
...
bool toV8PaymentRequestEventInit(const PaymentRequestEventInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (payment_request_id_has_value_or_default &&
      !create_property(4, payment_request_id_value)) {
    return false;
  }
  ...
  if (payment_request_origin_has_value_or_default &&
      !create_property(5, payment_request_origin_value)) {
    return false;
  }
  ...
  if (top_origin_has_value_or_default &&
      !create_property(7, top_origin_value)) {
    return false;
  }
  ...
  if (total_has_value_or_default &&
      !create_property(8, total_value)) {
    return false;
  }

  if (RuntimeEnabledFeatures::PaymentHandlerHandlesShippingAndContactEnabled()) {
    v8::Local<v8::Value> payment_options_value;
    bool payment_options_has_value_or_default = false;
    if (impl->hasPaymentOptions()) {
      payment_options_value = ToV8(impl->paymentOptions(), creationContext, isolate);
      payment_options_has_value_or_default = true;
    }
    if (payment_options_has_value_or_default &&
        !create_property(3, payment_options_value)) {
      return false;
    }
    ...
    if (shipping_options_has_value_or_default &&
        !create_property(6, shipping_options_value)) {
      return false;
    }
  }
...
PaymentRequestEventInit* NativeValueTraits<PaymentRequestEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PaymentRequestEventInit* impl = MakeGarbageCollected<PaymentRequestEventInit>();
