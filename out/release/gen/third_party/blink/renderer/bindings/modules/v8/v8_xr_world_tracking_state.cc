...
static void LightEstimationStateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  XRWorldTrackingState* impl = V8XRWorldTrackingState::ToImpl(holder);

  XRLightEstimationState* cpp_value(WTF::GetPtr(impl->lightEstimationState()));
...
void V8XRWorldTrackingState::LightEstimationStateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRWorldTrackingState_lightEstimationState_Getter");

  xr_world_tracking_state_v8_internal::LightEstimationStateAttributeGetter(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          { "lightEstimationState", V8XRWorldTrackingState::LightEstimationStateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
