...
static const v8::Eternal<v8::Name>* eternalV8NDEFScanOptionsKeys(v8::Isolate* isolate) {
...
void V8NDEFScanOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, NDEFScanOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8NDEFScanOptionsKeys(isolate);
...
v8::Local<v8::Value> NDEFScanOptions::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8NDEFScanOptions(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8NDEFScanOptions(const NDEFScanOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8NDEFScanOptionsKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
NDEFScanOptions* NativeValueTraits<NDEFScanOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  NDEFScanOptions* impl = MakeGarbageCollected<NDEFScanOptions>();
  V8NDEFScanOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
