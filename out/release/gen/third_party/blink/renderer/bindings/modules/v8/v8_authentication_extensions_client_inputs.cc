...
void V8AuthenticationExtensionsClientInputs::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, AuthenticationExtensionsClientInputs* impl, ExceptionState& exception_state) {
  ...
  v8::Local<v8::Value> appid_exclude_value;
  if (!v8Object->Get(context, keys[1].Get(isolate)).ToLocal(&appid_exclude_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (appid_exclude_value.IsEmpty() || appid_exclude_value->IsUndefined()) {
    // Do nothing.
  } else {
    V8StringResource<> appid_exclude_cpp_value = NativeValueTraits<IDLUSVString>::NativeValue(isolate, appid_exclude_value, exception_state);
    if (exception_state.HadException())
      return;
    impl->setAppidExclude(appid_exclude_cpp_value);
  }

  v8::Local<v8::Value> cable_authentication_value;
  if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&cable_authentication_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&cable_registration_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&credential_protection_policy_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&enforce_credential_protection_policy_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&hmac_create_secret_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&uvm_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8AuthenticationExtensionsClientInputs(const AuthenticationExtensionsClientInputs* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  v8::Local<v8::Value> appid_exclude_value;
  bool appid_exclude_has_value_or_default = false;
  if (impl->hasAppidExclude()) {
    appid_exclude_value = V8String(isolate, impl->appidExclude());
    appid_exclude_has_value_or_default = true;
  }
  if (appid_exclude_has_value_or_default &&
      !create_property(1, appid_exclude_value)) {
    return false;
  }
  ...
  if (cable_authentication_has_value_or_default &&
      !create_property(2, cable_authentication_value)) {
    return false;
  }
  ...
  if (cable_registration_has_value_or_default &&
      !create_property(3, cable_registration_value)) {
    return false;
  }
  ...
  if (credential_protection_policy_has_value_or_default &&
      !create_property(4, credential_protection_policy_value)) {
    return false;
  }
  ...
  if (enforce_credential_protection_policy_has_value_or_default &&
      !create_property(5, enforce_credential_protection_policy_value)) {
    return false;
  }
  ...
  if (hmac_create_secret_has_value_or_default &&
      !create_property(6, hmac_create_secret_value)) {
    return false;
  }
...
AuthenticationExtensionsClientInputs* NativeValueTraits<AuthenticationExtensionsClientInputs>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  AuthenticationExtensionsClientInputs* impl = MakeGarbageCollected<AuthenticationExtensionsClientInputs>();
