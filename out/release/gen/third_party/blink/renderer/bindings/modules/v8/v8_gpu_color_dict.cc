...
static const v8::Eternal<v8::Name>* eternalV8GPUColorDictKeys(v8::Isolate* isolate) {
...
void V8GPUColorDict::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUColorDict* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUColorDictKeys(isolate);
  ...
  if (a_value.IsEmpty() || a_value->IsUndefined()) {
    ...
    double a_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, a_value, exception_state);
  ...
  if (b_value.IsEmpty() || b_value->IsUndefined()) {
    ...
    double b_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, b_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (g_value.IsEmpty() || g_value->IsUndefined()) {
    ...
    double g_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, g_value, exception_state);
    if (exception_state.HadException())
      return;
  ...
  if (r_value.IsEmpty() || r_value->IsUndefined()) {
    ...
    double r_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, r_value, exception_state);
    if (exception_state.HadException())
      return;
...
v8::Local<v8::Value> GPUColorDict::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GPUColorDict(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GPUColorDict(const GPUColorDict* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8GPUColorDictKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
GPUColorDict* NativeValueTraits<GPUColorDict>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUColorDict* impl = MakeGarbageCollected<GPUColorDict>();
  V8GPUColorDict::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
