...
static void InlineVerticalFieldOfViewAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  double cpp_value(impl->inlineVerticalFieldOfView(is_null));
...
static void BaseLayerAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  XRWebGLLayer* cpp_value(WTF::GetPtr(impl->baseLayer()));
...
void V8XRRenderState::InlineVerticalFieldOfViewAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRRenderState_inlineVerticalFieldOfView_Getter");

  xr_render_state_v8_internal::InlineVerticalFieldOfViewAttributeGetter(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          ...
          { "inlineVerticalFieldOfView", V8XRRenderState::InlineVerticalFieldOfViewAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      };
