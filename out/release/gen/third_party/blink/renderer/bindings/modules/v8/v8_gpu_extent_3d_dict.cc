...
static const v8::Eternal<v8::Name>* eternalV8GPUExtent3DDictKeys(v8::Isolate* isolate) {
...
void V8GPUExtent3DDict::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUExtent3DDict* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUExtent3DDictKeys(isolate);
...
v8::Local<v8::Value> GPUExtent3DDict::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GPUExtent3DDict(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GPUExtent3DDict(const GPUExtent3DDict* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8GPUExtent3DDictKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
GPUExtent3DDict* NativeValueTraits<GPUExtent3DDict>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUExtent3DDict* impl = MakeGarbageCollected<GPUExtent3DDict>();
  V8GPUExtent3DDict::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
