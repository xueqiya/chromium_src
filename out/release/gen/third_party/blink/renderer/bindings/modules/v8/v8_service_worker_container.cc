...
static void ReadyAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise cpp_value(impl->ready(script_state, exception_state));
...
void V8ServiceWorkerContainer::OnmessageerrorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ServiceWorkerContainer_onmessageerror_Getter");

  service_worker_container_v8_internal::OnmessageerrorAttributeGetter(info);
}

void V8ServiceWorkerContainer::OnmessageerrorAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ServiceWorkerContainer_onmessageerror_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  service_worker_container_v8_internal::OnmessageerrorAttributeSetter(v8_value, info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          ...
          { "onmessageerror", V8ServiceWorkerContainer::OnmessageerrorAttributeGetterCallback, V8ServiceWorkerContainer::OnmessageerrorAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      };
