...
static const v8::Eternal<v8::Name>* eternalV8FileSystemCreateWriterOptionsKeys(v8::Isolate* isolate) {
...
void V8FileSystemCreateWriterOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, FileSystemCreateWriterOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8FileSystemCreateWriterOptionsKeys(isolate);
