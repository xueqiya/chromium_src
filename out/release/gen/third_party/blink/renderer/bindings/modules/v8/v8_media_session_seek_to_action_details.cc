...
static const v8::Eternal<v8::Name>* eternalV8MediaSessionSeekToActionDetailsKeys(v8::Isolate* isolate) {
...
void V8MediaSessionSeekToActionDetails::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaSessionSeekToActionDetails* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8MediaSessionSeekToActionDetailsKeys(isolate);
