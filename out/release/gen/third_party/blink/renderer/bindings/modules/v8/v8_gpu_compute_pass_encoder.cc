...
static void PushDebugGroupMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(info.Length() < 1)) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("pushDebugGroup", "GPUComputePassEncoder", ExceptionMessages::NotEnoughArguments(1, info.Length())));
    return;
  }
...
static void InsertDebugMarkerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(info.Length() < 1)) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("insertDebugMarker", "GPUComputePassEncoder", ExceptionMessages::NotEnoughArguments(1, info.Length())));
    return;
  }
