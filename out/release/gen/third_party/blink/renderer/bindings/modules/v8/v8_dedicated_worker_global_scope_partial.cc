...
void V8DedicatedWorkerGlobalScopePartial::FileSystemWriterConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DedicatedWorkerGlobalScope_FileSystemWriter_ConstructorGetterCallback");
...
void V8DedicatedWorkerGlobalScopePartial::DetectedBarcodeConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DedicatedWorkerGlobalScope_DetectedBarcode_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8DetectedBarcode::GetWrapperTypeInfo());
}

void V8DedicatedWorkerGlobalScopePartial::DetectedFaceConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DedicatedWorkerGlobalScope_DetectedFace_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8DetectedFace::GetWrapperTypeInfo());
}

void V8DedicatedWorkerGlobalScopePartial::DetectedTextConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DedicatedWorkerGlobalScope_DetectedText_ConstructorGetterCallback");
...
void V8DedicatedWorkerGlobalScopePartial::InstallContentIndex(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
void V8DedicatedWorkerGlobalScopePartial::InstallNativeFileSystem(
  ...
  if (is_secure_context) {
    ...
    kAttributeConfigurations[] = {
        ...
        { "FileSystemWriter", V8DedicatedWorkerGlobalScopePartial::FileSystemWriterConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance, prototype,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8DedicatedWorkerGlobalScopePartial::InstallSmsReceiver(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
...
void V8DedicatedWorkerGlobalScopePartial::InstallWakeLock(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
...
void V8DedicatedWorkerGlobalScopePartial::InstallWebSocketStream(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
    ...
    if (is_secure_context) {
      ...
      if (RuntimeEnabledFeatures::ShapeDetectionEnabled()) {
        ...
        kAttributeConfigurations[] = {
            ...
            { "DetectedBarcode", V8DedicatedWorkerGlobalScopePartial::DetectedBarcodeConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "DetectedFace", V8DedicatedWorkerGlobalScopePartial::DetectedFaceConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "DetectedText", V8DedicatedWorkerGlobalScopePartial::DetectedTextConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
