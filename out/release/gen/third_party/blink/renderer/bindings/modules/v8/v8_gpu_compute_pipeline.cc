...
static void GetBindGroupLayoutMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "GPUComputePipeline", "getBindGroupLayout");

  GPUComputePipeline* impl = V8GPUComputePipeline::ToImpl(info.Holder());
  ...
  V8SetReturnValue(info, impl->getBindGroupLayout(index));
}

}  // namespace gpu_compute_pipeline_v8_internal

void V8GPUComputePipeline::GetBindGroupLayoutMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  gpu_compute_pipeline_v8_internal::GetBindGroupLayoutMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8GPUComputePipelineMethods[] = {
    {"getBindGroupLayout", V8GPUComputePipeline::GetBindGroupLayoutMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
};
...
static void InstallV8GPUComputePipelineTemplate(
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, kV8GPUComputePipelineMethods, base::size(kV8GPUComputePipelineMethods));
