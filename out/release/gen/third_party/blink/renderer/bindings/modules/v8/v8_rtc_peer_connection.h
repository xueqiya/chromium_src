...
class V8RTCPeerConnection {
 ...
 public:
  ...
  MODULES_EXPORT static void OnicecandidateerrorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnicecandidateerrorAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void RestartIceMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
