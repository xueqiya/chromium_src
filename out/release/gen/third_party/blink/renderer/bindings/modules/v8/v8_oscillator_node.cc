...
static void SetPeriodicWaveMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!periodic_wave) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("setPeriodicWave", "OscillatorNode", ExceptionMessages::ArgumentNotOfType(0, "PeriodicWave")));
    return;
  }
