...
static void InstallV8GPUTextureUsageTemplate(
  ...
  // Register IDL constants, attributes and operations.
  {
    static constexpr V8DOMConfiguration::ConstantConfiguration kConstants[] = {
        {"COPY_SRC", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(1)},
        {"COPY_DST", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(2)},
  ...
  static_assert(1 == GPUTextureUsage::kCopySrc, "the value of GPUTextureUsage_kCopySrc does not match with implementation");
  static_assert(2 == GPUTextureUsage::kCopyDst, "the value of GPUTextureUsage_kCopyDst does not match with implementation");
