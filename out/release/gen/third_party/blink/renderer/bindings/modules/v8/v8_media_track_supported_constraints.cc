...
void V8MediaTrackSupportedConstraints::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaTrackSupportedConstraints* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[21].Get(isolate)).ToLocal(&points_of_interest_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&resize_mode_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&sample_rate_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&sample_size_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&saturation_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&sharpness_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&white_balance_mode_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&width_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[32].Get(isolate)).ToLocal(&zoom_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (!v8Object->Get(context, keys[20].Get(isolate)).ToLocal(&pan_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (pan_value.IsEmpty() || pan_value->IsUndefined()) {
      ...
      bool pan_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, pan_value, exception_state);
      if (exception_state.HadException())
        return;
    ...
    if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&tilt_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (tilt_value.IsEmpty() || tilt_value->IsUndefined()) {
      ...
      bool tilt_cpp_value = NativeValueTraits<IDLBoolean>::NativeValue(isolate, tilt_value, exception_state);
      if (exception_state.HadException())
        return;
...
bool toV8MediaTrackSupportedConstraints(const MediaTrackSupportedConstraints* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (points_of_interest_has_value_or_default &&
      !create_property(21, points_of_interest_value)) {
    return false;
  }
  ...
  if (resize_mode_has_value_or_default &&
      !create_property(22, resize_mode_value)) {
    return false;
  }
  ...
  if (sample_rate_has_value_or_default &&
      !create_property(23, sample_rate_value)) {
    return false;
  }
  ...
  if (sample_size_has_value_or_default &&
      !create_property(24, sample_size_value)) {
    return false;
  }
  ...
  if (saturation_has_value_or_default &&
      !create_property(25, saturation_value)) {
    return false;
  }
  ...
  if (sharpness_has_value_or_default &&
      !create_property(26, sharpness_value)) {
    return false;
  }
  ...
  if (white_balance_mode_has_value_or_default &&
      !create_property(30, white_balance_mode_value)) {
    return false;
  }
  ...
  if (width_has_value_or_default &&
      !create_property(31, width_value)) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (impl->hasPan()) {
      pan_value = v8::Boolean::New(isolate, impl->pan());
      pan_has_value_or_default = true;
    } else {
      pan_value = v8::Boolean::New(isolate, true);
      pan_has_value_or_default = true;
    }
    if (pan_has_value_or_default &&
        !create_property(20, pan_value)) {
      return false;
    }
    ...
    if (impl->hasTilt()) {
      tilt_value = v8::Boolean::New(isolate, impl->tilt());
      tilt_has_value_or_default = true;
    } else {
      tilt_value = v8::Boolean::New(isolate, true);
      tilt_has_value_or_default = true;
    }
    if (tilt_has_value_or_default &&
        !create_property(27, tilt_value)) {
      return false;
    }
  }
...
MediaTrackSupportedConstraints* NativeValueTraits<MediaTrackSupportedConstraints>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaTrackSupportedConstraints* impl = MakeGarbageCollected<MediaTrackSupportedConstraints>();
