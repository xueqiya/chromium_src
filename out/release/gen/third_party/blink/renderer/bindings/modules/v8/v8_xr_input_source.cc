...
static void ProfilesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  V8SetReturnValue(info, FreezeV8Object(ToV8(impl->profiles(), info.Holder(), info.GetIsolate()), info.GetIsolate()));
...
void V8XRInputSource::GamepadAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8XRInputSource_Gamepad_AttributeGetter);

  xr_input_source_v8_internal::GamepadAttributeGetter(info);
}

void V8XRInputSource::ProfilesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSource_profiles_Getter");

  xr_input_source_v8_internal::ProfilesAttributeGetter(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          ...
          { "profiles", V8XRInputSource::ProfilesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
