...
static const v8::Eternal<v8::Name>* eternalV8XRTransientInputHitTestOptionsInitKeys(v8::Isolate* isolate) {
...
void V8XRTransientInputHitTestOptionsInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, XRTransientInputHitTestOptionsInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8XRTransientInputHitTestOptionsInitKeys(isolate);
