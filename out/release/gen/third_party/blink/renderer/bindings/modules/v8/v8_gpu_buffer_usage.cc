...
static void InstallV8GPUBufferUsageTemplate(
  ...
  // Register IDL constants, attributes and operations.
  {
    static constexpr V8DOMConfiguration::ConstantConfiguration kConstants[] = {
        ...
        {"COPY_SRC", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(4)},
        {"COPY_DST", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(8)},
        ...
        {"INDIRECT", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(256)},
    };
  ...
  static_assert(4 == GPUBufferUsage::kCopySrc, "the value of GPUBufferUsage_kCopySrc does not match with implementation");
  static_assert(8 == GPUBufferUsage::kCopyDst, "the value of GPUBufferUsage_kCopyDst does not match with implementation");
  ...
  static_assert(256 == GPUBufferUsage::kIndirect, "the value of GPUBufferUsage_kIndirect does not match with implementation");
