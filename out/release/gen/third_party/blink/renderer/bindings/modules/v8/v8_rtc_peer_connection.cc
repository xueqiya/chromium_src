...
static void OnicecandidateerrorAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  RTCPeerConnection* impl = V8RTCPeerConnection::ToImpl(holder);

  EventListener* cpp_value(WTF::GetPtr(impl->onicecandidateerror()));

  V8SetReturnValue(info, JSEventHandler::AsV8Value(info.GetIsolate(), impl, cpp_value));
}

static void OnicecandidateerrorAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setOnicecandidateerror(JSEventHandler::CreateOrNull(v8_value, JSEventHandler::HandlerType::kEventHandler));
}
...
static void CreateOffer1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->createOffer(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void CreateAnswer1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->createAnswer(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void SetLocalDescription1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->setLocalDescription(script_state, description, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void SetRemoteDescription1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = impl->setRemoteDescription(script_state, description, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void RestartIceMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RTCPeerConnection* impl = V8RTCPeerConnection::ToImpl(info.Holder());
...
static void GetStatsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  callback_or_selector = ScriptValue(info.GetIsolate(), info[0]);

  if (UNLIKELY(num_args_passed <= 1)) {
    ScriptPromise result = impl->getStats(script_state, callback_or_selector, exception_state);
    if (exception_state.HadException()) {
      return;
    }
    V8SetReturnValue(info, result.V8Value());
  ...
  legacy_selector = ScriptValue(info.GetIsolate(), info[1]);

  ScriptPromise result = impl->getStats(script_state, callback_or_selector, legacy_selector, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void AddTrackMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  for (int i = 1; i < info.Length(); ++i) {
    if (!V8MediaStream::HasInstance(info[i], info.GetIsolate())) {
      exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(1, "MediaStream"));
      return;
    }
...
static void RemoveTrackMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!sender) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "RTCRtpSender"));
    return;
  }
...
void V8RTCPeerConnection::OnicecandidateerrorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCPeerConnection_onicecandidateerror_Getter");

  rtc_peer_connection_v8_internal::OnicecandidateerrorAttributeGetter(info);
}

void V8RTCPeerConnection::OnicecandidateerrorAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCPeerConnection_onicecandidateerror_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  rtc_peer_connection_v8_internal::OnicecandidateerrorAttributeSetter(v8_value, info);
}
...
void V8RTCPeerConnection::RestartIceMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  rtc_peer_connection_v8_internal::RestartIceMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8RTCPeerConnectionMethods[] = {
    {"restartIce", V8RTCPeerConnection::RestartIceMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    ...
    {"setLocalDescription", V8RTCPeerConnection::SetLocalDescriptionMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
...
static void InstallV8RTCPeerConnectionTemplate(
  ...
  kAccessorConfigurations[] = {
      ...
      { "onicecandidateerror", V8RTCPeerConnection::OnicecandidateerrorAttributeGetterCallback, V8RTCPeerConnection::OnicecandidateerrorAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
