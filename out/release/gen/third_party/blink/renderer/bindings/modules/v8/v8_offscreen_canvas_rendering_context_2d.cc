...
static void Stroke2Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  path = V8Path2D::ToImplWithTypeCheck(info.GetIsolate(), info[0]);
  if (!path) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("stroke", "OffscreenCanvasRenderingContext2D", ExceptionMessages::ArgumentNotOfType(0, "Path2D")));
    return;
  }
...
void V8OffscreenCanvasRenderingContext2D::GetTransformMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  offscreen_canvas_rendering_context_2d_v8_internal::GetTransformMethod(info);
}
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8OffscreenCanvasRenderingContext2DMethods[] = {
    ...
    {"setTransform", V8OffscreenCanvasRenderingContext2D::SetTransformMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"getTransform", V8OffscreenCanvasRenderingContext2D::GetTransformMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
