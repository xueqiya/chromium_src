...
static void SpeakMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!utterance) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("speak", "SpeechSynthesis", ExceptionMessages::ArgumentNotOfType(0, "SpeechSynthesisUtterance")));
    return;
  }
