...
static const v8::Eternal<v8::Name>* eternalV8RTCPeerConnectionIceErrorEventInitKeys(v8::Isolate* isolate) {
...
void V8RTCPeerConnectionIceErrorEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, RTCPeerConnectionIceErrorEventInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8RTCPeerConnectionIceErrorEventInitKeys(isolate);
