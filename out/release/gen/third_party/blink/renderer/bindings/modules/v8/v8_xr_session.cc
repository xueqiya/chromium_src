...
static void InputSourcesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  XRInputSourceArray* cpp_value(WTF::GetPtr(impl->inputSources()));
...
static void RequestHitTestMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!ray) {
    exception_state.ThrowTypeError(ExceptionMessages::ArgumentNotOfType(0, "XRRay"));
    return;
  }
  ...
  ScriptPromise result = impl->requestHitTest(script_state, ray, space, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
static void CreateAnchorMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "XRSession", "createAnchor");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
...
void V8XRSession::TrackedAnchorsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRSession_trackedAnchors_Getter");

  xr_session_v8_internal::TrackedAnchorsAttributeGetter(info);
}
...
void V8XRSession::RequestHitTestMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("XRSession.requestHitTest");
...
void V8XRSession::CreateAnchorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("XRSession.createAnchor");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRSession_createAnchor");

  xr_session_v8_internal::CreateAnchorMethod(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          { "visibilityState", V8XRSession::VisibilityStateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
          { "inputSources", V8XRSession::InputSourcesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      ...
      if (RuntimeEnabledFeatures::WebXRIncubationsEnabled()) {
        ...
        kAccessorConfigurations[] = {
            ...
            { "trackedAnchors", V8XRSession::TrackedAnchorsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      ...
      if (RuntimeEnabledFeatures::WebXRIncubationsEnabled()) {
        {
          ...
          const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
              {"createAnchor", V8XRSession::CreateAnchorMethodCallback, 2, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
          };
          for (const auto& config : kConfigurations) {
            V8DOMConfiguration::InstallMethod(
                isolate, world, instance_object, prototype_object,
