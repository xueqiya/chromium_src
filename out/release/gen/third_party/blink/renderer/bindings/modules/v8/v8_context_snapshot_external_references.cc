...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace abort_controller_v8_internal

namespace absolute_orientation_sensor_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace absolute_orientation_sensor_v8_internal
...
namespace byte_length_queuing_strategy_v8_internal {
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace byte_length_queuing_strategy_v8_internal
...
namespace decompression_stream_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace decompression_stream_v8_internal
...
namespace ndef_message_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace ndef_message_v8_internal
...
namespace ndef_record_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace ndef_record_v8_internal

namespace ndef_writer_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace ndef_writer_v8_internal
...
namespace submit_event_v8_internal {
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace submit_event_v8_internal

namespace dom_task_controller_v8_internal {
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>&);
}  // namespace dom_task_controller_v8_internal
...
const intptr_t* V8ContextSnapshotExternalReferences::GetTable() {
  static const intptr_t kReferenceTable[] = {
    ...
    reinterpret_cast<intptr_t>(abort_controller_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(absolute_orientation_sensor_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(accelerometer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(analyser_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(animation_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(animation_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(application_cache_error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(audio_buffer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(audio_buffer_source_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(audio_context_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(audio_processing_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(audio_worklet_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(before_install_prompt_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(biquad_filter_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(blob_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(blob_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(broadcast_channel_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(byte_length_queuing_strategy_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_keyword_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_invert_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_max_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_min_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_negate_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_product_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_math_sum_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_matrix_component_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_perspective_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_position_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_rotate_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_scale_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_skew_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_skew_x_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_skew_y_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(css_style_sheet_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_transform_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_translate_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_unit_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_unparsed_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(css_style_variable_reference_value_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(channel_merger_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(channel_splitter_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(clipboard_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(close_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(comment_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(composition_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(compression_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(constant_source_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(convolver_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(count_queuing_strategy_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(custom_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_error_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_exception_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_matrix_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_matrix_read_only_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_parser_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_point_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_point_read_only_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_quad_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_rect_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_rect_read_only_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(data_transfer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(decompression_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(delay_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(device_motion_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(device_orientation_event_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::FeaturePolicyAttributeGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::FullscreenElementAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::AdoptedStyleSheetsAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::AdoptedStyleSheetsAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnactivateinvisibleAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnactivateinvisibleAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnoverscrollAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnoverscrollAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnrendersubtreeactivationAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnrendersubtreeactivationAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnscrollendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnscrollendAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationendAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationiterationAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationiterationAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationstartAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkitanimationstartAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkittransitionendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnwebkittransitionendAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnpointerrawupdateAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnpointerrawupdateAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::OnanimationendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnanimationendAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnanimationiterationAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnanimationiterationAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnanimationstartAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OnanimationstartAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OntransitionendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::OntransitionendAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::FullscreenEnabledAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Document::FullscreenAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Document::FullscreenAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Document::HasStorageAccessMethodCallback),
    reinterpret_cast<intptr_t>(V8Document::RequestStorageAccessMethodCallback),
    ...
    reinterpret_cast<intptr_t>(document_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(document_fragment_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(drag_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dynamics_compressor_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(event_source_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(event_target_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(federated_credential_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(file_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(file_reader_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(focus_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(font_face_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(font_face_set_load_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(form_data_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(form_data_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(gain_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(gamepad_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(gyroscope_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_anchor_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_area_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_audio_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_br_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_base_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_body_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_button_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_canvas_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_dlist_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_data_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_data_list_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_details_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_dialog_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_directory_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_div_element_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(html_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_embed_element_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(html_field_set_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_font_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_form_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_frame_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_frame_set_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_hr_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_head_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_heading_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_html_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_iframe_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_image_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_input_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_li_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_label_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_legend_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_link_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_map_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_marquee_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_menu_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_meta_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_meter_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_mod_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_olist_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_object_element_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(html_opt_group_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_option_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_output_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_paragraph_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_param_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_picture_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_pre_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_progress_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_quote_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_script_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_select_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_slot_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_source_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_span_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_style_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_caption_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_cell_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_col_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_row_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_table_section_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_template_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_text_area_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_time_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_title_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_track_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_ulist_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(html_video_element_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(hash_change_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(headers_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(idb_version_change_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(iir_filter_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(image_capture_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(image_data_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(input_device_capabilities_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(input_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(intersection_observer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(keyboard_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(keyframe_effect_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(linear_acceleration_sensor_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(midi_connection_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(midi_message_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_element_audio_source_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_encrypted_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_key_message_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_query_list_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_recorder_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_stream_audio_destination_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_stream_audio_source_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_stream_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(media_stream_track_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(message_channel_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(message_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(mouse_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(mutation_observer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ndef_message_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ndef_reader_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ndef_reading_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ndef_record_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ndef_writer_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(V8Node::SetApplyScrollMethodCallback),
    reinterpret_cast<intptr_t>(V8Node::SetDistributeScrollMethodCallback),
    ...
    reinterpret_cast<intptr_t>(offline_audio_completion_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(offline_audio_context_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(oscillator_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(overconstrained_error_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(page_transition_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(panner_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(password_credential_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(path_2d_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(performance_mark_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(performance_observer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(periodic_wave_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(pointer_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(pop_state_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(progress_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(promise_rejection_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_dtmf_tone_change_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_data_channel_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_error_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_ice_candidate_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_ice_transport_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_peer_connection_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_peer_connection_ice_error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_peer_connection_ice_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_quic_stream_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_quic_transport_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_session_description_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(rtc_track_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(range_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(readable_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(readable_stream_default_reader_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(relative_orientation_sensor_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(reporting_observer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(request_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(resize_observer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(response_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(scroll_timeline_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(security_policy_violation_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(sensor_error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(speech_grammar_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(speech_grammar_list_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(speech_recognition_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(speech_recognition_error_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(speech_recognition_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(stereo_panner_node_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(storage_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(submit_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_task_controller_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(text_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(text_decoder_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(text_decoder_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(text_encoder_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(text_encoder_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(timestamp_trigger_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(touch_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(touch_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(track_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(transform_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(transition_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(ui_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_url_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(url_search_params_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(vtt_cue_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(wave_shaper_node_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(webgl_context_event_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(dom_websocket_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(websocket_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(wheel_event_v8_internal::ConstructorCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::TrustedTypesAttributeGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::CSSPropertyRuleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::CSSViewportRuleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::RenderSubtreeActivationEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::EditContextConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TextFormatUpdateEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TextUpdateEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::SchedulingConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::ProfilerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::FeaturePolicyConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::ActivateInvisibleEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::MathMLElementConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OverscrollEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::HTMLPortalElementConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::PortalActivateEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::PortalHostConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::ResizeObserverSizeConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::FragmentDirectiveConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TrustedHTMLConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TrustedScriptConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TrustedScriptURLConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TrustedTypePolicyConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::TrustedTypePolicyFactoryConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::UserActivationConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::CSSAnimationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::CSSTransitionConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::ByteLengthQueuingStrategyConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::CountQueuingStrategyConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::ElementInternalsConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::ExternalConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::LargestContentfulPaintConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::LayoutShiftConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::PerformanceElementTimingConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::ReadableStreamConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::ReadableStreamDefaultReaderConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::SubmitEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::TransformStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::WritableStreamConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::WritableStreamDefaultWriterConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnactivateinvisibleAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnactivateinvisibleAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnoverscrollAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnoverscrollAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnrendersubtreeactivationAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnrendersubtreeactivationAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnscrollendAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnscrollendAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnpointerrawupdateAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnpointerrawupdateAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnselectstartAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnselectstartAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnselectionchangeAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnselectionchangeAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::OnportalactivateAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::OnportalactivateAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::PortalHostAttributeGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::QueueMicrotaskMethodCallback),
    ...
    reinterpret_cast<intptr_t>(V8Window::RequestPostAnimationFrameMethodCallback),
    reinterpret_cast<intptr_t>(V8Window::CancelPostAnimationFrameMethodCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::ClipboardItemConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BackgroundFetchManagerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BackgroundFetchRecordConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BackgroundFetchRegistrationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::ContactsManagerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::ContactAddressConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::ContentIndexConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::CookieStoreManagerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::LaunchParamsConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::LaunchQueueConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GamepadAxisEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GamepadButtonEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::IdleDetectorConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::IdleStateConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::FileSystemDirectoryHandleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::FileSystemFileHandleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::FileSystemHandleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::FileSystemWriterConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::TimestampTriggerConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::PaymentMethodChangeEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::MerchantValidationEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::PaymentRequestUpdateEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::PeriodicSyncManagerConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::EnterPictureInPictureEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::QuicTransportConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::SendStreamConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCDtlsTransportConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCQuicStreamConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCQuicTransportConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCQuicStreamEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCSctpTransportConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RemotePlaybackConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::SpeechSynthesisErrorEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::SMSConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::SMSReceiverConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::WakeLockConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::WakeLockSentinelConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::BluetoothAdvertisingEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BluetoothLEScanConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BluetoothManufacturerDataMapConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BluetoothServiceDataMapConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::BluetoothUUIDConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::EncodedVideoChunkConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::VideoDecoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::VideoFrameConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::VideoTrackReaderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::VideoTrackWriterConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUAdapterConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUBindGroupConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUBindGroupLayoutConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUBufferConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUBufferUsageConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUCanvasContextConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUColorWriteConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUCommandBufferConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUCommandEncoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUComputePassEncoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUComputePipelineConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUDeviceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUDeviceLostInfoConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUFenceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUOutOfMemoryErrorConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUPipelineLayoutConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUQueueConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPURenderBundleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPURenderBundleEncoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPURenderPassEncoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPURenderPipelineConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUSamplerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUShaderModuleConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUShaderStageConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUSwapChainConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUTextureConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUTextureUsageConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUTextureViewConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUUncapturedErrorEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GPUValidationErrorConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDCollectionInfoConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDConnectionEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDDeviceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDInputReportEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDReportInfoConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::HIDReportItemConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::NDEFMessageConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::NDEFReaderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::NDEFReadingEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::NDEFRecordConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::NDEFWriterConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::SchedulerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::TaskControllerConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::TaskSignalConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::WebSocketStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::XRBoundedReferenceSpaceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRFrameConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRInputSourceArrayConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::XRInputSourcesChangeEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRPoseConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRReferenceSpaceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRReferenceSpaceEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRRenderStateConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRRigidTransformConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::XRSpaceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRViewConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRViewerPoseConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::XRHitTestResultConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRHitTestSourceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRRayConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRTransientInputHitTestResultConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRTransientInputHitTestSourceConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRAnchorConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRAnchorSetConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRCubeMapConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRDOMOverlayStateConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRHitResultConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRLightEstimationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRLightEstimationStateConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRLightProbeConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRPlaneConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRPlaneDetectionStateConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRPlaneSetConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRReflectionProbeConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRSphericalHarmonicsConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRWorldInformationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::XRWorldTrackingStateConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::FileSystemWritableFileStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::DeviceMotionEventAccelerationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::DeviceMotionEventConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::DeviceMotionEventRotationRateConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCIceTransportConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::CompressionStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::DecompressionStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::GeolocationConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GeolocationCoordinatesConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GeolocationPositionConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GeolocationPositionErrorConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCErrorConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCErrorEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCPeerConnectionIceErrorEventConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::RTCRtpTransceiverConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::TextDecoderStreamConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::TextEncoderConstructorGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::TextEncoderStreamConstructorGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::LaunchQueueAttributeGetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::SchedulerAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::SchedulerAttributeSetterCallback),
    ...
    reinterpret_cast<intptr_t>(V8WindowPartial::ChooseFileSystemEntriesMethodCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::GetScreensMethodCallback),
    reinterpret_cast<intptr_t>(V8WindowPartial::OpenDatabaseMethodCallback),
    reinterpret_cast<intptr_t>(dedicated_worker_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(worklet_animation_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(writable_stream_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(writable_stream_default_writer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(xml_http_request_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(xml_serializer_v8_internal::ConstructorCallback),
    reinterpret_cast<intptr_t>(xpath_evaluator_v8_internal::ConstructorCallback),
