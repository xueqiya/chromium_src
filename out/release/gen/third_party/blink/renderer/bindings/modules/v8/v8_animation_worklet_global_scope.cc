...
void V8AnimationWorkletGlobalScope::ByteLengthQueuingStrategyConstructorGetterCallback(
...
void V8AnimationWorkletGlobalScope::CountQueuingStrategyConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8AnimationWorkletGlobalScope::WorkletAnimationEffectConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8WorkletAnimationEffect::GetWrapperTypeInfo());
}

void V8AnimationWorkletGlobalScope::WorkletGroupEffectConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8WorkletGroupEffect::GetWrapperTypeInfo());
}
...
static void InstallV8AnimationWorkletGlobalScopeTemplate(
  ...
  kAttributeConfigurations[] = {
      { "ByteLengthQueuingStrategy", V8AnimationWorkletGlobalScope::ByteLengthQueuingStrategyConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "CountQueuingStrategy", V8AnimationWorkletGlobalScope::CountQueuingStrategyConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
...
void V8AnimationWorkletGlobalScope::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::GroupEffectEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "WorkletGroupEffect", V8AnimationWorkletGlobalScope::WorkletGroupEffectConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8AnimationWorkletGlobalScope::InstallAnimationWorklet(
  ...
  kAttributeConfigurations[] = {
      ...
      { "WorkletAnimationEffect", V8AnimationWorkletGlobalScope::WorkletAnimationEffectConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
