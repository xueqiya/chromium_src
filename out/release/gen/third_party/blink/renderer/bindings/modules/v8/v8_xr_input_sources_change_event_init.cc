...
static const v8::Eternal<v8::Name>* eternalV8XRInputSourcesChangeEventInitKeys(v8::Isolate* isolate) {
...
void V8XRInputSourcesChangeEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, XRInputSourcesChangeEventInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8XRInputSourcesChangeEventInitKeys(isolate);
