...
void V8MediaTrackSettings::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaTrackSettings* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&points_of_interest_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&resize_mode_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&sample_rate_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&sample_size_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&saturation_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&sharpness_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&torch_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[33].Get(isolate)).ToLocal(&white_balance_mode_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[34].Get(isolate)).ToLocal(&width_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[35].Get(isolate)).ToLocal(&zoom_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (!v8Object->Get(context, keys[32].Get(isolate)).ToLocal(&video_kind_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&pan_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (pan_value.IsEmpty() || pan_value->IsUndefined()) {
      ...
      double pan_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, pan_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setPan(pan_cpp_value);
    }

    v8::Local<v8::Value> tilt_value;
    if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&tilt_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
    if (tilt_value.IsEmpty() || tilt_value->IsUndefined()) {
      // Do nothing.
    } else {
      double tilt_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, tilt_value, exception_state);
      if (exception_state.HadException())
        return;
      impl->setTilt(tilt_cpp_value);
    }
  }
}
...
bool toV8MediaTrackSettings(const MediaTrackSettings* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (points_of_interest_has_value_or_default &&
      !create_property(24, points_of_interest_value)) {
    return false;
  }
  ...
  if (resize_mode_has_value_or_default &&
      !create_property(25, resize_mode_value)) {
    return false;
  }
  ...
  if (sample_rate_has_value_or_default &&
      !create_property(26, sample_rate_value)) {
    return false;
  }
  ...
  if (sample_size_has_value_or_default &&
      !create_property(27, sample_size_value)) {
    return false;
  }
  ...
  if (saturation_has_value_or_default &&
      !create_property(28, saturation_value)) {
    return false;
  }
  ...
  if (sharpness_has_value_or_default &&
      !create_property(29, sharpness_value)) {
    return false;
  }
  ...
  if (torch_has_value_or_default &&
      !create_property(31, torch_value)) {
    return false;
  }
  ...
  if (white_balance_mode_has_value_or_default &&
      !create_property(33, white_balance_mode_value)) {
    return false;
  }
  ...
  if (width_has_value_or_default &&
      !create_property(34, width_value)) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (video_kind_has_value_or_default &&
        !create_property(32, video_kind_value)) {
      return false;
    }
  }
  ...
  if (RuntimeEnabledFeatures::MediaCapturePanTiltEnabled()) {
    ...
    if (pan_has_value_or_default &&
        !create_property(23, pan_value)) {
      return false;
    }

    v8::Local<v8::Value> tilt_value;
    bool tilt_has_value_or_default = false;
    if (impl->hasTilt()) {
      tilt_value = v8::Number::New(isolate, impl->tilt());
      tilt_has_value_or_default = true;
    }
    if (tilt_has_value_or_default &&
        !create_property(30, tilt_value)) {
      return false;
    }
  }
...
MediaTrackSettings* NativeValueTraits<MediaTrackSettings>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaTrackSettings* impl = MakeGarbageCollected<MediaTrackSettings>();
