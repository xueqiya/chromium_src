...
void V8MediaTrackCapabilities::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaTrackCapabilities* impl, ExceptionState& exception_state) {
  ...
  if (pan_value.IsEmpty() || pan_value->IsUndefined()) {
    ...
    MediaSettingsRange* pan_cpp_value = V8MediaSettingsRange::ToImplWithTypeCheck(isolate, pan_value);
    if (!pan_cpp_value) {
      exception_state.ThrowTypeError("member pan is not of type MediaSettingsRange.");
      return;
    }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&tilt_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (tilt_value.IsEmpty() || tilt_value->IsUndefined()) {
    ...
    MediaSettingsRange* tilt_cpp_value = V8MediaSettingsRange::ToImplWithTypeCheck(isolate, tilt_value);
    if (!tilt_cpp_value) {
      exception_state.ThrowTypeError("member tilt is not of type MediaSettingsRange.");
      return;
    }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&torch_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&white_balance_mode_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&width_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&zoom_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8MediaTrackCapabilities(const MediaTrackCapabilities* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasPan()) {
    pan_value = ToV8(impl->pan(), creationContext, isolate);
  ...
  if (impl->hasTilt()) {
    tilt_value = ToV8(impl->tilt(), creationContext, isolate);
    tilt_has_value_or_default = true;
  }
  if (tilt_has_value_or_default &&
      !create_property(26, tilt_value)) {
    return false;
  }
  ...
  if (torch_has_value_or_default &&
      !create_property(27, torch_value)) {
    return false;
  }
  ...
  if (white_balance_mode_has_value_or_default &&
      !create_property(28, white_balance_mode_value)) {
    return false;
  }
  ...
  if (width_has_value_or_default &&
      !create_property(29, width_value)) {
    return false;
  }
...
MediaTrackCapabilities* NativeValueTraits<MediaTrackCapabilities>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaTrackCapabilities* impl = MakeGarbageCollected<MediaTrackCapabilities>();
