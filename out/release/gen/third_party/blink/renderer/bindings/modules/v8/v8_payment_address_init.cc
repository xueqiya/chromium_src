...
static const v8::Eternal<v8::Name>* eternalV8PaymentAddressInitKeys(v8::Isolate* isolate) {
...
void V8PaymentAddressInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PaymentAddressInit* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PaymentAddressInitKeys(isolate);
  ...
  if (address_line_value.IsEmpty() || address_line_value->IsUndefined()) {
    ...
    Vector<String> address_line_cpp_value = NativeValueTraits<IDLSequence<IDLString>>::NativeValue(isolate, address_line_value, exception_state);
...
v8::Local<v8::Value> PaymentAddressInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8PaymentAddressInit(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8PaymentAddressInit(const PaymentAddressInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8PaymentAddressInitKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  ...
  if (impl->hasAddressLine()) {
    address_line_value = ToV8(impl->addressLine(), creationContext, isolate);
...
PaymentAddressInit* NativeValueTraits<PaymentAddressInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PaymentAddressInit* impl = MakeGarbageCollected<PaymentAddressInit>();
  V8PaymentAddressInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
