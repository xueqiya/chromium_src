...
#include "third_party/blink/renderer/bindings/modules/v8/v8_ndef_writer.h"
...
#include "third_party/blink/renderer/bindings/modules/v8/v8_video_track_reader.h"
...
#include "third_party/blink/renderer/bindings/modules/v8/v8_xr_cube_map.h"
...
#include "third_party/blink/renderer/bindings/modules/v8/v8_xr_light_estimation.h"
#include "third_party/blink/renderer/bindings/modules/v8/v8_xr_light_estimation_state.h"
...
#include "third_party/blink/renderer/bindings/modules/v8/v8_xr_reflection_probe.h"
...
#include "third_party/blink/renderer/bindings/modules/v8/v8_xr_spherical_harmonics.h"
...
static void LaunchQueueAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  LaunchQueue* cpp_value(DOMWindowLaunchQueue::launchQueue(*impl));
...
static void SchedulerAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();
  ...
  DOMScheduler* cpp_value(WindowScheduler::scheduler(*impl));
...
static void SchedulerAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  v8::Local<v8::String> property_name = V8AtomicString(isolate, "scheduler");
  if (info.Holder()->CreateDataProperty(info.GetIsolate()->GetCurrentContext(), property_name, v8_value).IsNothing())
    return;
}
...
static void ChooseFileSystemEntriesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = WindowNativeFileSystem::chooseFileSystemEntries(script_state, *impl, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void GetScreensMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "Window", "getScreens");
  ExceptionToRejectPromiseScope reject_promise_scope(info, exception_state);
  ...
  ScriptPromise result = GlobalScreenEnumeration::getScreens(script_state, *impl, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
void V8WindowPartial::ContactAddressConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_ContactAddress_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8ContactAddress::GetWrapperTypeInfo());
}

void V8WindowPartial::ContentIndexConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::CookieStoreManagerConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::LaunchParamsConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_LaunchParams_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8LaunchParams::GetWrapperTypeInfo());
}

void V8WindowPartial::LaunchQueueConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_LaunchQueue_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8LaunchQueue::GetWrapperTypeInfo());
}
...
void V8WindowPartial::PeriodicSyncManagerConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::QuicTransportConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_QuicTransport_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8QuicTransport::GetWrapperTypeInfo());
}

void V8WindowPartial::SendStreamConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_SendStream_ConstructorGetterCallback");
...
void V8WindowPartial::WakeLockSentinelConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::EncodedVideoChunkConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_EncodedVideoChunk_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8EncodedVideoChunk::GetWrapperTypeInfo());
}

void V8WindowPartial::VideoDecoderConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_VideoDecoder_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8VideoDecoder::GetWrapperTypeInfo());
}

void V8WindowPartial::VideoFrameConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_VideoFrame_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8VideoFrame::GetWrapperTypeInfo());
}

void V8WindowPartial::VideoTrackReaderConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_VideoTrackReader_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8VideoTrackReader::GetWrapperTypeInfo());
}

void V8WindowPartial::VideoTrackWriterConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_VideoTrackWriter_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8VideoTrackWriter::GetWrapperTypeInfo());
}
...
void V8WindowPartial::GPUColorWriteConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::GPUDeviceLostInfoConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_GPUDeviceLostInfo_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8GPUDeviceLostInfo::GetWrapperTypeInfo());
}
...
void V8WindowPartial::GPURenderBundleConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::GPURenderBundleEncoderConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::GPUShaderStageConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::NDEFMessageConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_NDEFMessage_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8NDEFMessage::GetWrapperTypeInfo());
}

void V8WindowPartial::NDEFReaderConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_NDEFReader_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8NDEFReader::GetWrapperTypeInfo());
}

void V8WindowPartial::NDEFReadingEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_NDEFReadingEvent_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8NDEFReadingEvent::GetWrapperTypeInfo());
}

void V8WindowPartial::NDEFRecordConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_NDEFRecord_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8NDEFRecord::GetWrapperTypeInfo());
}

void V8WindowPartial::NDEFWriterConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_NDEFWriter_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8NDEFWriter::GetWrapperTypeInfo());
}

void V8WindowPartial::SchedulerConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_Scheduler_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8Scheduler::GetWrapperTypeInfo());
}

void V8WindowPartial::TaskControllerConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_TaskController_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8TaskController::GetWrapperTypeInfo());
}

void V8WindowPartial::TaskSignalConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_TaskSignal_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8TaskSignal::GetWrapperTypeInfo());
}

void V8WindowPartial::WebSocketStreamConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::XRInputSourceArrayConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8XRInputSourceArray::GetWrapperTypeInfo());
}
...
void V8WindowPartial::XRInputSourcesChangeEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8XRInputSourcesChangeEvent::GetWrapperTypeInfo());
}
...
void V8WindowPartial::XRHitTestResultConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRHitTestResult_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRHitTestResult::GetWrapperTypeInfo());
}

void V8WindowPartial::XRHitTestSourceConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRHitTestSource_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRHitTestSource::GetWrapperTypeInfo());
}
...
void V8WindowPartial::XRTransientInputHitTestResultConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8XRTransientInputHitTestResult::GetWrapperTypeInfo());
}

void V8WindowPartial::XRTransientInputHitTestSourceConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8XRTransientInputHitTestSource::GetWrapperTypeInfo());
}

void V8WindowPartial::XRAnchorConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRAnchor_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRAnchor::GetWrapperTypeInfo());
}

void V8WindowPartial::XRAnchorSetConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRAnchorSet_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRAnchorSet::GetWrapperTypeInfo());
}

void V8WindowPartial::XRCubeMapConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRCubeMap_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRCubeMap::GetWrapperTypeInfo());
}

void V8WindowPartial::XRDOMOverlayStateConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRDOMOverlayState_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRDOMOverlayState::GetWrapperTypeInfo());
}
...
void V8WindowPartial::XRLightEstimationConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRLightEstimation_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRLightEstimation::GetWrapperTypeInfo());
}

void V8WindowPartial::XRLightEstimationStateConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRLightEstimationState_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRLightEstimationState::GetWrapperTypeInfo());
}

void V8WindowPartial::XRLightProbeConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRLightProbe_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRLightProbe::GetWrapperTypeInfo());
}
...
void V8WindowPartial::XRPlaneSetConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRPlaneSet_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRPlaneSet::GetWrapperTypeInfo());
}

void V8WindowPartial::XRReflectionProbeConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRReflectionProbe_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRReflectionProbe::GetWrapperTypeInfo());
}

void V8WindowPartial::XRSphericalHarmonicsConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_XRSphericalHarmonics_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8XRSphericalHarmonics::GetWrapperTypeInfo());
}
...
void V8WindowPartial::FileSystemWritableFileStreamConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::CompressionStreamConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::DecompressionStreamConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8WindowPartial::GeolocationConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_Geolocation_ConstructorGetterCallback");

  V8ConstructorAttributeGetter(property, info, V8Geolocation::GetWrapperTypeInfo());
}

void V8WindowPartial::GeolocationCoordinatesConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8GeolocationCoordinates::GetWrapperTypeInfo());
}

void V8WindowPartial::GeolocationPositionConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8GeolocationPosition::GetWrapperTypeInfo());
}

void V8WindowPartial::GeolocationPositionErrorConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8GeolocationPositionError::GetWrapperTypeInfo());
}
...
void V8WindowPartial::RTCPeerConnectionIceErrorEventConstructorGetterCallback(
    v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& info) {
  ...
  V8ConstructorAttributeGetter(property, info, V8RTCPeerConnectionIceErrorEvent::GetWrapperTypeInfo());
}
...
void V8WindowPartial::LaunchQueueAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_launchQueue_Getter");

  dom_window_partial_v8_internal::LaunchQueueAttributeGetter(info);
}
...
void V8WindowPartial::SchedulerAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_scheduler_Getter");

  dom_window_partial_v8_internal::SchedulerAttributeGetter(info);
}

void V8WindowPartial::SchedulerAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_scheduler_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_window_partial_v8_internal::SchedulerAttributeSetter(v8_value, info);
}
...
void V8WindowPartial::WebkitSpeechRecognitionErrorConstructorGetterCallback(
  ...
  V8ConstructorAttributeGetter(property, info, V8SpeechRecognitionErrorEvent::GetWrapperTypeInfo());
}
...
void V8WindowPartial::ChooseFileSystemEntriesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("Window.chooseFileSystemEntries");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_chooseFileSystemEntries");

  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8Window_ChooseFileSystemEntries_Method);
  dom_window_partial_v8_internal::ChooseFileSystemEntriesMethod(info);
}

void V8WindowPartial::GetScreensMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("Window.getScreens");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMWindow_getScreens");

  dom_window_partial_v8_internal::GetScreensMethod(info);
}
...
void V8WindowPartial::InstallV8WindowTemplate(
  ...
  kAttributeConfigurations[] = {
      ...
      { "CompressionStream", V8WindowPartial::CompressionStreamConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      { "DecompressionStream", V8WindowPartial::DecompressionStreamConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      { "Geolocation", V8WindowPartial::GeolocationConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "GeolocationCoordinates", V8WindowPartial::GeolocationCoordinatesConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "GeolocationPosition", V8WindowPartial::GeolocationPositionConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "GeolocationPositionError", V8WindowPartial::GeolocationPositionErrorConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      { "RTCPeerConnectionIceErrorEvent", V8WindowPartial::RTCPeerConnectionIceErrorEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
...
void V8WindowPartial::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::FileHandlingEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "LaunchParams", V8WindowPartial::LaunchParamsConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "LaunchQueue", V8WindowPartial::LaunchQueueConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::PeriodicBackgroundSyncEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "PeriodicSyncManager", V8WindowPartial::PeriodicSyncManagerConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::QuicTransportEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "QuicTransport", V8WindowPartial::QuicTransportConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "SendStream", V8WindowPartial::SendStreamConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::WebCodecsEnabled()) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "EncodedVideoChunk", V8WindowPartial::EncodedVideoChunkConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "VideoDecoder", V8WindowPartial::VideoDecoderConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "VideoFrame", V8WindowPartial::VideoFrameConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "VideoTrackReader", V8WindowPartial::VideoTrackReaderConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "VideoTrackWriter", V8WindowPartial::VideoTrackWriterConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance_template, prototype_template,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
  ...
  if (RuntimeEnabledFeatures::WebGPUEnabled()) {
    ...
    kAttributeConfigurations[] = {
        ...
        { "GPUColorWrite", V8WindowPartial::GPUColorWriteConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        ...
        { "GPUDeviceLostInfo", V8WindowPartial::GPUDeviceLostInfoConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        ...
        { "GPURenderBundle", V8WindowPartial::GPURenderBundleConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "GPURenderBundleEncoder", V8WindowPartial::GPURenderBundleEncoderConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        ...
        { "GPUShaderStage", V8WindowPartial::GPUShaderStageConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  ...
  if (RuntimeEnabledFeatures::FileHandlingEnabled()) {
    static constexpr V8DOMConfiguration::AccessorConfiguration
    kAccessorConfigurations[] = {
        { "launchQueue", V8WindowPartial::LaunchQueueAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAccessors(
        isolate, world, instance_template, prototype_template, interface_template,
        signature, kAccessorConfigurations,
...
void V8WindowPartial::InstallContactsManagerExtraProperties(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  if (is_secure_context) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "ContactAddress", V8WindowPartial::ContactAddressConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance, prototype,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8WindowPartial::InstallContactsManagerExtraProperties(
  ...
  InstallContactsManagerExtraProperties(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}

void V8WindowPartial::InstallContentIndex(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "ContentIndex", V8WindowPartial::ContentIndexConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8WindowPartial::InstallContentIndex(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallContentIndex(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}

void V8WindowPartial::InstallNativeFileSystem(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  if (is_secure_context) {
    ...
    kChooseFileSystemEntriesConfigurations[] = {
    ...
    for (const auto& config : kChooseFileSystemEntriesConfigurations) {
      V8DOMConfiguration::InstallMethod(
          isolate, world, instance, prototype,
          interface, signature, config);
    }
...
void V8WindowPartial::InstallWebNFC(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  if (is_secure_context) {
    static constexpr V8DOMConfiguration::AttributeConfiguration
    kAttributeConfigurations[] = {
        { "NDEFMessage", V8WindowPartial::NDEFMessageConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "NDEFReader", V8WindowPartial::NDEFReaderConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "NDEFReadingEvent", V8WindowPartial::NDEFReadingEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "NDEFRecord", V8WindowPartial::NDEFRecordConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        { "NDEFWriter", V8WindowPartial::NDEFWriterConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance, prototype,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8WindowPartial::InstallWebNFC(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallWebNFC(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}
...
void V8WindowPartial::InstallWebScheduler(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "Scheduler", V8WindowPartial::SchedulerConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "TaskController", V8WindowPartial::TaskControllerConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      { "TaskSignal", V8WindowPartial::TaskSignalConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
  static constexpr V8DOMConfiguration::AccessorConfiguration
  kAccessorConfigurations[] = {
      { "scheduler", V8WindowPartial::SchedulerAttributeGetterCallback, V8WindowPartial::SchedulerAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAccessors(
      isolate, world, instance, prototype, interface,
      signature, kAccessorConfigurations,
...
void V8WindowPartial::InstallWebScheduler(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallWebScheduler(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}

void V8WindowPartial::InstallSmsReceiver(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
...
void V8WindowPartial::InstallSmsReceiver(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallSmsReceiver(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}

void V8WindowPartial::InstallNotificationTriggers(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
...
void V8WindowPartial::InstallWakeLock(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  if (is_secure_context) {
    ...
    kAttributeConfigurations[] = {
        ...
        { "WakeLockSentinel", V8WindowPartial::WakeLockSentinelConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
    };
    V8DOMConfiguration::InstallAttributes(
        isolate, world, instance, prototype,
        kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8WindowPartial::InstallWakeLock(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallWakeLock(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}

void V8WindowPartial::InstallWebSocketStream(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::Object> instance,
    v8::Local<v8::Object> prototype,
  ...
  static constexpr V8DOMConfiguration::AttributeConfiguration
  kAttributeConfigurations[] = {
      { "WebSocketStream", V8WindowPartial::WebSocketStreamConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
  };
  V8DOMConfiguration::InstallAttributes(
      isolate, world, instance, prototype,
      kAttributeConfigurations, base::size(kAttributeConfigurations));
...
void V8WindowPartial::InstallWebSocketStream(
  ...
  v8::Local<v8::Function> interface = per_context_data->ConstructorForType(
      V8Window::GetWrapperTypeInfo());
  ALLOW_UNUSED_LOCAL(interface);
  InstallWebSocketStream(script_state->GetIsolate(), script_state->World(), instance, prototype, interface);
}
...
void V8WindowPartial::InstallConditionalFeatures(
  ...
  if (!instance_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      if (RuntimeEnabledFeatures::CookieStoreDocumentEnabled()) {
        static constexpr V8DOMConfiguration::AccessorConfiguration
        kAccessorConfigurations[] = {
    ...
    if (is_secure_context) {
      ...
      if (RuntimeEnabledFeatures::ContactsManagerEnabled()) {
        static constexpr V8DOMConfiguration::AttributeConfiguration
        kAttributeConfigurations[] = {
      ...
      if (RuntimeEnabledFeatures::CookieStoreWorkerEnabled()) {
        static constexpr V8DOMConfiguration::AttributeConfiguration
        kAttributeConfigurations[] = {
            { "CookieStoreManager", V8WindowPartial::CookieStoreManagerConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        };
        V8DOMConfiguration::InstallAttributes(
            isolate, world, instance_object, prototype_object,
            kAttributeConfigurations, base::size(kAttributeConfigurations));
      ...
      if (RuntimeEnabledFeatures::WebXREnabled()) {
        ...
        kAttributeConfigurations[] = {
            ...
            { "XRInputSourceArray", V8WindowPartial::XRInputSourceArrayConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRInputSourceEvent", V8WindowPartial::XRInputSourceEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRInputSourcesChangeEvent", V8WindowPartial::XRInputSourcesChangeEventConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      if (RuntimeEnabledFeatures::WebXRHitTestEnabled()) {
        static constexpr V8DOMConfiguration::AttributeConfiguration
        kAttributeConfigurations[] = {
            { "XRHitTestResult", V8WindowPartial::XRHitTestResultConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRHitTestSource", V8WindowPartial::XRHitTestSourceConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            ...
            { "XRTransientInputHitTestResult", V8WindowPartial::XRTransientInputHitTestResultConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRTransientInputHitTestSource", V8WindowPartial::XRTransientInputHitTestSourceConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        };
        V8DOMConfiguration::InstallAttributes(
            isolate, world, instance_object, prototype_object,
            kAttributeConfigurations, base::size(kAttributeConfigurations));
      }
      if (RuntimeEnabledFeatures::WebXRIncubationsEnabled()) {
        static constexpr V8DOMConfiguration::AttributeConfiguration
        kAttributeConfigurations[] = {
            { "XRAnchor", V8WindowPartial::XRAnchorConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRAnchorSet", V8WindowPartial::XRAnchorSetConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRCubeMap", V8WindowPartial::XRCubeMapConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRDOMOverlayState", V8WindowPartial::XRDOMOverlayStateConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            ...
            { "XRLightEstimation", V8WindowPartial::XRLightEstimationConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRLightEstimationState", V8WindowPartial::XRLightEstimationStateConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRLightProbe", V8WindowPartial::XRLightProbeConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            ...
            { "XRPlaneSet", V8WindowPartial::XRPlaneSetConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRReflectionProbe", V8WindowPartial::XRReflectionProbeConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
            { "XRSphericalHarmonics", V8WindowPartial::XRSphericalHarmonicsConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
      ...
      if (RuntimeEnabledFeatures::WritableFileStreamEnabled()) {
        static constexpr V8DOMConfiguration::AttributeConfiguration
        kAttributeConfigurations[] = {
            { "FileSystemWritableFileStream", V8WindowPartial::FileSystemWritableFileStreamConstructorGetterCallback, nullptr, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kReplaceWithDataProperty, V8DOMConfiguration::kAllWorlds },
        };
        V8DOMConfiguration::InstallAttributes(
            isolate, world, instance_object, prototype_object,
            kAttributeConfigurations, base::size(kAttributeConfigurations));
    ...
    if (is_secure_context) {
      if (RuntimeEnabledFeatures::ScreenEnumerationEnabled()) {
        {
          // Install getScreens configuration
          const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
              {"getScreens", V8WindowPartial::GetScreensMethodCallback, 0, v8::None, V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
          };
          for (const auto& config : kConfigurations) {
            V8DOMConfiguration::InstallMethod(
                isolate, world, instance_object, prototype_object,
