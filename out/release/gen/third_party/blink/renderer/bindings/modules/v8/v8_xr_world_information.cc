...
static void DetectedPlanesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  XRPlaneSet* cpp_value(WTF::GetPtr(impl->detectedPlanes()));
...
static void LightEstimationAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  XRWorldInformation* impl = V8XRWorldInformation::ToImpl(holder);

  XRLightEstimation* cpp_value(WTF::GetPtr(impl->lightEstimation()));
...
void V8XRWorldInformation::LightEstimationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRWorldInformation_lightEstimation_Getter");

  xr_world_information_v8_internal::LightEstimationAttributeGetter(info);
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      kAccessorConfigurations[] = {
          ...
          { "lightEstimation", V8XRWorldInformation::LightEstimationAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      };
