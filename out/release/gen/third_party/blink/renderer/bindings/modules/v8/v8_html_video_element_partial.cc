...
#include "third_party/blink/renderer/modules/xr/element_xr.h"
...
static void RequestPictureInPictureMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptPromise result = HTMLVideoElementPictureInPicture::requestPictureInPicture(script_state, *impl, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void RequestAnimationFrameMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (UNLIKELY(info.Length() < 1)) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("requestAnimationFrame", "HTMLVideoElement", ExceptionMessages::NotEnoughArguments(1, info.Length())));
    return;
  }

  V8VideoFrameRequestCallback* callback;
  if (info[0]->IsFunction()) {
    callback = V8VideoFrameRequestCallback::Create(info[0].As<v8::Function>());
  } else {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::FailedToExecute("requestAnimationFrame", "HTMLVideoElement", "The callback provided as parameter 1 is not a function."));
    return;
  }

  V8SetReturnValueInt(info, VideoRequestAnimationFrameImpl::requestAnimationFrame(*impl, callback));
}

static void CancelAnimationFrameMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "HTMLVideoElement", "cancelAnimationFrame");
  ...
  VideoRequestAnimationFrameImpl::cancelAnimationFrame(*impl, handle);
}
...
void V8HTMLVideoElementPartial::RequestAnimationFrameMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("HTMLVideoElement.requestAnimationFrame");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLVideoElement_requestAnimationFrame");

  html_video_element_partial_v8_internal::RequestAnimationFrameMethod(info);
}

void V8HTMLVideoElementPartial::CancelAnimationFrameMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  BLINK_BINDINGS_TRACE_EVENT("HTMLVideoElement.cancelAnimationFrame");
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLVideoElement_cancelAnimationFrame");

  html_video_element_partial_v8_internal::CancelAnimationFrameMethod(info);
}
  ...
  if (RuntimeEnabledFeatures::VideoRequestAnimationFrameEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"requestAnimationFrame", V8HTMLVideoElementPartial::RequestAnimationFrameMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
  ...
  if (RuntimeEnabledFeatures::VideoRequestAnimationFrameEnabled()) {
    {
      ...
      constexpr V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
          {"cancelAnimationFrame", V8HTMLVideoElementPartial::CancelAnimationFrameMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
      };
      for (const auto& config : kConfigurations) {
        V8DOMConfiguration::InstallMethod(
            isolate, world, instance_template, prototype_template,
