...
static void GetContextMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  CanvasRenderingContext2DOrWebGLRenderingContextOrWebGL2RenderingContextOrImageBitmapRenderingContextOrGPUCanvasContext result;
...
static void TransferControlToOffscreenMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  OffscreenCanvas* result = HTMLCanvasElementModule::transferControlToOffscreen(execution_context, *impl, exception_state);
  if (exception_state.HadException()) {
    return;
  }
