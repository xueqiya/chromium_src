...
static const v8::Eternal<v8::Name>* eternalV8GPUObjectDescriptorBaseKeys(v8::Isolate* isolate) {
...
void V8GPUObjectDescriptorBase::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUObjectDescriptorBase* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUObjectDescriptorBaseKeys(isolate);
  ...
  if (label_value.IsEmpty() || label_value->IsUndefined()) {
    ...
    V8StringResource<kTreatNullAndUndefinedAsNullString> label_cpp_value = label_value;
