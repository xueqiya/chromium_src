...
class V8NavigatorPartial {
 ...
 public:
  ...
  static void InstallSmsReceiver(ScriptState*);
  ...
  static void InstallWakeLock(ScriptState*);
  ...
  static void SmsAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
  static void WakeLockAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
  ...
  static void SetAppBadgeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info);
  static void ClearAppBadgeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info);
