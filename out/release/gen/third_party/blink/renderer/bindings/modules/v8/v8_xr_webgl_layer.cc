...
static void InstallV8XRWebGLLayerTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8XRWebGLLayer::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8XRWebGLLayer::kInternalFieldCount);
