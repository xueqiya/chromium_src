...
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8SpeechRecognition_Constructor);
...
void V8SpeechRecognition::GrammarsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8SpeechRecognition_Grammars_AttributeGetter);
...
void V8SpeechRecognition::GrammarsAttributeSetterCallback(
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8SpeechRecognition_Grammars_AttributeSetter);
