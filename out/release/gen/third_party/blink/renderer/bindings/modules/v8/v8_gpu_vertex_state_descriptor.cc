...
static const v8::Eternal<v8::Name>* eternalV8GPUVertexStateDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPUVertexStateDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUVertexStateDescriptor* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUVertexStateDescriptorKeys(isolate);
  ...
  if (vertex_buffers_value.IsEmpty() || vertex_buffers_value->IsUndefined()) {
    ...
    ScriptValue vertex_buffers_cpp_value = ScriptValue(isolate, vertex_buffers_value);
