...
static const v8::Eternal<v8::Name>* eternalV8ContentIconDefinitionKeys(v8::Isolate* isolate) {
...
void V8ContentIconDefinition::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ContentIconDefinition* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8ContentIconDefinitionKeys(isolate);
...
v8::Local<v8::Value> ContentIconDefinition::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8ContentIconDefinition(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8ContentIconDefinition(const ContentIconDefinition* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8ContentIconDefinitionKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
ContentIconDefinition* NativeValueTraits<ContentIconDefinition>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  ContentIconDefinition* impl = MakeGarbageCollected<ContentIconDefinition>();
  V8ContentIconDefinition::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
