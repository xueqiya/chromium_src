...
static const v8::Eternal<v8::Name>* eternalV8GPUVertexBufferLayoutDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPUVertexBufferLayoutDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUVertexBufferLayoutDescriptor* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUVertexBufferLayoutDescriptorKeys(isolate);
  ...
  if (array_stride_value.IsEmpty() || array_stride_value->IsUndefined()) {
    ...
    uint64_t array_stride_cpp_value = NativeValueTraits<IDLUnsignedLongLong>::NativeValue(isolate, array_stride_value, exception_state);
