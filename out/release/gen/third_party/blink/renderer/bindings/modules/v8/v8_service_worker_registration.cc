...
void V8ServiceWorkerRegistration::InstallContentIndex(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
  ...
  if (is_secure_context) {
    ...
    kAccessorConfigurations[] = {
        { "index", V8ServiceWorkerRegistration::IndexAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    };
...
void V8ServiceWorkerRegistration::InstallContentIndex(ScriptState* script_state) {
  InstallContentIndex(script_state, v8::Local<v8::Object>());
}
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      ...
      if (RuntimeEnabledFeatures::CookieStoreWorkerEnabled()) {
        static constexpr V8DOMConfiguration::AccessorConfiguration
        kAccessorConfigurations[] = {
            { "cookies", V8ServiceWorkerRegistration::CookiesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
        };
        V8DOMConfiguration::InstallAccessors(
            isolate, world, instance_object, prototype_object, interface_object,
            signature, kAccessorConfigurations,
