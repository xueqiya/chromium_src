...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_CUSTOM_FRAGMENT_RESULT_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_CUSTOM_FRAGMENT_RESULT_OPTIONS_H_
...
class CORE_EXPORT FragmentResultOptions : public IDLDictionaryBase {
 public:
  ...
  double baseline() const {
    DCHECK(has_baseline_);
    return baseline_;
  }
  inline void setBaseline(double);
...
void FragmentResultOptions::setBaseline(double value) {
  baseline_ = value;
  has_baseline_ = true;
}
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_CUSTOM_FRAGMENT_RESULT_OPTIONS_H_
