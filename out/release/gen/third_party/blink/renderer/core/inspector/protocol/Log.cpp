...
void ViolationSetting::AppendSerialized(std::vector<uint8_t>* out) const {
    ...
    out->push_back(crdtp::cbor::EncodeIndefiniteLengthMapStart());
      ...
      crdtp::SerializeField(crdtp::SpanFrom("threshold"), m_threshold, out);
    out->push_back(crdtp::cbor::EncodeStop());
    envelope_encoder.EncodeStop(out);
}
...
protected:
    ...
    void startViolationsReport(int callId, const String& method, crdtp::span<uint8_t> message, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport*);
    void stopViolationsReport(int callId, const String& method, crdtp::span<uint8_t> message, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport*);
...
void DispatcherImpl::startViolationsReport(int callId, const String& method, crdtp::span<uint8_t> message, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport* errors)
{
...
void DispatcherImpl::stopViolationsReport(int callId, const String& method, crdtp::span<uint8_t> message, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport* errors)
{
