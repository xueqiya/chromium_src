...
class CORE_EXPORT BlockedSetCookieWithReason : public Serializable{
...
class CORE_EXPORT BlockedCookieWithReason : public Serializable{
...
class CORE_EXPORT RequestWillBeSentExtraInfoNotification : public Serializable{
...
class CORE_EXPORT ResponseReceivedExtraInfoNotification : public Serializable{
