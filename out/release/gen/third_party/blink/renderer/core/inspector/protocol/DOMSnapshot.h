...
public:
    ...
    protocol::Array<protocol::Array<double>>* getOffsetRects(protocol::Array<protocol::Array<double>>* defaultValue) { return m_offsetRects.isJust() ? m_offsetRects.fromJust() : defaultValue; }
    ...
    protocol::Array<protocol::Array<double>>* getScrollRects(protocol::Array<protocol::Array<double>>* defaultValue) { return m_scrollRects.isJust() ? m_scrollRects.fromJust() : defaultValue; }
    ...
    protocol::Array<protocol::Array<double>>* getClientRects(protocol::Array<protocol::Array<double>>* defaultValue) { return m_clientRects.isJust() ? m_clientRects.fromJust() : defaultValue; }
...
public:
    ...
    virtual DispatchResponse captureSnapshot(std::unique_ptr<protocol::Array<String>> in_computedStyles, Maybe<bool> in_includePaintOrder, Maybe<bool> in_includeDOMRects, std::unique_ptr<protocol::Array<protocol::DOMSnapshot::DocumentSnapshot>>* out_documents, std::unique_ptr<protocol::Array<String>>* out_strings) = 0;
