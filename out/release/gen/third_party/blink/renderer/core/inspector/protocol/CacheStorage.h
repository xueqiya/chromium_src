...
public:
    ...
    virtual void requestEntries(const String& in_cacheId, Maybe<int> in_skipCount, Maybe<int> in_pageSize, Maybe<String> in_pathFilter, std::unique_ptr<RequestEntriesCallback> callback) = 0;
