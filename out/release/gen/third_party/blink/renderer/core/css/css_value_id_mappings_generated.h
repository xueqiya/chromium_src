...
template <>
inline RenderSubtreeFlags cssValueIDToPlatformEnumGenerated(CSSValueID v) {
  switch (v) {
    case CSSValueID::kNone:
      return RenderSubtreeFlags::kNone;
    case CSSValueID::kInvisible:
      return RenderSubtreeFlags::kInvisible;
    case CSSValueID::kSkipActivation:
      return RenderSubtreeFlags::kSkipActivation;
    case CSSValueID::kSkipViewportActivation:
      return RenderSubtreeFlags::kSkipViewportActivation;
    default:
      NOTREACHED();
      return RenderSubtreeFlags::kNone;
  }
...
inline CSSValueID platformEnumToCSSValueIDGenerated(RenderSubtreeFlags v) {
  switch (v) {
    case RenderSubtreeFlags::kNone:
      return CSSValueID::kNone;
    case RenderSubtreeFlags::kInvisible:
      return CSSValueID::kInvisible;
    case RenderSubtreeFlags::kSkipActivation:
      return CSSValueID::kSkipActivation;
    case RenderSubtreeFlags::kSkipViewportActivation:
      return CSSValueID::kSkipViewportActivation;
    default:
      NOTREACHED();
      return CSSValueID::kNone;
  }
