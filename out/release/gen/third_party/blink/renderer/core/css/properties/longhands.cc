...
CSSExposure InternalEffectiveZoom::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalEffectiveZoom::GetPropertyName() const {
  return "-internal-effective-zoom";
}

const WTF::AtomicString& InternalEffectiveZoom::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-effective-zoom"));
  return name;
}

const char* InternalEffectiveZoom::GetJSPropertyName() const {
...
const CSSProperty* BackgroundAttachment::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundAttachment();
}
...
const CSSProperty* BackgroundBlendMode::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundBlendMode();
}
...
const CSSProperty* BackgroundClip::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundClip();
}
...
const CSSProperty* BackgroundColor::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundColor();
}
...
const CSSProperty* BackgroundImage::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundImage();
}
...
const CSSProperty* BackgroundOrigin::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundOrigin();
}
...
const CSSProperty* BackgroundPositionX::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundPositionX();
}
...
const CSSProperty* BackgroundPositionY::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundPositionY();
}
...
const CSSProperty* BackgroundSize::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBackgroundSize();
}
...
const CSSProperty* BorderBottomColor::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderBottomColor();
}
...
const CSSProperty* BorderBottomLeftRadius::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderBottomLeftRadius();
}
...
const CSSProperty* BorderBottomRightRadius::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderBottomRightRadius();
}
...
const CSSProperty* BorderBottomStyle::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderBottomStyle();
}
...
const CSSProperty* BorderBottomWidth::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderBottomWidth();
}
...
const CSSProperty* BorderImageOutset::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderImageOutset();
}
...
const CSSProperty* BorderImageRepeat::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderImageRepeat();
}
...
const CSSProperty* BorderImageSlice::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderImageSlice();
}
...
const CSSProperty* BorderImageSource::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderImageSource();
}
...
const CSSProperty* BorderImageWidth::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderImageWidth();
}
...
const CSSProperty* BorderLeftColor::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderLeftColor();
}
...
const CSSProperty* BorderLeftStyle::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderLeftStyle();
}
...
const CSSProperty* BorderLeftWidth::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderLeftWidth();
}
...
const CSSProperty* BorderRightColor::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderRightColor();
}
...
const CSSProperty* BorderRightStyle::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderRightStyle();
}
...
const CSSProperty* BorderRightWidth::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderRightWidth();
}
...
const CSSProperty* BorderTopColor::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderTopColor();
}
...
const CSSProperty* BorderTopLeftRadius::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderTopLeftRadius();
}
...
const CSSProperty* BorderTopRightRadius::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderTopRightRadius();
}
...
const CSSProperty* BorderTopStyle::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderTopStyle();
}
...
const CSSProperty* BorderTopWidth::GetUAProperty() const {
  return &GetCSSPropertyInternalUaBorderTopWidth();
}
...
CSSExposure ContainIntrinsicBlockSize::Exposure() const {
  if (!RuntimeEnabledFeatures::CSSIntrinsicSizeEnabled())
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}
...
const CSSProperty& ContainIntrinsicBlockSize::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
  return CSSDirectionAwareResolver::ResolveBlock(direction, writing_mode,
      CSSDirectionAwareResolver::ContainIntrinsicSizeGroup());
}
...
CSSExposure ContainIntrinsicHeight::Exposure() const {
  if (!RuntimeEnabledFeatures::CSSIntrinsicSizeEnabled())
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}
...
void ContainIntrinsicHeight::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetContainIntrinsicHeight(state.ParentStyle()->ContainIntrinsicHeight());
}
void ContainIntrinsicHeight::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetContainIntrinsicHeight(StyleBuilderConverter::ConvertIntrinsicLength(state, value));
}

 // contain-intrinsic-inline-size

CSSExposure ContainIntrinsicInlineSize::Exposure() const {
  if (!RuntimeEnabledFeatures::CSSIntrinsicSizeEnabled())
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}
...
const CSSProperty& ContainIntrinsicInlineSize::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
...
CSSExposure ContainIntrinsicWidth::Exposure() const {
  if (!RuntimeEnabledFeatures::CSSIntrinsicSizeEnabled())
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}
...
void ContainIntrinsicWidth::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetContainIntrinsicWidth(ComputedStyleInitialValues::InitialContainIntrinsicWidth());
}
void ContainIntrinsicWidth::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetContainIntrinsicWidth(state.ParentStyle()->ContainIntrinsicWidth());
}
void ContainIntrinsicWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetContainIntrinsicWidth(StyleBuilderConverter::ConvertIntrinsicLength(state, value));
}
...
void InternalEmptyLineHeight::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
 ...
 // -internal-ua-background-attachment

CSSExposure InternalUaBackgroundAttachment::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundAttachment::GetPropertyName() const {
  return "-internal-ua-background-attachment";
}

const WTF::AtomicString& InternalUaBackgroundAttachment::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-attachment"));
  return name;
}

const char* InternalUaBackgroundAttachment::GetJSPropertyName() const {
  return "internalUaBackgroundAttachment";
}


void InternalUaBackgroundAttachment::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetAttachment(FillLayer::InitialFillAttachment(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearAttachment();
}

void InternalUaBackgroundAttachment::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsAttachmentSet()) {
...
void InternalUaBackgroundAttachment::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-blend-mode

CSSExposure InternalUaBackgroundBlendMode::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundBlendMode::GetPropertyName() const {
  return "-internal-ua-background-blend-mode";
}

const WTF::AtomicString& InternalUaBackgroundBlendMode::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-blend-mode"));
  return name;
}

const char* InternalUaBackgroundBlendMode::GetJSPropertyName() const {
  return "internalUaBackgroundBlendMode";
}


void InternalUaBackgroundBlendMode::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetBlendMode(FillLayer::InitialFillBlendMode(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearBlendMode();
...
void InternalUaBackgroundBlendMode::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsBlendModeSet()) {
...
void InternalUaBackgroundBlendMode::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-clip

CSSExposure InternalUaBackgroundClip::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundClip::GetPropertyName() const {
  return "-internal-ua-background-clip";
}

const WTF::AtomicString& InternalUaBackgroundClip::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-clip"));
  return name;
}

const char* InternalUaBackgroundClip::GetJSPropertyName() const {
  return "internalUaBackgroundClip";
}


void InternalUaBackgroundClip::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetClip(FillLayer::InitialFillClip(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearClip();
...
void InternalUaBackgroundClip::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsClipSet()) {
...
void InternalUaBackgroundClip::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
...
CSSExposure InternalUaBackgroundColor::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundColor::GetPropertyName() const {
  return "-internal-ua-background-color";
}

const WTF::AtomicString& InternalUaBackgroundColor::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-color"));
  return name;
}

const char* InternalUaBackgroundColor::GetJSPropertyName() const {
  return "internalUaBackgroundColor";
}


void InternalUaBackgroundColor::ApplyInitial(StyleResolverState& state) const {
  auto color = ComputedStyleInitialValues::InitialBackgroundColor();
  state.EnsureUAStyle()->SetBackgroundColor(color);
}

void InternalUaBackgroundColor::ApplyInherit(StyleResolverState& state) const {
  auto color = state.ParentStyle()->BackgroundColor();
  state.EnsureUAStyle()->SetBackgroundColor(color);
}

void InternalUaBackgroundColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBackgroundColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}

 // -internal-ua-background-image

CSSExposure InternalUaBackgroundImage::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundImage::GetPropertyName() const {
  return "-internal-ua-background-image";
}

const WTF::AtomicString& InternalUaBackgroundImage::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-image"));
  return name;
}

const char* InternalUaBackgroundImage::GetJSPropertyName() const {
  return "internalUaBackgroundImage";
}


void InternalUaBackgroundImage::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetImage(FillLayer::InitialFillImage(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearImage();
...
void InternalUaBackgroundImage::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsImageSet()) {
...
void InternalUaBackgroundImage::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-origin

CSSExposure InternalUaBackgroundOrigin::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundOrigin::GetPropertyName() const {
  return "-internal-ua-background-origin";
}

const WTF::AtomicString& InternalUaBackgroundOrigin::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-origin"));
  return name;
}

const char* InternalUaBackgroundOrigin::GetJSPropertyName() const {
  return "internalUaBackgroundOrigin";
}


void InternalUaBackgroundOrigin::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetOrigin(FillLayer::InitialFillOrigin(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearOrigin();
...
void InternalUaBackgroundOrigin::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsOriginSet()) {
...
void InternalUaBackgroundOrigin::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-position-x

CSSExposure InternalUaBackgroundPositionX::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundPositionX::GetPropertyName() const {
  return "-internal-ua-background-position-x";
}

const WTF::AtomicString& InternalUaBackgroundPositionX::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-position-x"));
  return name;
}

const char* InternalUaBackgroundPositionX::GetJSPropertyName() const {
  return "internalUaBackgroundPositionX";
}


void InternalUaBackgroundPositionX::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetPositionX(FillLayer::InitialFillPositionX(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearPositionX();
...
void InternalUaBackgroundPositionX::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsPositionXSet()) {
...
void InternalUaBackgroundPositionX::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-position-y

CSSExposure InternalUaBackgroundPositionY::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundPositionY::GetPropertyName() const {
  return "-internal-ua-background-position-y";
}

const WTF::AtomicString& InternalUaBackgroundPositionY::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-position-y"));
  return name;
}

const char* InternalUaBackgroundPositionY::GetJSPropertyName() const {
  return "internalUaBackgroundPositionY";
}


void InternalUaBackgroundPositionY::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetPositionY(FillLayer::InitialFillPositionY(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearPositionY();
...
void InternalUaBackgroundPositionY::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsPositionYSet()) {
...
void InternalUaBackgroundPositionY::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-background-size

CSSExposure InternalUaBackgroundSize::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBackgroundSize::GetPropertyName() const {
  return "-internal-ua-background-size";
}

const WTF::AtomicString& InternalUaBackgroundSize::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-background-size"));
  return name;
}

const char* InternalUaBackgroundSize::GetJSPropertyName() const {
  return "internalUaBackgroundSize";
}


void InternalUaBackgroundSize::ApplyInitial(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  curr_child->SetSize(FillLayer::InitialFillSize(EFillLayerType::kBackground));
  for (curr_child = curr_child->Next(); curr_child; curr_child = curr_child->Next())
    curr_child->ClearSize();
...
void InternalUaBackgroundSize::ApplyInherit(StyleResolverState& state) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const FillLayer* curr_parent = &state.ParentStyle()->BackgroundLayers();
  while (curr_parent && curr_parent->IsSizeSet()) {
...
void InternalUaBackgroundSize::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  FillLayer* curr_child = &state.EnsureUAStyle()->AccessBackgroundLayers();
  FillLayer* prev_child = 0;
  const auto* value_list = DynamicTo<CSSValueList>(value);
  if (value_list && !value.IsImageSetValue()) {
 ...
 // -internal-ua-border-bottom-color

CSSExposure InternalUaBorderBottomColor::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderBottomColor::GetPropertyName() const {
  return "-internal-ua-border-bottom-color";
}

const WTF::AtomicString& InternalUaBorderBottomColor::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-bottom-color"));
  return name;
}

const char* InternalUaBorderBottomColor::GetJSPropertyName() const {
  return "internalUaBorderBottomColor";
}


void InternalUaBorderBottomColor::ApplyInitial(StyleResolverState& state) const {
  auto color = StyleColor::CurrentColor();
  state.EnsureUAStyle()->SetBorderBottomColor(color);
}

void InternalUaBorderBottomColor::ApplyInherit(StyleResolverState& state) const {
  auto color = state.ParentStyle()->BorderBottomColor();
  state.EnsureUAStyle()->SetBorderBottomColor(color);
}

void InternalUaBorderBottomColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderBottomColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}

 // -internal-ua-border-bottom-left-radius

CSSExposure InternalUaBorderBottomLeftRadius::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderBottomLeftRadius::GetPropertyName() const {
  return "-internal-ua-border-bottom-left-radius";
}

const WTF::AtomicString& InternalUaBorderBottomLeftRadius::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-bottom-left-radius"));
  return name;
}

const char* InternalUaBorderBottomLeftRadius::GetJSPropertyName() const {
  return "internalUaBorderBottomLeftRadius";
}


void InternalUaBorderBottomLeftRadius::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomLeftRadius(ComputedStyleInitialValues::InitialBorderBottomLeftRadius());
}
void InternalUaBorderBottomLeftRadius::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomLeftRadius(state.ParentStyle()->BorderBottomLeftRadius());
}
void InternalUaBorderBottomLeftRadius::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderBottomLeftRadius(StyleBuilderConverter::ConvertRadius(state, value));
}

 // -internal-ua-border-bottom-right-radius

CSSExposure InternalUaBorderBottomRightRadius::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderBottomRightRadius::GetPropertyName() const {
  return "-internal-ua-border-bottom-right-radius";
}

const WTF::AtomicString& InternalUaBorderBottomRightRadius::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-bottom-right-radius"));
  return name;
}

const char* InternalUaBorderBottomRightRadius::GetJSPropertyName() const {
  return "internalUaBorderBottomRightRadius";
}


void InternalUaBorderBottomRightRadius::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomRightRadius(ComputedStyleInitialValues::InitialBorderBottomRightRadius());
}
void InternalUaBorderBottomRightRadius::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomRightRadius(state.ParentStyle()->BorderBottomRightRadius());
}
void InternalUaBorderBottomRightRadius::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderBottomRightRadius(StyleBuilderConverter::ConvertRadius(state, value));
}

 // -internal-ua-border-bottom-style

CSSExposure InternalUaBorderBottomStyle::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderBottomStyle::GetPropertyName() const {
  return "-internal-ua-border-bottom-style";
}

const WTF::AtomicString& InternalUaBorderBottomStyle::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-bottom-style"));
  return name;
}

const char* InternalUaBorderBottomStyle::GetJSPropertyName() const {
  return "internalUaBorderBottomStyle";
}


void InternalUaBorderBottomStyle::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomStyle(ComputedStyleInitialValues::InitialBorderBottomStyle());
}
void InternalUaBorderBottomStyle::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomStyle(state.ParentStyle()->BorderBottomStyle());
}
void InternalUaBorderBottomStyle::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderBottomStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::EBorderStyle>());
}

 // -internal-ua-border-bottom-width

CSSExposure InternalUaBorderBottomWidth::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderBottomWidth::GetPropertyName() const {
  return "-internal-ua-border-bottom-width";
}

const WTF::AtomicString& InternalUaBorderBottomWidth::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-bottom-width"));
  return name;
}

const char* InternalUaBorderBottomWidth::GetJSPropertyName() const {
  return "internalUaBorderBottomWidth";
}


void InternalUaBorderBottomWidth::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomWidth(ComputedStyleInitialValues::InitialBorderBottomWidth());
}
void InternalUaBorderBottomWidth::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderBottomWidth(state.ParentStyle()->BorderBottomWidth());
}
void InternalUaBorderBottomWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderBottomWidth(StyleBuilderConverter::ConvertBorderWidth(state, value));
}

 // -internal-ua-border-image-outset

CSSExposure InternalUaBorderImageOutset::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderImageOutset::GetPropertyName() const {
  return "-internal-ua-border-image-outset";
}

const WTF::AtomicString& InternalUaBorderImageOutset::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-image-outset"));
  return name;
}

const char* InternalUaBorderImageOutset::GetJSPropertyName() const {
  return "internalUaBorderImageOutset";
}


void InternalUaBorderImageOutset::ApplyInitial(StyleResolverState& state) const {
  const NinePieceImage& current_image = state.EnsureUAStyle()->BorderImage();
  if (style_building_utils::BorderImageLengthMatchesAllSides(current_image.Outset(),
                                       BorderImageLength(Length::Fixed(0))))
    return;
  NinePieceImage image(current_image);
  image.SetOutset(Length::Fixed(0));
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageOutset::ApplyInherit(StyleResolverState& state) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.CopyOutsetFrom(state.ParentStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageOutset::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.SetOutset(CSSToStyleMap::MapNinePieceImageQuad(state, value));
  state.EnsureUAStyle()->SetBorderImage(image);
}

 // -internal-ua-border-image-repeat

CSSExposure InternalUaBorderImageRepeat::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderImageRepeat::GetPropertyName() const {
  return "-internal-ua-border-image-repeat";
}

const WTF::AtomicString& InternalUaBorderImageRepeat::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-image-repeat"));
  return name;
}

const char* InternalUaBorderImageRepeat::GetJSPropertyName() const {
  return "internalUaBorderImageRepeat";
}


void InternalUaBorderImageRepeat::ApplyInitial(StyleResolverState& state) const {
  const NinePieceImage& current_image = state.EnsureUAStyle()->BorderImage();
  if (current_image.HorizontalRule() == kStretchImageRule &&
      current_image.VerticalRule() == kStretchImageRule)
    return;
...
void InternalUaBorderImageRepeat::ApplyInherit(StyleResolverState& state) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.CopyRepeatFrom(state.ParentStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageRepeat::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  CSSToStyleMap::MapNinePieceImageRepeat(state, value, image);
  state.EnsureUAStyle()->SetBorderImage(image);
}

 // -internal-ua-border-image-slice

CSSExposure InternalUaBorderImageSlice::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderImageSlice::GetPropertyName() const {
  return "-internal-ua-border-image-slice";
}

const WTF::AtomicString& InternalUaBorderImageSlice::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-image-slice"));
  return name;
}

const char* InternalUaBorderImageSlice::GetJSPropertyName() const {
  return "internalUaBorderImageSlice";
}


void InternalUaBorderImageSlice::ApplyInitial(StyleResolverState& state) const {
  const NinePieceImage& current_image = state.EnsureUAStyle()->BorderImage();
  if (current_image.Fill() == false &&
      style_building_utils::LengthMatchesAllSides(current_image.ImageSlices(), Length::Percent(100)))
    return;
...
void InternalUaBorderImageSlice::ApplyInherit(StyleResolverState& state) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.CopyImageSlicesFrom(state.ParentStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageSlice::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  CSSToStyleMap::MapNinePieceImageSlice(state, value, image);
  state.EnsureUAStyle()->SetBorderImage(image);
}

 // -internal-ua-border-image-source

CSSExposure InternalUaBorderImageSource::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderImageSource::GetPropertyName() const {
  return "-internal-ua-border-image-source";
}

const WTF::AtomicString& InternalUaBorderImageSource::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-image-source"));
  return name;
}

const char* InternalUaBorderImageSource::GetJSPropertyName() const {
  return "internalUaBorderImageSource";
}


void InternalUaBorderImageSource::ApplyInitial(StyleResolverState& state) const {
  const NinePieceImage& current_image = state.EnsureUAStyle()->BorderImage();
  NinePieceImage image(current_image);
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageSource::ApplyInherit(StyleResolverState& state) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageSource::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}

 // -internal-ua-border-image-width

CSSExposure InternalUaBorderImageWidth::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderImageWidth::GetPropertyName() const {
  return "-internal-ua-border-image-width";
}

const WTF::AtomicString& InternalUaBorderImageWidth::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-image-width"));
  return name;
}

const char* InternalUaBorderImageWidth::GetJSPropertyName() const {
  return "internalUaBorderImageWidth";
}


void InternalUaBorderImageWidth::ApplyInitial(StyleResolverState& state) const {
  const NinePieceImage& current_image = state.EnsureUAStyle()->BorderImage();
  if (style_building_utils::BorderImageLengthMatchesAllSides(current_image.BorderSlices(),
                                       BorderImageLength(1.0)))
    return;
...
void InternalUaBorderImageWidth::ApplyInherit(StyleResolverState& state) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.CopyBorderSlicesFrom(state.ParentStyle()->BorderImage());
  state.EnsureUAStyle()->SetBorderImage(image);
}
void InternalUaBorderImageWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  NinePieceImage image(state.EnsureUAStyle()->BorderImage());
  image.SetBorderSlices(CSSToStyleMap::MapNinePieceImageQuad(state, value));
  state.EnsureUAStyle()->SetBorderImage(image);
}

 // -internal-ua-border-left-color

CSSExposure InternalUaBorderLeftColor::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderLeftColor::GetPropertyName() const {
  return "-internal-ua-border-left-color";
}

const WTF::AtomicString& InternalUaBorderLeftColor::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-left-color"));
  return name;
}

const char* InternalUaBorderLeftColor::GetJSPropertyName() const {
  return "internalUaBorderLeftColor";
}


void InternalUaBorderLeftColor::ApplyInitial(StyleResolverState& state) const {
  auto color = StyleColor::CurrentColor();
  state.EnsureUAStyle()->SetBorderLeftColor(color);
}

void InternalUaBorderLeftColor::ApplyInherit(StyleResolverState& state) const {
  auto color = state.ParentStyle()->BorderLeftColor();
  state.EnsureUAStyle()->SetBorderLeftColor(color);
}

void InternalUaBorderLeftColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderLeftColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}

 // -internal-ua-border-left-style

CSSExposure InternalUaBorderLeftStyle::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderLeftStyle::GetPropertyName() const {
  return "-internal-ua-border-left-style";
}

const WTF::AtomicString& InternalUaBorderLeftStyle::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-left-style"));
  return name;
}

const char* InternalUaBorderLeftStyle::GetJSPropertyName() const {
  return "internalUaBorderLeftStyle";
}


void InternalUaBorderLeftStyle::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderLeftStyle(ComputedStyleInitialValues::InitialBorderLeftStyle());
}
void InternalUaBorderLeftStyle::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderLeftStyle(state.ParentStyle()->BorderLeftStyle());
}
void InternalUaBorderLeftStyle::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderLeftStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::EBorderStyle>());
}

 // -internal-ua-border-left-width

CSSExposure InternalUaBorderLeftWidth::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderLeftWidth::GetPropertyName() const {
  return "-internal-ua-border-left-width";
}

const WTF::AtomicString& InternalUaBorderLeftWidth::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-left-width"));
  return name;
}

const char* InternalUaBorderLeftWidth::GetJSPropertyName() const {
  return "internalUaBorderLeftWidth";
}


void InternalUaBorderLeftWidth::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderLeftWidth(ComputedStyleInitialValues::InitialBorderLeftWidth());
}
void InternalUaBorderLeftWidth::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderLeftWidth(state.ParentStyle()->BorderLeftWidth());
}
void InternalUaBorderLeftWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderLeftWidth(StyleBuilderConverter::ConvertBorderWidth(state, value));
}

 // -internal-ua-border-right-color

CSSExposure InternalUaBorderRightColor::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderRightColor::GetPropertyName() const {
  return "-internal-ua-border-right-color";
}

const WTF::AtomicString& InternalUaBorderRightColor::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-right-color"));
  return name;
}

const char* InternalUaBorderRightColor::GetJSPropertyName() const {
  return "internalUaBorderRightColor";
}


void InternalUaBorderRightColor::ApplyInitial(StyleResolverState& state) const {
  auto color = StyleColor::CurrentColor();
  state.EnsureUAStyle()->SetBorderRightColor(color);
}

void InternalUaBorderRightColor::ApplyInherit(StyleResolverState& state) const {
  auto color = state.ParentStyle()->BorderRightColor();
  state.EnsureUAStyle()->SetBorderRightColor(color);
}

void InternalUaBorderRightColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderRightColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}

 // -internal-ua-border-right-style

CSSExposure InternalUaBorderRightStyle::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderRightStyle::GetPropertyName() const {
  return "-internal-ua-border-right-style";
}

const WTF::AtomicString& InternalUaBorderRightStyle::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-right-style"));
  return name;
}

const char* InternalUaBorderRightStyle::GetJSPropertyName() const {
  return "internalUaBorderRightStyle";
}


void InternalUaBorderRightStyle::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderRightStyle(ComputedStyleInitialValues::InitialBorderRightStyle());
}
void InternalUaBorderRightStyle::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderRightStyle(state.ParentStyle()->BorderRightStyle());
}
void InternalUaBorderRightStyle::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderRightStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::EBorderStyle>());
}

 // -internal-ua-border-right-width

CSSExposure InternalUaBorderRightWidth::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderRightWidth::GetPropertyName() const {
  return "-internal-ua-border-right-width";
}

const WTF::AtomicString& InternalUaBorderRightWidth::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-right-width"));
  return name;
}

const char* InternalUaBorderRightWidth::GetJSPropertyName() const {
  return "internalUaBorderRightWidth";
}


void InternalUaBorderRightWidth::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderRightWidth(ComputedStyleInitialValues::InitialBorderRightWidth());
}
void InternalUaBorderRightWidth::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderRightWidth(state.ParentStyle()->BorderRightWidth());
}
void InternalUaBorderRightWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderRightWidth(StyleBuilderConverter::ConvertBorderWidth(state, value));
}

 // -internal-ua-border-top-color

CSSExposure InternalUaBorderTopColor::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderTopColor::GetPropertyName() const {
  return "-internal-ua-border-top-color";
}

const WTF::AtomicString& InternalUaBorderTopColor::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-top-color"));
  return name;
}

const char* InternalUaBorderTopColor::GetJSPropertyName() const {
  return "internalUaBorderTopColor";
}


void InternalUaBorderTopColor::ApplyInitial(StyleResolverState& state) const {
  auto color = StyleColor::CurrentColor();
  state.EnsureUAStyle()->SetBorderTopColor(color);
}

void InternalUaBorderTopColor::ApplyInherit(StyleResolverState& state) const {
  auto color = state.ParentStyle()->BorderTopColor();
  state.EnsureUAStyle()->SetBorderTopColor(color);
}

void InternalUaBorderTopColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderTopColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}

 // -internal-ua-border-top-left-radius

CSSExposure InternalUaBorderTopLeftRadius::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderTopLeftRadius::GetPropertyName() const {
  return "-internal-ua-border-top-left-radius";
}

const WTF::AtomicString& InternalUaBorderTopLeftRadius::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-top-left-radius"));
  return name;
}

const char* InternalUaBorderTopLeftRadius::GetJSPropertyName() const {
  return "internalUaBorderTopLeftRadius";
}


void InternalUaBorderTopLeftRadius::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopLeftRadius(ComputedStyleInitialValues::InitialBorderTopLeftRadius());
}
void InternalUaBorderTopLeftRadius::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopLeftRadius(state.ParentStyle()->BorderTopLeftRadius());
}
void InternalUaBorderTopLeftRadius::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderTopLeftRadius(StyleBuilderConverter::ConvertRadius(state, value));
}

 // -internal-ua-border-top-right-radius

CSSExposure InternalUaBorderTopRightRadius::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderTopRightRadius::GetPropertyName() const {
  return "-internal-ua-border-top-right-radius";
}

const WTF::AtomicString& InternalUaBorderTopRightRadius::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-top-right-radius"));
  return name;
}

const char* InternalUaBorderTopRightRadius::GetJSPropertyName() const {
  return "internalUaBorderTopRightRadius";
}


void InternalUaBorderTopRightRadius::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopRightRadius(ComputedStyleInitialValues::InitialBorderTopRightRadius());
}
void InternalUaBorderTopRightRadius::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopRightRadius(state.ParentStyle()->BorderTopRightRadius());
}
void InternalUaBorderTopRightRadius::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderTopRightRadius(StyleBuilderConverter::ConvertRadius(state, value));
}

 // -internal-ua-border-top-style

CSSExposure InternalUaBorderTopStyle::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderTopStyle::GetPropertyName() const {
  return "-internal-ua-border-top-style";
}

const WTF::AtomicString& InternalUaBorderTopStyle::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-top-style"));
  return name;
}

const char* InternalUaBorderTopStyle::GetJSPropertyName() const {
  return "internalUaBorderTopStyle";
}


void InternalUaBorderTopStyle::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopStyle(ComputedStyleInitialValues::InitialBorderTopStyle());
}
void InternalUaBorderTopStyle::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopStyle(state.ParentStyle()->BorderTopStyle());
}
void InternalUaBorderTopStyle::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderTopStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::EBorderStyle>());
}

 // -internal-ua-border-top-width

CSSExposure InternalUaBorderTopWidth::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalUaBorderTopWidth::GetPropertyName() const {
  return "-internal-ua-border-top-width";
}

const WTF::AtomicString& InternalUaBorderTopWidth::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("-internal-ua-border-top-width"));
  return name;
}

const char* InternalUaBorderTopWidth::GetJSPropertyName() const {
  return "internalUaBorderTopWidth";
}


void InternalUaBorderTopWidth::ApplyInitial(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopWidth(ComputedStyleInitialValues::InitialBorderTopWidth());
}
void InternalUaBorderTopWidth::ApplyInherit(StyleResolverState& state) const {
  state.EnsureUAStyle()->SetBorderTopWidth(state.ParentStyle()->BorderTopWidth());
}
void InternalUaBorderTopWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.EnsureUAStyle()->SetBorderTopWidth(StyleBuilderConverter::ConvertBorderWidth(state, value));
}
...
CSSExposure MaskSourceType::Exposure() const {
...
const char* MaskSourceType::GetPropertyName() const {
  return "mask-source-type";
}

const WTF::AtomicString& MaskSourceType::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("mask-source-type"));
  return name;
}

const char* MaskSourceType::GetJSPropertyName() const {
...
CSSExposure RenderSubtree::Exposure() const {
...
const char* RenderSubtree::GetPropertyName() const {
  return "render-subtree";
}

const WTF::AtomicString& RenderSubtree::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("render-subtree"));
  return name;
}

const char* RenderSubtree::GetJSPropertyName() const {
  return "renderSubtree";
}


void RenderSubtree::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetRenderSubtree(ComputedStyleInitialValues::InitialRenderSubtree());
}
void RenderSubtree::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetRenderSubtree(state.ParentStyle()->RenderSubtree());
}
void RenderSubtree::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetRenderSubtree(StyleBuilderConverter::ConvertFlags<RenderSubtreeFlags>(state, value));
}
...
void ScrollBehavior::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetScrollBehavior(To<CSSIdentifierValue>(value).ConvertTo<blink::mojom::blink::ScrollIntoViewParams::Behavior>());
}
...
void WebkitAppearance::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetAppearance(ComputedStyleInitialValues::InitialAppearance());
}
void WebkitAppearance::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetAppearance(state.ParentStyle()->Appearance());
}
void WebkitAppearance::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
