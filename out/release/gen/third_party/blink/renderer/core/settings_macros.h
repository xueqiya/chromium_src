...
#define SETTINGS_GETTERS_AND_SETTERS \
    ...
    int GetDarkModeBackgroundBrightnessThreshold() const { return dark_mode_background_brightness_threshold_; } \
    void SetDarkModeBackgroundBrightnessThreshold(int dark_mode_background_brightness_threshold); \
    DarkModeClassifierType GetDarkModeClassifierType() const { return dark_mode_classifier_type_; } \
    void SetDarkModeClassifierType(DarkModeClassifierType dark_mode_classifier_type); \
    double GetDarkModeContrast() const { return dark_mode_contrast_; } \
    void SetDarkModeContrast(double dark_mode_contrast); \
    bool GetDarkModeEnabled() const { return dark_mode_enabled_; } \
    ...
    float GetDarkModeImageGrayscale() const { return dark_mode_image_grayscale_; } \
    void SetDarkModeImageGrayscale(float dark_mode_image_grayscale); \
    ...
    DarkModeInversionAlgorithm GetDarkModeInversionAlgorithm() const { return dark_mode_inversion_algorithm_; } \
    void SetDarkModeInversionAlgorithm(DarkModeInversionAlgorithm dark_mode_inversion_algorithm); \
    ...
    int GetDarkModeTextBrightnessThreshold() const { return dark_mode_text_brightness_threshold_; } \
    void SetDarkModeTextBrightnessThreshold(int dark_mode_text_brightness_threshold); \
    ...
    int GetLazyImageFirstKFullyLoad2G() const { return lazy_image_first_k_fully_load_2_g_; } \
    void SetLazyImageFirstKFullyLoad2G(int lazy_image_first_k_fully_load_2_g); \
    int GetLazyImageFirstKFullyLoad3G() const { return lazy_image_first_k_fully_load_3_g_; } \
    void SetLazyImageFirstKFullyLoad3G(int lazy_image_first_k_fully_load_3_g); \
    int GetLazyImageFirstKFullyLoad4G() const { return lazy_image_first_k_fully_load_4_g_; } \
    void SetLazyImageFirstKFullyLoad4G(int lazy_image_first_k_fully_load_4_g); \
    int GetLazyImageFirstKFullyLoadSlow2G() const { return lazy_image_first_k_fully_load_slow_2_g_; } \
    void SetLazyImageFirstKFullyLoadSlow2G(int lazy_image_first_k_fully_load_slow_2_g); \
    int GetLazyImageFirstKFullyLoadUnknown() const { return lazy_image_first_k_fully_load_unknown_; } \
    void SetLazyImageFirstKFullyLoadUnknown(int lazy_image_first_k_fully_load_unknown); \
    ...
    const String& GetTextTrackWindowPadding() const { return text_track_window_padding_; } \
    void SetTextTrackWindowPadding(const String& text_track_window_padding); \
...
#define SETTINGS_MEMBER_VARIABLES \
    ...
    int dark_mode_background_brightness_threshold_; \
    DarkModeClassifierType dark_mode_classifier_type_; \
    double dark_mode_contrast_; \
    float dark_mode_image_grayscale_; \
    DarkModeImagePolicy dark_mode_image_policy_; \
    DarkModeInversionAlgorithm dark_mode_inversion_algorithm_; \
    DarkModePagePolicy dark_mode_page_policy_; \
    int dark_mode_text_brightness_threshold_; \
    ...
    int lazy_image_first_k_fully_load_2_g_; \
    int lazy_image_first_k_fully_load_3_g_; \
    int lazy_image_first_k_fully_load_4_g_; \
    int lazy_image_first_k_fully_load_slow_2_g_; \
    int lazy_image_first_k_fully_load_unknown_; \
    ...
    String text_track_window_padding_; \
...
#define SETTINGS_INITIALIZER_LIST \
    ...
    , dark_mode_background_brightness_threshold_(205) \
    , dark_mode_classifier_type_(DarkModeClassifierType::kGeneric) \
    , dark_mode_contrast_(0) \
    , dark_mode_image_grayscale_(0.0) \
    , dark_mode_image_policy_(DarkModeImagePolicy::kFilterNone) \
    , dark_mode_inversion_algorithm_(DarkModeInversionAlgorithm::kInvertLightnessLAB) \
    , dark_mode_page_policy_(DarkModePagePolicy::kFilterByBackground) \
    , dark_mode_text_brightness_threshold_(150) \
    ...
    , lazy_image_first_k_fully_load_2_g_(10) \
    , lazy_image_first_k_fully_load_3_g_(8) \
    , lazy_image_first_k_fully_load_4_g_(6) \
    , lazy_image_first_k_fully_load_slow_2_g_(12) \
    , lazy_image_first_k_fully_load_unknown_(0) \
...
void Settings::SetAllowUniversalAccessFromFileURLs(bool allow_universal_access_from_file_urls) { \
  ...
  Invalidate(SettingsDelegate::kUniversalAccessChange); \
} \
...
void Settings::SetDarkModeBackgroundBrightnessThreshold(int dark_mode_background_brightness_threshold) { \
  if (dark_mode_background_brightness_threshold_ == dark_mode_background_brightness_threshold) \
    return; \
  dark_mode_background_brightness_threshold_ = dark_mode_background_brightness_threshold; \
  Invalidate(SettingsDelegate::kPaintChange); \
} \
void Settings::SetDarkModeClassifierType(DarkModeClassifierType dark_mode_classifier_type) { \
  if (dark_mode_classifier_type_ == dark_mode_classifier_type) \
    return; \
  dark_mode_classifier_type_ = dark_mode_classifier_type; \
  Invalidate(SettingsDelegate::kPaintChange); \
} \
...
void Settings::SetDarkModeEnabled(bool dark_mode_enabled) { \
...
void Settings::SetDarkModeImageGrayscale(float dark_mode_image_grayscale) { \
  if (dark_mode_image_grayscale_ == dark_mode_image_grayscale) \
    return; \
  dark_mode_image_grayscale_ = dark_mode_image_grayscale; \
  Invalidate(SettingsDelegate::kPaintChange); \
} \
...
void Settings::SetDarkModeInversionAlgorithm(DarkModeInversionAlgorithm dark_mode_inversion_algorithm) { \
  if (dark_mode_inversion_algorithm_ == dark_mode_inversion_algorithm) \
    return; \
  dark_mode_inversion_algorithm_ = dark_mode_inversion_algorithm; \
  Invalidate(SettingsDelegate::kPaintChange); \
} \
...
void Settings::SetDarkModeTextBrightnessThreshold(int dark_mode_text_brightness_threshold) { \
  if (dark_mode_text_brightness_threshold_ == dark_mode_text_brightness_threshold) \
    return; \
  dark_mode_text_brightness_threshold_ = dark_mode_text_brightness_threshold; \
  Invalidate(SettingsDelegate::kPaintChange); \
} \
...
void Settings::SetLazyImageFirstKFullyLoad2G(int lazy_image_first_k_fully_load_2_g) { \
  if (lazy_image_first_k_fully_load_2_g_ == lazy_image_first_k_fully_load_2_g) \
    return; \
  lazy_image_first_k_fully_load_2_g_ = lazy_image_first_k_fully_load_2_g; \
} \
void Settings::SetLazyImageFirstKFullyLoad3G(int lazy_image_first_k_fully_load_3_g) { \
  if (lazy_image_first_k_fully_load_3_g_ == lazy_image_first_k_fully_load_3_g) \
    return; \
  lazy_image_first_k_fully_load_3_g_ = lazy_image_first_k_fully_load_3_g; \
} \
void Settings::SetLazyImageFirstKFullyLoad4G(int lazy_image_first_k_fully_load_4_g) { \
  if (lazy_image_first_k_fully_load_4_g_ == lazy_image_first_k_fully_load_4_g) \
    return; \
  lazy_image_first_k_fully_load_4_g_ = lazy_image_first_k_fully_load_4_g; \
} \
void Settings::SetLazyImageFirstKFullyLoadSlow2G(int lazy_image_first_k_fully_load_slow_2_g) { \
  if (lazy_image_first_k_fully_load_slow_2_g_ == lazy_image_first_k_fully_load_slow_2_g) \
    return; \
  lazy_image_first_k_fully_load_slow_2_g_ = lazy_image_first_k_fully_load_slow_2_g; \
} \
void Settings::SetLazyImageFirstKFullyLoadUnknown(int lazy_image_first_k_fully_load_unknown) { \
  if (lazy_image_first_k_fully_load_unknown_ == lazy_image_first_k_fully_load_unknown) \
    return; \
  lazy_image_first_k_fully_load_unknown_ = lazy_image_first_k_fully_load_unknown; \
} \
...
void Settings::SetTextTrackWindowPadding(const String& text_track_window_padding) { \
  if (text_track_window_padding_ == text_track_window_padding) \
    return; \
  text_track_window_padding_ = text_track_window_padding; \
} \
...
void Settings::SetFromStrings(const String& name, const String& value) { \
  ...
  if (name == "darkModeBackgroundBrightnessThreshold") { \
    SetDarkModeBackgroundBrightnessThreshold( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "darkModeClassifierType") { \
    SetDarkModeClassifierType( \
      static_cast<DarkModeClassifierType>(value.ToInt()) \
    ); \
    return; \
  } \
  ...
  if (name == "darkModeImageGrayscale") { \
    SetDarkModeImageGrayscale( \
      value.ToFloat() \
    ); \
    return; \
  } \
  ...
  if (name == "darkModeInversionAlgorithm") { \
    SetDarkModeInversionAlgorithm( \
      static_cast<DarkModeInversionAlgorithm>(value.ToInt()) \
    ); \
    return; \
  } \
  ...
  if (name == "darkModeTextBrightnessThreshold") { \
    SetDarkModeTextBrightnessThreshold( \
      value.ToInt() \
    ); \
    return; \
  } \
  ...
  if (name == "displayModeOverride") { \
    SetDisplayModeOverride( \
      static_cast<blink::mojom::DisplayMode>(value.ToInt()) \
    ); \
    return; \
  } \
  ...
  if (name == "lazyImageFirstKFullyLoad2G") { \
    SetLazyImageFirstKFullyLoad2G( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "lazyImageFirstKFullyLoad3G") { \
    SetLazyImageFirstKFullyLoad3G( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "lazyImageFirstKFullyLoad4G") { \
    SetLazyImageFirstKFullyLoad4G( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "lazyImageFirstKFullyLoadSlow2G") { \
    SetLazyImageFirstKFullyLoadSlow2G( \
      value.ToInt() \
    ); \
    return; \
  } \
  if (name == "lazyImageFirstKFullyLoadUnknown") { \
    SetLazyImageFirstKFullyLoadUnknown( \
      value.ToInt() \
    ); \
    return; \
  } \
  ...
  if (name == "navigationControls") { \
    SetNavigationControls( \
      static_cast<NavigationControls>(value.ToInt()) \
    ); \
    return; \
  } \
  ...
  if (name == "textTrackWindowColor") { \
    SetTextTrackWindowColor( \
      value \
    ); \
    return; \
  } \
  if (name == "textTrackWindowPadding") { \
    SetTextTrackWindowPadding( \
      value \
    ); \
    return; \
  } \
  if (name == "textTrackWindowRadius") { \
    SetTextTrackWindowRadius( \
      value \
    ); \
    return; \
  } \
