...
InternalSettingsGenerated::InternalSettingsGenerated(Page* page)
    ...
    , darkModeBackgroundBrightnessThreshold_(page->GetSettings().GetDarkModeBackgroundBrightnessThreshold())
    , darkModeContrast_(page->GetSettings().GetDarkModeContrast())
    , darkModeEnabled_(page->GetSettings().GetDarkModeEnabled())
    , darkModeGrayscale_(page->GetSettings().GetDarkModeGrayscale())
    , darkModeTextBrightnessThreshold_(page->GetSettings().GetDarkModeTextBrightnessThreshold())
    ...
    , lazyImageFirstKFullyLoad2G_(page->GetSettings().GetLazyImageFirstKFullyLoad2G())
    , lazyImageFirstKFullyLoad3G_(page->GetSettings().GetLazyImageFirstKFullyLoad3G())
    , lazyImageFirstKFullyLoad4G_(page->GetSettings().GetLazyImageFirstKFullyLoad4G())
    , lazyImageFirstKFullyLoadSlow2G_(page->GetSettings().GetLazyImageFirstKFullyLoadSlow2G())
    , lazyImageFirstKFullyLoadUnknown_(page->GetSettings().GetLazyImageFirstKFullyLoadUnknown())
    ...
    , textTrackWindowPadding_(page->GetSettings().GetTextTrackWindowPadding())
...
void InternalSettingsGenerated::resetToConsistentState() {
  ...
  page_->GetSettings().SetDarkModeBackgroundBrightnessThreshold(darkModeBackgroundBrightnessThreshold_);
  page_->GetSettings().SetDarkModeContrast(darkModeContrast_);
  page_->GetSettings().SetDarkModeEnabled(darkModeEnabled_);
  page_->GetSettings().SetDarkModeGrayscale(darkModeGrayscale_);
  page_->GetSettings().SetDarkModeTextBrightnessThreshold(darkModeTextBrightnessThreshold_);
  ...
  page_->GetSettings().SetLazyImageFirstKFullyLoad2G(lazyImageFirstKFullyLoad2G_);
  page_->GetSettings().SetLazyImageFirstKFullyLoad3G(lazyImageFirstKFullyLoad3G_);
  page_->GetSettings().SetLazyImageFirstKFullyLoad4G(lazyImageFirstKFullyLoad4G_);
  page_->GetSettings().SetLazyImageFirstKFullyLoadSlow2G(lazyImageFirstKFullyLoadSlow2G_);
  page_->GetSettings().SetLazyImageFirstKFullyLoadUnknown(lazyImageFirstKFullyLoadUnknown_);
  ...
  page_->GetSettings().SetTextTrackWindowPadding(textTrackWindowPadding_);
...
void InternalSettingsGenerated::setCaretBrowsingEnabled(bool caretBrowsingEnabled) {
  page_->GetSettings().SetCaretBrowsingEnabled(caretBrowsingEnabled);
}
...
void InternalSettingsGenerated::setDarkModeBackgroundBrightnessThreshold(int darkModeBackgroundBrightnessThreshold) {
  page_->GetSettings().SetDarkModeBackgroundBrightnessThreshold(darkModeBackgroundBrightnessThreshold);
}
...
void InternalSettingsGenerated::setDarkModeEnabled(bool darkModeEnabled) {
  page_->GetSettings().SetDarkModeEnabled(darkModeEnabled);
}
...
void InternalSettingsGenerated::setDarkModeTextBrightnessThreshold(int darkModeTextBrightnessThreshold) {
  page_->GetSettings().SetDarkModeTextBrightnessThreshold(darkModeTextBrightnessThreshold);
}
...
void InternalSettingsGenerated::setLazyImageFirstKFullyLoad2G(int lazyImageFirstKFullyLoad2G) {
  page_->GetSettings().SetLazyImageFirstKFullyLoad2G(lazyImageFirstKFullyLoad2G);
}

void InternalSettingsGenerated::setLazyImageFirstKFullyLoad3G(int lazyImageFirstKFullyLoad3G) {
  page_->GetSettings().SetLazyImageFirstKFullyLoad3G(lazyImageFirstKFullyLoad3G);
}

void InternalSettingsGenerated::setLazyImageFirstKFullyLoad4G(int lazyImageFirstKFullyLoad4G) {
  page_->GetSettings().SetLazyImageFirstKFullyLoad4G(lazyImageFirstKFullyLoad4G);
}

void InternalSettingsGenerated::setLazyImageFirstKFullyLoadSlow2G(int lazyImageFirstKFullyLoadSlow2G) {
  page_->GetSettings().SetLazyImageFirstKFullyLoadSlow2G(lazyImageFirstKFullyLoadSlow2G);
}

void InternalSettingsGenerated::setLazyImageFirstKFullyLoadUnknown(int lazyImageFirstKFullyLoadUnknown) {
  page_->GetSettings().SetLazyImageFirstKFullyLoadUnknown(lazyImageFirstKFullyLoadUnknown);
}
...
void InternalSettingsGenerated::setTextTrackWindowColor(const String& textTrackWindowColor) {
  page_->GetSettings().SetTextTrackWindowColor(textTrackWindowColor);
}

void InternalSettingsGenerated::setTextTrackWindowPadding(const String& textTrackWindowPadding) {
  page_->GetSettings().SetTextTrackWindowPadding(textTrackWindowPadding);
}

void InternalSettingsGenerated::setTextTrackWindowRadius(const String& textTrackWindowRadius) {
  page_->GetSettings().SetTextTrackWindowRadius(textTrackWindowRadius);
}
