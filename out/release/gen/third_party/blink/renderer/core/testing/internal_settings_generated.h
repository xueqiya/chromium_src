...
class InternalSettingsGenerated : public ScriptWrappable {
 ...
 public:
  ...
  void setDarkModeBackgroundBrightnessThreshold(int darkModeBackgroundBrightnessThreshold);
  ...
  void setDarkModeTextBrightnessThreshold(int darkModeTextBrightnessThreshold);
  ...
  void setLazyImageFirstKFullyLoad2G(int lazyImageFirstKFullyLoad2G);
  void setLazyImageFirstKFullyLoad3G(int lazyImageFirstKFullyLoad3G);
  void setLazyImageFirstKFullyLoad4G(int lazyImageFirstKFullyLoad4G);
  void setLazyImageFirstKFullyLoadSlow2G(int lazyImageFirstKFullyLoadSlow2G);
  void setLazyImageFirstKFullyLoadUnknown(int lazyImageFirstKFullyLoadUnknown);
  ...
  void setTextTrackWindowPadding(const String& textTrackWindowPadding);
 ...
 private:
  ...
  bool cookieEnabled_;
  int darkModeBackgroundBrightnessThreshold_;
  double darkModeContrast_;
  bool darkModeEnabled_;
  bool darkModeGrayscale_;
  int darkModeTextBrightnessThreshold_;
  ...
  int lazyImageFirstKFullyLoad2G_;
  int lazyImageFirstKFullyLoad3G_;
  int lazyImageFirstKFullyLoad4G_;
  int lazyImageFirstKFullyLoadSlow2G_;
  int lazyImageFirstKFullyLoadUnknown_;
  ...
  String textTrackWindowPadding_;
