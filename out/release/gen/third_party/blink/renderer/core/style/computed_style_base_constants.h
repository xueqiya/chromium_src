...
enum class RenderSubtreeFlags : unsigned {
  kNone = 0,
  kInvisible = 1,
  kSkipActivation = 2,
  kSkipViewportActivation = 4,
};

static const int kRenderSubtreeFlagsBits = 3;

inline RenderSubtreeFlags operator|(RenderSubtreeFlags a, RenderSubtreeFlags b) {
  return static_cast<RenderSubtreeFlags>(
    static_cast<unsigned>(a) | static_cast<unsigned>(b)
  );
}
inline RenderSubtreeFlags& operator|=(RenderSubtreeFlags& a, RenderSubtreeFlags b) {
