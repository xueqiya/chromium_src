...
class ComputedStyleInitialValues{
 ...
 public:
  ...
  static float InitialInternalEffectiveZoom() {
    return 1.0f;
  }

  static Color InitialInternalVisitedColor() {
    return Color::kBlack;
  }
  ...
  static IntrinsicLength InitialContainIntrinsicHeight() {
    return IntrinsicLength();
  }

  static IntrinsicLength InitialContainIntrinsicWidth() {
    return IntrinsicLength();
  }
  ...
  static Color InitialInternalVisitedCaretColor() {
    return Color();
  }

  static StyleColor InitialInternalVisitedColumnRuleColor() {
    return StyleColor::CurrentColor();
  }
  ...
  static Color InitialInternalVisitedTextEmphasisColor() {
    return Color();
  }

  static Color InitialInternalVisitedTextFillColor() {
    return Color();
  }

  static Color InitialInternalVisitedTextStrokeColor() {
    return Color();
  }
  ...
  static RenderSubtreeFlags InitialRenderSubtree() {
    return RenderSubtreeFlags::kNone;
  }
  ...
  static mojom::blink::ScrollIntoViewParams::Behavior InitialScrollBehavior() {
  ...
  static bool InitialInsideNGFragmentationContext() {
    return false;
  }
  ...
  static bool InitialInternalVisitedTextStrokeColorIsCurrentColor() {
    return true;
  }

  static bool InitialInternalVisitedTextFillColorIsCurrentColor() {
    return true;
  }

  static bool InitialInternalVisitedTextEmphasisColorIsCurrentColor() {
    return true;
  }

  static bool InitialInternalVisitedCaretColorIsCurrentColor() {
    return false;
  }

  static bool InitialInternalVisitedCaretColorIsAuto() {
    return true;
  }
  ...
  static AtomicString InitialListStyleStringValue() {
    return g_null_atom;
  }
