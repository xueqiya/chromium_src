...
void MediaServiceProxy::CreateInterfaceFactory(
    mojo::PendingReceiver<::media::mojom::blink::InterfaceFactory> in_factory, mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> in_host_interfaces) {
