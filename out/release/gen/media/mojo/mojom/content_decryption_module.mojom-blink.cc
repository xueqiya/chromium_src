...
class ContentDecryptionModule_Initialize_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      CdmPromiseResultPtr in_result, int32_t in_cdm_id, mojo::PendingRemote<::media::mojom::blink::Decryptor> in_decryptor);
...
bool ContentDecryptionModule_Initialize_ForwardToCallback::Accept(
  ...
  int32_t p_cdm_id{};
  mojo::PendingRemote<::media::mojom::blink::Decryptor> p_decryptor{};
...
bool ContentDecryptionModuleStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kContentDecryptionModule_Initialize_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)media::mojom::ContentDecryptionModule::Initialize",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)media::mojom::ContentDecryptionModule::Initialize");
      ...
      if (success && !input_data_view.ReadKeySystem(&p_key_system))
        success = false;
      if (success && !input_data_view.ReadSecurityOrigin(&p_security_origin))
        success = false;
...
static const mojo::internal::GenericValidationInfo kContentDecryptionModuleValidationInfo[] = {
    {&internal::ContentDecryptionModule_SetClient_Params_Data::Validate,
     nullptr /* no response */},
    {&internal::ContentDecryptionModule_Initialize_Params_Data::Validate,
     &internal::ContentDecryptionModule_Initialize_ResponseParams_Data::Validate},
...
void CdmFactoryProxy::CreateCdm(
    const WTF::String& in_key_system, mojo::PendingReceiver<ContentDecryptionModule> in_cdm) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CdmFactoryStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kCdmFactory_CreateCdm_Name: {
      ...
      bool success = true;
      WTF::String p_key_system{};
      mojo::PendingReceiver<ContentDecryptionModule> p_cdm{};
