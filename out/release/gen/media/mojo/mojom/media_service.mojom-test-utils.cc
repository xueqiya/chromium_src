// media/mojo/mojom/media_service.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MediaServiceInterceptorForTesting::CreateInterfaceFactory(mojo::PendingReceiver<::media::mojom::InterfaceFactory> factory, mojo::PendingRemote<::service_manager::mojom::InterfaceProvider> host_interfaces) {
