...
class BLINK_PLATFORM_EXPORT MediaService
 ...
 public:
  ...
  virtual void CreateInterfaceFactory(mojo::PendingReceiver<::media::mojom::blink::InterfaceFactory> factory, mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> host_interfaces) = 0;
};
...
class BLINK_PLATFORM_EXPORT MediaServiceProxy
 ...
 public:
  ...
  void CreateInterfaceFactory(mojo::PendingReceiver<::media::mojom::blink::InterfaceFactory> factory, mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> host_interfaces) final;
