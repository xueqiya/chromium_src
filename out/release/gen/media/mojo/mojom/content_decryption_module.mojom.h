...
class  ContentDecryptionModule
 ...
 public:
  ...
  using InitializeCallback = base::OnceCallback<void(CdmPromiseResultPtr, int32_t, mojo::PendingRemote<::media::mojom::Decryptor>)>;
...
class  CdmFactory
 ...
 public:
  ...
  virtual void CreateCdm(const std::string& key_system, mojo::PendingReceiver<ContentDecryptionModule> cdm) = 0;
};
...
class  CdmFactoryProxy
 ...
 public:
  ...
  void CreateCdm(const std::string& key_system, mojo::PendingReceiver<ContentDecryptionModule> cdm) final;
