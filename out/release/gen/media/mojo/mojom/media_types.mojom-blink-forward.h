...
using AudioCodecProfile = AudioCodecProfile;  // Alias for definition in the parent namespace.
using BufferingState = BufferingState;  // Alias for definition in the parent namespace.
using BufferingStateChangeReason = BufferingStateChangeReason;  // Alias for definition in the parent namespace.
...
using EncryptionScheme = EncryptionScheme;  // Alias for definition in the parent namespace.
...
using DmabufVideoFrameDataPtr = mojo::StructPtr<DmabufVideoFrameData>;
...
using PipelineDecoderInfoPtr = mojo::InlinedStructPtr<PipelineDecoderInfo>;
