...
class ContentDecryptionModule_Initialize_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      CdmPromiseResultPtr in_result, int32_t in_cdm_id, mojo::PendingRemote<::media::mojom::Decryptor> in_decryptor);
...
void CdmFactoryProxy::CreateCdm(
    const std::string& in_key_system, mojo::PendingReceiver<ContentDecryptionModule> in_cdm) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
