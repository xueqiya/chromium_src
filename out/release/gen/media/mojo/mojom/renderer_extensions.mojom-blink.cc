...
void MediaPlayerRendererClientExtensionProxy::OnVideoSizeChange(
  ...
  TRACE_EVENT0("mojom", "media::mojom::MediaPlayerRendererClientExtension::OnVideoSizeChange");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::MediaPlayerRendererClientExtension::OnDurationChange");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::MediaPlayerRendererExtension::InitiateScopedSurfaceRequest");
#endif
...
bool MediaPlayerRendererExtension_InitiateScopedSurfaceRequest_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "media::mojom::MediaPlayerRendererExtension::InitiateScopedSurfaceRequestCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::MediaPlayerRendererExtension::InitiateScopedSurfaceRequestCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::FlingingRendererClientExtension::OnRemotePlayStateChange");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
