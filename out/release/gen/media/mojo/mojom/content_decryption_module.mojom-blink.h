...
class BLINK_PLATFORM_EXPORT ContentDecryptionModule
 ...
 public:
  ...
  using InitializeCallback = base::OnceCallback<void(CdmPromiseResultPtr, int32_t, mojo::PendingRemote<::media::mojom::blink::Decryptor>)>;
...
class BLINK_PLATFORM_EXPORT CdmFactory
 ...
 public:
  ...
  virtual void CreateCdm(const WTF::String& key_system, mojo::PendingReceiver<ContentDecryptionModule> cdm) = 0;
};
...
class BLINK_PLATFORM_EXPORT CdmFactoryProxy
 ...
 public:
  ...
  void CreateCdm(const WTF::String& key_system, mojo::PendingReceiver<ContentDecryptionModule> cdm) final;
