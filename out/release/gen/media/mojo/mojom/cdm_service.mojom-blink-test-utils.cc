// media/mojo/mojom/cdm_service.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CdmServiceInterceptorForTesting::CreateCdmFactory(mojo::PendingReceiver<::media::mojom::blink::CdmFactory> factory, mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> host_interfaces) {
