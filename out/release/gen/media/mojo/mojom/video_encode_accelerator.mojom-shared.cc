...
std::ostream& operator<<(std::ostream& os, VideoEncodeAcceleratorConfig_StorageType value) {
  switch(value) {
    case VideoEncodeAcceleratorConfig_StorageType::kShmem:
      return os << "VideoEncodeAcceleratorConfig_StorageType::kShmem";
    case VideoEncodeAcceleratorConfig_StorageType::kDmabuf:
      return os << "VideoEncodeAcceleratorConfig_StorageType::kDmabuf";
    default:
      return os << "Unknown VideoEncodeAcceleratorConfig_StorageType value: " << static_cast<int32_t>(value);
  }
}
