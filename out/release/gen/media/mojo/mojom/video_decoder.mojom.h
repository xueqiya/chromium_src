...
class  VideoDecoder
 ...
 public:
  ...
  virtual void Construct(mojo::PendingAssociatedRemote<VideoDecoderClient> client, mojo::PendingAssociatedRemote<::media::mojom::MediaLog> media_log, mojo::PendingReceiver<VideoFrameHandleReleaser> video_frame_handle_releaser, mojo::ScopedDataPipeConsumerHandle decoder_buffer_pipe, CommandBufferIdPtr command_buffer_id, ::media::VideoDecoderImplementation implementation, const ::gfx::ColorSpace& target_color_space) = 0;
...
class  VideoDecoderProxy
 ...
 public:
  ...
  void Construct(mojo::PendingAssociatedRemote<VideoDecoderClient> client, mojo::PendingAssociatedRemote<::media::mojom::MediaLog> media_log, mojo::PendingReceiver<VideoFrameHandleReleaser> video_frame_handle_releaser, mojo::ScopedDataPipeConsumerHandle decoder_buffer_pipe, CommandBufferIdPtr command_buffer_id, ::media::VideoDecoderImplementation implementation, const ::gfx::ColorSpace& target_color_space) final;
