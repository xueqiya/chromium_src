...
class  MediaMetricsProvider
 ...
 public:
  ...
  virtual void SetVideoPipelineInfo(const ::media::PipelineDecoderInfo& info) = 0;

  
  virtual void SetAudioPipelineInfo(const ::media::PipelineDecoderInfo& info) = 0;
};
...
class  MediaMetricsProviderProxy
 ...
 public:
  ...
  void SetVideoPipelineInfo(const ::media::PipelineDecoderInfo& info) final;
  
  void SetAudioPipelineInfo(const ::media::PipelineDecoderInfo& info) final;
