...
VideoBitrateAllocation::VideoBitrateAllocation(
    WTF::Vector<int32_t> bitrates_in)
...
bool VideoEncodeAccelerator::Initialize(VideoEncodeAcceleratorConfigPtr config, mojo::PendingRemote<VideoEncodeAcceleratorClient> client, bool* out_result) {
  NOTREACHED();
  return false;
}
...
bool VideoEncodeAcceleratorProxy::Initialize(
    VideoEncodeAcceleratorConfigPtr param_config, mojo::PendingRemote<VideoEncodeAcceleratorClient> param_client, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VideoEncodeAcceleratorProxy::Initialize(
    VideoEncodeAcceleratorConfigPtr in_config, mojo::PendingRemote<VideoEncodeAcceleratorClient> in_client, InitializeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::VideoEncodeAccelerator::Initialize");
#endif
  const bool kExpectsResponse = true;
