...
class  CdmService
 ...
 public:
  ...
  virtual void CreateCdmFactory(mojo::PendingReceiver<::media::mojom::CdmFactory> factory, mojo::PendingRemote<::service_manager::mojom::InterfaceProvider> host_interfaces) = 0;
};
...
class  CdmServiceProxy
 ...
 public:
  ...
  void CreateCdmFactory(mojo::PendingReceiver<::media::mojom::CdmFactory> factory, mojo::PendingRemote<::service_manager::mojom::InterfaceProvider> host_interfaces) final;
