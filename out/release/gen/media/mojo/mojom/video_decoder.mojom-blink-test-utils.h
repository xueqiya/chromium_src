...
class BLINK_PLATFORM_EXPORT VideoDecoderInterceptorForTesting : public VideoDecoder {
  ...
  void Construct(mojo::PendingAssociatedRemote<VideoDecoderClient> client, mojo::PendingAssociatedRemote<::media::mojom::blink::MediaLog> media_log, mojo::PendingReceiver<VideoFrameHandleReleaser> video_frame_handle_releaser, mojo::ScopedDataPipeConsumerHandle decoder_buffer_pipe, CommandBufferIdPtr command_buffer_id, VideoDecoderImplementation implementation, const ::gfx::ColorSpace& target_color_space) override;
