...
inline bool IsKnownEnumValue(CdmFile_Status value) {
  return internal::CdmFile_Status_Data::IsKnownValue(
      static_cast<int32_t>(value));
}
...
template <>
struct hash<::media::mojom::CdmFile_Status>
    : public mojo::internal::EnumHashImpl<::media::mojom::CdmFile_Status> {};
...
template <>
struct EnumTraits<::media::mojom::CdmFile_Status, ::media::mojom::CdmFile_Status> {
  static ::media::mojom::CdmFile_Status ToMojom(::media::mojom::CdmFile_Status input) { return input; }
  static bool FromMojom(::media::mojom::CdmFile_Status input, ::media::mojom::CdmFile_Status* output) {
    *output = input;
    return true;
  }
};
...
template <typename MaybeConstUserType>
struct Serializer<::media::mojom::CdmFile_Status, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(static_cast<::media::mojom::CdmFile_Status>(input), output);
  }
};
