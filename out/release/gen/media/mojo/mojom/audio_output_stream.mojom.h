...
class  AudioOutputStreamProvider
 ...
 public:
  ...
  virtual void Acquire(const ::media::AudioParameters& params, mojo::PendingRemote<AudioOutputStreamProviderClient> client, const base::Optional<::base::UnguessableToken>& processing_id) = 0;
};
...
class  AudioOutputStreamProviderProxy
 ...
 public:
  ...
  void Acquire(const ::media::AudioParameters& params, mojo::PendingRemote<AudioOutputStreamProviderClient> client, const base::Optional<::base::UnguessableToken>& processing_id) final;
