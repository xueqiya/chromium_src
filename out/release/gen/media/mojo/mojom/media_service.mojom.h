...
class  MediaService
 ...
 public:
  ...
  virtual void CreateInterfaceFactory(mojo::PendingReceiver<::media::mojom::InterfaceFactory> factory, mojo::PendingRemote<::service_manager::mojom::InterfaceProvider> host_interfaces) = 0;
};
...
class  MediaServiceProxy
 ...
 public:
  ...
  void CreateInterfaceFactory(mojo::PendingReceiver<::media::mojom::InterfaceFactory> factory, mojo::PendingRemote<::service_manager::mojom::InterfaceProvider> host_interfaces) final;
