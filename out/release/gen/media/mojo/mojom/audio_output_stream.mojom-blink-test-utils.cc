// media/mojo/mojom/audio_output_stream.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void AudioOutputStreamProviderInterceptorForTesting::Acquire(const ::media::AudioParameters& params, mojo::PendingRemote<AudioOutputStreamProviderClient> client, const base::Optional<::base::UnguessableToken>& processing_id) {
