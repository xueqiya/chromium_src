...
bool VideoFrameData_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case VideoFrameData_Tag::DMABUF_DATA: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_dmabuf_data, 3, validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_dmabuf_data, validation_context))
        return false;
      return true;
    }
    case VideoFrameData_Tag::GPU_MEMORY_BUFFER_DATA: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_gpu_memory_buffer_data, 4, validation_context)) {
        return false;
      }
    ...
    case VideoFrameData_Tag::MAILBOX_DATA: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_mailbox_data, 5, validation_context)) {
        return false;
      }
...
bool AudioDecoderConfig_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->extra_data, 6, validation_context)) {
    return false;
  }
...
// static
bool DmabufVideoFrameData_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DmabufVideoFrameData_Data* object = static_cast<const DmabufVideoFrameData_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->dmabuf_fds, 1, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams dmabuf_fds_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->dmabuf_fds, validation_context,
                                         &dmabuf_fds_validate_params)) {
    return false;
  }
...
DmabufVideoFrameData_Data::DmabufVideoFrameData_Data()
    : header_({sizeof(*this), 0}) {}
...
bool GpuMemoryBufferVideoFrameData_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const GpuMemoryBufferVideoFrameData_Data* object = static_cast<const GpuMemoryBufferVideoFrameData_Data*>(data);
...
// static
bool PipelineDecoderInfo_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PipelineDecoderInfo_Data* object = static_cast<const PipelineDecoderInfo_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->decoder_name, 1, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams decoder_name_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->decoder_name, validation_context,
                                         &decoder_name_validate_params)) {
    return false;
  }
...
PipelineDecoderInfo_Data::PipelineDecoderInfo_Data()
    : header_({sizeof(*this), 0}) {}
