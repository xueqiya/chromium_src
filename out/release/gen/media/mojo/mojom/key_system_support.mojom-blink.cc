...
KeySystemCapability::KeySystemCapability(
    WTF::Vector<::media::mojom::blink::VideoCodec> video_codecs_in,
    bool supports_vp9_profile2_in,
    WTF::Vector<::media::mojom::blink::EncryptionScheme> encryption_schemes_in,
    WTF::Vector<::media::mojom::blink::VideoCodec> hw_secure_video_codecs_in,
    WTF::Vector<::media::mojom::blink::EncryptionScheme> hw_secure_encryption_schemes_in,
    WTF::Vector<::media::mojom::blink::CdmSessionType> session_types_in)
...
bool KeySystemSupportStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kKeySystemSupport_IsKeySystemSupported_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)media::mojom::KeySystemSupport::IsKeySystemSupported",
          "message", message->name());
#endif
...
static const mojo::internal::GenericValidationInfo kKeySystemSupportValidationInfo[] = {
    {&internal::KeySystemSupport_IsKeySystemSupported_Params_Data::Validate,
     &internal::KeySystemSupport_IsKeySystemSupported_ResponseParams_Data::Validate},
};
...
bool KeySystemSupportResponseValidator::Accept(mojo::Message* message) {
  const char* name = ::media::mojom::blink::KeySystemSupport::Name_;
  return mojo::internal::ValidateResponseGenericPacked(message, name, kKeySystemSupportValidationInfo);
}
}  // namespace blink
}  // namespace mojom
}  // namespace media
...
bool StructTraits<::media::mojom::blink::KeySystemCapability::DataView, ::media::mojom::blink::KeySystemCapabilityPtr>::Read(
  ...
  ::media::mojom::blink::KeySystemCapabilityPtr result(::media::mojom::blink::KeySystemCapability::New());
      ...
      if (success && !input.ReadEncryptionSchemes(&result->encryption_schemes))
        success = false;
      if (success && !input.ReadHwSecureVideoCodecs(&result->hw_secure_video_codecs))
        success = false;
      if (success && !input.ReadHwSecureEncryptionSchemes(&result->hw_secure_encryption_schemes))
        success = false;
