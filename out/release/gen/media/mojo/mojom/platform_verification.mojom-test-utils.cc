// media/mojo/mojom/platform_verification.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "media/mojo/mojom/platform_verification.mojom-test-utils.h"
