...
void InterfaceFactoryProxy::CreateAudioDecoder(
    mojo::PendingReceiver<::media::mojom::blink::AudioDecoder> in_audio_decoder) {
...
void InterfaceFactoryProxy::CreateVideoDecoder(
    mojo::PendingReceiver<::media::mojom::blink::VideoDecoder> in_video_decoder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateDefaultRenderer(
    const WTF::String& in_audio_device_id, mojo::PendingReceiver<::media::mojom::blink::Renderer> in_renderer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateMediaPlayerRenderer(
    mojo::PendingRemote<::media::mojom::blink::MediaPlayerRendererClientExtension> in_client_extension, mojo::PendingReceiver<::media::mojom::blink::Renderer> in_renderer, mojo::PendingReceiver<::media::mojom::blink::MediaPlayerRendererExtension> in_renderer_extension) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateFlingingRenderer(
    const WTF::String& in_presentation_id, mojo::PendingRemote<::media::mojom::blink::FlingingRendererClientExtension> in_client_extension, mojo::PendingReceiver<::media::mojom::blink::Renderer> in_renderer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateCdm(
    const WTF::String& in_key_system, mojo::PendingReceiver<::media::mojom::blink::ContentDecryptionModule> in_cdm) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateDecryptor(
    int32_t in_cdm_id, mojo::PendingReceiver<::media::mojom::blink::Decryptor> in_decryptor) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_renderer));
    ...
    case internal::kInterfaceFactory_CreateMediaPlayerRenderer_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingRemote<::media::mojom::blink::MediaPlayerRendererClientExtension> p_client_extension{};
      mojo::PendingReceiver<::media::mojom::blink::Renderer> p_renderer{};
      mojo::PendingReceiver<::media::mojom::blink::MediaPlayerRendererExtension> p_renderer_extension{};
...
std::move(p_renderer_extension));
    ...
    case internal::kInterfaceFactory_CreateFlingingRenderer_Name: {
      ...
      mojo::PendingRemote<::media::mojom::blink::FlingingRendererClientExtension> p_client_extension{};
      mojo::PendingReceiver<::media::mojom::blink::Renderer> p_renderer{};
...
std::move(p_renderer));
    ...
    case internal::kInterfaceFactory_CreateCdm_Name: {
      ...
      mojo::PendingReceiver<::media::mojom::blink::ContentDecryptionModule> p_cdm{};
...
std::move(p_cdm));
    ...
    case internal::kInterfaceFactory_CreateDecryptor_Name: {
      ...
      bool success = true;
      int32_t p_cdm_id{};
      mojo::PendingReceiver<::media::mojom::blink::Decryptor> p_decryptor{};
