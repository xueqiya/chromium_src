// media/mojo/mojom/platform_verification.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "media/mojo/mojom/platform_verification.mojom-blink.h"
...
#include "media/mojo/mojom/platform_verification.mojom-blink-import-headers.h"
#include "mojo/public/cpp/bindings/lib/wtf_serialization.h"


#ifndef MEDIA_MOJO_MOJOM_PLATFORM_VERIFICATION_MOJOM_BLINK_JUMBO_H_
#define MEDIA_MOJO_MOJOM_PLATFORM_VERIFICATION_MOJOM_BLINK_JUMBO_H_
#endif
namespace media {
namespace mojom {
namespace blink {
...
static const mojo::internal::GenericValidationInfo kPlatformVerificationValidationInfo[] = {
...
bool PlatformVerificationRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::media::mojom::blink::PlatformVerification::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kPlatformVerificationValidationInfo);
}

bool PlatformVerificationResponseValidator::Accept(mojo::Message* message) {
  const char* name = ::media::mojom::blink::PlatformVerification::Name_;
  return mojo::internal::ValidateResponseGenericPacked(message, name, kPlatformVerificationValidationInfo);
}
}  // namespace blink
}  // namespace mojom
}  // namespace media
