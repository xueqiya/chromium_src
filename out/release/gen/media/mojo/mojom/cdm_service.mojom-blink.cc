...
void CdmServiceProxy::CreateCdmFactory(
    mojo::PendingReceiver<::media::mojom::blink::CdmFactory> in_factory, mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> in_host_interfaces) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
      "invalid host_interfaces in CdmService.CreateCdmFactory request");
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
...
std::move(p_cdm_path));
    ...
    case internal::kCdmService_CreateCdmFactory_Name: {
      ...
      mojo::PendingRemote<::service_manager::mojom::blink::InterfaceProvider> p_host_interfaces{};
