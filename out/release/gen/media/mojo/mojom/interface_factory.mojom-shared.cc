...
// static
bool InterfaceFactory_CreateMediaPlayerRenderer_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const InterfaceFactory_CreateMediaPlayerRenderer_Params_Data* object = static_cast<const InterfaceFactory_CreateMediaPlayerRenderer_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->client_extension, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->client_extension,
                                                 validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->renderer_extension, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->renderer_extension,
                                                 validation_context)) {
    return false;
  }
...
InterfaceFactory_CreateMediaPlayerRenderer_Params_Data::InterfaceFactory_CreateMediaPlayerRenderer_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool InterfaceFactory_CreateFlingingRenderer_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const InterfaceFactory_CreateFlingingRenderer_Params_Data* object = static_cast<const InterfaceFactory_CreateFlingingRenderer_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->presentation_id, 1, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->client_extension, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->client_extension,
                                                 validation_context)) {
...
InterfaceFactory_CreateFlingingRenderer_Params_Data::InterfaceFactory_CreateFlingingRenderer_Params_Data()
    : header_({sizeof(*this), 0}) {}
