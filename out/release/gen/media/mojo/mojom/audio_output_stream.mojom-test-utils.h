...
class  AudioOutputStreamProviderInterceptorForTesting : public AudioOutputStreamProvider {
  ...
  void Acquire(const ::media::AudioParameters& params, mojo::PendingRemote<AudioOutputStreamProviderClient> client, const base::Optional<::base::UnguessableToken>& processing_id) override;
};
