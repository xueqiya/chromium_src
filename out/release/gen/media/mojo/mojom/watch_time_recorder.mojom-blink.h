...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.video_codec_profile < lhs.video_codec_profile)
    return false;
  if (lhs.audio_decoder_name < rhs.audio_decoder_name)
    return true;
  if (rhs.audio_decoder_name < lhs.audio_decoder_name)
    return false;
  if (lhs.video_decoder_name < rhs.video_decoder_name)
    return true;
  if (rhs.video_decoder_name < lhs.video_decoder_name)
    return false;
