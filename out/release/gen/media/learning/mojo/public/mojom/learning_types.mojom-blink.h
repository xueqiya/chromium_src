...
class  LabelledExample {
 public:
  ...
  LabelledExample(
      WTF::Vector<FeatureValuePtr> features,
      TargetValuePtr target_value);
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(LabelledExample);
};
...
class  ObservationCompletion {
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(ObservationCompletion);
};
...
class  TargetHistogram {
 public:
  ...
  explicit TargetHistogram(
      WTF::HashMap<TargetValuePtr, double> counts);
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(TargetHistogram);
};
...
bool TargetHistogram::Equals(const T& other_struct) const {
  if (!mojo::Equals(this->counts, other_struct.counts))
    return false;
  return true;
}
...
template <>
struct  StructTraits<::media::learning::mojom::blink::FeatureValue::DataView,
...
template <>
struct  StructTraits<::media::learning::mojom::blink::TargetValue::DataView,
...
template <>
struct  StructTraits<::media::learning::mojom::blink::LabelledExample::DataView,
...
template <>
struct  StructTraits<::media::learning::mojom::blink::ObservationCompletion::DataView,
...
template <>
struct  StructTraits<::media::learning::mojom::blink::TargetHistogram::DataView,
  ...
  static const decltype(::media::learning::mojom::blink::TargetHistogram::counts)& counts(
