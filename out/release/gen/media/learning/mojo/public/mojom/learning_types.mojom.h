...
class  TargetHistogram {
 public:
  ...
  explicit TargetHistogram(
      const base::flat_map<::media::learning::TargetValue, double>& counts);
  ...
  base::flat_map<::media::learning::TargetValue, double> counts;
...
struct  StructTraits<::media::learning::mojom::TargetHistogram::DataView,
  ...
  static const decltype(::media::learning::mojom::TargetHistogram::counts)& counts(
