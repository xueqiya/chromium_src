...
void LearningTaskControllerProxy::BeginObservation(
    const ::base::UnguessableToken& in_id, WTF::Vector<::media::learning::mojom::blink::FeatureValuePtr> in_features, ::media::learning::mojom::blink::TargetValuePtr in_default_target) {
...
void LearningTaskControllerProxy::CompleteObservation(
    const ::base::UnguessableToken& in_id, ::media::learning::mojom::blink::ObservationCompletionPtr in_completion) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LearningTaskControllerProxy::UpdateDefaultTarget(
    const ::base::UnguessableToken& in_id, ::media::learning::mojom::blink::TargetValuePtr in_default_target) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LearningTaskControllerProxy::PredictDistribution(
    WTF::Vector<::media::learning::mojom::blink::FeatureValuePtr> in_features, PredictDistributionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class LearningTaskController_PredictDistribution_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::media::learning::mojom::blink::TargetHistogramPtr in_predicted);
...
bool LearningTaskController_PredictDistribution_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::media::learning::mojom::blink::TargetHistogramPtr p_predicted{};
...
bool LearningTaskControllerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kLearningTaskController_BeginObservation_Name: {
      ...
      WTF::Vector<::media::learning::mojom::blink::FeatureValuePtr> p_features{};
      ::media::learning::mojom::blink::TargetValuePtr p_default_target{};
...
std::move(p_default_target));
    ...
    case internal::kLearningTaskController_CompleteObservation_Name: {
      ...
      bool success = true;
      ::base::UnguessableToken p_id{};
      ::media::learning::mojom::blink::ObservationCompletionPtr p_completion{};
