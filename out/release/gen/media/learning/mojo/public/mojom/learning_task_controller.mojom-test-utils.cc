...
void LearningTaskControllerInterceptorForTesting::BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features, const base::Optional<::media::learning::TargetValue>& default_target) {
...
void LearningTaskControllerAsyncWaiter::PredictDistribution(
    const std::vector<::media::learning::FeatureValue>& features, base::Optional<::media::learning::TargetHistogram>* out_predicted) {
  base::RunLoop loop;
