...
class PhotoStateDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPan(UserType* output) {
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadTilt(UserType* output) {
...
struct Serializer<::media::mojom::PhotoStateDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    typename decltype((*output)->pan)::BaseType::BufferWriter
        pan_writer;
    mojo::internal::Serialize<::media::mojom::RangeDataView>(
        in_pan, buffer, &pan_writer, context);
    (*output)->pan.Set(
        pan_writer.is_null() ? nullptr : pan_writer.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        (*output)->pan.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        "null pan in PhotoState struct");
    decltype(Traits::tilt(input)) in_tilt = Traits::tilt(input);
    typename decltype((*output)->tilt)::BaseType::BufferWriter
        tilt_writer;
    mojo::internal::Serialize<::media::mojom::RangeDataView>(
        in_tilt, buffer, &tilt_writer, context);
    (*output)->tilt.Set(
        tilt_writer.is_null() ? nullptr : tilt_writer.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        (*output)->tilt.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
...
struct Serializer<::media::mojom::PhotoSettingsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->has_pan = Traits::has_pan(input);
    (*output)->pan = Traits::pan(input);
    (*output)->has_tilt = Traits::has_tilt(input);
    (*output)->tilt = Traits::tilt(input);
