...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<28> scc_info_EventStream_rtc_5fevent_5flog2_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 28, InitDefaultsscc_info_EventStream_rtc_5fevent_5flog2_2eproto}, {
