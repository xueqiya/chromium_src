...
class FetchAPIRequest :
 ...
 public:
  ...
  enum : int {
    ...
    kModeFieldNumber = 6,
    kRequestContextTypeFieldNumber = 8,
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 request_context_type() const;
  void set_request_context_type(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 request_context_type_;
...
// optional int32 request_context_type = 8;
inline bool FetchAPIRequest::has_request_context_type() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void FetchAPIRequest::clear_request_context_type() {
  request_context_type_ = 0;
  _has_bits_[0] &= ~0x00000020u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 FetchAPIRequest::request_context_type() const {
  // @@protoc_insertion_point(field_get:content.proto.internal.FetchAPIRequest.request_context_type)
  return request_context_type_;
}
inline void FetchAPIRequest::set_request_context_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000020u;
  request_context_type_ = value;
  // @@protoc_insertion_point(field_set:content.proto.internal.FetchAPIRequest.request_context_type)
}
