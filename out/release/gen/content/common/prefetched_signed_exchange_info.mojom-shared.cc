// content/common/prefetched_signed_exchange_info.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool PrefetchedSignedExchangeInfo_Data::Validate(
  ...
  const PrefetchedSignedExchangeInfo_Data* object = static_cast<const PrefetchedSignedExchangeInfo_Data*>(data);
