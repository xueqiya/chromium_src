// content/common/render_frame_metadata.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool RenderFrameMetadata_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->scrollable_viewport_size, 21, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->root_layer_size, 22, validation_context)) {
    return false;
  }
...
// static
bool RenderFrameMetadataObserver_ReportAllRootScrollsForAccessibility_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RenderFrameMetadataObserver_ReportAllRootScrollsForAccessibility_Params_Data* object = static_cast<const RenderFrameMetadataObserver_ReportAllRootScrollsForAccessibility_Params_Data*>(data);
...
RenderFrameMetadataObserver_ReportAllRootScrollsForAccessibility_Params_Data::RenderFrameMetadataObserver_ReportAllRootScrollsForAccessibility_Params_Data()
    : header_({sizeof(*this), 0}) {}
