...
class CONTENT_EXPORT BlockedSetCookieWithReason : public Serializable{
...
class CONTENT_EXPORT BlockedCookieWithReason : public Serializable{
...
class CONTENT_EXPORT RequestWillBeSentExtraInfoNotification : public Serializable{
...
class CONTENT_EXPORT ResponseReceivedExtraInfoNotification : public Serializable{
...
public:
    ...
    virtual void SetCookie(const String& in_name, const String& in_value, Maybe<String> in_url, Maybe<String> in_domain, Maybe<String> in_path, Maybe<bool> in_secure, Maybe<bool> in_httpOnly, Maybe<String> in_sameSite, Maybe<double> in_expires, Maybe<String> in_priority, std::unique_ptr<SetCookieCallback> callback) = 0;
