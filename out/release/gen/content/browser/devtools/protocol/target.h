...
public:
    ...
    virtual void SetAutoAttach(bool in_autoAttach, bool in_waitForDebuggerOnStart, Maybe<bool> in_flatten, Maybe<bool> in_windowOpen, std::unique_ptr<SetAutoAttachCallback> callback) = 0;
