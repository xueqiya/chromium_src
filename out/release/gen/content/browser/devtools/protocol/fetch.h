...
public:
    ...
    virtual void FulfillRequest(const String& in_requestId, int in_responseCode, Maybe<protocol::Array<protocol::Fetch::HeaderEntry>> in_responseHeaders, Maybe<Binary> in_binaryResponseHeaders, Maybe<Binary> in_body, Maybe<String> in_responsePhrase, std::unique_ptr<FulfillRequestCallback> callback) = 0;
