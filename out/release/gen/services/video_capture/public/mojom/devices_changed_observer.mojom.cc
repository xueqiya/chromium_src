...
void DevicesChangedObserverProxy::OnDevicesChanged(
  ...
  TRACE_EVENT0("mojom", "video_capture::mojom::DevicesChangedObserver::OnDevicesChanged");
#endif
  ...
  ::video_capture::mojom::internal::DevicesChangedObserver_OnDevicesChanged_Params_Data::BufferWriter
      params;
...
bool DevicesChangedObserverStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kDevicesChangedObserver_OnDevicesChanged_Name: {
      ...
      bool success = true;
      DevicesChangedObserver_OnDevicesChanged_ParamsDataView input_data_view(params, &serialization_context);
