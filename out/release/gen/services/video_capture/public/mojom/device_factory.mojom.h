// services/video_capture/public/mojom/device_factory.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  DeviceFactory
 ...
 public:
  ...
  using Base_ = DeviceFactoryInterfaceBase;
  ...
  virtual void CreateDevice(const std::string& device_id, mojo::PendingReceiver<::video_capture::mojom::Device> device_receiver, CreateDeviceCallback callback) = 0;
...
class  DeviceFactoryProxy
 ...
 public:
  using InterfaceType = DeviceFactory;
  ...
  void CreateDevice(const std::string& device_id, mojo::PendingReceiver<::video_capture::mojom::Device> device_receiver, CreateDeviceCallback callback) final;
