  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(VideoCaptureService_ConnectToDeviceFactory_Params_Data));
      new (data()) VideoCaptureService_ConnectToDeviceFactory_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    VideoCaptureService_ConnectToDeviceFactory_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<VideoCaptureService_ConnectToDeviceFactory_Params_Data>(index_);
    }
    VideoCaptureService_ConnectToDeviceFactory_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(VideoCaptureService_ConnectToVideoSourceProvider_Params_Data));
      new (data()) VideoCaptureService_ConnectToVideoSourceProvider_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    VideoCaptureService_ConnectToVideoSourceProvider_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<VideoCaptureService_ConnectToVideoSourceProvider_Params_Data>(index_);
    }
    VideoCaptureService_ConnectToVideoSourceProvider_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(VideoCaptureService_SetRetryCount_Params_Data));
      new (data()) VideoCaptureService_SetRetryCount_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    VideoCaptureService_SetRetryCount_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<VideoCaptureService_SetRetryCount_Params_Data>(index_);
    }
    VideoCaptureService_SetRetryCount_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(VideoCaptureService_BindControlsForTesting_Params_Data));
      new (data()) VideoCaptureService_BindControlsForTesting_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    VideoCaptureService_BindControlsForTesting_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<VideoCaptureService_BindControlsForTesting_Params_Data>(index_);
    }
    VideoCaptureService_BindControlsForTesting_Params_Data* operator->() { return data(); }
