...
void CoordinatorProxy::RequestGlobalMemoryDump(
    DumpType in_dump_type, LevelOfDetail in_level_of_detail, Determinism in_determinsm, const WTF::Vector<WTF::String>& in_allocator_dump_names, RequestGlobalMemoryDumpCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CoordinatorControllerProxy::RegisterClientProcess(
    mojo::PendingReceiver<Coordinator> in_receiver, mojo::PendingRemote<ClientProcess> in_client_process, ProcessType in_process_type, ::mojo_base::mojom::blink::ProcessIdPtr in_process_id, const WTF::String& in_service_name) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CoordinatorControllerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kCoordinatorController_RegisterClientProcess_Name: {
      ...
      ::mojo_base::mojom::blink::ProcessIdPtr p_process_id{};
...
bool CoordinatorControllerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::memory_instrumentation::mojom::blink::CoordinatorController::Name_;
