...
template <>
struct DefaultHash<::memory_instrumentation::mojom::Determinism> {
  using Hash = memory_instrumentation_mojom_internal_Determinism_DataHashFn;
};
}  // namespace WTF
...
using Determinism = Determinism;  // Alias for definition in the parent namespace.
