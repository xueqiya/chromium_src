...
std::ostream& operator<<(std::ostream& os, Determinism value) {
  switch(value) {
    case Determinism::NONE:
      return os << "Determinism::NONE";
    case Determinism::FORCE_GC:
      return os << "Determinism::FORCE_GC";
    default:
      return os << "Unknown Determinism value: " << static_cast<int32_t>(value);
  }
}
...
bool Coordinator_RequestGlobalMemoryDump_Params_Data::Validate(
  ...
  if (!::memory_instrumentation::mojom::internal::Determinism_Data
        ::Validate(object->determinsm, validation_context))
    return false;
...
bool CoordinatorConnector_RegisterCoordinatorClient_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const CoordinatorConnector_RegisterCoordinatorClient_Params_Data* object = static_cast<const CoordinatorConnector_RegisterCoordinatorClient_Params_Data*>(data);
...
// static
bool CoordinatorController_RegisterClientProcess_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const CoordinatorController_RegisterClientProcess_Params_Data* object = static_cast<const CoordinatorController_RegisterClientProcess_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->process_id, 4, validation_context)) {
    return false;
  }
...
CoordinatorController_RegisterClientProcess_Params_Data::CoordinatorController_RegisterClientProcess_Params_Data()
    : header_({sizeof(*this), 0}) {}
