// services/resource_coordinator/public/mojom/memory_instrumentation/memory_instrumentation.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CoordinatorInterceptorForTesting::RequestGlobalMemoryDump(DumpType dump_type, LevelOfDetail level_of_detail, Determinism determinsm, const WTF::Vector<WTF::String>& allocator_dump_names, RequestGlobalMemoryDumpCallback callback) {
...
void CoordinatorControllerInterceptorForTesting::RegisterClientProcess(mojo::PendingReceiver<Coordinator> receiver, mojo::PendingRemote<ClientProcess> client_process, ProcessType process_type, ::mojo_base::mojom::blink::ProcessIdPtr process_id, const WTF::String& service_name) {
