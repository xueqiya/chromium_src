...
ProcessMemoryDump::ProcessMemoryDump(
    ...
    const base::Optional<std::string>& service_name_in)
...
void CoordinatorProxy::RequestGlobalMemoryDump(
    ::base::trace_event::MemoryDumpType in_dump_type, ::base::trace_event::MemoryDumpLevelOfDetail in_level_of_detail, ::base::trace_event::MemoryDumpDeterminism in_determinsm, const std::vector<std::string>& in_allocator_dump_names, RequestGlobalMemoryDumpCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  mojo::internal::Serialize<::memory_instrumentation::mojom::Determinism>(
      in_determinsm, &params->determinsm);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RequestPrivateMemoryFootprint");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool Coordinator_RequestPrivateMemoryFootprint_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::Coordinator::RequestPrivateMemoryFootprintCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestPrivateMemoryFootprintCallback",
               "message", message.name());
#endif
...
bool CoordinatorStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kCoordinator_RequestGlobalMemoryDump_Name: {
      ...
      ::base::trace_event::MemoryDumpDeterminism p_determinsm{};
      ...
      if (success && !input_data_view.ReadLevelOfDetail(&p_level_of_detail))
        success = false;
      if (success && !input_data_view.ReadDeterminsm(&p_determinsm))
        success = false;
...
void CoordinatorConnectorProxy::RegisterCoordinatorClient(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::CoordinatorConnector::RegisterCoordinatorClient");
#endif
  ...
  auto* buffer = message.payload_buffer();
  ::memory_instrumentation::mojom::internal::CoordinatorConnector_RegisterCoordinatorClient_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
bool CoordinatorConnectorStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kCoordinatorConnector_RegisterCoordinatorClient_Name: {
      ...
      CoordinatorConnector_RegisterCoordinatorClient_ParamsDataView input_data_view(params, &serialization_context);
...
const char CoordinatorController::Name_[] = "memory_instrumentation.mojom.CoordinatorController";

CoordinatorControllerProxy::CoordinatorControllerProxy(mojo::MessageReceiverWithResponder* receiver)
    : receiver_(receiver) {
}

void CoordinatorControllerProxy::RegisterClientProcess(
    mojo::PendingReceiver<Coordinator> in_receiver, mojo::PendingRemote<ClientProcess> in_client_process, ProcessType in_process_type, ::base::ProcessId in_process_id, const base::Optional<std::string>& in_service_name) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::CoordinatorController::RegisterClientProcess");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kCoordinatorController_RegisterClientProcess_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::memory_instrumentation::mojom::internal::CoordinatorController_RegisterClientProcess_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  mojo::internal::Serialize<mojo::InterfaceRequestDataView<::memory_instrumentation::mojom::CoordinatorInterfaceBase>>(
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      !mojo::internal::IsHandleOrInterfaceValid(params->receiver),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
      "invalid receiver in CoordinatorController.RegisterClientProcess request");
  mojo::internal::Serialize<mojo::InterfacePtrDataView<::memory_instrumentation::mojom::ClientProcessInterfaceBase>>(
      in_client_process, &params->client_process, &serialization_context);
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      !mojo::internal::IsHandleOrInterfaceValid(params->client_process),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
      "invalid client_process in CoordinatorController.RegisterClientProcess request");
  mojo::internal::Serialize<::memory_instrumentation::mojom::ProcessType>(
      in_process_type, &params->process_type);
  typename decltype(params->process_id)::BaseType::BufferWriter
      process_id_writer;
  mojo::internal::Serialize<::mojo_base::mojom::ProcessIdDataView>(
      in_process_id, buffer, &process_id_writer, &serialization_context);
  params->process_id.Set(
      process_id_writer.is_null() ? nullptr : process_id_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->process_id.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null process_id in CoordinatorController.RegisterClientProcess request");
...
#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(CoordinatorController::Name_);
...
// static
bool CoordinatorControllerStubDispatch::Accept(
    CoordinatorController* impl,
    mojo::Message* message) {
  switch (message->header()->name) {
    case internal::kCoordinatorController_RegisterClientProcess_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      TRACE_EVENT1(
          "mojom",
          "(Impl)memory_instrumentation::mojom::CoordinatorController::RegisterClientProcess",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)memory_instrumentation::mojom::CoordinatorController::RegisterClientProcess");
      ...
      DCHECK(message->is_serialized());
      internal::CoordinatorController_RegisterClientProcess_Params_Data* params =
          reinterpret_cast<internal::CoordinatorController_RegisterClientProcess_Params_Data*>(
              message->mutable_payload());
      ...
      ::base::ProcessId p_process_id{};
      base::Optional<std::string> p_service_name{};
      CoordinatorController_RegisterClientProcess_ParamsDataView input_data_view(params, &serialization_context);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            CoordinatorController::Name_, 0, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
...
// static
bool CoordinatorControllerStubDispatch::AcceptWithResponder(
    CoordinatorController* impl,
    mojo::Message* message,
    std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
  switch (message->header()->name) {
...
static const mojo::internal::GenericValidationInfo kCoordinatorControllerValidationInfo[] = {
    {&internal::CoordinatorController_RegisterClientProcess_Params_Data::Validate,
     nullptr /* no response */},
};

bool CoordinatorControllerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::memory_instrumentation::mojom::CoordinatorController::Name_;
  return mojo::internal::ValidateRequestGenericPacked(message, name, kCoordinatorControllerValidationInfo);
}
