...
namespace WTF {
struct memory_instrumentation_mojom_internal_Determinism_DataHashFn {
  static unsigned GetHash(const ::memory_instrumentation::mojom::Determinism& value) {
    using utype = std::underlying_type<::memory_instrumentation::mojom::Determinism>::type;
    return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
  }
  static bool Equal(const ::memory_instrumentation::mojom::Determinism& left, const ::memory_instrumentation::mojom::Determinism& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::memory_instrumentation::mojom::Determinism>
    : public GenericHashTraits<::memory_instrumentation::mojom::Determinism> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::memory_instrumentation::mojom::Determinism& value) {
    return value == static_cast<::memory_instrumentation::mojom::Determinism>(-1000000);
  }
  static void ConstructDeletedValue(::memory_instrumentation::mojom::Determinism& slot, bool) {
    slot = static_cast<::memory_instrumentation::mojom::Determinism>(-1000001);
  }
  static bool IsDeletedValue(const ::memory_instrumentation::mojom::Determinism& value) {
    return value == static_cast<::memory_instrumentation::mojom::Determinism>(-1000001);
  }
};
}  // namespace WTF
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) Coordinator
 ...
 public:
  ...
  virtual void RequestGlobalMemoryDump(DumpType dump_type, LevelOfDetail level_of_detail, Determinism determinsm, const WTF::Vector<WTF::String>& allocator_dump_names, RequestGlobalMemoryDumpCallback callback) = 0;
  ...
  virtual void RequestGlobalMemoryDumpAndAppendToTrace(DumpType dump_type, LevelOfDetail level_of_detail, Determinism determinism, RequestGlobalMemoryDumpAndAppendToTraceCallback callback) = 0;
};
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinatorController
 ...
 public:
  ...
  virtual void RegisterClientProcess(mojo::PendingReceiver<Coordinator> receiver, mojo::PendingRemote<ClientProcess> client_process, ProcessType process_type, ::mojo_base::mojom::blink::ProcessIdPtr process_id, const WTF::String& service_name) = 0;
};
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinatorProxy
 ...
 public:
  ...
  void RequestGlobalMemoryDump(DumpType dump_type, LevelOfDetail level_of_detail, Determinism determinsm, const WTF::Vector<WTF::String>& allocator_dump_names, RequestGlobalMemoryDumpCallback callback) final;
  ...
  void RequestGlobalMemoryDumpAndAppendToTrace(DumpType dump_type, LevelOfDetail level_of_detail, Determinism determinism, RequestGlobalMemoryDumpAndAppendToTraceCallback callback) final;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinatorControllerProxy
 ...
 public:
  ...
  void RegisterClientProcess(mojo::PendingReceiver<Coordinator> receiver, mojo::PendingRemote<ClientProcess> client_process, ProcessType process_type, ::mojo_base::mojom::blink::ProcessIdPtr process_id, const WTF::String& service_name) final;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinatorControllerStubDispatch {
 public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinatorControllerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
