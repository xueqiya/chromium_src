...
class AdFrameLoad final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kLoading_CacheBytesName[];
  static constexpr uint64_t kLoading_CacheBytesNameHash = UINT64_C(3625162449246346137);
  AdFrameLoad& SetLoading_CacheBytes(int64_t value);
...
class Blink_PageLoad final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  Blink_PageLoad& SetProxyCommit(int64_t value);
  ...
  Blink_PageLoad& SetStyleAndLayout(int64_t value);
...
class DetachedWindows_Experimental final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  explicit DetachedWindows_Experimental(ukm::SourceId source_id);
  explicit DetachedWindows_Experimental(base::UkmSourceId source_id);
  ~DetachedWindows_Experimental() override;

  static const char kEntryName[];
  static constexpr uint64_t kEntryNameHash = UINT64_C(3046056935164988903);
  ...
  DetachedWindows_Experimental& SetNavigationSourceId(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByClosingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosingNameHash = UINT64_C(3469103663685255145);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByClosing(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByClosing_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosing_After10sSinceDetachingNameHash = UINT64_C(833622309968576671);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByClosing_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByClosing_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosing_After1minSinceDetachingNameHash = UINT64_C(492073542413652759);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByClosing_After1minSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigationName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigationNameHash = UINT64_C(14735133671491329494);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByNavigation(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetachingNameHash = UINT64_C(17158779201740571864);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetachingNameHash = UINT64_C(1122679608792506289);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReasonName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReasonNameHash = UINT64_C(17025082506642825117);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetachingNameHash = UINT64_C(18234129363408864339);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetachingNameHash = UINT64_C(13443559868265382820);
  DetachedWindows_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetaching(int64_t value);
...
class Graphics_Smoothness_Latency final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kSubmitCompositorFrameToPresentationCompositorFrame_StartDrawToSwapEndName[];
  static constexpr uint64_t kSubmitCompositorFrameToPresentationCompositorFrame_StartDrawToSwapEndNameHash = UINT64_C(11886829800656394032);
  Graphics_Smoothness_Latency& SetSubmitCompositorFrameToPresentationCompositorFrame_StartDrawToSwapEnd(int64_t value);
...
class Graphics_Smoothness_Throughput final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  explicit Graphics_Smoothness_Throughput(ukm::SourceId source_id);
  explicit Graphics_Smoothness_Throughput(base::UkmSourceId source_id);
  ~Graphics_Smoothness_Throughput() override;

  static const char kEntryName[];
  static constexpr uint64_t kEntryNameHash = UINT64_C(5216328806701863176);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_CompositorAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_MainThreadAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_PinchZoom(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_RAF(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_TouchScroll(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_Universal(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_Video(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetCompositorThread_WheelScroll(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_CompositorAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_MainThreadAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_PinchZoom(int64_t value);

  static const char kMainThread_RAFName[];
  static constexpr uint64_t kMainThread_RAFNameHash = UINT64_C(6083877763173548455);
  Graphics_Smoothness_Throughput& SetMainThread_RAF(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_TouchScroll(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_Universal(int64_t value);

  static const char kMainThread_VideoName[];
  static constexpr uint64_t kMainThread_VideoNameHash = UINT64_C(4791323324276332364);
  Graphics_Smoothness_Throughput& SetMainThread_Video(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetMainThread_WheelScroll(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_CompositorAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_MainThreadAnimation(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_PinchZoom(int64_t value);

  static const char kSlowerThread_RAFName[];
  static constexpr uint64_t kSlowerThread_RAFNameHash = UINT64_C(10470149913463790153);
  Graphics_Smoothness_Throughput& SetSlowerThread_RAF(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_TouchScroll(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_Universal(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_Video(int64_t value);
  ...
  Graphics_Smoothness_Throughput& SetSlowerThread_WheelScroll(int64_t value);
...
class Memory_Experimental final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kNumberOfCallsInDetachedWindowByClosingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosingNameHash = UINT64_C(3469103663685255145);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByClosing(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByClosing_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosing_After10sSinceDetachingNameHash = UINT64_C(833622309968576671);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByClosing_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByClosing_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByClosing_After1minSinceDetachingNameHash = UINT64_C(492073542413652759);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByClosing_After1minSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigationName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigationNameHash = UINT64_C(14735133671491329494);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByNavigation(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetachingNameHash = UINT64_C(17158779201740571864);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByNavigation_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetachingNameHash = UINT64_C(1122679608792506289);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByNavigation_After1minSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReasonName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReasonNameHash = UINT64_C(17025082506642825117);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetachingNameHash = UINT64_C(18234129363408864339);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason_After10sSinceDetaching(int64_t value);

  static const char kNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetachingName[];
  static constexpr uint64_t kNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetachingNameHash = UINT64_C(13443559868265382820);
  Memory_Experimental& SetNumberOfCallsInDetachedWindowByOtherReason_After1minSinceDetaching(int64_t value);
...
class OptimizationGuide final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kHintGenerationTimestampName[];
  static constexpr uint64_t kHintGenerationTimestampNameHash = UINT64_C(16849610484315018691);
  OptimizationGuide& SetHintGenerationTimestamp(int64_t value);

  static const char kHintSourceName[];
  static constexpr uint64_t kHintSourceNameHash = UINT64_C(12943760743307125723);
  OptimizationGuide& SetHintSource(int64_t value);

  static const char kNavigationHostCoveredName[];
  static constexpr uint64_t kNavigationHostCoveredNameHash = UINT64_C(230690170121802363);
  OptimizationGuide& SetNavigationHostCovered(int64_t value);
...
class PageLoad final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kLayoutStability_JankScore_MainFrame_BeforeInputOrScrollName[];
  static constexpr uint64_t kLayoutStability_JankScore_MainFrame_BeforeInputOrScrollNameHash = UINT64_C(5304313775773086794);
  PageLoad& SetLayoutStability_JankScore_MainFrame_BeforeInputOrScroll(int64_t value);
...
class SameSiteDifferentSchemeRequest final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kSameSiteContextWithSchemesName[];
  static constexpr uint64_t kSameSiteContextWithSchemesNameHash = UINT64_C(2948241824342055797);
  SameSiteDifferentSchemeRequest& SetSameSiteContextWithSchemes(int64_t value);
...
class SameSiteDifferentSchemeResponse final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kSameSiteContextWithSchemesName[];
  static constexpr uint64_t kSameSiteContextWithSchemesNameHash = UINT64_C(2948241824342055797);
  SameSiteDifferentSchemeResponse& SetSameSiteContextWithSchemes(int64_t value);
...
class XR_WebXR_Session final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kIsLegacyWebVRName[];
  static constexpr uint64_t kIsLegacyWebVRNameHash = UINT64_C(4518029700062447293);
  XR_WebXR_Session& SetIsLegacyWebVR(int64_t value);
