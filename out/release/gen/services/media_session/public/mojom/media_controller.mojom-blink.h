...
class BLINK_PLATFORM_EXPORT MediaController
 ...
 public:
  ...
  virtual void ObserveImages(::media_session::mojom::blink::MediaSessionImageType type, int32_t minimum_size_px, int32_t desired_size_px, mojo::PendingRemote<MediaControllerImageObserver> observer) = 0;
...
class BLINK_PLATFORM_EXPORT MediaControllerProxy
 ...
 public:
  ...
  void ObserveImages(::media_session::mojom::blink::MediaSessionImageType type, int32_t minimum_size_px, int32_t desired_size_px, mojo::PendingRemote<MediaControllerImageObserver> observer) final;
