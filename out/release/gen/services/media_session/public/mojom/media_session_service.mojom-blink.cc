// services/media_session/public/mojom/media_session_service.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/media_session/public/mojom/media_session_service.mojom-blink-import-headers.h"
...
void MediaSessionServiceProxy::BindAudioFocusManager(
    mojo::PendingReceiver<::media_session::mojom::blink::AudioFocusManager> in_receiver) {
...
void MediaSessionServiceProxy::BindAudioFocusManagerDebug(
    mojo::PendingReceiver<::media_session::mojom::blink::AudioFocusManagerDebug> in_receiver) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaSessionServiceProxy::BindMediaControllerManager(
    mojo::PendingReceiver<::media_session::mojom::blink::MediaControllerManager> in_receiver) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool MediaSessionServiceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kMediaSessionService_BindAudioFocusManager_Name: {
      ...
      bool success = true;
      mojo::PendingReceiver<::media_session::mojom::blink::AudioFocusManager> p_receiver{};
...
std::move(p_receiver));
    ...
    case internal::kMediaSessionService_BindAudioFocusManagerDebug_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingReceiver<::media_session::mojom::blink::AudioFocusManagerDebug> p_receiver{};
...
std::move(p_receiver));
    ...
    case internal::kMediaSessionService_BindMediaControllerManager_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      mojo::PendingReceiver<::media_session::mojom::blink::MediaControllerManager> p_receiver{};
...
bool MediaSessionServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::media_session::mojom::blink::MediaSessionService::Name_;
