...
void AudioFocusManagerProxy::RequestAudioFocus(
    mojo::PendingReceiver<AudioFocusRequestClient> in_client, mojo::PendingRemote<::media_session::mojom::MediaSession> in_media_session, ::media_session::mojom::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, RequestAudioFocusCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AudioFocusManagerProxy::RequestGroupedAudioFocus(
    const ::base::UnguessableToken& in_request_id, mojo::PendingReceiver<AudioFocusRequestClient> in_client, mojo::PendingRemote<::media_session::mojom::MediaSession> in_media_session, ::media_session::mojom::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, const ::base::UnguessableToken& in_group_id, RequestGroupedAudioFocusCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AudioFocusManagerStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kAudioFocusManager_RequestAudioFocus_Name: {
      ...
      mojo::PendingRemote<::media_session::mojom::MediaSession> p_media_session{};
      ::media_session::mojom::MediaSessionInfoPtr p_session_info{};
      AudioFocusType p_type{};
