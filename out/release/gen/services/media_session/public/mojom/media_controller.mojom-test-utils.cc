// services/media_session/public/mojom/media_controller.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MediaControllerObserverInterceptorForTesting::MediaSessionPositionChanged(const base::Optional<::media_session::MediaPosition>& position) {
