...
class BLINK_PLATFORM_EXPORT AudioFocusManager
 ...
 public:
  ...
  virtual void RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) = 0;
...
class BLINK_PLATFORM_EXPORT AudioFocusManagerProxy
 ...
 public:
  ...
  void RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) final;
