...
class  AudioFocusManager
 ...
 public:
  ...
  virtual void RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::MediaSession> media_session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) = 0;
...
class  AudioFocusManagerProxy
 ...
 public:
  ...
  void RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::MediaSession> media_session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) final;
