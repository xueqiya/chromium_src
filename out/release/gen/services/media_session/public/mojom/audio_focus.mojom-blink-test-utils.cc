// services/media_session/public/mojom/audio_focus.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void AudioFocusManagerInterceptorForTesting::RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) {
...
void AudioFocusManagerInterceptorForTesting::RequestGroupedAudioFocus(const ::base::UnguessableToken& request_id, mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, const ::base::UnguessableToken& group_id, RequestGroupedAudioFocusCallback callback) {
  GetForwardingInterface()->RequestGroupedAudioFocus(std::move(request_id), std::move(client), std::move(media_session), std::move(session_info), std::move(type), std::move(group_id), std::move(callback));
}
...
void AudioFocusManagerAsyncWaiter::RequestAudioFocus(
    mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, ::base::UnguessableToken* out_request_id) {
  base::RunLoop loop;
...
void AudioFocusManagerAsyncWaiter::RequestGroupedAudioFocus(
    const ::base::UnguessableToken& request_id, mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::blink::MediaSession> media_session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, const ::base::UnguessableToken& group_id, bool* out_success) {
  base::RunLoop loop;
  proxy_->RequestGroupedAudioFocus(std::move(request_id),std::move(client),std::move(media_session),std::move(session_info),std::move(type),std::move(group_id),
      base::BindOnce(
          [](base::RunLoop* loop,
             bool* out_success
,
