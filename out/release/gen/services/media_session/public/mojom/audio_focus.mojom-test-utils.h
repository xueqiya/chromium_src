...
class  AudioFocusManagerInterceptorForTesting : public AudioFocusManager {
  ...
  void RequestAudioFocus(mojo::PendingReceiver<AudioFocusRequestClient> client, mojo::PendingRemote<::media_session::mojom::MediaSession> media_session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) override;
