...
bool MediaController_SeekTo_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const MediaController_SeekTo_Params_Data* object = static_cast<const MediaController_SeekTo_Params_Data*>(data);
...
bool MediaController_ScrubTo_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const MediaController_ScrubTo_Params_Data* object = static_cast<const MediaController_ScrubTo_Params_Data*>(data);
...
bool MediaController_EnterPictureInPicture_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const MediaController_EnterPictureInPicture_Params_Data* object = static_cast<const MediaController_EnterPictureInPicture_Params_Data*>(data);
...
bool MediaController_ExitPictureInPicture_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const MediaController_ExitPictureInPicture_Params_Data* object = static_cast<const MediaController_ExitPictureInPicture_Params_Data*>(data);
...
bool MediaControllerObserver_MediaSessionPositionChanged_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const MediaControllerObserver_MediaSessionPositionChanged_Params_Data* object = static_cast<const MediaControllerObserver_MediaSessionPositionChanged_Params_Data*>(data);
