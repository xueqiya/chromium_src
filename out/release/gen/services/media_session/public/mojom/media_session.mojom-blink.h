...
struct HashTraits<::media_session::mojom::MediaPictureInPictureState>
  ...
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::media_session::mojom::MediaPictureInPictureState& value) {
    return value == static_cast<::media_session::mojom::MediaPictureInPictureState>(-1000000);
  }
...
struct HashTraits<::media_session::mojom::MediaImageBitmapColorType>
  ...
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::media_session::mojom::MediaImageBitmapColorType& value) {
    return value == static_cast<::media_session::mojom::MediaImageBitmapColorType>(-1000000);
  }
