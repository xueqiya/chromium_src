// services/network/public/mojom/origin_policy_manager.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
namespace mojom {
namespace internal {
using OriginPolicy_Data = mojo::native::internal::NativeStruct_Data;
