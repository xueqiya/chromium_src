...
class P2PSocketClient_IncomingTcpConnection_ParamsDataView {
 public:
  ...
  UserType TakeSocket() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::P2PSocketInterfaceBase>>(
            &data_->socket, &result, context_);
    DCHECK(ret);
    return result;
  }
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::P2PSocketClientInterfaceBase>>(
            &data_->client, &result, context_);
    DCHECK(ret);
    return result;
  }
