...
template <>
struct DefaultHash<::network::mojom::NetworkContextParams_CorsMode> {
  using Hash = network_mojom_internal_NetworkContextParams_CorsMode_DataHashFn;
};
}  // namespace WTF
...
using ClientCertificateResponderPtr = mojo::InterfacePtr<ClientCertificateResponder>;
using ClientCertificateResponderPtrInfo = mojo::InterfacePtrInfo<ClientCertificateResponder>;
using ThreadSafeClientCertificateResponderPtr =
    mojo::ThreadSafeInterfacePtr<ClientCertificateResponder>;

using ClientCertificateResponderRequest = mojo::InterfaceRequest<ClientCertificateResponder>;

using ClientCertificateResponderAssociatedPtr =
    mojo::AssociatedInterfacePtr<ClientCertificateResponder>;
using ThreadSafeClientCertificateResponderAssociatedPtr =
    mojo::ThreadSafeAssociatedInterfacePtr<ClientCertificateResponder>;
using ClientCertificateResponderAssociatedPtrInfo =
    mojo::AssociatedInterfacePtrInfo<ClientCertificateResponder>;

using ClientCertificateResponderAssociatedRequest =
    mojo::AssociatedInterfaceRequest<ClientCertificateResponder>;
