...
void CookieManagerInterceptorForTesting::SetCanonicalCookie(const ::blink::CanonicalCookie& cookie, const WTF::String& source_scheme, CookieOptionsPtr cookie_options, SetCanonicalCookieCallback callback) {
...
void CookieManagerInterceptorForTesting::DeleteCanonicalCookie(const ::blink::CanonicalCookie& cookie, DeleteCanonicalCookieCallback callback) {
...
,
             const WTF::Vector<::blink::CanonicalCookie>& cookies,
...
void CookieManagerAsyncWaiter::GetCookieList(
  ...
  proxy_->GetCookieList(std::move(url),std::move(cookie_options),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<CookieWithStatusPtr>* out_cookies
,
             WTF::Vector<CookieWithStatusPtr>* out_excluded_cookies
,
             WTF::Vector<CookieWithStatusPtr> cookies,
...
void CookieManagerAsyncWaiter::SetCanonicalCookie(
  ...
  proxy_->SetCanonicalCookie(std::move(cookie),std::move(source_scheme),std::move(cookie_options),
      base::BindOnce(
          [](base::RunLoop* loop,
             CookieInclusionStatusPtr* out_status
,
             CookieInclusionStatusPtr status) {*out_status = std::move(status);
            loop->Quit();
          },
          &loop,
          out_status));
