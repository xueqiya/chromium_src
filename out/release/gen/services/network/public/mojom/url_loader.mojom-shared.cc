...
std::ostream& operator<<(std::ostream& os, UpdateNetworkIsolationKeyOnRedirect value) {
  switch(value) {
    case UpdateNetworkIsolationKeyOnRedirect::kDoNotUpdate:
      return os << "UpdateNetworkIsolationKeyOnRedirect::kDoNotUpdate";
    case UpdateNetworkIsolationKeyOnRedirect::kUpdateTopFrameAndFrameOrigin:
      return os << "UpdateNetworkIsolationKeyOnRedirect::kUpdateTopFrameAndFrameOrigin";
    case UpdateNetworkIsolationKeyOnRedirect::kUpdateFrameOrigin:
      return os << "UpdateNetworkIsolationKeyOnRedirect::kUpdateFrameOrigin";
    default:
      return os << "Unknown UpdateNetworkIsolationKeyOnRedirect value: " << static_cast<int32_t>(value);
  }
}
...
bool TrustedUrlRequestParams_Data::Validate(
  ...
  if (!::network::mojom::internal::UpdateNetworkIsolationKeyOnRedirect_Data
        ::Validate(object->update_network_isolation_key_on_redirect, validation_context))
    return false;
...
bool URLRequest_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->fetch_integrity, 25, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->custom_proxy_pre_cache_headers, 42, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->custom_proxy_post_cache_headers, 43, validation_context)) {
    return false;
  }
