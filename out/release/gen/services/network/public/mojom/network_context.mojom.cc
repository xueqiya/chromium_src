...
NetworkContextParams::NetworkContextParams(
    ...
    std::vector<std::string> cors_extra_safelisted_request_header_names_in,
...
URLLoaderFactoryParams::URLLoaderFactoryParams()
    : process_id(kInvalidProcessId),
      ...
      cross_origin_embedder_policy(::network::mojom::CrossOriginEmbedderPolicy::kNone),
      header_client(),
...
URLLoaderFactoryParams::URLLoaderFactoryParams(
    ...
    ::network::mojom::CrossOriginEmbedderPolicy cross_origin_embedder_policy_in,
    ...
    const base::Optional<::net::NetworkIsolationKey>& network_isolation_key_in,
...
void NetworkContextClientProxy::OnCookiesChanged(
    bool in_is_service_worker, int32_t in_process_id, int32_t in_routing_id, const ::GURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const std::vector<::net::CookieWithStatus>& in_cookie_list) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_cert_responder));
    ...
    case internal::kNetworkContextClient_OnCookiesChanged_Name: {
      ...
      std::vector<::net::CookieWithStatus> p_cookie_list{};
...
void NetworkContextProxy::CreateQuicTransport(
    const ::GURL& in_url, const ::url::Origin& in_origin, const ::net::NetworkIsolationKey& in_network_isolation_key, mojo::PendingRemote<::network::mojom::QuicTransportHandshakeClient> in_handshake_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::CreateP2PSocketManager(
    mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> in_client, mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> in_trusted_socket_manager, mojo::PendingReceiver<::network::mojom::P2PSocketManager> in_socket_manager) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::SetCorsExtraSafelistedRequestHeaderNames(
    const std::vector<std::string>& in_cors_extra_safelisted_request_header_names) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_host_resolver));
    ...
    case internal::kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      std::vector<std::string> p_cors_extra_safelisted_request_header_names{};
