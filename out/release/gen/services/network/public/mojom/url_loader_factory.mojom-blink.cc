...
void URLLoaderFactoryProxy::CreateLoaderAndStart(
    mojo::PendingReceiver<::network::mojom::blink::URLLoader> in_loader, int32_t in_routing_id, int32_t in_request_id, uint32_t in_options, const ::network::ResourceRequest& in_request, mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> in_client, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation) {
