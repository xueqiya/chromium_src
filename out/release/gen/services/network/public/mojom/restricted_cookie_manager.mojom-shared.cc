...
std::ostream& operator<<(std::ostream& os, RestrictedCookieManagerRole value) {
  switch(value) {
    case RestrictedCookieManagerRole::SCRIPT:
      return os << "RestrictedCookieManagerRole::SCRIPT";
    case RestrictedCookieManagerRole::NETWORK:
      return os << "RestrictedCookieManagerRole::NETWORK";
    default:
      return os << "Unknown RestrictedCookieManagerRole value: " << static_cast<int32_t>(value);
  }
}
...
bool RestrictedCookieManager_SetCookieFromString_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_SetCookieFromString_Params_Data* object = static_cast<const RestrictedCookieManager_SetCookieFromString_Params_Data*>(data);
...
bool RestrictedCookieManager_SetCookieFromString_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_SetCookieFromString_ResponseParams_Data* object = static_cast<const RestrictedCookieManager_SetCookieFromString_ResponseParams_Data*>(data);
...
bool RestrictedCookieManager_GetCookiesString_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_GetCookiesString_Params_Data* object = static_cast<const RestrictedCookieManager_GetCookiesString_Params_Data*>(data);
...
bool RestrictedCookieManager_GetCookiesString_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_GetCookiesString_ResponseParams_Data* object = static_cast<const RestrictedCookieManager_GetCookiesString_ResponseParams_Data*>(data);
...
bool RestrictedCookieManager_CookiesEnabledFor_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_CookiesEnabledFor_Params_Data* object = static_cast<const RestrictedCookieManager_CookiesEnabledFor_Params_Data*>(data);
...
bool RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data* object = static_cast<const RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data*>(data);
