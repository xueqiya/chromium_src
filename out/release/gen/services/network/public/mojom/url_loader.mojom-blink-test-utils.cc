// services/network/public/mojom/url_loader.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void URLLoaderInterceptorForTesting::FollowRedirect(const WTF::Vector<WTF::String>& removed_headers, const ::net::HttpRequestHeaders& modified_headers, const base::Optional<::blink::KURL>& new_url) {
...
void URLLoaderClientInterceptorForTesting::OnReceiveResponse(::network::mojom::blink::URLResponseHeadPtr head) {
