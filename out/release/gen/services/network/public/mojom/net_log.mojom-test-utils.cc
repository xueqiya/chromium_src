// services/network/public/mojom/net_log.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void NetLogExporterInterceptorForTesting::Start(::base::File destination, ::base::Value extra_constants, ::net::NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) {
...
void NetLogExporterAsyncWaiter::Start(
    ::base::File destination, ::base::Value extra_constants, ::net::NetLogCaptureMode capture_mode, uint64_t max_file_size, int32_t* out_net_error) {
  base::RunLoop loop;
