...
bool LoadTimingInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->push_start, 12, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->push_end, 13, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->service_worker_start_time, 14, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->service_worker_ready_time, 15, validation_context)) {
    return false;
  }
