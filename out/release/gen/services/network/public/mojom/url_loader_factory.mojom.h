...
class  URLLoaderFactory
 ...
 public:
  ...
  virtual void CreateLoaderAndStart(mojo::PendingReceiver<::network::mojom::URLLoader> loader, int32_t routing_id, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, mojo::PendingRemote<::network::mojom::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) = 0;
...
class  URLLoaderFactoryProxy
 ...
 public:
  ...
  void CreateLoaderAndStart(mojo::PendingReceiver<::network::mojom::URLLoader> loader, int32_t routing_id, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, mojo::PendingRemote<::network::mojom::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) final;
