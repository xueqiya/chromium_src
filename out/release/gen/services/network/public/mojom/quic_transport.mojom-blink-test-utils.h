// services/network/public/mojom/quic_transport.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_QUIC_TRANSPORT_MOJOM_BLINK_TEST_UTILS_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_QUIC_TRANSPORT_MOJOM_BLINK_TEST_UTILS_H_
...
class BLINK_PLATFORM_EXPORT QuicTransportInterceptorForTesting : public QuicTransport {
...
class BLINK_PLATFORM_EXPORT QuicTransportAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT QuicTransportClientInterceptorForTesting : public QuicTransportClient {
...
class BLINK_PLATFORM_EXPORT QuicTransportClientAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT QuicTransportHandshakeClientInterceptorForTesting : public QuicTransportHandshakeClient {
...
class BLINK_PLATFORM_EXPORT QuicTransportHandshakeClientAsyncWaiter {
 public:
...
#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_QUIC_TRANSPORT_MOJOM_BLINK_TEST_UTILS_H_