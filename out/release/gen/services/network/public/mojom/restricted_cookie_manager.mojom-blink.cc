...
bool RestrictedCookieManager::SetCookieFromString(const ::blink::KURL& url, const ::net::SiteForCookies& site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, const WTF::String& cookie) {
  NOTREACHED();
  return false;
}
bool RestrictedCookieManager::GetCookiesString(const ::blink::KURL& url, const ::net::SiteForCookies& site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, WTF::String* out_cookies) {
  NOTREACHED();
  return false;
}
...
class RestrictedCookieManager_GetCookiesString_HandleSyncResponse
 ...
 private:
  bool* result_;
  WTF::String* out_cookies_;DISALLOW_COPY_AND_ASSIGN(RestrictedCookieManager_GetCookiesString_HandleSyncResponse);
};
...
void RestrictedCookieManagerProxy::GetAllForUrl(
    const ::blink::KURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, CookieManagerGetOptionsPtr in_options, GetAllForUrlCallback callback) {
...
void RestrictedCookieManagerProxy::SetCanonicalCookie(
    const ::blink::CanonicalCookie& in_cookie, const ::blink::KURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool RestrictedCookieManagerProxy::SetCookieFromString(
    const ::blink::KURL& param_url, const ::net::SiteForCookies& param_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& param_top_frame_origin, const WTF::String& param_cookie) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RestrictedCookieManagerProxy::SetCookieFromString(
    const ::blink::KURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, const WTF::String& in_cookie, SetCookieFromStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::RestrictedCookieManager::SetCookieFromString");
#endif
  const bool kExpectsResponse = true;
...
bool RestrictedCookieManagerProxy::GetCookiesString(
    const ::blink::KURL& param_url, const ::net::SiteForCookies& param_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& param_top_frame_origin, WTF::String* out_param_cookies) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RestrictedCookieManagerProxy::GetCookiesString(
    const ::blink::KURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, GetCookiesStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::RestrictedCookieManager::GetCookiesString");
#endif
  const bool kExpectsResponse = true;
