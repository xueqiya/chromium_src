...
class  URLResponseHead {
 public:
  ...
  URLResponseHead(
      ...
      ::network::mojom::CrossOriginOpenerPolicy cross_origin_opener_policy);
...
struct  StructTraits<::network::mojom::URLResponseHead::DataView,
  ...
  static decltype(::network::mojom::URLResponseHead::is_in_cache_storage) is_in_cache_storage(
      const ::network::mojom::URLResponseHeadPtr& input) {
  ...
  static const decltype(::network::mojom::URLResponseHead::content_security_policy)& content_security_policy(
      const ::network::mojom::URLResponseHeadPtr& input) {
  ...
  static decltype(::network::mojom::URLResponseHead::cross_origin_embedder_policy) cross_origin_embedder_policy(
      const ::network::mojom::URLResponseHeadPtr& input) {
    return input->cross_origin_embedder_policy;
  }

  static decltype(::network::mojom::URLResponseHead::cross_origin_opener_policy) cross_origin_opener_policy(
      const ::network::mojom::URLResponseHeadPtr& input) {
