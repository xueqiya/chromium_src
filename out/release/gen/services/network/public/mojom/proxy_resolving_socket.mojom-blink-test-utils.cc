// services/network/public/mojom/proxy_resolving_socket.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ProxyResolvingSocketFactoryInterceptorForTesting::CreateProxyResolvingSocket(const ::blink::KURL& url, ProxyResolvingSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, mojo::PendingReceiver<ProxyResolvingSocket> socket, mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, CreateProxyResolvingSocketCallback callback) {
