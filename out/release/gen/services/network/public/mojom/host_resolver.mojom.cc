...
DnsConfigOverrides::DnsConfigOverrides(
    base::Optional<std::vector<::net::IPEndPoint>> nameservers_in,
    base::Optional<std::vector<std::string>> search_in,
    ...
    base::Optional<std::vector<std::string>> disabled_upgrade_providers_in)
...
void ResolveHostClientProxy::OnComplete(
    int32_t in_result, const ::net::ResolveErrorInfo& in_resolve_error_info, const base::Optional<::net::AddressList>& in_resolved_addresses) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
