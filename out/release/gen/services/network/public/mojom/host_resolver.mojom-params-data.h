...
class  ResolveHostClient_OnComplete_Params_Data {
 public:
  ...
  int32_t result;
  uint8_t pad0_[4];
  mojo::internal::Pointer<internal::ResolveErrorInfo_Data> resolve_error_info;
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(DnsConfigChangeManagerClient_OnDnsConfigChanged_Params_Data));
      new (data()) DnsConfigChangeManagerClient_OnDnsConfigChanged_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    DnsConfigChangeManagerClient_OnDnsConfigChanged_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<DnsConfigChangeManagerClient_OnDnsConfigChanged_Params_Data>(index_);
    }
    DnsConfigChangeManagerClient_OnDnsConfigChanged_Params_Data* operator->() { return data(); }
...
class ResolveHostClient_OnComplete_ParamsDataView {
 public:
  ...
  inline void GetResolveErrorInfoDataView(
      ResolveErrorInfoDataView* output);
...
inline void ResolveHostClient_OnComplete_ParamsDataView::GetResolveErrorInfoDataView(
    ResolveErrorInfoDataView* output) {
  auto pointer = data_->resolve_error_info.Get();
  *output = ResolveErrorInfoDataView(pointer, context_);
}
