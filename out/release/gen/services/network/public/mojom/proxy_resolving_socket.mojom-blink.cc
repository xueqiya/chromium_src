...
void ProxyResolvingSocketProxy::UpgradeToTLS(
  ...
  TRACE_EVENT0("mojom", "network::mojom::ProxyResolvingSocket::UpgradeToTLS");
#endif
...
bool ProxyResolvingSocket_UpgradeToTLS_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "network::mojom::ProxyResolvingSocket::UpgradeToTLSCallback",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::ProxyResolvingSocket::UpgradeToTLSCallback",
               "message", message.name());
#endif
...
void ProxyResolvingSocketFactoryProxy::CreateProxyResolvingSocket(
    const ::blink::KURL& in_url, ProxyResolvingSocketOptionsPtr in_options, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, mojo::PendingReceiver<ProxyResolvingSocket> in_socket, mojo::PendingRemote<::network::mojom::blink::SocketObserver> in_observer, CreateProxyResolvingSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::ProxyResolvingSocketFactory::CreateProxyResolvingSocket");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool ProxyResolvingSocketFactory_CreateProxyResolvingSocket_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "network::mojom::ProxyResolvingSocketFactory::CreateProxyResolvingSocketCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::ProxyResolvingSocketFactory::CreateProxyResolvingSocketCallback",
               "message", message.name());
#endif
