...
std::ostream& operator<<(std::ostream& os, OptionalSecureDnsMode value) {
  switch(value) {
    case OptionalSecureDnsMode::NO_OVERRIDE:
      return os << "OptionalSecureDnsMode::NO_OVERRIDE";
    case OptionalSecureDnsMode::OFF:
      return os << "OptionalSecureDnsMode::OFF";
    case OptionalSecureDnsMode::AUTOMATIC:
      return os << "OptionalSecureDnsMode::AUTOMATIC";
    case OptionalSecureDnsMode::SECURE:
      return os << "OptionalSecureDnsMode::SECURE";
    default:
      return os << "Unknown OptionalSecureDnsMode value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, SecureDnsMode value) {
  switch(value) {
    case SecureDnsMode::OFF:
      return os << "SecureDnsMode::OFF";
    case SecureDnsMode::AUTOMATIC:
      return os << "SecureDnsMode::AUTOMATIC";
    case SecureDnsMode::SECURE:
      return os << "SecureDnsMode::SECURE";
    default:
      return os << "Unknown SecureDnsMode value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, ResolveHostParameters_CacheUsage value) {
  switch(value) {
    case ResolveHostParameters_CacheUsage::ALLOWED:
      return os << "ResolveHostParameters_CacheUsage::ALLOWED";
    case ResolveHostParameters_CacheUsage::STALE_ALLOWED:
      return os << "ResolveHostParameters_CacheUsage::STALE_ALLOWED";
    case ResolveHostParameters_CacheUsage::DISALLOWED:
      return os << "ResolveHostParameters_CacheUsage::DISALLOWED";
    default:
      return os << "Unknown ResolveHostParameters_CacheUsage value: " << static_cast<int32_t>(value);
  }
}
