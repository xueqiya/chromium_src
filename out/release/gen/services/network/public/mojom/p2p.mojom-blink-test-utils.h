...
class BLINK_PLATFORM_EXPORT P2PNetworkNotificationClientInterceptorForTesting : public P2PNetworkNotificationClient {
  ...
  void NetworkListChanged(const WTF::Vector<::net::NetworkInterface>& networks, const ::net::IPAddress& default_ipv4_local_address, const ::net::IPAddress& default_ipv6_local_address) override;
};
...
class BLINK_PLATFORM_EXPORT P2PSocketManagerInterceptorForTesting : public P2PSocketManager {
  ...
  void CreateSocket(::network::P2PSocketType type, const ::net::IPEndPoint& local_address, const ::network::P2PPortRange& port_range, const ::network::P2PHostAndIPEndPoint& remote_address, mojo::PendingRemote<P2PSocketClient> client, mojo::PendingReceiver<P2PSocket> socket) override;
};
...
class BLINK_PLATFORM_EXPORT P2PSocketClientInterceptorForTesting : public P2PSocketClient {
  ...
  void IncomingTcpConnection(const ::net::IPEndPoint& socket_address, mojo::PendingRemote<P2PSocket> socket, mojo::PendingReceiver<P2PSocketClient> client) override;
