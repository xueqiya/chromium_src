// services/network/public/mojom/url_loader_factory.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void URLLoaderFactoryInterceptorForTesting::CreateLoaderAndStart(mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t routing_id, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
