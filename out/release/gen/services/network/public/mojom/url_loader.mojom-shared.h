...
enum class UpdateNetworkIsolationKeyOnRedirect : int32_t {
 ...
 std::ostream& operator<<(std::ostream& os, UpdateNetworkIsolationKeyOnRedirect value);
inline bool IsKnownEnumValue(UpdateNetworkIsolationKeyOnRedirect value) {
  return internal::UpdateNetworkIsolationKeyOnRedirect_Data::IsKnownValue(
      static_cast<int32_t>(value));
}
...
class TrustedUrlRequestParamsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadUpdateNetworkIsolationKeyOnRedirect(UserType* output) const {
    auto data_value = data_->update_network_isolation_key_on_redirect;
    return mojo::internal::Deserialize<::network::mojom::UpdateNetworkIsolationKeyOnRedirect>(
        data_value, output);
  }

  UpdateNetworkIsolationKeyOnRedirect update_network_isolation_key_on_redirect() const {
    return static_cast<UpdateNetworkIsolationKeyOnRedirect>(data_->update_network_isolation_key_on_redirect);
  }
...
class URLRequestDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadIsolatedWorldOrigin(UserType* output) {
  ...
  bool obey_origin_policy() const {
    return data_->obey_origin_policy;
  }
  inline void GetTrustedParamsDataView(
      TrustedUrlRequestParamsDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadTrustedParams(UserType* output) {
...
template <>
struct hash<::network::mojom::UpdateNetworkIsolationKeyOnRedirect>
    : public mojo::internal::EnumHashImpl<::network::mojom::UpdateNetworkIsolationKeyOnRedirect> {};
...
template <>
struct EnumTraits<::network::mojom::UpdateNetworkIsolationKeyOnRedirect, ::network::mojom::UpdateNetworkIsolationKeyOnRedirect> {
  static ::network::mojom::UpdateNetworkIsolationKeyOnRedirect ToMojom(::network::mojom::UpdateNetworkIsolationKeyOnRedirect input) { return input; }
  static bool FromMojom(::network::mojom::UpdateNetworkIsolationKeyOnRedirect input, ::network::mojom::UpdateNetworkIsolationKeyOnRedirect* output) {
    *output = input;
    return true;
  }
};
...
template <typename MaybeConstUserType>
struct Serializer<::network::mojom::UpdateNetworkIsolationKeyOnRedirect, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = EnumTraits<::network::mojom::UpdateNetworkIsolationKeyOnRedirect, UserType>;
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(static_cast<::network::mojom::UpdateNetworkIsolationKeyOnRedirect>(input), output);
  }
};
...
struct Serializer<::network::mojom::TrustedUrlRequestParamsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::network::mojom::internal::TrustedUrlRequestParams_Data::BufferWriter* output,
    ...
    mojo::internal::Serialize<::network::mojom::UpdateNetworkIsolationKeyOnRedirect>(
        Traits::update_network_isolation_key_on_redirect(input), &(*output)->update_network_isolation_key_on_redirect);
    (*output)->disable_secure_dns = Traits::disable_secure_dns(input);
    (*output)->has_user_activation = Traits::has_user_activation(input);
  }
  ...
  static bool Deserialize(::network::mojom::internal::TrustedUrlRequestParams_Data* input,
    ...
    ::network::mojom::TrustedUrlRequestParamsDataView data_view(input, context);
...
struct Serializer<::network::mojom::URLRequestDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    typename decltype((*output)->isolated_world_origin)::BaseType::BufferWriter
        isolated_world_origin_writer;
    mojo::internal::Serialize<::url::mojom::OriginDataView>(
        in_isolated_world_origin, buffer, &isolated_world_origin_writer, context);
    (*output)->isolated_world_origin.Set(
        isolated_world_origin_writer.is_null() ? nullptr : isolated_world_origin_writer.data());
    ...
    (*output)->is_signed_exchange_prefetch_cache_enabled = Traits::is_signed_exchange_prefetch_cache_enabled(input);
    (*output)->obey_origin_policy = Traits::obey_origin_policy(input);
    decltype(Traits::trusted_params(input)) in_trusted_params = Traits::trusted_params(input);
    typename decltype((*output)->trusted_params)::BaseType::BufferWriter
        trusted_params_writer;
    mojo::internal::Serialize<::network::mojom::TrustedUrlRequestParamsDataView>(
        in_trusted_params, buffer, &trusted_params_writer, context);
    (*output)->trusted_params.Set(
        trusted_params_writer.is_null() ? nullptr : trusted_params_writer.data());
...
inline void TrustedUrlRequestParamsDataView::GetNetworkIsolationKeyDataView(
    ::network::mojom::NetworkIsolationKeyDataView* output) {
  auto pointer = data_->network_isolation_key.Get();
...
inline void URLRequestDataView::GetTrustedParamsDataView(
    TrustedUrlRequestParamsDataView* output) {
  auto pointer = data_->trusted_params.Get();
  *output = TrustedUrlRequestParamsDataView(pointer, context_);
}
