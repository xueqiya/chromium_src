...
class  NetworkContextClient
 ...
 public:
  ...
  virtual void OnCookiesChanged(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) = 0;

  
  virtual void OnCookiesRead(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) = 0;


  using OnGenerateHttpNegotiateAuthTokenCallback = base::OnceCallback<void(int32_t, const std::string&)>;
  
  virtual void OnGenerateHttpNegotiateAuthToken(const std::string& server_auth_token, bool can_delegate, const std::string& auth_negotiate_android_account_type, const std::string& spn, OnGenerateHttpNegotiateAuthTokenCallback callback) = 0;
};
...
class  NetworkContext
 ...
 public:
  ...
  virtual void GetRestrictedCookieManager(mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::RestrictedCookieManagerRole role, const ::url::Origin& origin, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, bool is_service_worker, int32_t process_id, int32_t routing_id) = 0;
  ...
  virtual void CreateWebSocket(const ::GURL& url, const std::vector<std::string>& requested_protocols, const ::net::SiteForCookies& site_for_cookies, const ::net::NetworkIsolationKey& network_isolation_key, std::vector<::network::mojom::HttpHeaderPtr> additional_headers, int32_t process_id, int32_t render_frame_id, const ::url::Origin& origin, uint32_t options, mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> handshake_client, mojo::PendingRemote<::network::mojom::AuthenticationHandler> auth_handler, mojo::PendingRemote<TrustedHeaderClient> header_client) = 0;

  
  virtual void CreateQuicTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkIsolationKey& network_isolation_key, mojo::PendingRemote<::network::mojom::QuicTransportHandshakeClient> handshake_client) = 0;
  ...
  virtual void CreateP2PSocketManager(mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> client, mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> trusted_socket_manager, mojo::PendingReceiver<::network::mojom::P2PSocketManager> socket_manager) = 0;
  ...
  virtual void SetCorsExtraSafelistedRequestHeaderNames(const std::vector<std::string>& cors_extra_safelisted_request_header_names) = 0;
...
class  NetworkContextClientProxy
 ...
 public:
  ...
  void OnCookiesChanged(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) final;
  
  void OnCookiesRead(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) final;
  
  void OnGenerateHttpNegotiateAuthToken(const std::string& server_auth_token, bool can_delegate, const std::string& auth_negotiate_android_account_type, const std::string& spn, OnGenerateHttpNegotiateAuthTokenCallback callback) final;
...
class  NetworkContextProxy
 ...
 public:
  ...
  void GetRestrictedCookieManager(mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::RestrictedCookieManagerRole role, const ::url::Origin& origin, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, bool is_service_worker, int32_t process_id, int32_t routing_id) final;
  ...
  void CreateQuicTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkIsolationKey& network_isolation_key, mojo::PendingRemote<::network::mojom::QuicTransportHandshakeClient> handshake_client) final;
  ...
  void CreateP2PSocketManager(mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> client, mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> trusted_socket_manager, mojo::PendingReceiver<::network::mojom::P2PSocketManager> socket_manager) final;
  ...
  void SetCorsExtraSafelistedRequestHeaderNames(const std::vector<std::string>& cors_extra_safelisted_request_header_names) final;
...
struct  StructTraits<::network::mojom::NetworkContextParams::DataView,
  ...
  static decltype(::network::mojom::NetworkContextParams::check_clear_text_permitted) check_clear_text_permitted(
      const ::network::mojom::NetworkContextParamsPtr& input) {
  ...
  static const decltype(::network::mojom::NetworkContextParams::cors_extra_safelisted_request_header_names)& cors_extra_safelisted_request_header_names(
      const ::network::mojom::NetworkContextParamsPtr& input) {
    return input->cors_extra_safelisted_request_header_names;
  }

  static decltype(::network::mojom::NetworkContextParams::cors_mode) cors_mode(
      const ::network::mojom::NetworkContextParamsPtr& input) {
...
struct  StructTraits<::network::mojom::URLLoaderFactoryParams::DataView,
  ...
  static decltype(::network::mojom::URLLoaderFactoryParams::cross_origin_embedder_policy) cross_origin_embedder_policy(
      const ::network::mojom::URLLoaderFactoryParamsPtr& input) {
  ...
  static const decltype(::network::mojom::URLLoaderFactoryParams::network_isolation_key)& network_isolation_key(
      const ::network::mojom::URLLoaderFactoryParamsPtr& input) {
