...
class BLINK_PLATFORM_EXPORT URLLoaderFactory
 ...
 public:
  ...
  virtual void CreateLoaderAndStart(mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t routing_id, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) = 0;
...
class BLINK_PLATFORM_EXPORT URLLoaderFactoryProxy
 ...
 public:
  ...
  void CreateLoaderAndStart(mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t routing_id, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) final;
