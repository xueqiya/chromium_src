// services/network/public/mojom/quic_transport.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool QuicTransportRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::network::mojom::blink::QuicTransport::Name_;
...
bool QuicTransportClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::network::mojom::blink::QuicTransportClient::Name_;
...
bool QuicTransportHandshakeClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::network::mojom::blink::QuicTransportHandshakeClient::Name_;
