// services/network/public/mojom/tcp_socket.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void TCPConnectedSocketAsyncWaiter::UpgradeToTLS(
    const ::net::HostPortPair& host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, mojo::ScopedDataPipeConsumerHandle* out_receive_stream, mojo::ScopedDataPipeProducerHandle* out_send_stream, base::Optional<::net::SSLInfo>* out_ssl_info) {
  base::RunLoop loop;
