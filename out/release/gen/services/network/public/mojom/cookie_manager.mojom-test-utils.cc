// services/network/public/mojom/cookie_manager.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CookieManagerInterceptorForTesting::AddCookieChangeListener(const ::GURL& url, const base::Optional<std::string>& name, mojo::PendingRemote<CookieChangeListener> listener) {
...
void CookieManagerAsyncWaiter::GetCookieList(
    const ::GURL& url, const ::net::CookieOptions& cookie_options, std::vector<::net::CookieWithStatus>* out_cookies, std::vector<::net::CookieWithStatus>* out_excluded_cookies) {
  base::RunLoop loop;
  proxy_->GetCookieList(std::move(url),std::move(cookie_options),
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<::net::CookieWithStatus>* out_cookies
,
             std::vector<::net::CookieWithStatus>* out_excluded_cookies
,
             const std::vector<::net::CookieWithStatus>& cookies,
