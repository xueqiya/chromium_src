...
class  CookieManager
 ...
 public:
  ...
  using GetCookieListCallback = base::OnceCallback<void(const std::vector<::net::CookieWithStatus>&, const std::vector<::net::CookieWithStatus>&)>;
...
struct  StructTraits<::network::mojom::CookieWithStatus::DataView,
  ...
  static const decltype(::network::mojom::CookieWithStatus::status)& status(
      const ::network::mojom::CookieWithStatusPtr& input) {
    return input->status;
  }
...
struct  StructTraits<::network::mojom::CookieAndLineWithStatus::DataView,
  ...
  static const decltype(::network::mojom::CookieAndLineWithStatus::status)& status(
      const ::network::mojom::CookieAndLineWithStatusPtr& input) {
    return input->status;
  }
...
struct  StructTraits<::network::mojom::CookieChangeInfo::DataView,
  ...
  static decltype(::network::mojom::CookieChangeInfo::access_semantics) access_semantics(
      const ::network::mojom::CookieChangeInfoPtr& input) {
