...
size_t Rule::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->host_resolver_flags);
  seed = mojo::internal::WTFHash(seed, this->canonical_name);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::SimulateNetworkQualityChange");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::SetTransportSecurityStateSource");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::CrashOnResolveHost");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::GetEnvironmentVariableValue");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::Log");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "network::mojom::NetworkServiceTest::ActivateFieldTrial");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::SimulateNetworkQualityChangeCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::SetTransportSecurityStateSourceCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::SetAllowNetworkAccessToHostResolutionsCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::GetLatestMemoryPressureLevelCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::GetPeerToPeerConnectionsCountChangeCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::GetEnvironmentVariableValueCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::NetworkServiceTest::LogCallback",
               "message", message.name());
#endif
...
std::move(p_rv), std::move(callback));
    ...
    case internal::kNetworkServiceTest_SetShouldRequireCT_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)network::mojom::NetworkServiceTest::SetShouldRequireCT",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)network::mojom::NetworkServiceTest::SetShouldRequireCT");
...
static const mojo::internal::GenericValidationInfo kNetworkServiceTestValidationInfo[] = {
    ...
    {&internal::NetworkServiceTest_SetShouldRequireCT_Params_Data::Validate,
     &internal::NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data::Validate},
