...
,
             ...
             const base::Optional<::GURL>& preserve_fragment_on_redirect_url) {*out_result = std::move(result);*out_headers = std::move(headers);*out_preserve_fragment_on_redirect_url = std::move(preserve_fragment_on_redirect_url);
            loop->Quit();
          },
          &loop,
          out_result,
...
void NetworkContextClientInterceptorForTesting::OnCertificateRequested(const base::Optional<::base::UnguessableToken>& window_id, int32_t process_id, int32_t routing_id, uint32_t request_id, const ::scoped_refptr<::net::SSLCertRequestInfo>& cert_info, mojo::PendingRemote<ClientCertificateResponder> cert_responder) {
...
void NetworkContextClientInterceptorForTesting::OnSSLCertificateError(int32_t process_id, int32_t routing_id, const ::GURL& url, int32_t net_error, const ::net::SSLInfo& ssl_info, bool fatal, OnSSLCertificateErrorCallback callback) {
...
void NetworkContextClientInterceptorForTesting::OnClearSiteData(int32_t process_id, int32_t routing_id, const ::GURL& url, const std::string& header_value, int32_t load_flags, OnClearSiteDataCallback callback) {
...
void NetworkContextClientInterceptorForTesting::OnCookiesChanged(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) {
...
void NetworkContextClientInterceptorForTesting::OnCookiesRead(bool is_service_worker, int32_t process_id, int32_t routing_id, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const std::vector<::net::CookieWithStatus>& cookie_list) {
...
void NetworkContextInterceptorForTesting::GetRestrictedCookieManager(mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::RestrictedCookieManagerRole role, const ::url::Origin& origin, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, bool is_service_worker, int32_t process_id, int32_t routing_id) {
...
void NetworkContextInterceptorForTesting::NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key) {
...
void NetworkContextInterceptorForTesting::CreateQuicTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkIsolationKey& network_isolation_key, mojo::PendingRemote<::network::mojom::QuicTransportHandshakeClient> handshake_client) {
...
void NetworkContextInterceptorForTesting::CreateP2PSocketManager(mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> client, mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> trusted_socket_manager, mojo::PendingReceiver<::network::mojom::P2PSocketManager> socket_manager) {
...
void NetworkContextInterceptorForTesting::CreateHostResolver(const base::Optional<::net::DnsConfigOverrides>& config_overrides, mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver) {
...
void NetworkContextInterceptorForTesting::SetCorsExtraSafelistedRequestHeaderNames(const std::vector<std::string>& cors_extra_safelisted_request_header_names) {
