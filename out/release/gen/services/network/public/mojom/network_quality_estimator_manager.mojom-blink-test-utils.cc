// services/network/public/mojom/network_quality_estimator_manager.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
