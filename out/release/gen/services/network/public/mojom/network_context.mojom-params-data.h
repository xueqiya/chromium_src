...
class  NetworkContextClient_OnCookiesChanged_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkContextClient_OnCookiesChanged_Params_Data));
      new (data()) NetworkContextClient_OnCookiesChanged_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkContextClient_OnCookiesChanged_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkContextClient_OnCookiesChanged_Params_Data>(index_);
    }
    NetworkContextClient_OnCookiesChanged_Params_Data* operator->() { return data(); }
 ...
 private:
  NetworkContextClient_OnCookiesChanged_Params_Data();
  ~NetworkContextClient_OnCookiesChanged_Params_Data() = delete;
};
static_assert(sizeof(NetworkContextClient_OnCookiesChanged_Params_Data) == 48,
              "Bad sizeof(NetworkContextClient_OnCookiesChanged_Params_Data)");
class  NetworkContextClient_OnCookiesRead_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkContextClient_OnCookiesRead_Params_Data));
      new (data()) NetworkContextClient_OnCookiesRead_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkContextClient_OnCookiesRead_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkContextClient_OnCookiesRead_Params_Data>(index_);
    }
    NetworkContextClient_OnCookiesRead_Params_Data* operator->() { return data(); }
 ...
 private:
  NetworkContextClient_OnCookiesRead_Params_Data();
  ~NetworkContextClient_OnCookiesRead_Params_Data() = delete;
};
static_assert(sizeof(NetworkContextClient_OnCookiesRead_Params_Data) == 48,
              "Bad sizeof(NetworkContextClient_OnCookiesRead_Params_Data)");
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data));
      new (data()) NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data>(index_);
    }
    NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data));
      new (data()) NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data>(index_);
    }
    NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data* operator->() { return data(); }
...
static_assert(sizeof(NetworkContext_CreateQuicTransport_Params_Data) == 40,
...
class NetworkContextClient_OnCookiesChanged_ParamsDataView {
 public:
  NetworkContextClient_OnCookiesChanged_ParamsDataView() {}

  NetworkContextClient_OnCookiesChanged_ParamsDataView(
      internal::NetworkContextClient_OnCookiesChanged_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}

  bool is_null() const { return !data_; }
  bool is_service_worker() const {
    return data_->is_service_worker;
  }
  int32_t process_id() const {
    return data_->process_id;
  }
 ...
 private:
  internal::NetworkContextClient_OnCookiesChanged_Params_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};

class NetworkContextClient_OnCookiesRead_ParamsDataView {
 public:
  NetworkContextClient_OnCookiesRead_ParamsDataView() {}

  NetworkContextClient_OnCookiesRead_ParamsDataView(
      internal::NetworkContextClient_OnCookiesRead_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
 ...
 private:
  internal::NetworkContextClient_OnCookiesRead_Params_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
...
class NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ParamsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadServerAuthToken(UserType* output) {
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadAuthNegotiateAndroidAccountType(UserType* output) {
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadSpn(UserType* output) {
...
inline void NetworkContextClient_OnCookiesChanged_ParamsDataView::GetUrlDataView(
    ::url::mojom::UrlDataView* output) {
  auto pointer = data_->url.Get();
  *output = ::url::mojom::UrlDataView(pointer, context_);
}
inline void NetworkContextClient_OnCookiesChanged_ParamsDataView::GetSiteForCookiesDataView(
    ::network::mojom::SiteForCookiesDataView* output) {
  auto pointer = data_->site_for_cookies.Get();
  *output = ::network::mojom::SiteForCookiesDataView(pointer, context_);
}
inline void NetworkContextClient_OnCookiesChanged_ParamsDataView::GetCookieListDataView(
    mojo::ArrayDataView<::network::mojom::CookieWithStatusDataView>* output) {
  auto pointer = data_->cookie_list.Get();
...
inline void NetworkContextClient_OnCookiesRead_ParamsDataView::GetUrlDataView(
    ::url::mojom::UrlDataView* output) {
  auto pointer = data_->url.Get();
  *output = ::url::mojom::UrlDataView(pointer, context_);
}
inline void NetworkContextClient_OnCookiesRead_ParamsDataView::GetSiteForCookiesDataView(
    ::network::mojom::SiteForCookiesDataView* output) {
  auto pointer = data_->site_for_cookies.Get();
  *output = ::network::mojom::SiteForCookiesDataView(pointer, context_);
}
inline void NetworkContextClient_OnCookiesRead_ParamsDataView::GetCookieListDataView(
    mojo::ArrayDataView<::network::mojom::CookieWithStatusDataView>* output) {
  auto pointer = data_->cookie_list.Get();
  *output = mojo::ArrayDataView<::network::mojom::CookieWithStatusDataView>(pointer, context_);
}
...
inline void NetworkContext_CreateWebSocket_ParamsDataView::GetNetworkIsolationKeyDataView(
    ::network::mojom::NetworkIsolationKeyDataView* output) {
  auto pointer = data_->network_isolation_key.Get();
  *output = ::network::mojom::NetworkIsolationKeyDataView(pointer, context_);
}
