...
SSLConfig::SSLConfig()
    : rev_checking_enabled(false),
      ...
      tls13_hardening_for_local_anchors_enabled(false),
...
SSLConfig::SSLConfig(
    ...
    bool tls13_hardening_for_local_anchors_enabled_in,
    ...
    : rev_checking_enabled(std::move(rev_checking_enabled_in)),
      ...
      tls13_hardening_for_local_anchors_enabled(std::move(tls13_hardening_for_local_anchors_enabled_in)),
...
bool StructTraits<::network::mojom::SSLConfig::DataView, ::network::mojom::SSLConfigPtr>::Read(
  ...
  ::network::mojom::SSLConfigPtr result(::network::mojom::SSLConfig::New());
      ...
      if (success)
        result->tls13_hardening_for_local_anchors_enabled = input.tls13_hardening_for_local_anchors_enabled();
