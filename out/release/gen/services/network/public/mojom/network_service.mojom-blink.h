...
class BLINK_PLATFORM_EXPORT NetworkServiceClient
 ...
 public:
  ...
  virtual void OnRawRequest(int32_t process_id, int32_t routing_id, const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieWithStatusPtr> cookies_with_status, WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers) = 0;

  
  virtual void OnRawResponse(int32_t process_id, int32_t routing_id, const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieAndLineWithStatusPtr> cookies_with_status, WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const WTF::String& raw_response_headers) = 0;
};
...
class BLINK_PLATFORM_EXPORT NetworkService
 ...
 public:
  ...
  virtual void ConfigureStubHostResolver(bool insecure_dns_client_enabled, ::network::mojom::blink::SecureDnsMode secure_dns_mode, base::Optional<WTF::Vector<::network::mojom::blink::DnsOverHttpsServerPtr>> dns_over_https_servers) = 0;
  ...
  using GetNetworkListCallback = base::OnceCallback<void(const base::Optional<WTF::Vector<::net::NetworkInterface>>&)>;
...
class BLINK_PLATFORM_EXPORT NetworkServiceClientProxy
 ...
 public:
  ...
  void OnRawRequest(int32_t process_id, int32_t routing_id, const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieWithStatusPtr> cookies_with_status, WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers) final;
  
  void OnRawResponse(int32_t process_id, int32_t routing_id, const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieAndLineWithStatusPtr> cookies_with_status, WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const WTF::String& raw_response_headers) final;
...
class BLINK_PLATFORM_EXPORT NetworkServiceProxy
 ...
 public:
  ...
  void ConfigureStubHostResolver(bool insecure_dns_client_enabled, ::network::mojom::blink::SecureDnsMode secure_dns_mode, base::Optional<WTF::Vector<::network::mojom::blink::DnsOverHttpsServerPtr>> dns_over_https_servers) final;
