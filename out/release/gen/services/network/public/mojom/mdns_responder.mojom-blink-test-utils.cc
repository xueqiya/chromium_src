// services/network/public/mojom/mdns_responder.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MdnsResponderAsyncWaiter::CreateNameForAddress(
    const ::net::IPAddress& address, WTF::String* out_name, bool* out_announcement_scheduled) {
  base::RunLoop loop;
