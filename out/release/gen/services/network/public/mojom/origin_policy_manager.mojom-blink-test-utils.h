// services/network/public/mojom/origin_policy_manager.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_PLATFORM_EXPORT OriginPolicyManagerInterceptorForTesting : public OriginPolicyManager {
  ...
  void RetrieveOriginPolicy(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::String& header_value, RetrieveOriginPolicyCallback callback) override;
  void AddExceptionFor(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin) override;
};
