...
bool NetworkService_OnApplicationStateChange_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkService_OnApplicationStateChange_Params_Data* object = static_cast<const NetworkService_OnApplicationStateChange_Params_Data*>(data);
...
bool NetworkService_DumpWithoutCrashing_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkService_DumpWithoutCrashing_Params_Data* object = static_cast<const NetworkService_DumpWithoutCrashing_Params_Data*>(data);
