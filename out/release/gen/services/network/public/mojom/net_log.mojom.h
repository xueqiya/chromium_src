...
class  NetLogExporter
 ...
 public:
  ...
  virtual void Start(::base::File destination, ::base::Value extra_constants, ::net::NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) = 0;
...
class  NetLogExporterProxy
 ...
 public:
  ...
  void Start(::base::File destination, ::base::Value extra_constants, ::net::NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) final;
