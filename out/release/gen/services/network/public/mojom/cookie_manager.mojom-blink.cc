...
void CookieManagerProxy::SetCanonicalCookie(
    const ::blink::CanonicalCookie& in_cookie, const WTF::String& in_source_scheme, CookieOptionsPtr in_cookie_options, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class CookieManager_GetCookieList_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<CookieWithStatusPtr> in_cookies, WTF::Vector<CookieWithStatusPtr> in_excluded_cookies);
...
bool CookieManager_GetCookieList_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::Vector<CookieWithStatusPtr> p_cookies{};
...
class CookieManager_SetCanonicalCookie_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      CookieInclusionStatusPtr in_status);
...
bool CookieManager_SetCanonicalCookie_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  CookieInclusionStatusPtr p_status{};
...
// static
bool StructTraits<::network::mojom::blink::CookieAndLineWithStatus::DataView, ::network::mojom::blink::CookieAndLineWithStatusPtr>::Read(
    ::network::mojom::blink::CookieAndLineWithStatus::DataView input,
    ::network::mojom::blink::CookieAndLineWithStatusPtr* output) {
  bool success = true;
  ::network::mojom::blink::CookieAndLineWithStatusPtr result(::network::mojom::blink::CookieAndLineWithStatus::New());
