// services/network/public/mojom/udp_socket.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void UDPSocketListenerInterceptorForTesting::OnReceived(int32_t result, const base::Optional<::net::IPEndPoint>& src_addr, base::Optional<::base::span<const ::uint8_t>> data) {
