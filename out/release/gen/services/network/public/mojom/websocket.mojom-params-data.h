...
static_assert(sizeof(WebSocketHandshakeClient_OnConnectionEstablished_Params_Data) == 32,
...
class  WebSocketClient_AddSendFlowControlQuota_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(WebSocketClient_AddSendFlowControlQuota_Params_Data));
      new (data()) WebSocketClient_AddSendFlowControlQuota_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    WebSocketClient_AddSendFlowControlQuota_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<WebSocketClient_AddSendFlowControlQuota_Params_Data>(index_);
    }
    WebSocketClient_AddSendFlowControlQuota_Params_Data* operator->() { return data(); }
 ...
 private:
  WebSocketClient_AddSendFlowControlQuota_Params_Data();
  ~WebSocketClient_AddSendFlowControlQuota_Params_Data() = delete;
};
static_assert(sizeof(WebSocketClient_AddSendFlowControlQuota_Params_Data) == 16,
              "Bad sizeof(WebSocketClient_AddSendFlowControlQuota_Params_Data)");
...
class WebSocketClient_AddSendFlowControlQuota_ParamsDataView {
 public:
  WebSocketClient_AddSendFlowControlQuota_ParamsDataView() {}

  WebSocketClient_AddSendFlowControlQuota_ParamsDataView(
      internal::WebSocketClient_AddSendFlowControlQuota_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
 ...
 private:
  internal::WebSocketClient_AddSendFlowControlQuota_Params_Data* data_ = nullptr;
};
