...
struct  StructTraits<::network::mojom::SiteForCookies::DataView,
  ...
  static const decltype(::network::mojom::SiteForCookies::scheme)& scheme(
      const ::network::mojom::SiteForCookiesPtr& input) {
    return input->scheme;
  }

  static const decltype(::network::mojom::SiteForCookies::registrable_domain)& registrable_domain(
      const ::network::mojom::SiteForCookiesPtr& input) {
