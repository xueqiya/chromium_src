...
bool NetworkContextParams_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->ct_log_update_time, 34, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->cors_extra_safelisted_request_header_names, 45, validation_context)) {
    return false;
  }
...
// static
bool NetworkContextClient_OnCookiesChanged_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkContextClient_OnCookiesChanged_Params_Data* object = static_cast<const NetworkContextClient_OnCookiesChanged_Params_Data*>(data);
...
NetworkContextClient_OnCookiesChanged_Params_Data::NetworkContextClient_OnCookiesChanged_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkContextClient_OnCookiesRead_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkContextClient_OnCookiesRead_Params_Data* object = static_cast<const NetworkContextClient_OnCookiesRead_Params_Data*>(data);
...
NetworkContextClient_OnCookiesRead_Params_Data::NetworkContextClient_OnCookiesRead_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data* object = static_cast<const NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params_Data*>(data);
...
bool NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data* object = static_cast<const NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams_Data*>(data);
...
bool NetworkContext_CreateQuicTransport_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->handshake_client, 4, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->handshake_client,
                                                 validation_context)) {
