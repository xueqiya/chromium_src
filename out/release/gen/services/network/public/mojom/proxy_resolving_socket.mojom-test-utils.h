...
class  ProxyResolvingSocketInterceptorForTesting : public ProxyResolvingSocket {
  ...
  void UpgradeToTLS(const ::net::HostPortPair& host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, mojo::PendingRemote<::network::mojom::SocketObserver> observer, UpgradeToTLSCallback callback) override;
};
