 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(NetworkChangeManager_OnNetworkChanged_Params_Data));
      new (data()) NetworkChangeManager_OnNetworkChanged_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    NetworkChangeManager_OnNetworkChanged_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<NetworkChangeManager_OnNetworkChanged_Params_Data>(index_);
    }
    NetworkChangeManager_OnNetworkChanged_Params_Data* operator->() { return data(); }
  ...
  UserType TakeClientRemote() {
    ...
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::NetworkChangeManagerClientInterfaceBase>>(
            &data_->client_remote, &result, context_);
    DCHECK(ret);
    return result;
  }
 private:
...
class NetworkChangeManager_OnNetworkChanged_ParamsDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadNewConnectionType(UserType* output) const {
  ...
  ConnectionType new_connection_type() const {
    return static_cast<ConnectionType>(data_->new_connection_type);
  }
  bool connection_subtype_changed() const {
    return data_->connection_subtype_changed;
  }
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadNewConnectionSubtype(UserType* output) const {
  ...
  ConnectionSubtype new_connection_subtype() const {
    return static_cast<ConnectionSubtype>(data_->new_connection_subtype);
  }
 private:
