 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(UDPSocketListener_OnReceived_Params_Data));
      new (data()) UDPSocketListener_OnReceived_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    UDPSocketListener_OnReceived_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<UDPSocketListener_OnReceived_Params_Data>(index_);
    }
    UDPSocketListener_OnReceived_Params_Data* operator->() { return data(); }
