// services/viz/public/mojom/compositing/compositor_frame_sink.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void CompositorFrameSinkInterceptorForTesting::DidAllocateSharedBitmap(::base::ReadOnlySharedMemoryRegion region, ::gpu::mojom::blink::MailboxPtr id) {
...
void CompositorFrameSinkClientInterceptorForTesting::OnBeginFrame(const ::viz::BeginFrameArgs& args, WTF::HashMap<uint32_t, ::viz::mojom::blink::FrameTimingDetailsPtr> details) {
