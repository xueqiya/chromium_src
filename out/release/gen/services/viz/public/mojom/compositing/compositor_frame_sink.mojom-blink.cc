...
void CompositorFrameSinkProxy::DidAllocateSharedBitmap(
    ::base::ReadOnlySharedMemoryRegion in_region, ::gpu::mojom::blink::MailboxPtr in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CompositorFrameSinkClientProxy::OnBeginFrame(
    const ::viz::BeginFrameArgs& in_args, WTF::HashMap<uint32_t, ::viz::mojom::blink::FrameTimingDetailsPtr> in_details) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_resources));
    ...
    case internal::kCompositorFrameSinkClient_OnBeginFrame_Name: {
      ...
      WTF::HashMap<uint32_t, ::viz::mojom::blink::FrameTimingDetailsPtr> p_details{};
