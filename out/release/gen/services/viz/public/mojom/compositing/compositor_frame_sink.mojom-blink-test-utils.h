...
class  CompositorFrameSinkInterceptorForTesting : public CompositorFrameSink {
  ...
  void DidAllocateSharedBitmap(::base::ReadOnlySharedMemoryRegion region, ::gpu::mojom::blink::MailboxPtr id) override;
...
class  CompositorFrameSinkClientInterceptorForTesting : public CompositorFrameSinkClient {
  ...
  void OnBeginFrame(const ::viz::BeginFrameArgs& args, WTF::HashMap<uint32_t, ::viz::mojom::blink::FrameTimingDetailsPtr> details) override;
