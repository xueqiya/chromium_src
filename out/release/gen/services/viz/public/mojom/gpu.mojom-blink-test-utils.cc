// services/viz/public/mojom/gpu.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void GpuMemoryBufferFactoryInterceptorForTesting::CreateGpuMemoryBuffer(gfx::GpuMemoryBufferId id, const ::blink::WebSize& size, gfx::BufferFormat format, gfx::BufferUsage usage, CreateGpuMemoryBufferCallback callback) {
