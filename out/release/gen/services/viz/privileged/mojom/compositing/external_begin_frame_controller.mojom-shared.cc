...
bool ExternalBeginFrameController_IssueExternalBeginFrame_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ExternalBeginFrameController_IssueExternalBeginFrame_ResponseParams_Data* object = static_cast<const ExternalBeginFrameController_IssueExternalBeginFrame_ResponseParams_Data*>(data);
