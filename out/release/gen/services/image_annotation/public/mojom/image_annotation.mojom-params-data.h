 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ImageAnnotationService_BindAnnotator_Params_Data));
      new (data()) ImageAnnotationService_BindAnnotator_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ImageAnnotationService_BindAnnotator_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ImageAnnotationService_BindAnnotator_Params_Data>(index_);
    }
    ImageAnnotationService_BindAnnotator_Params_Data* operator->() { return data(); }
...
static_assert(sizeof(ImageAnnotationService_BindAnnotator_Params_Data) == 16,
              "Bad sizeof(ImageAnnotationService_BindAnnotator_Params_Data)");
...
class Annotator_AnnotateImage_ParamsDataView {
 public:
  ...
  UserType TakeImageProcessor() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::image_annotation::mojom::ImageProcessorInterfaceBase>>(
...
class ImageAnnotationService_BindAnnotator_ParamsDataView {
 public:
  ImageAnnotationService_BindAnnotator_ParamsDataView() {}

  ImageAnnotationService_BindAnnotator_ParamsDataView(
      internal::ImageAnnotationService_BindAnnotator_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
  ...
  UserType TakeReceiver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::image_annotation::mojom::AnnotatorInterfaceBase>>(
