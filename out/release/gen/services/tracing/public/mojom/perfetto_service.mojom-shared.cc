...
std::ostream& operator<<(std::ostream& os, BufferFillPolicy value) {
  switch(value) {
    case BufferFillPolicy::kUnspecified:
      return os << "BufferFillPolicy::kUnspecified";
    case BufferFillPolicy::kRingBuffer:
      return os << "BufferFillPolicy::kRingBuffer";
    case BufferFillPolicy::kDiscard:
      return os << "BufferFillPolicy::kDiscard";
    default:
      return os << "Unknown BufferFillPolicy value: " << static_cast<int32_t>(value);
  }
}
