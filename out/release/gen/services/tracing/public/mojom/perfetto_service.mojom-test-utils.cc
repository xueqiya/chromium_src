// services/tracing/public/mojom/perfetto_service.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ProducerClientInterceptorForTesting::OnTracingStart(mojo::ScopedSharedBufferHandle shared_memory, uint64_t shared_memory_buffer_page_size_bytes) {
  GetForwardingInterface()->OnTracingStart(std::move(shared_memory), std::move(shared_memory_buffer_page_size_bytes));
}
...
void PerfettoServiceInterceptorForTesting::ConnectToProducerHost(mojo::PendingRemote<ProducerClient> producer_client, mojo::PendingReceiver<ProducerHost> producer_host_receiver) {
  GetForwardingInterface()->ConnectToProducerHost(std::move(producer_client), std::move(producer_host_receiver));
}
...
void ConsumerHostInterceptorForTesting::EnableTracing(mojo::PendingReceiver<TracingSessionHost> tracing_session_host, mojo::PendingRemote<TracingSessionClient> tracing_session_client, const ::perfetto::TraceConfig& config, TracingClientPriority priority) {
