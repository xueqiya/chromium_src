 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IncrementalStateConfig_Data));
      new (data()) IncrementalStateConfig_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    IncrementalStateConfig_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IncrementalStateConfig_Data>(index_);
    }
    IncrementalStateConfig_Data* operator->() { return data(); }
...
struct IncrementalStateConfig_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    IncrementalStateConfig_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
