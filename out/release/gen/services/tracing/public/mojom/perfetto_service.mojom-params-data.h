 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ProducerHost_CommitData_ResponseParams_Data));
      new (data()) ProducerHost_CommitData_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ProducerHost_CommitData_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ProducerHost_CommitData_ResponseParams_Data>(index_);
    }
    ProducerHost_CommitData_ResponseParams_Data* operator->() { return data(); }
...
static_assert(sizeof(ProducerClient_OnTracingStart_Params_Data) == 24,
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ProducerClient_ClearIncrementalState_Params_Data));
      new (data()) ProducerClient_ClearIncrementalState_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ProducerClient_ClearIncrementalState_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ProducerClient_ClearIncrementalState_Params_Data>(index_);
    }
    ProducerClient_ClearIncrementalState_Params_Data* operator->() { return data(); }
  ...
  UserType TakeProducerHostReceiver() {
    ...
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::tracing::mojom::ProducerHostInterfaceBase>>(
            &data_->producer_host_receiver, &result, context_);
    DCHECK(ret);
    return result;
  }
 private:
