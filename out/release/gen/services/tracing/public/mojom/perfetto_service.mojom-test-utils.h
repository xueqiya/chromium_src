...
class COMPONENT_EXPORT(TRACING_MOJOM) ProducerClientInterceptorForTesting : public ProducerClient {
  ...
  void OnTracingStart(mojo::ScopedSharedBufferHandle shared_memory, uint64_t shared_memory_buffer_page_size_bytes) override;
...
class COMPONENT_EXPORT(TRACING_MOJOM) PerfettoServiceInterceptorForTesting : public PerfettoService {
  ...
  void ConnectToProducerHost(mojo::PendingRemote<ProducerClient> producer_client, mojo::PendingReceiver<ProducerHost> producer_host_receiver) override;
};
...
class COMPONENT_EXPORT(TRACING_MOJOM) ConsumerHostInterceptorForTesting : public ConsumerHost {
  ...
  void EnableTracing(mojo::PendingReceiver<TracingSessionHost> tracing_session_host, mojo::PendingRemote<TracingSessionClient> tracing_session_client, const ::perfetto::TraceConfig& config, TracingClientPriority priority) override;
};
