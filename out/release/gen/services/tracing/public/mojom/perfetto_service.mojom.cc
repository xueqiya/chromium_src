...
void ProducerClientProxy::OnTracingStart(
    mojo::ScopedSharedBufferHandle in_shared_memory, uint64_t in_shared_memory_buffer_page_size_bytes) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PerfettoServiceProxy::ConnectToProducerHost(
    mojo::PendingRemote<ProducerClient> in_producer_client, mojo::PendingReceiver<ProducerHost> in_producer_host_receiver) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
