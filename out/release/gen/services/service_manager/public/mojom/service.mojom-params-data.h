...
class Service_OnStart_ResponseParamsDataView {
 public:
  ...
  bool is_null() const { return !data_; }
  template <typename UserType>
  UserType TakeConnectorReceiver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::service_manager::mojom::ConnectorInterfaceBase>>(
            &data_->connector_receiver, &result, context_);
    DCHECK(ret);
    return result;
  }
  template <typename UserType>
  UserType TakeControlReceiver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<::service_manager::mojom::ServiceControlAssociatedRequestDataView>(
            &data_->control_receiver, &result, context_);
    DCHECK(ret);
    return result;
  }
 private:
