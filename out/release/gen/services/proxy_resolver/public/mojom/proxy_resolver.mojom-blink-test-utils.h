...
class BLINK_PLATFORM_EXPORT ProxyResolverInterceptorForTesting : public ProxyResolver {
  ...
  void GetProxyForUrl(const ::blink::KURL& url, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, mojo::PendingRemote<ProxyResolverRequestClient> client) override;
};
...
class BLINK_PLATFORM_EXPORT ProxyResolverRequestClientInterceptorForTesting : public ProxyResolverRequestClient {
  ...
  void ResolveDns(const WTF::String& host, HostResolveOperation operation, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, mojo::PendingRemote<HostResolverRequestClient> client) override;
};
