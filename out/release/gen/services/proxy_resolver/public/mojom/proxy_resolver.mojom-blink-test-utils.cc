// services/proxy_resolver/public/mojom/proxy_resolver.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void ProxyResolverInterceptorForTesting::GetProxyForUrl(const ::blink::KURL& url, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, mojo::PendingRemote<ProxyResolverRequestClient> client) {
...
void ProxyResolverRequestClientInterceptorForTesting::ResolveDns(const WTF::String& host, HostResolveOperation operation, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, mojo::PendingRemote<HostResolverRequestClient> client) {
...
void ProxyResolverFactoryRequestClientInterceptorForTesting::ResolveDns(const WTF::String& host, HostResolveOperation operation, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, mojo::PendingRemote<HostResolverRequestClient> client) {
  GetForwardingInterface()->ResolveDns(std::move(host), std::move(operation), std::move(network_isolation_key), std::move(client));
}
