...
class UsbDeviceManager_RefreshDeviceInfo_ForwardToCallback
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(UsbDeviceManager_RefreshDeviceInfo_ForwardToCallback);
};
...
void UsbDeviceManagerProxy::RefreshDeviceInfo(
    const std::string& in_guid, RefreshDeviceInfoCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::UsbDeviceManager::RefreshDeviceInfo");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::device::mojom::internal::UsbDeviceManager_RefreshDeviceInfo_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->guid)::BaseType::BufferWriter
...
class UsbDeviceManager_RefreshDeviceInfo_ProxyToResponder {
 public:
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(UsbDeviceManager_RefreshDeviceInfo_ProxyToResponder);
};

bool UsbDeviceManager_RefreshDeviceInfo_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "device::mojom::UsbDeviceManager::RefreshDeviceInfoCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  UsbDeviceManager_RefreshDeviceInfo_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void UsbDeviceManager_RefreshDeviceInfo_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kUsbDeviceManager_RefreshDeviceInfo_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::device::mojom::internal::UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::UsbDeviceManager::RefreshDeviceInfoCallback",
               "message", message.name());
#endif
...
std::move(p_options), std::move(callback));
    ...
    case internal::kUsbDeviceManager_RefreshDeviceInfo_Name: {
      ...
      bool success = true;
      std::string p_guid{};
      UsbDeviceManager_RefreshDeviceInfo_ParamsDataView input_data_view(params, &serialization_context);
