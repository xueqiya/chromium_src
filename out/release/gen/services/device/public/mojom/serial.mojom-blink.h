...
class BLINK_PLATFORM_EXPORT SerialPortManager
 ...
 public:
  ...
  virtual void GetPort(const ::base::UnguessableToken& token, mojo::PendingReceiver<SerialPort> port_receiver, mojo::PendingRemote<SerialPortConnectionWatcher> watcher) = 0;
};
...
class BLINK_PLATFORM_EXPORT SerialPort
 ...
 public:
  ...
  virtual void Open(SerialConnectionOptionsPtr options, mojo::ScopedDataPipeConsumerHandle in_stream, mojo::ScopedDataPipeProducerHandle out_stream, mojo::PendingRemote<SerialPortClient> client, OpenCallback callback) = 0;
...
class BLINK_PLATFORM_EXPORT SerialPortManagerProxy
 ...
 public:
  ...
  void GetPort(const ::base::UnguessableToken& token, mojo::PendingReceiver<SerialPort> port_receiver, mojo::PendingRemote<SerialPortConnectionWatcher> watcher) final;
...
class BLINK_PLATFORM_EXPORT SerialPortProxy
 ...
 public:
  ...
  void Open(SerialConnectionOptionsPtr options, mojo::ScopedDataPipeConsumerHandle in_stream, mojo::ScopedDataPipeProducerHandle out_stream, mojo::PendingRemote<SerialPortClient> client, OpenCallback callback) final;
