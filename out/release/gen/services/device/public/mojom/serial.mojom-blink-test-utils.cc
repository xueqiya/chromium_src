// services/device/public/mojom/serial.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void SerialPortManagerInterceptorForTesting::GetPort(const ::base::UnguessableToken& token, mojo::PendingReceiver<SerialPort> port_receiver, mojo::PendingRemote<SerialPortConnectionWatcher> watcher) {
  GetForwardingInterface()->GetPort(std::move(token), std::move(port_receiver), std::move(watcher));
}
...
void SerialPortInterceptorForTesting::Open(SerialConnectionOptionsPtr options, mojo::ScopedDataPipeConsumerHandle in_stream, mojo::ScopedDataPipeProducerHandle out_stream, mojo::PendingRemote<SerialPortClient> client, OpenCallback callback) {
...
void SerialPortAsyncWaiter::Open(
    SerialConnectionOptionsPtr options, mojo::ScopedDataPipeConsumerHandle in_stream, mojo::ScopedDataPipeProducerHandle out_stream, mojo::PendingRemote<SerialPortClient> client, bool* out_success) {
  base::RunLoop loop;
