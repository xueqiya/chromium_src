...
using HidConnectionWatcherPtr = mojo::InterfacePtr<HidConnectionWatcher>;
using HidConnectionWatcherPtrInfo = mojo::InterfacePtrInfo<HidConnectionWatcher>;
using ThreadSafeHidConnectionWatcherPtr =
    mojo::ThreadSafeInterfacePtr<HidConnectionWatcher>;

using HidConnectionWatcherRequest = mojo::InterfaceRequest<HidConnectionWatcher>;

using HidConnectionWatcherAssociatedPtr =
    mojo::AssociatedInterfacePtr<HidConnectionWatcher>;
using ThreadSafeHidConnectionWatcherAssociatedPtr =
    mojo::ThreadSafeAssociatedInterfacePtr<HidConnectionWatcher>;
using HidConnectionWatcherAssociatedPtrInfo =
    mojo::AssociatedInterfacePtrInfo<HidConnectionWatcher>;

using HidConnectionWatcherAssociatedRequest =
    mojo::AssociatedInterfaceRequest<HidConnectionWatcher>;
