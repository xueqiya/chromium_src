...
constexpr uint32_t kWakeLockProvider_NotifyOnWakeLockDeactivation_Name = 2;
constexpr uint32_t kWakeLockProvider_GetActiveWakeLocksForTests_Name = 3;
constexpr uint32_t kWakeLockObserver_OnWakeLockDeactivated_Name = 0;
