// services/device/public/mojom/wake_lock_context.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void WakeLockContextInterceptorForTesting::GetWakeLock(::device::mojom::WakeLockType type, ::device::mojom::WakeLockReason reason, const std::string& description, mojo::PendingReceiver<::device::mojom::WakeLock> wake_lock) {
