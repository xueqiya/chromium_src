...
// static
bool UsbDeviceManager_RefreshDeviceInfo_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_RefreshDeviceInfo_Params_Data* object = static_cast<const UsbDeviceManager_RefreshDeviceInfo_Params_Data*>(data);
...
UsbDeviceManager_RefreshDeviceInfo_Params_Data::UsbDeviceManager_RefreshDeviceInfo_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data* object = static_cast<const UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data*>(data);
...
UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data::UsbDeviceManager_RefreshDeviceInfo_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
