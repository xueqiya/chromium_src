// services/device/public/mojom/hid.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void HidManagerInterceptorForTesting::Connect(const std::string& device_guid, mojo::PendingRemote<HidConnectionClient> connection_client, mojo::PendingRemote<HidConnectionWatcher> watcher, ConnectCallback callback) {
...
void HidManagerAsyncWaiter::Connect(
    const std::string& device_guid, mojo::PendingRemote<HidConnectionClient> connection_client, mojo::PendingRemote<HidConnectionWatcher> watcher, mojo::PendingRemote<HidConnection>* out_connection) {
  base::RunLoop loop;
