// services/device/public/mojom/wake_lock_context.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void WakeLockContextInterceptorForTesting::GetWakeLock(::device::mojom::blink::WakeLockType type, ::device::mojom::blink::WakeLockReason reason, const WTF::String& description, mojo::PendingReceiver<::device::mojom::blink::WakeLock> wake_lock) {
