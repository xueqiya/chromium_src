...
// static
bool StructTraits<::device::mojom::blink::NDEFScanOptions::DataView, ::device::mojom::blink::NDEFScanOptionsPtr>::Read(
    ::device::mojom::blink::NDEFScanOptions::DataView input,
    ::device::mojom::blink::NDEFScanOptionsPtr* output) {
  bool success = true;
  ::device::mojom::blink::NDEFScanOptionsPtr result(::device::mojom::blink::NDEFScanOptions::New());
