...
class BLINK_PLATFORM_EXPORT WakeLockProvider
 ...
 public:
  ...
  virtual void GetWakeLockWithoutContext(::device::mojom::blink::WakeLockType type, ::device::mojom::blink::WakeLockReason reason, const WTF::String& description, mojo::PendingReceiver<::device::mojom::blink::WakeLock> wake_lock) = 0;
...
class BLINK_PLATFORM_EXPORT WakeLockProviderProxy
 ...
 public:
  ...
  void GetWakeLockWithoutContext(::device::mojom::blink::WakeLockType type, ::device::mojom::blink::WakeLockReason reason, const WTF::String& description, mojo::PendingReceiver<::device::mojom::blink::WakeLock> wake_lock) final;
