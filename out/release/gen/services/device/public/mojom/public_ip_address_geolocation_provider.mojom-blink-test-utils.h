...
class BLINK_PLATFORM_EXPORT PublicIpAddressGeolocationProviderInterceptorForTesting : public PublicIpAddressGeolocationProvider {
  ...
  void CreateGeolocation(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr tag, mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver) override;
};
