...
class BLINK_PLATFORM_EXPORT WakeLockProviderInterceptorForTesting : public WakeLockProvider {
  ...
  void GetWakeLockWithoutContext(::device::mojom::blink::WakeLockType type, ::device::mojom::blink::WakeLockReason reason, const WTF::String& description, mojo::PendingReceiver<::device::mojom::blink::WakeLock> wake_lock) override;
