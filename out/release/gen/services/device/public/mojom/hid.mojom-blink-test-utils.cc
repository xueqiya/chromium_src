// services/device/public/mojom/hid.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void HidManagerInterceptorForTesting::Connect(const WTF::String& device_guid, mojo::PendingRemote<HidConnectionClient> connection_client, mojo::PendingRemote<HidConnectionWatcher> watcher, ConnectCallback callback) {
  GetForwardingInterface()->Connect(std::move(device_guid), std::move(connection_client), std::move(watcher), std::move(callback));
}
...
void HidManagerAsyncWaiter::Connect(
  ...
  base::RunLoop loop;
  proxy_->Connect(std::move(device_guid),std::move(connection_client),std::move(watcher),
      base::BindOnce(
          [](base::RunLoop* loop,
