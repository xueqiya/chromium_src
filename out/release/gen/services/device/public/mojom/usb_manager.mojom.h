...
class  UsbDeviceManager
 ...
 public:
  ...
  virtual void GetDevice(const std::string& guid, mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver, mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client) = 0;


  using RefreshDeviceInfoCallback = base::OnceCallback<void(::device::mojom::UsbDeviceInfoPtr)>;
  
  virtual void RefreshDeviceInfo(const std::string& guid, RefreshDeviceInfoCallback callback) = 0;
...
class  UsbDeviceManagerProxy
 ...
 public:
  ...
  void GetDevice(const std::string& guid, mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver, mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client) final;
  
  void RefreshDeviceInfo(const std::string& guid, RefreshDeviceInfoCallback callback) final;
