...
void HidManagerProxy::Connect(
    const std::string& in_device_guid, mojo::PendingRemote<HidConnectionClient> in_connection_client, mojo::PendingRemote<HidConnectionWatcher> in_watcher, ConnectCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::HidConnectionClient::OnInputReport");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
