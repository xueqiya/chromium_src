...
bool SerialPortManager_GetPort_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->port_receiver, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->port_receiver,
                                                 validation_context)) {
    return false;
  }
...
bool SerialPort_Close_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SerialPort_Close_Params_Data* object = static_cast<const SerialPort_Close_Params_Data*>(data);
...
bool SerialPort_Close_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SerialPort_Close_ResponseParams_Data* object = static_cast<const SerialPort_Close_ResponseParams_Data*>(data);
