...
void HidManagerProxy::Connect(
    const WTF::String& in_device_guid, mojo::PendingRemote<HidConnectionClient> in_connection_client, mojo::PendingRemote<HidConnectionWatcher> in_watcher, ConnectCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
