// services/device/public/mojom/bluetooth_system.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_PLATFORM_EXPORT BluetoothSystemFactoryInterceptorForTesting : public BluetoothSystemFactory {
  ...
  void Create(mojo::PendingReceiver<BluetoothSystem> system, mojo::PendingRemote<BluetoothSystemClient> system_client) override;
};
