...
class  SerialPortManagerInterceptorForTesting : public SerialPortManager {
  ...
  void GetPort(const ::base::UnguessableToken& token, mojo::PendingReceiver<SerialPort> port_receiver, mojo::PendingRemote<SerialPortConnectionWatcher> watcher) override;
};
...
class  SerialPortInterceptorForTesting : public SerialPort {
  ...
  void Open(SerialConnectionOptionsPtr options, mojo::ScopedDataPipeConsumerHandle in_stream, mojo::ScopedDataPipeProducerHandle out_stream, mojo::PendingRemote<SerialPortClient> client, OpenCallback callback) override;
