...
class BLINK_PLATFORM_EXPORT PublicIpAddressGeolocationProvider
 ...
 public:
  ...
  virtual void CreateGeolocation(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr tag, mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver) = 0;
};
