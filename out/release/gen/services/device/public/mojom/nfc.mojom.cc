...
NDEFRecord::NDEFRecord(
    ...
    const base::Optional<std::string>& encoding_in,
...
NDEFScanOptions::NDEFScanOptions(
    const base::Optional<std::string>& id_in,
    const base::Optional<std::string>& record_type_in,
    const base::Optional<std::string>& media_type_in)
    : id(std::move(id_in)),
      record_type(std::move(record_type_in)),
      media_type(std::move(media_type_in)) {}
...
void NFCProxy::Watch(
    NDEFScanOptionsPtr in_options, uint32_t in_id, WatchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  typename decltype(params->options)::BaseType::BufferWriter
      options_writer;
  mojo::internal::Serialize<::device::mojom::NDEFScanOptionsDataView>(
      in_options, buffer, &options_writer, &serialization_context);
  params->options.Set(
      options_writer.is_null() ? nullptr : options_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
std::move(p_client));
    ...
    case internal::kNFC_SuspendNFCOperations_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::NFC::SuspendNFCOperations",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::NFC::SuspendNFCOperations");
    ...
    case internal::kNFC_ResumeNFCOperations_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::NFC::ResumeNFCOperations",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::NFC::ResumeNFCOperations");
...
std::move(p_options), std::move(callback));
    ...
    case internal::kNFC_CancelPush_Name: {
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->CancelPush(std::move(callback));
      return true;
    }
    case internal::kNFC_Watch_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_id), std::move(callback));
    ...
    case internal::kNFC_CancelAllWatches_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::NFC::CancelAllWatches",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::NFC::CancelAllWatches");
...
static const mojo::internal::GenericValidationInfo kNFCValidationInfo[] = {
    ...
    {&internal::NFC_CancelPush_Params_Data::Validate,
     &internal::NFC_CancelPush_ResponseParams_Data::Validate},
    ...
    {&internal::NFC_CancelWatch_Params_Data::Validate,
     &internal::NFC_CancelWatch_ResponseParams_Data::Validate},
    {&internal::NFC_CancelAllWatches_Params_Data::Validate,
     &internal::NFC_CancelAllWatches_ResponseParams_Data::Validate},
    {&internal::NFC_SuspendNFCOperations_Params_Data::Validate,
     nullptr /* no response */},
    {&internal::NFC_ResumeNFCOperations_Params_Data::Validate,
     nullptr /* no response */},
};
...
void NFCClientProxy::OnWatch(
    const std::vector<uint32_t>& in_watch_ids, const base::Optional<std::string>& in_serial_number, NDEFMessagePtr in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NFCClientProxy::OnError(
    NDEFErrorPtr in_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::NFCClient::OnError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::device::mojom::internal::NFCClient_OnError_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->error)::BaseType::BufferWriter
...
bool NFCClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kNFCClient_OnWatch_Name: {
      ...
      base::Optional<std::string> p_serial_number{};
      NDEFMessagePtr p_message{};
...
std::move(p_message));
    ...
    case internal::kNFCClient_OnError_Name: {
      ...
      bool success = true;
      NDEFErrorPtr p_error{};
      NFCClient_OnError_ParamsDataView input_data_view(params, &serialization_context);
...
// static
bool StructTraits<::device::mojom::NDEFScanOptions::DataView, ::device::mojom::NDEFScanOptionsPtr>::Read(
    ::device::mojom::NDEFScanOptions::DataView input,
    ::device::mojom::NDEFScanOptionsPtr* output) {
  bool success = true;
  ::device::mojom::NDEFScanOptionsPtr result(::device::mojom::NDEFScanOptions::New());
