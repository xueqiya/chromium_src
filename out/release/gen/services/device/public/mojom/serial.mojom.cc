...
void SerialPortManagerProxy::GetPort(
    const ::base::UnguessableToken& in_token, mojo::PendingReceiver<SerialPort> in_port_receiver, mojo::PendingRemote<SerialPortConnectionWatcher> in_watcher) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPortManager::GetPort");
#endif
  ...
  mojo::internal::Serialize<mojo::InterfaceRequestDataView<::device::mojom::SerialPortInterfaceBase>>(
      in_port_receiver, &params->port_receiver, &serialization_context);
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      !mojo::internal::IsHandleOrInterfaceValid(params->port_receiver),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
      "invalid port_receiver in SerialPortManager.GetPort request");
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPortManager::GetDevicesCallback",
               "message", message.name());
#endif
...
bool SerialPortManagerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kSerialPortManager_GetPort_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::SerialPortManager::GetPort",
          "message", message->name());
#endif
      ...
      mojo::PendingReceiver<SerialPort> p_port_receiver{};
      ...
      if (success) {
        p_port_receiver =
            input_data_view.TakePortReceiver<decltype(p_port_receiver)>();
      }
      if (success) {
        p_watcher =
...
static const mojo::internal::GenericValidationInfo kSerialPortManagerValidationInfo[] = {
    ...
    {&internal::SerialPortManager_GetPort_Params_Data::Validate,
     nullptr /* no response */},
};
...
void SerialPortProxy::Open(
    SerialConnectionOptionsPtr in_options, mojo::ScopedDataPipeConsumerHandle in_in_stream, mojo::ScopedDataPipeProducerHandle in_out_stream, mojo::PendingRemote<SerialPortClient> in_client, OpenCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::Open");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::ClearSendError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::ClearReadError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::Flush");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::SetControlSignals");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPort::ConfigurePort");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
void SerialPortProxy::Close(
  ...
  auto* buffer = message.payload_buffer();
  ::device::mojom::internal::SerialPort_Close_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  message.AttachHandlesFromSerializationContext(
...
bool SerialPort_Open_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "device::mojom::SerialPort::OpenCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::OpenCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::FlushCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::GetControlSignalsCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::SetControlSignalsCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::ConfigurePortCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::GetPortInfoCallback",
               "message", message.name());
#endif
...
bool SerialPort_Close_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  SerialPort_Close_ResponseParamsDataView input_data_view(params, &serialization_context);
...
void SerialPort_Close_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kSerialPort_Close_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::device::mojom::internal::SerialPort_Close_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  message.AttachHandlesFromSerializationContext(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::SerialPort::CloseCallback",
               "message", message.name());
#endif
...
bool SerialPortStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kSerialPort_ClearSendError_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::SerialPort::ClearSendError",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::SerialPort::ClearSendError");
...
std::move(p_consumer));
    ...
    case internal::kSerialPort_ClearReadError_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::SerialPort::ClearReadError",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::SerialPort::ClearReadError");
...
bool SerialPortStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kSerialPort_Open_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)device::mojom::SerialPort::Open",
          "message", message->name());
#endif
      static constexpr uint32_t kMessageHash = base::MD5Hash32Constexpr(
              "(Impl)device::mojom::SerialPort::Open");
...
std::move(p_options), std::move(callback));
    ...
    case internal::kSerialPort_Close_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      SerialPort_Close_ParamsDataView input_data_view(params, &serialization_context);
...
static const mojo::internal::GenericValidationInfo kSerialPortValidationInfo[] = {
    {&internal::SerialPort_Open_Params_Data::Validate,
     &internal::SerialPort_Open_ResponseParams_Data::Validate},
    {&internal::SerialPort_ClearSendError_Params_Data::Validate,
     nullptr /* no response */},
    {&internal::SerialPort_ClearReadError_Params_Data::Validate,
     nullptr /* no response */},
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPortClient::OnReadError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::SerialPortClient::OnSendError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
