...
class  WakeLockProviderInterceptorForTesting : public WakeLockProvider {
  ...
  void GetWakeLockWithoutContext(::device::mojom::WakeLockType type, ::device::mojom::WakeLockReason reason, const std::string& description, mojo::PendingReceiver<::device::mojom::WakeLock> wake_lock) override;
