...
class BLINK_PLATFORM_EXPORT NDEFScanOptions {
 public:
  template <typename T>
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        NDEFScanOptions::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct BLINK_PLATFORM_EXPORT StructTraits<::device::mojom::blink::NDEFWriteOptions::DataView,
  ...
  static decltype(::device::mojom::blink::NDEFWriteOptions::ignore_read) ignore_read(
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::device::mojom::blink::NDEFScanOptions::DataView,
                                         ::device::mojom::blink::NDEFScanOptionsPtr> {
  static bool IsNull(const ::device::mojom::blink::NDEFScanOptionsPtr& input) { return !input; }
  static void SetToNull(::device::mojom::blink::NDEFScanOptionsPtr* output) { output->reset(); }

  static const decltype(::device::mojom::blink::NDEFScanOptions::id)& id(
      const ::device::mojom::blink::NDEFScanOptionsPtr& input) {
    return input->id;
  }

  static const decltype(::device::mojom::blink::NDEFScanOptions::record_type)& record_type(
      const ::device::mojom::blink::NDEFScanOptionsPtr& input) {
    return input->record_type;
  }

  static const decltype(::device::mojom::blink::NDEFScanOptions::media_type)& media_type(
      const ::device::mojom::blink::NDEFScanOptionsPtr& input) {
    return input->media_type;
  }

  static bool Read(::device::mojom::blink::NDEFScanOptions::DataView input, ::device::mojom::blink::NDEFScanOptionsPtr* output);
};
