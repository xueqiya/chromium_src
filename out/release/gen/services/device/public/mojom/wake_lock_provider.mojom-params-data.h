...
class WakeLockProvider_GetWakeLockContextForID_ParamsDataView {
 public:
  ...
  UserType TakeContext() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::device::mojom::WakeLockContextInterfaceBase>>(
...
class WakeLockProvider_NotifyOnWakeLockDeactivation_ParamsDataView {
 public:
  ...
  UserType TakeObserver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::device::mojom::WakeLockObserverInterfaceBase>>(
