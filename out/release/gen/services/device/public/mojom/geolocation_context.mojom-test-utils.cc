// services/device/public/mojom/geolocation_context.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void GeolocationContextInterceptorForTesting::BindGeolocation(mojo::PendingReceiver<::device::mojom::Geolocation> receiver) {
  GetForwardingInterface()->BindGeolocation(std::move(receiver));
}
