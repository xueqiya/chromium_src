...
TNode<Int32T> Method_JSPromise_Status_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSPromise, Int32T> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    TNode<BoolT> tmp1;
    USE(tmp1);
    tmp1 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(JSPromise::kStatusShift, 0)));
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp1});
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    TNode<Smi>tmp3 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp0, tmp2});
    TNode<Int32T> tmp4;
    USE(tmp4);
    tmp4 = Convert_int32_Smi_0(state_, TNode<Smi>{tmp3});
    TNode<Int32T> tmp5;
    USE(tmp5);
    tmp5 = FromConstexpr_int32_constexpr_int31_0(state_, JSPromise::kStatusMask);
    TNode<Int32T> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).Word32And(TNode<Int32T>{tmp4}, TNode<Int32T>{tmp5});
    TNode<Int32T> tmp7;
    USE(tmp7);
    tmp7 = Convert_PromiseState_int32_0(state_, TNode<Int32T>{tmp6});
    ca_.Goto(&block2, tmp0, tmp7);
  }

    TNode<JSPromise> tmp8;
    TNode<Int32T> tmp9;
    ca_.Bind(&block2, &tmp8, &tmp9);
  return TNode<Int32T>{tmp9};
}
...
void Method_JSPromise_SetStatus_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this, Promise::PromiseState p_status) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block9(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_this);
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi> tmp1;
    USE(tmp1);
    tmp1 = CodeStubAssembler(state_).SmiConstant(p_status);
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    TNode<IntPtrT> tmp3;
    ...
    TNode<Smi> tmp5;
    USE(tmp5);
    tmp5 = CodeStubAssembler(state_).SmiOr(TNode<Smi>{tmp4}, TNode<Smi>{tmp1});
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp0, tmp2}, tmp5);
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.Status() == PromiseState::kPending' failed", "src/objects/js-promise.tq", 22);
  }

  if (block4.is_used()) {
    TNode<JSPromise> tmp7;
    ca_.Bind(&block4, &tmp7);
  }

  if (block9.is_used()) {
    TNode<JSPromise> tmp8;
    ca_.Bind(&block9, &tmp8);
    CodeStubAssembler(state_).FailAssert("Torque assert 'status != PromiseState::kPending' failed", "src/objects/js-promise.tq", 23);
  }
...
TNode<BoolT> Method_JSPromise_HasHandler_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi> tmp3;
    USE(tmp3);
    tmp3 = FromConstexpr_Smi_constexpr_int31_0(state_, JSPromise::kHasHandlerMask);
    TNode<Smi> tmp4;
    USE(tmp4);
    tmp4 = CodeStubAssembler(state_).SmiAnd(TNode<Smi>{tmp2}, TNode<Smi>{tmp3});
    TNode<Smi> tmp5;
    USE(tmp5);
    tmp5 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    TNode<BoolT> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).SmiNotEqual(TNode<Smi>{tmp4}, TNode<Smi>{tmp5});
    ca_.Goto(&block2, tmp0, tmp6);
  }
...
void Method_JSPromise_SetHasHandler_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSPromise> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_this);
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi> tmp4;
    USE(tmp4);
    tmp4 = CodeStubAssembler(state_).SmiOr(TNode<Smi>{tmp2}, TNode<Smi>{tmp3});
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp0, tmp1}, tmp4);
