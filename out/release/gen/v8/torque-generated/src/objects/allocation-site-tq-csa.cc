...
TNode<AllocationSite> LoadAllocationMementoAllocationSite_0(compiler::CodeAssemblerState* state_, TNode<AllocationMemento> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<AllocationMemento, AllocationSite> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o);
  ...
  if (block0.is_used()) {
    ...
    TNode<AllocationSite>tmp2 = CodeStubAssembler(state_).LoadReference<AllocationSite>(CodeStubAssembler::Reference{tmp0, tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }

    TNode<AllocationMemento> tmp3;
    TNode<AllocationSite> tmp4;
    ca_.Bind(&block2, &tmp3, &tmp4);
  return TNode<AllocationSite>{tmp4};
}
...
void StoreAllocationMementoAllocationSite_0(compiler::CodeAssemblerState* state_, TNode<AllocationMemento> p_o, TNode<AllocationSite> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<AllocationMemento, AllocationSite> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<AllocationMemento, AllocationSite> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<AllocationSite>(CodeStubAssembler::Reference{tmp0, tmp2}, tmp1);
