...
TF_BUILTIN(ProxyGetProperty, CodeStubAssembler) {
  ...
  if (block23.is_used()) {
    ...
    TNode<Object> tmp94;
    USE(tmp94);
    tmp94 = CodeStubAssembler(state_).Call(TNode<Context>{tmp84}, TNode<Object>{tmp93}, TNode<Object>{tmp89}, TNode<Object>{tmp90}, TNode<Object>{tmp86}, TNode<Object>{tmp87});
