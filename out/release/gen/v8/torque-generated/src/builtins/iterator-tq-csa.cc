...
TF_BUILTIN(CallIteratorWithFeedback, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    TNode<Object> tmp26;
    USE(tmp26);
    tmp26 = CodeStubAssembler(state_).Call(TNode<Context>{tmp17}, TNode<Object>{tmp25}, TNode<Object>{tmp18});
...
void IteratorCloseOnException_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructIteratorRecord p_iterator, TNode<Object> p_exception, compiler::CodeAssemblerLabel* label_IfException, compiler::TypedCodeAssemblerVariable<Object>* label_IfException_parameter_0) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object, JSReceiver, String, Context, Object> block4(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object, BoolT> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object, BoolT> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object, BoolT, BoolT> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, Object, Context, Object, JSReceiver, Object> block12(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Object> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_iterator.object, p_iterator.next, p_exception);
  ...
  if (block0.is_used()) {
    ...
    TNode<String> tmp4;
    USE(tmp4);
    tmp4 = kReturnString_0(state_);
    TNode<Object> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerExceptionHandlerLabel catch6__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
    { compiler::CodeAssemblerScopedExceptionHandler s(&ca_, &catch6__label);
    tmp5 = CodeStubAssembler(state_).GetProperty(TNode<Context>{tmp0}, TNode<Object>{tmp1}, TNode<Object>{tmp4});
    }
    if (catch6__label.is_used()) {
      compiler::CodeAssemblerLabel catch6_skip(&ca_);
      ca_.Goto(&catch6_skip);
      TNode<Object> catch6_exception_object;
      ca_.Bind(&catch6__label, &catch6_exception_object);
      ca_.Goto(&block4, tmp0, tmp1, tmp2, tmp3, ca_.Uninitialized<Object>(), tmp1, tmp4, tmp0, catch6_exception_object);
    ...
    TNode<BoolT> tmp8;
    USE(tmp8);
    tmp8 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp5}, TNode<HeapObject>{tmp7});
    ca_.Branch(tmp8, &block7, &block8, tmp0, tmp1, tmp2, tmp3, tmp5, tmp8);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Goto(&block9, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<Object> tmp29;
    TNode<BoolT> tmp30;
    ca_.Bind(&block8, &tmp25, &tmp26, &tmp27, &tmp28, &tmp29, &tmp30);
    TNode<Oddball> tmp31;
    USE(tmp31);
    tmp31 = Null_0(state_);
    TNode<BoolT> tmp32;
    USE(tmp32);
    tmp32 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp29}, TNode<HeapObject>{tmp31});
    ca_.Goto(&block9, tmp25, tmp26, tmp27, tmp28, tmp29, tmp30, tmp32);
  }
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(tmp39, &block5, &block6, tmp33, tmp34, tmp35, tmp36, tmp37);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<Object> tmp43;
    TNode<Object> tmp44;
    ca_.Bind(&block5, &tmp40, &tmp41, &tmp42, &tmp43, &tmp44);
  ...
  if (block6.is_used()) {
    ...
    TNode<Object> tmp48;
    TNode<Object> tmp49;
    ca_.Bind(&block6, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49);
    TNode<Object> tmp50;
    USE(tmp50);
    compiler::CodeAssemblerExceptionHandlerLabel catch51__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
    { compiler::CodeAssemblerScopedExceptionHandler s(&ca_, &catch51__label);
    tmp50 = CodeStubAssembler(state_).Call(TNode<Context>{tmp45}, TNode<Object>{tmp49}, TNode<Object>{tmp46});
    }
    if (catch51__label.is_used()) {
      compiler::CodeAssemblerLabel catch51_skip(&ca_);
      ca_.Goto(&catch51_skip);
      TNode<Object> catch51_exception_object;
      ca_.Bind(&catch51__label, &catch51_exception_object);
      ca_.Goto(&block12, tmp45, tmp46, tmp47, tmp48, tmp49, tmp45, tmp49, tmp46, catch51_exception_object);
  ...
  if (block12.is_used()) {
    ...
    TNode<Object> tmp60;
    ca_.Bind(&block12, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60);
    ca_.Goto(&block1, tmp55);
  }

  if (block1.is_used()) {
    TNode<Object> tmp61;
    ca_.Bind(&block1, &tmp61);
    *label_IfException_parameter_0 = tmp61;
    ca_.Goto(label_IfException);
  }
}
