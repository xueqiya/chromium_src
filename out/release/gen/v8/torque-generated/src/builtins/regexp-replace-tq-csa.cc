...
void RegExpReplaceCallableNoExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, Object, Smi, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, Object, Smi, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, Object, String, Object, String, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block35(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, String, JSReceiver, Smi, IntPtrT, Object, String, Object, String, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block36(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    TNode<Smi>tmp25 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp16, tmp24});
    TNode<IntPtrT> tmp26;
    USE(tmp26);
    tmp26 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp25});
    TNode<UintPtrT> tmp27;
    USE(tmp27);
    tmp27 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp21});
    ...
    ca_.Branch(tmp29, &block10, &block11, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp16, tmp16, tmp22, tmp26, tmp21, tmp21, tmp16, tmp22, tmp26, tmp21, tmp21);
  }
  ...
  if (block10.is_used()) {
    ...
    TNode<IntPtrT> tmp46;
    TNode<IntPtrT> tmp47;
    ca_.Bind(&block10, &tmp30, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38, &tmp39, &tmp40, &tmp41, &tmp42, &tmp43, &tmp44, &tmp45, &tmp46, &tmp47);
    TNode<IntPtrT> tmp48;
    USE(tmp48);
    tmp48 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp49;
    USE(tmp49);
    tmp49 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp47}, TNode<IntPtrT>{tmp48});
    TNode<IntPtrT> tmp50;
    USE(tmp50);
    tmp50 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp44}, TNode<IntPtrT>{tmp49});
    TNode<HeapObject> tmp51;
    USE(tmp51);
    TNode<IntPtrT> tmp52;
    USE(tmp52);
    std::tie(tmp51, tmp52) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp43}, TNode<IntPtrT>{tmp50}).Flatten();
    TNode<Object>tmp53 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp51, tmp52});
    TNode<Smi> tmp54;
    USE(tmp54);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp54 = Cast_Smi_0(state_, TNode<Object>{tmp53}, &label0);
    ca_.Goto(&block15, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp53, tmp53, tmp54);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block16, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp53, tmp53);
    }
  }
  ...
  if (block11.is_used()) {
    ...
    TNode<IntPtrT> tmp71;
    TNode<IntPtrT> tmp72;
    ca_.Bind(&block11, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72);
  ...
  if (block16.is_used()) {
    ...
    TNode<Object> tmp80;
    TNode<Object> tmp81;
    ca_.Bind(&block16, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81);
    TNode<String> tmp82;
    USE(tmp82);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp82 = Cast_String_0(state_, TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(tmp80)}, &label0);
    ca_.Goto(&block29, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp79, tmp80, ca_.UncheckedCast<HeapObject>(tmp80), tmp82);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block30, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp79, tmp80, ca_.UncheckedCast<HeapObject>(tmp80));
    }
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<Object> tmp91;
    TNode<Smi> tmp92;
    ca_.Bind(&block15, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92);
    TNode<Smi> tmp93;
    USE(tmp93);
    tmp93 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    TNode<BoolT> tmp94;
    USE(tmp94);
    tmp94 = CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp92}, TNode<Smi>{tmp93});
    ca_.Branch(tmp94, &block17, &block18, tmp83, tmp84, tmp85, tmp86, tmp87, tmp88, tmp89, tmp90, tmp92);
  }
  ...
  if (block17.is_used()) {
    ...
    USE(tmp105);
    tmp105 = FromConstexpr_intptr_constexpr_int31_0(state_, 11);
    TNode<IntPtrT> tmp106;
    USE(tmp106);
    tmp106 = CodeStubAssembler(state_).WordSar(TNode<IntPtrT>{tmp104}, TNode<IntPtrT>{tmp105});
    TNode<IntPtrT> tmp107;
    USE(tmp107);
    tmp107 = FromConstexpr_intptr_constexpr_int31_0(state_, 2047);
    TNode<IntPtrT> tmp108;
    USE(tmp108);
    tmp108 = CodeStubAssembler(state_).WordAnd(TNode<IntPtrT>{tmp104}, TNode<IntPtrT>{tmp107});
    TNode<IntPtrT> tmp109;
    USE(tmp109);
    tmp109 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp106}, TNode<IntPtrT>{tmp108});
    TNode<Smi> tmp110;
    USE(tmp110);
    tmp110 = Convert_Smi_intptr_0(state_, TNode<IntPtrT>{tmp109});
    ca_.Goto(&block19, tmp95, tmp96, tmp97, tmp98, tmp99, tmp110, tmp101, tmp102, tmp103);
  }
  ...
  if (block18.is_used()) {
    ...
    TNode<Object> tmp118;
    TNode<Smi> tmp119;
    ca_.Bind(&block18, &tmp111, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119);
    ...
    TNode<Smi>tmp123 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp112, tmp122});
    ...
    ca_.Branch(tmp129, &block24, &block25, tmp111, tmp112, tmp113, tmp114, tmp115, tmp116, tmp126, tmp118, tmp119, tmp112, tmp112, tmp120, tmp124, tmp126, tmp126, tmp112, tmp120, tmp124, tmp126, tmp126);
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.Bind(&block24, &tmp130, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139, &tmp140, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149);
    TNode<IntPtrT> tmp150;
    USE(tmp150);
    tmp150 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp151;
    USE(tmp151);
    tmp151 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp149}, TNode<IntPtrT>{tmp150});
    TNode<IntPtrT> tmp152;
    USE(tmp152);
    tmp152 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp146}, TNode<IntPtrT>{tmp151});
    TNode<HeapObject> tmp153;
    USE(tmp153);
    TNode<IntPtrT> tmp154;
    USE(tmp154);
    std::tie(tmp153, tmp154) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp145}, TNode<IntPtrT>{tmp152}).Flatten();
    TNode<Object>tmp155 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp153, tmp154});
    TNode<Smi> tmp156;
    USE(tmp156);
    tmp156 = UnsafeCast_Smi_0(state_, TNode<Context>{tmp130}, TNode<Object>{tmp155});
    TNode<Smi> tmp157;
    USE(tmp157);
    tmp157 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp156}, TNode<Smi>{tmp138});
    ca_.Goto(&block19, tmp130, tmp131, tmp132, tmp133, tmp134, tmp157, tmp136, tmp137, tmp138);
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Bind(&block25, &tmp158, &tmp159, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174, &tmp175, &tmp176, &tmp177);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Goto(&block13, tmp178, tmp179, tmp180, tmp181, tmp182, tmp183, tmp184, tmp185);
  }
  ...
  if (block30.is_used()) {
    ...
    ca_.Bind(&block30, &tmp187, &tmp188, &tmp189, &tmp190, &tmp191, &tmp192, &tmp193, &tmp194, &tmp195);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block29.is_used()) {
    ...
    TNode<String> tmp205;
    ca_.Bind(&block29, &tmp196, &tmp197, &tmp198, &tmp199, &tmp200, &tmp201, &tmp202, &tmp203, &tmp204, &tmp205);
    TNode<Oddball> tmp206;
    USE(tmp206);
    tmp206 = Undefined_0(state_);
    TNode<Object> tmp207;
    USE(tmp207);
    tmp207 = CodeStubAssembler(state_).Call(TNode<Context>{tmp196}, TNode<Object>{tmp200}, TNode<Object>{tmp206}, TNode<Object>{tmp205}, TNode<Object>{tmp201}, TNode<Object>{tmp199});
    TNode<String> tmp208;
    USE(tmp208);
    tmp208 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{tmp196}, TNode<Object>{tmp207});
    TNode<IntPtrT> tmp209;
    USE(tmp209);
    tmp209 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<IntPtrT> tmp210;
    USE(tmp210);
    tmp210 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<IntPtrT> tmp211;
    USE(tmp211);
    tmp211 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp212 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp197, tmp211});
    TNode<IntPtrT> tmp213;
    USE(tmp213);
    tmp213 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp212});
    TNode<UintPtrT> tmp214;
    USE(tmp214);
    tmp214 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp202});
    TNode<UintPtrT> tmp215;
    USE(tmp215);
    tmp215 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp213});
    TNode<BoolT> tmp216;
    USE(tmp216);
    tmp216 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp214}, TNode<UintPtrT>{tmp215});
    ca_.Branch(tmp216, &block35, &block36, tmp196, tmp197, tmp198, tmp199, tmp200, tmp201, tmp202, tmp203, tmp205, tmp207, tmp208, tmp197, tmp197, tmp209, tmp213, tmp202, tmp202, tmp197, tmp209, tmp213, tmp202, tmp202);
  }
  ...
  if (block35.is_used()) {
    ...
    ca_.Bind(&block35, &tmp217, &tmp218, &tmp219, &tmp220, &tmp221, &tmp222, &tmp223, &tmp224, &tmp225, &tmp226, &tmp227, &tmp228, &tmp229, &tmp230, &tmp231, &tmp232, &tmp233, &tmp234, &tmp235, &tmp236, &tmp237, &tmp238);
    TNode<IntPtrT> tmp239;
    USE(tmp239);
    tmp239 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp240;
    USE(tmp240);
    tmp240 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp238}, TNode<IntPtrT>{tmp239});
    TNode<IntPtrT> tmp241;
    USE(tmp241);
    tmp241 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp235}, TNode<IntPtrT>{tmp240});
    TNode<HeapObject> tmp242;
    USE(tmp242);
    TNode<IntPtrT> tmp243;
    USE(tmp243);
    std::tie(tmp242, tmp243) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp234}, TNode<IntPtrT>{tmp241}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp242, tmp243}, tmp227);
    TNode<Smi> tmp244;
    USE(tmp244);
    tmp244 = CodeStubAssembler(state_).LoadStringLengthAsSmi(TNode<String>{tmp225});
    TNode<Smi> tmp245;
    USE(tmp245);
    tmp245 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp222}, TNode<Smi>{tmp244});
    ca_.Goto(&block13, tmp217, tmp218, tmp219, tmp220, tmp221, tmp245, tmp223, tmp224);
  }
  ...
  if (block36.is_used()) {
    ...
    TNode<HeapObject> tmp263;
    TNode<IntPtrT> tmp264;
    TNode<IntPtrT> tmp265;
    TNode<IntPtrT> tmp266;
    TNode<IntPtrT> tmp267;
    ca_.Bind(&block36, &tmp246, &tmp247, &tmp248, &tmp249, &tmp250, &tmp251, &tmp252, &tmp253, &tmp254, &tmp255, &tmp256, &tmp257, &tmp258, &tmp259, &tmp260, &tmp261, &tmp262, &tmp263, &tmp264, &tmp265, &tmp266, &tmp267);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block13.is_used()) {
    ...
    TNode<Object> tmp275;
    ca_.Bind(&block13, &tmp268, &tmp269, &tmp270, &tmp271, &tmp272, &tmp273, &tmp274, &tmp275);
    TNode<IntPtrT> tmp276;
    USE(tmp276);
    tmp276 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    TNode<IntPtrT> tmp277;
    USE(tmp277);
    tmp277 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp274}, TNode<IntPtrT>{tmp276});
    ca_.Goto(&block4, tmp268, tmp269, tmp270, tmp271, tmp272, tmp273, tmp277);
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Bind(&block3, &tmp278, &tmp279, &tmp280, &tmp281, &tmp282, &tmp283, &tmp284);
    ca_.Goto(&block38, tmp278, tmp279, tmp280, tmp281, tmp282);
  }
    ...
    ca_.Bind(&block38, &tmp285, &tmp286, &tmp287, &tmp288, &tmp289);
}
...
void RegExpReplaceCallableWithExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<JSReceiver> p_replaceFn) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, JSReceiver, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, JSReceiver, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, JSReceiver, IntPtrT, JSArray, Object, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, JSReceiver, IntPtrT, JSArray, Object, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp23, &block12, &block13, tmp11, tmp12, tmp13, tmp14, tmp15, tmp12, tmp12, tmp16, tmp20, tmp15, tmp15, tmp12, tmp16, tmp20, tmp15, tmp15);
  }
  ...
  if (block12.is_used()) {
    ...
    TNode<IntPtrT> tmp38;
    TNode<IntPtrT> tmp39;
    ca_.Bind(&block12, &tmp24, &tmp25, &tmp26, &tmp27, &tmp28, &tmp29, &tmp30, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38, &tmp39);
    TNode<IntPtrT> tmp40;
    USE(tmp40);
    ...
    USE(tmp46);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp46 = Cast_JSArray_1(state_, TNode<Context>{tmp24}, TNode<Object>{tmp45}, &label0);
    ca_.Goto(&block15, tmp24, tmp25, tmp26, tmp27, tmp28, tmp45, tmp24, tmp46);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block16, tmp24, tmp25, tmp26, tmp27, tmp28, tmp45, tmp24);
    }
  }
  ...
  if (block13.is_used()) {
    ...
    TNode<IntPtrT> tmp61;
    TNode<IntPtrT> tmp62;
    ca_.Bind(&block13, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ...
    TNode<Object> tmp68;
    TNode<Context> tmp69;
    ca_.Bind(&block16, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69);
    ca_.Goto(&block5, tmp63, tmp64, tmp65, tmp66, tmp67);
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<Context> tmp76;
    TNode<JSArray> tmp77;
    ca_.Bind(&block15, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77);
    TNode<JSReceiver> tmp78;
    USE(tmp78);
    tmp78 = GetReflectApply_0(state_, TNode<Context>{tmp70});
    TNode<Oddball> tmp79;
    USE(tmp79);
    ...
    TNode<Object> tmp81;
    USE(tmp81);
    tmp81 = CodeStubAssembler(state_).Call(TNode<Context>{tmp70}, TNode<Object>{tmp78}, TNode<Object>{tmp79}, TNode<Object>{tmp73}, TNode<Object>{tmp80}, TNode<Object>{tmp77});
    TNode<IntPtrT> tmp82;
    USE(tmp82);
    ...
    TNode<Smi>tmp85 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp71, tmp84});
    TNode<IntPtrT> tmp86;
    USE(tmp86);
    tmp86 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp85});
    TNode<UintPtrT> tmp87;
    USE(tmp87);
    tmp87 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp74});
    TNode<UintPtrT> tmp88;
    USE(tmp88);
    tmp88 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp86});
    TNode<BoolT> tmp89;
    USE(tmp89);
    tmp89 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp87}, TNode<UintPtrT>{tmp88});
    ca_.Branch(tmp89, &block21, &block22, tmp70, tmp71, tmp72, tmp73, tmp74, tmp77, tmp81, tmp71, tmp71, tmp82, tmp86, tmp74, tmp74, tmp71, tmp82, tmp86, tmp74, tmp74);
  }
  ...
  if (block21.is_used()) {
    ...
    TNode<IntPtrT> tmp106;
    TNode<IntPtrT> tmp107;
    ca_.Bind(&block21, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100, &tmp101, &tmp102, &tmp103, &tmp104, &tmp105, &tmp106, &tmp107);
    TNode<IntPtrT> tmp108;
    USE(tmp108);
    tmp108 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp109;
    USE(tmp109);
    tmp109 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp107}, TNode<IntPtrT>{tmp108});
    ...
    USE(tmp112);
    std::tie(tmp111, tmp112) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp103}, TNode<IntPtrT>{tmp110}).Flatten();
    TNode<String> tmp113;
    USE(tmp113);
    tmp113 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{tmp90}, TNode<Object>{tmp96});
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp111, tmp112}, tmp113);
    ca_.Goto(&block5, tmp90, tmp91, tmp92, tmp93, tmp94);
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Bind(&block22, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130, &tmp131);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<IntPtrT> tmp136;
    ca_.Bind(&block5, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136);
    ...
    ca_.Goto(&block4, tmp132, tmp133, tmp134, tmp135, tmp138);
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Goto(&block24, tmp139, tmp140, tmp141, tmp142);
  }
    ...
    ca_.Bind(&block24, &tmp144, &tmp145, &tmp146, &tmp147);
}
...
TNode<String> RegExpReplaceFastGlobalCallable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block0.is_used()) {
    ...
    TNode<JSArray> tmp9;
    USE(tmp9);
    tmp9 = CodeStubAssembler(state_).AllocateJSArray(ElementsKind::PACKED_ELEMENTS, TNode<Map>{tmp8}, TNode<IntPtrT>{tmp5}, TNode<Smi>{tmp6});
