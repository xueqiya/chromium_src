...
TNode<Object> RegExpExec_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block4.is_used()) {
    ...
    TNode<Object> tmp22;
    USE(tmp22);
    tmp22 = CodeStubAssembler(state_).Call(TNode<Context>{tmp14}, TNode<Object>{tmp21}, TNode<Object>{tmp15}, TNode<Object>{tmp16});
    TNode<Oddball> tmp23;
    USE(tmp23);
    tmp23 = Null_0(state_);
    TNode<BoolT> tmp24;
...
TNode<RegExpMatchInfo> RegExpPrototypeExecBodyWithoutResult_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<Number> p_regexpLastIndex, bool p_isFastPath, compiler::CodeAssemblerLabel* label_IfDidNotMatch) {
  ...
  if (block9.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'HasInitialRegExpMap(regexp)' failed", "src/builtins/regexp.tq", 75);
  }
...
TNode<JSFunction> LoadRegExpFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_REGEXP_FUNCTION_INDEX_0(state_, Context::Field::REGEXP_FUNCTION_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kGlobal, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.global");
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kIgnoreCase, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.ignoreCase");
    CodeStubAssembler(state_).Return(tmp2);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kMultiline, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.multiline");
    CodeStubAssembler(state_).Return(tmp2);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kDotAll, -1, "RegExp.prototype.dotAll");
    CodeStubAssembler(state_).Return(tmp2);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kSticky, v8::Isolate::kRegExpPrototypeStickyGetter, "RegExp.prototype.sticky");
    CodeStubAssembler(state_).Return(tmp2);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = FlagGetter_0(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, JSRegExp::Flag::kUnicode, v8::Isolate::kRegExpPrototypeUnicodeGetter, "RegExp.prototype.unicode");
    CodeStubAssembler(state_).Return(tmp2);
  }
}
...
TNode<BoolT> IsRegExp_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_obj) {
  ...
  if (block11.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'value != Undefined' failed", "src/builtins/regexp.tq", 383);
  }
  ...
  if (block19.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert '!ToBoolean(value)' failed", "src/builtins/regexp.tq", 394);
  }
