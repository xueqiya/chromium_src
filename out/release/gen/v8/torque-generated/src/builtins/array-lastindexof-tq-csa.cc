...
TNode<Object> LoadWithHoleCheck_FixedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_IfHole) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp12, &block7, &block8, tmp0, tmp1, tmp2, tmp3, tmp3, tmp3, tmp4, tmp8, tmp2, tmp2, tmp9, tmp3, tmp4, tmp8, tmp9, tmp9);
  }
  ...
  if (block7.is_used()) {
    ...
    TNode<IntPtrT> tmp27;
    TNode<IntPtrT> tmp28;
    ca_.Bind(&block7, &tmp13, &tmp14, &tmp15, &tmp16, &tmp17, &tmp18, &tmp19, &tmp20, &tmp21, &tmp22, &tmp23, &tmp24, &tmp25, &tmp26, &tmp27, &tmp28);
    TNode<IntPtrT> tmp29;
    USE(tmp29);
    ...
    TNode<BoolT> tmp36;
    USE(tmp36);
    tmp36 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp34}, TNode<HeapObject>{tmp35});
    ca_.Branch(tmp36, &block10, &block11, tmp13, tmp14, tmp15, tmp16, tmp34);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<IntPtrT> tmp51;
    TNode<IntPtrT> tmp52;
    ca_.Bind(&block8, &tmp37, &tmp38, &tmp39, &tmp40, &tmp41, &tmp42, &tmp43, &tmp44, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52);
  ...
  if (block11.is_used()) {
    ...
    TNode<Object> tmp62;
    ca_.Bind(&block11, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62);
    TNode<Object> tmp63;
    USE(tmp63);
    tmp63 = UnsafeCast_JSAny_0(state_, TNode<Context>{tmp58}, TNode<Object>{tmp62});
    ca_.Goto(&block12, tmp58, tmp59, tmp60, tmp63);
  }
...
TNode<Object> LoadWithHoleCheck_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_IfHole) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, Smi, Smi, HeapObject, IntPtrT, BoolT, Float64T> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Object> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_elements, p_index);
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp34, &block11, &block12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp32, tmp33, tmp34, tmp35);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<IntPtrT> tmp50;
    TNode<IntPtrT> tmp51;
    ca_.Bind(&block8, &tmp36, &tmp37, &tmp38, &tmp39, &tmp40, &tmp41, &tmp42, &tmp43, &tmp44, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Bind(&block11, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65);
    ca_.Goto(label_IfHole);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp66, &tmp67, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79);
    TNode<HeapNumber> tmp80;
    USE(tmp80);
    tmp80 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp79});
    ca_.Goto(&block13, tmp66, tmp67, tmp68, tmp80);
  }
    ...
    TNode<Smi> tmp83;
    TNode<Object> tmp84;
    ca_.Bind(&block13, &tmp81, &tmp82, &tmp83, &tmp84);
  return TNode<Object>{tmp84};
}
...
TNode<Object> TryFastArrayLastIndexOf_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<Object> p_searchElement, TNode<Number> p_from, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsDoubleElementsKind(kind)' failed", "src/builtins/array-lastindexof.tq", 95);
  }
...
TNode<Smi> FastArrayLastIndexOf_FixedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_array, TNode<Smi> p_from, TNode<Object> p_searchElement) {
  ...
  if (block16.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'Is<FastJSArray>(array)' failed", "src/builtins/array-lastindexof.tq", 47);
  }
  ...
  if (block20.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'Is<FastJSArray>(array)' failed", "src/builtins/array-lastindexof.tq", 56);
  }
