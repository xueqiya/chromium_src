...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    TNode<Object> tmp86;
    tmp86 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayFindLoopContinuation, tmp75, tmp81, tmp82, tmp78, tmp81, tmp83, tmp85);
    USE(tmp86);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ...
    TNode<Object> tmp129;
    tmp129 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayFindLoopContinuation, tmp117, tmp125, tmp126, tmp120, tmp125, tmp127, tmp128);
    USE(tmp129);
...
TF_BUILTIN(ArrayFindLoopContinuation, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    TNode<Object> tmp25;
    USE(tmp25);
    tmp25 = CodeStubAssembler(state_).Call(TNode<Context>{tmp16}, TNode<Object>{tmp18}, TNode<Object>{tmp19}, TNode<Object>{tmp24}, TNode<Object>{tmp23}, TNode<Object>{tmp20});
    TNode<BoolT> tmp26;
    USE(tmp26);
...
TNode<Object> FastArrayFind_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block25.is_used()) {
    ...
    TNode<Object> tmp391;
    USE(tmp391);
    tmp391 = CodeStubAssembler(state_).Call(TNode<Context>{tmp372}, TNode<Object>{tmp375}, TNode<Object>{tmp376}, TNode<Object>{tmp390}, TNode<Object>{tmp377}, TNode<Object>{tmp381});
    TNode<BoolT> tmp392;
    USE(tmp392);
  ...
  if (block37.is_used()) {
    ...
    ca_.Goto(&block2, tmp393, tmp394, tmp395, tmp396, tmp397, tmp407);
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_0(state_, TNode<Context>{tmp3}, TNode<Object>{tmp4}, "Array.prototype.find");
    TNode<JSReceiver> tmp6;
    USE(tmp6);
  ...
  if (block9.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp76 = FastArrayFind_0(state_, TNode<Context>{tmp70}, TNode<JSReceiver>{tmp72}, TNode<Number>{tmp73}, TNode<JSReceiver>{tmp74}, TNode<Object>{tmp75}, &label0, &result_0_0);
  ...
  if (block14.is_used()) {
    ...
    TNode<Object> tmp92;
    tmp92 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayFindLoopContinuation, tmp80, tmp82, tmp84, tmp85, tmp82, tmp91, tmp83);
    USE(tmp92);
