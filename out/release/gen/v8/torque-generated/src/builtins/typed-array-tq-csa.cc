...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_elementsKind) {
  ...
  if (block0.is_used()) {
    ...
    TNode<BoolT> tmp1;
    USE(tmp1);
    tmp1 = CodeStubAssembler(state_).IsElementsKindGreaterThan(TNode<Int32T>{tmp0}, ElementsKind::UINT32_ELEMENTS);
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp3;
    USE(tmp3);
    tmp3 = FromConstexpr_ElementsKind_constexpr_INT32_ELEMENTS_0(state_, ElementsKind::INT32_ELEMENTS);
    TNode<BoolT> tmp4;
    USE(tmp4);
  ...
  if (block6.is_used()) {
    ...
    TNode<Int32T> tmp10;
    USE(tmp10);
    tmp10 = FromConstexpr_ElementsKind_constexpr_FLOAT32_ELEMENTS_0(state_, ElementsKind::FLOAT32_ELEMENTS);
    TNode<BoolT> tmp11;
    USE(tmp11);
  ...
  if (block12.is_used()) {
    ...
    TNode<Int32T> tmp24;
    USE(tmp24);
    tmp24 = FromConstexpr_ElementsKind_constexpr_UINT8_CLAMPED_ELEMENTS_0(state_, ElementsKind::UINT8_CLAMPED_ELEMENTS);
    TNode<BoolT> tmp25;
    USE(tmp25);
  ...
  if (block15.is_used()) {
    ...
    TNode<Int32T> tmp31;
    USE(tmp31);
    tmp31 = FromConstexpr_ElementsKind_constexpr_BIGUINT64_ELEMENTS_0(state_, ElementsKind::BIGUINT64_ELEMENTS);
    TNode<BoolT> tmp32;
    USE(tmp32);
  ...
  if (block18.is_used()) {
    ...
    TNode<Int32T> tmp38;
    USE(tmp38);
    tmp38 = FromConstexpr_ElementsKind_constexpr_BIGINT64_ELEMENTS_0(state_, ElementsKind::BIGINT64_ELEMENTS);
    TNode<BoolT> tmp39;
    USE(tmp39);
  ...
  if (block3.is_used()) {
    ...
    TNode<Int32T> tmp46;
    USE(tmp46);
    tmp46 = FromConstexpr_ElementsKind_constexpr_UINT8_ELEMENTS_0(state_, ElementsKind::UINT8_ELEMENTS);
    TNode<BoolT> tmp47;
    USE(tmp47);
  ...
  if (block23.is_used()) {
    ...
    TNode<Int32T> tmp53;
    USE(tmp53);
    tmp53 = FromConstexpr_ElementsKind_constexpr_INT8_ELEMENTS_0(state_, ElementsKind::INT8_ELEMENTS);
    TNode<BoolT> tmp54;
    USE(tmp54);
  ...
  if (block26.is_used()) {
    ...
    TNode<Int32T> tmp60;
    USE(tmp60);
    tmp60 = FromConstexpr_ElementsKind_constexpr_UINT16_ELEMENTS_0(state_, ElementsKind::UINT16_ELEMENTS);
    TNode<BoolT> tmp61;
    USE(tmp61);
  ...
  if (block29.is_used()) {
    ...
    TNode<Int32T> tmp67;
    USE(tmp67);
    tmp67 = FromConstexpr_ElementsKind_constexpr_INT16_ELEMENTS_0(state_, ElementsKind::INT16_ELEMENTS);
    TNode<BoolT> tmp68;
    USE(tmp68);
  ...
  if (block32.is_used()) {
    ...
    TNode<Int32T> tmp74;
    USE(tmp74);
    tmp74 = FromConstexpr_ElementsKind_constexpr_UINT32_ELEMENTS_0(state_, ElementsKind::UINT32_ELEMENTS);
    TNode<BoolT> tmp75;
    USE(tmp75);
