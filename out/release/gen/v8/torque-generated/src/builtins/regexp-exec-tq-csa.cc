...
TNode<Object> RegExpPrototypeExecBodyFast_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = RegExpPrototypeExecBody_0(state_, TNode<Context>{tmp0}, TNode<JSReceiver>{tmp1}, TNode<String>{tmp2}, true);
...
TNode<Object> RegExpPrototypeExecBodySlow_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = RegExpPrototypeExecBody_0(state_, TNode<Context>{tmp0}, TNode<JSReceiver>{tmp1}, TNode<String>{tmp2}, false);
    ca_.Goto(&block2, tmp0, tmp1, tmp2, tmp3);
  }
...
TF_BUILTIN(RegExpPrototypeExecSlow, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = RegExpPrototypeExecBodySlow_0(state_, TNode<Context>{tmp0}, TNode<JSReceiver>{tmp1}, TNode<String>{tmp2});
...
USE(parameter1);
  ...
  compiler::CodeAssemblerParameterizedLabel<NativeContext, Object, Object, Object, NativeContext, JSRegExp> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<NativeContext, Object, Object, JSRegExp, String> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<NativeContext, Object, Object, JSRegExp, String> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<NativeContext, Object, Object, JSRegExp, String, Object> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, parameter0, parameter1, parameter2);
  ...
  if (block0.is_used()) {
    ...
    tmp3 = Cast_JSRegExp_1(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp4}, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object>{tmp9}, TNode<Object>{tmp5});
  }
  ...
  if (block3.is_used()) {
    ...
    TNode<String> tmp16;
    USE(tmp16);
    tmp16 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{tmp10}, TNode<Object>{tmp12});
    TNode<BoolT> tmp17;
    USE(tmp17);
    tmp17 = RegExpBuiltinsAssembler(state_).IsFastRegExpNoPrototype(TNode<Context>{tmp10}, TNode<Object>{tmp15});
    ca_.Branch(tmp17, &block5, &block6, tmp10, tmp11, tmp12, tmp15, tmp16);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<Object> tmp23;
    USE(tmp23);
    tmp23 = RegExpPrototypeExecBodyFast_0(state_, TNode<Context>{tmp18}, TNode<JSReceiver>{tmp21}, TNode<String>{tmp22});
    ca_.Goto(&block7, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23);
  }
  ...
  if (block6.is_used()) {
    ...
    TNode<Object> tmp29;
    tmp29 = CodeStubAssembler(state_).CallBuiltin(Builtins::kRegExpPrototypeExecSlow, tmp24, tmp27, tmp28);
    USE(tmp29);
    ca_.Goto(&block7, tmp24, tmp25, tmp26, tmp27, tmp28, tmp29);
  }
...
TNode<JSRegExp> Cast_JSRegExp_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block3.is_used()) {
    ...
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast_JSRegExp_0(state_, TNode<HeapObject>{tmp9}, &label0);
