...
TF_BUILTIN(ArrayReduceLoopContinuation, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ...
    TNode<Object> tmp55;
    USE(tmp55);
    tmp55 = CodeStubAssembler(state_).Call(TNode<Context>{tmp41}, TNode<Object>{tmp43}, TNode<Object>{tmp54}, TNode<Object>{ca_.UncheckedCast<Object>(tmp52)}, TNode<Object>{tmp51}, TNode<Object>{tmp49}, TNode<Object>{tmp45});
...
TNode<Object> FastArrayReduce_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block38.is_used()) {
    ...
    TNode<Object> tmp321;
    USE(tmp321);
    tmp321 = CodeStubAssembler(state_).Call(TNode<Context>{tmp305}, TNode<Object>{tmp308}, TNode<Object>{tmp320}, TNode<Object>{ca_.UncheckedCast<Object>(tmp318)}, TNode<Object>{tmp317}, TNode<Object>{tmp316}, TNode<Object>{tmp313});
