...
TNode<Object> ReduceAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  ...
  if (block16.is_used()) {
    ...
    TNode<Object> tmp72;
    USE(tmp72);
    tmp72 = CodeStubAssembler(state_).Call(TNode<Context>{tmp57}, TNode<Object>{tmp59}, TNode<Object>{tmp70}, TNode<Object>{ca_.UncheckedCast<Object>(tmp68)}, TNode<Object>{tmp67}, TNode<Object>{tmp71}, TNode<Object>{tmp61});
