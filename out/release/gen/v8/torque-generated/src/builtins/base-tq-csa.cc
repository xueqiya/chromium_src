...
TNode<Int32T> FastHoleyElementsKind_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_kind) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Int32T> tmp1;
    USE(tmp1);
    tmp1 = FromConstexpr_ElementsKind_constexpr_PACKED_SMI_ELEMENTS_0(state_, ElementsKind::PACKED_SMI_ELEMENTS);
    TNode<BoolT> tmp2;
    USE(tmp2);
    tmp2 = CodeStubAssembler(state_).ElementsKindEqual(TNode<Int32T>{tmp0}, TNode<Int32T>{tmp1});
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp4;
    USE(tmp4);
    tmp4 = FromConstexpr_ElementsKind_constexpr_HOLEY_SMI_ELEMENTS_0(state_, ElementsKind::HOLEY_SMI_ELEMENTS);
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'kind == ElementsKind::PACKED_ELEMENTS' failed", "src/builtins/base.tq", 956);
  }
...
TNode<Int32T> AllowDoubleElements_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_kind) {
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp4;
    USE(tmp4);
    tmp4 = FromConstexpr_ElementsKind_constexpr_PACKED_DOUBLE_ELEMENTS_0(state_, ElementsKind::PACKED_DOUBLE_ELEMENTS);
    ca_.Goto(&block1, tmp3, tmp4);
  }
  ...
  if (block3.is_used()) {
    ...
    TNode<Int32T> tmp6;
    USE(tmp6);
    tmp6 = FromConstexpr_ElementsKind_constexpr_HOLEY_SMI_ELEMENTS_0(state_, ElementsKind::HOLEY_SMI_ELEMENTS);
    TNode<BoolT> tmp7;
    USE(tmp7);
    tmp7 = CodeStubAssembler(state_).ElementsKindEqual(TNode<Int32T>{tmp5}, TNode<Int32T>{tmp6});
    ca_.Branch(tmp7, &block5, &block6, tmp5);
...
TNode<Int32T> AllowNonNumberElements_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_kind) {
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp4;
    USE(tmp4);
    tmp4 = FromConstexpr_ElementsKind_constexpr_PACKED_ELEMENTS_0(state_, ElementsKind::PACKED_ELEMENTS);
    ca_.Goto(&block1, tmp3, tmp4);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<Int32T> tmp9;
    USE(tmp9);
    tmp9 = FromConstexpr_ElementsKind_constexpr_HOLEY_ELEMENTS_0(state_, ElementsKind::HOLEY_ELEMENTS);
    ca_.Goto(&block1, tmp8, tmp9);
  }
  ...
  if (block6.is_used()) {
    ...
    TNode<Int32T> tmp11;
    USE(tmp11);
    tmp11 = FromConstexpr_ElementsKind_constexpr_PACKED_DOUBLE_ELEMENTS_0(state_, ElementsKind::PACKED_DOUBLE_ELEMENTS);
    TNode<BoolT> tmp12;
    USE(tmp12);
  ...
  if (block8.is_used()) {
    ...
    TNode<Int32T> tmp14;
    USE(tmp14);
    tmp14 = FromConstexpr_ElementsKind_constexpr_PACKED_ELEMENTS_0(state_, ElementsKind::PACKED_ELEMENTS);
  ...
  if (block9.is_used()) {
    ...
    TNode<Int32T> tmp16;
    USE(tmp16);
    tmp16 = FromConstexpr_ElementsKind_constexpr_HOLEY_DOUBLE_ELEMENTS_0(state_, ElementsKind::HOLEY_DOUBLE_ELEMENTS);
    TNode<BoolT> tmp17;
    USE(tmp17);
  ...
  if (block11.is_used()) {
    ...
    TNode<Int32T> tmp19;
    USE(tmp19);
    tmp19 = FromConstexpr_ElementsKind_constexpr_HOLEY_ELEMENTS_0(state_, ElementsKind::HOLEY_ELEMENTS);
...
TNode<JSFunction> GetObjectFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_OBJECT_FUNCTION_INDEX_0(state_, Context::Field::OBJECT_FUNCTION_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
...
TNode<JSFunction> GetArrayFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_FUNCTION_INDEX_0(state_, Context::Field::ARRAY_FUNCTION_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<JSFunction> tmp4;
...
TNode<JSReceiver> GetArrayBufferFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_BUFFER_FUN_INDEX_0(state_, Context::Field::ARRAY_BUFFER_FUN_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
...
TNode<JSFunction> GetArrayBufferNoInitFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_BUFFER_NOINIT_FUN_INDEX_0(state_, Context::Field::ARRAY_BUFFER_NOINIT_FUN_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<JSFunction> tmp4;
...
TNode<Map> GetFastPackedElementsJSArrayMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_JS_ARRAY_PACKED_ELEMENTS_MAP_INDEX_0(state_, Context::Field::JS_ARRAY_PACKED_ELEMENTS_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetFastPackedSmiElementsJSArrayMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_JS_ARRAY_PACKED_SMI_ELEMENTS_MAP_INDEX_0(state_, Context::Field::JS_ARRAY_PACKED_SMI_ELEMENTS_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetProxyRevocableResultMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_PROXY_REVOCABLE_RESULT_MAP_INDEX_0(state_, Context::Field::PROXY_REVOCABLE_RESULT_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetIteratorResultMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_ITERATOR_RESULT_MAP_INDEX_0(state_, Context::Field::ITERATOR_RESULT_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetInitialStringIteratorMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_INITIAL_STRING_ITERATOR_MAP_INDEX_0(state_, Context::Field::INITIAL_STRING_ITERATOR_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<JSReceiver> GetReflectApply_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_REFLECT_APPLY_INDEX_0(state_, Context::Field::REFLECT_APPLY_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<JSReceiver> tmp4;
...
TNode<RegExpMatchInfo> GetRegExpLastMatchInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_REGEXP_LAST_MATCH_INFO_INDEX_0(state_, Context::Field::REGEXP_LAST_MATCH_INFO_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
...
TNode<Map> GetStrictArgumentsMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_STRICT_ARGUMENTS_MAP_INDEX_0(state_, Context::Field::STRICT_ARGUMENTS_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetSloppyArgumentsMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_SLOPPY_ARGUMENTS_MAP_INDEX_0(state_, Context::Field::SLOPPY_ARGUMENTS_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
TNode<Map> GetFastAliasedArgumentsMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_FAST_ALIASED_ARGUMENTS_MAP_INDEX_0(state_, Context::Field::FAST_ALIASED_ARGUMENTS_MAP_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
    tmp3 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp1}, TNode<IntPtrT>{tmp2});
    TNode<Map> tmp4;
...
void CheckIntegerIndexAdditionOverflow_0(compiler::CodeAssemblerState* state_, TNode<UintPtrT> p_index1, TNode<UintPtrT> p_index2, TNode<UintPtrT> p_limit, compiler::CodeAssemblerLabel* label_IfOverflow) {
  ...
  if (block9.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'index1 <= kMaxSafeIntegerUint64' failed", "src/builtins/base.tq", 1107);
  }
  ...
  if (block13.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'index2 <= kMaxSafeIntegerUint64' failed", "src/builtins/base.tq", 1108);
  }
...
TNode<UintPtrT> TryNumberToUintPtr_0(compiler::CodeAssemblerState* state_, TNode<Number> p_valueNumber, int31_t p_kMode, compiler::CodeAssemblerLabel* label_IfLessThanZero, compiler::CodeAssemblerLabel* label_IfUIntPtrOverflow, compiler::CodeAssemblerLabel* label_IfSafeIntegerOverflow) {
  ...
  if (block17.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'valueSmi >= 0' failed", "src/builtins/base.tq", 1142);
  }
  ...
  if (block21.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsNumberNormalized(valueHeapNumber)' failed", "src/builtins/base.tq", 1150);
  }
  ...
  if (block25.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert '!Float64IsNaN(valueDouble)' failed", "src/builtins/base.tq", 1153);
  }
  ...
  if (block34.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'valueDouble >= 0' failed", "src/builtins/base.tq", 1157);
  }
  ...
  if (block46.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'valueDouble <= kMaxSafeInteger' failed", "src/builtins/base.tq", 1166);
  }
  ...
  if (block55.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'valueDouble <= kMaxUInt32Double' failed", "src/builtins/base.tq", 1175);
  }
...
TNode<UintPtrT> ConvertToRelativeIndex_2(compiler::CodeAssemblerState* state_, TNode<Number> p_indexNumber, TNode<UintPtrT> p_length) {
  ...
  if (block20.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsNumberNormalized(indexHeapNumber)' failed", "src/builtins/base.tq", 1318);
  }
  ...
  if (block24.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert '!Float64IsNaN(indexDouble)' failed", "src/builtins/base.tq", 1322);
  }
  ...
  if (block28.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'lengthDouble <= kMaxSafeInteger' failed", "src/builtins/base.tq", 1324);
  }
...
TNode<UintPtrT> ClampToIndexRange_1(compiler::CodeAssemblerState* state_, TNode<Number> p_indexNumber, TNode<UintPtrT> p_limit) {
  ...
  if (block13.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsNumberNormalized(indexHeapNumber)' failed", "src/builtins/base.tq", 1359);
  }
  ...
  if (block17.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert '!Float64IsNaN(indexDouble)' failed", "src/builtins/base.tq", 1363);
  }
  ...
  if (block23.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'maxIndexDouble <= kMaxSafeInteger' failed", "src/builtins/base.tq", 1367);
  }
...
TF_BUILTIN(FastCreateDataProperty, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Map, Context> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Map, Context, Int32T> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block28(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block27(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block32(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block31(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block34(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, JSArray, Object> block33(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block35(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Object> block39(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Object, Smi> block38(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Smi, FixedArrayBase> block43(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Smi, FixedArrayBase, FixedArray> block42(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block36(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Object> block48(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Object, Number> block47(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Number, FixedArrayBase> block52(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, Number, FixedArrayBase, FixedDoubleArray> block51(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block45(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block56(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block55(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, FixedArrayBase> block60(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T, FixedArrayBase, FixedArray> block59(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT, Int32T> block37(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Object, Object, JSArray, Smi, BoolT> block16(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp72, &block14, &block15, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp72);
  }
  ...
  if (block14.is_used()) {
    ...
    TNode<Smi> tmp78;
    TNode<BoolT> tmp79;
    ca_.Bind(&block14, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79);
    TNode<IntPtrT> tmp80;
    USE(tmp80);
    tmp80 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<Map>tmp81 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp77, tmp80});
    TNode<Int32T> tmp82;
    USE(tmp82);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp82 = CodeStubAssembler(state_).EnsureArrayPushable(TNode<Context>{tmp73}, TNode<Map>{tmp81}, &label0);
    ca_.Goto(&block17, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp79, tmp81, tmp73, tmp82);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block18, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp79, tmp81, tmp73);
    }
  }
  ...
  if (block18.is_used()) {
    ...
    TNode<Map> tmp90;
    TNode<Context> tmp91;
    ca_.Bind(&block18, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91);
    ca_.Goto(&block2, tmp83, tmp84, tmp85, tmp86);
  }
  ...
  if (block17.is_used()) {
    ...
    TNode<Int32T> tmp101;
    ca_.Bind(&block17, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100, &tmp101);
    EnsureWriteableFastElements_0(state_, TNode<Context>{tmp92}, TNode<JSArray>{tmp96});
    TNode<BoolT> tmp102;
    USE(tmp102);
    tmp102 = CodeStubAssembler(state_).IsFastSmiElementsKind(TNode<Int32T>{tmp101});
    ca_.Branch(tmp102, &block19, &block20, tmp92, tmp93, tmp94, tmp95, tmp96, tmp97, tmp98, tmp101);
  }
  ...
  if (block19.is_used()) {
    ...
    TNode<BoolT> tmp109;
    TNode<Int32T> tmp110;
    ca_.Bind(&block19, &tmp103, &tmp104, &tmp105, &tmp106, &tmp107, &tmp108, &tmp109, &tmp110);
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_SMI_ELEMENTS, TNode<JSArray>{tmp107}, TNode<Object>{tmp106}, &label0);
    ca_.Goto(&block22, tmp103, tmp104, tmp105, tmp106, tmp107, tmp108, tmp109, tmp110, tmp107, tmp106);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block23, tmp103, tmp104, tmp105, tmp106, tmp107, tmp108, tmp109, tmp110, tmp107, tmp106);
    }
  }
  ...
  if (block23.is_used()) {
    ...
    TNode<Object> tmp120;
    ca_.Bind(&block23, &tmp111, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120);
    ca_.Goto(&block2, tmp111, tmp112, tmp113, tmp114);
  }
  ...
  if (block22.is_used()) {
    ...
    TNode<Object> tmp130;
    ca_.Bind(&block22, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130);
    ca_.Goto(&block21, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128);
  }
  ...
  if (block20.is_used()) {
    ...
    TNode<BoolT> tmp137;
    TNode<Int32T> tmp138;
    ca_.Bind(&block20, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138);
    TNode<BoolT> tmp139;
    USE(tmp139);
    tmp139 = CodeStubAssembler(state_).IsDoubleElementsKind(TNode<Int32T>{tmp138});
    ca_.Branch(tmp139, &block24, &block25, tmp131, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138);
  }
  ...
  if (block24.is_used()) {
    ...
    TNode<BoolT> tmp146;
    TNode<Int32T> tmp147;
    ca_.Bind(&block24, &tmp140, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147);
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_DOUBLE_ELEMENTS, TNode<JSArray>{tmp144}, TNode<Object>{tmp143}, &label0);
    ca_.Goto(&block27, tmp140, tmp141, tmp142, tmp143, tmp144, tmp145, tmp146, tmp147, tmp144, tmp143);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block28, tmp140, tmp141, tmp142, tmp143, tmp144, tmp145, tmp146, tmp147, tmp144, tmp143);
    }
  }
  ...
  if (block28.is_used()) {
    ...
    TNode<Object> tmp157;
    ca_.Bind(&block28, &tmp148, &tmp149, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157);
    ca_.Goto(&block2, tmp148, tmp149, tmp150, tmp151);
  }
  ...
  if (block27.is_used()) {
    ...
    TNode<Object> tmp167;
    ca_.Bind(&block27, &tmp158, &tmp159, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167);
    ca_.Goto(&block26, tmp158, tmp159, tmp160, tmp161, tmp162, tmp163, tmp164, tmp165);
  }
  ...
  if (block25.is_used()) {
    ...
    TNode<BoolT> tmp174;
    TNode<Int32T> tmp175;
    ca_.Bind(&block25, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174, &tmp175);
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_ELEMENTS, TNode<JSArray>{tmp172}, TNode<Object>{tmp171}, &label0);
    ca_.Goto(&block33, tmp168, tmp169, tmp170, tmp171, tmp172, tmp173, tmp174, tmp175, tmp172, tmp171);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block34, tmp168, tmp169, tmp170, tmp171, tmp172, tmp173, tmp174, tmp175, tmp172, tmp171);
    }
  }
  ...
  if (block32.is_used()) {
    ...
    TNode<BoolT> tmp182;
    TNode<Int32T> tmp183;
    ca_.Bind(&block32, &tmp176, &tmp177, &tmp178, &tmp179, &tmp180, &tmp181, &tmp182, &tmp183);
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsFastSmiOrTaggedElementsKind(kind)' failed", "src/builtins/base.tq", 1458);
  }
  ...
  if (block31.is_used()) {
    ...
    TNode<BoolT> tmp190;
    TNode<Int32T> tmp191;
    ca_.Bind(&block31, &tmp184, &tmp185, &tmp186, &tmp187, &tmp188, &tmp189, &tmp190, &tmp191);
  }
  ...
  if (block34.is_used()) {
    ...
    TNode<Object> tmp201;
    ca_.Bind(&block34, &tmp192, &tmp193, &tmp194, &tmp195, &tmp196, &tmp197, &tmp198, &tmp199, &tmp200, &tmp201);
    ca_.Goto(&block2, tmp192, tmp193, tmp194, tmp195);
  }
  ...
  if (block33.is_used()) {
    ...
    TNode<Object> tmp211;
    ca_.Bind(&block33, &tmp202, &tmp203, &tmp204, &tmp205, &tmp206, &tmp207, &tmp208, &tmp209, &tmp210, &tmp211);
    ca_.Goto(&block26, tmp202, tmp203, tmp204, tmp205, tmp206, tmp207, tmp208, tmp209);
  }
  ...
  if (block26.is_used()) {
    ...
    TNode<BoolT> tmp218;
    TNode<Int32T> tmp219;
    ca_.Bind(&block26, &tmp212, &tmp213, &tmp214, &tmp215, &tmp216, &tmp217, &tmp218, &tmp219);
    ca_.Goto(&block21, tmp212, tmp213, tmp214, tmp215, tmp216, tmp217, tmp218, tmp219);
  }
  ...
  if (block21.is_used()) {
    ...
    TNode<BoolT> tmp226;
    TNode<Int32T> tmp227;
    ca_.Bind(&block21, &tmp220, &tmp221, &tmp222, &tmp223, &tmp224, &tmp225, &tmp226, &tmp227);
    ca_.Goto(&block16, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225, tmp226);
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<Smi> tmp233;
    TNode<BoolT> tmp234;
    ca_.Bind(&block15, &tmp228, &tmp229, &tmp230, &tmp231, &tmp232, &tmp233, &tmp234);
    TNode<IntPtrT> tmp235;
    USE(tmp235);
    tmp235 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<Map>tmp236 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp232, tmp235});
    TNode<Int32T> tmp237;
    USE(tmp237);
    tmp237 = CodeStubAssembler(state_).LoadMapElementsKind(TNode<Map>{tmp236});
    EnsureWriteableFastElements_0(state_, TNode<Context>{tmp228}, TNode<JSArray>{tmp232});
    TNode<BoolT> tmp238;
    USE(tmp238);
    tmp238 = CodeStubAssembler(state_).IsFastSmiElementsKind(TNode<Int32T>{tmp237});
    ca_.Branch(tmp238, &block35, &block36, tmp228, tmp229, tmp230, tmp231, tmp232, tmp233, tmp234, tmp237);
  }
  ...
  if (block35.is_used()) {
    ...
    TNode<BoolT> tmp245;
    TNode<Int32T> tmp246;
    ca_.Bind(&block35, &tmp239, &tmp240, &tmp241, &tmp242, &tmp243, &tmp244, &tmp245, &tmp246);
    TNode<Smi> tmp247;
    USE(tmp247);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp247 = Cast_Smi_0(state_, TNode<Object>{tmp242}, &label0);
    ca_.Goto(&block38, tmp239, tmp240, tmp241, tmp242, tmp243, tmp244, tmp245, tmp246, tmp242, tmp247);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block39, tmp239, tmp240, tmp241, tmp242, tmp243, tmp244, tmp245, tmp246, tmp242);
    }
  }
  ...
  if (block39.is_used()) {
    ...
    TNode<Int32T> tmp255;
    TNode<Object> tmp256;
    ca_.Bind(&block39, &tmp248, &tmp249, &tmp250, &tmp251, &tmp252, &tmp253, &tmp254, &tmp255, &tmp256);
    ca_.Goto(&block2, tmp248, tmp249, tmp250, tmp251);
  }
  ...
  if (block38.is_used()) {
    ...
    TNode<Object> tmp265;
    TNode<Smi> tmp266;
    ca_.Bind(&block38, &tmp257, &tmp258, &tmp259, &tmp260, &tmp261, &tmp262, &tmp263, &tmp264, &tmp265, &tmp266);
    TNode<IntPtrT> tmp267;
    USE(tmp267);
    tmp267 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArrayBase>tmp268 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp261, tmp267});
    TNode<FixedArray> tmp269;
    USE(tmp269);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp269 = Cast_FixedArray_0(state_, TNode<HeapObject>{tmp268}, &label0);
    ca_.Goto(&block42, tmp257, tmp258, tmp259, tmp260, tmp261, tmp262, tmp263, tmp264, tmp266, tmp268, tmp269);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block43, tmp257, tmp258, tmp259, tmp260, tmp261, tmp262, tmp263, tmp264, tmp266, tmp268);
    }
  }
  ...
  if (block43.is_used()) {
    ...
    TNode<Int32T> tmp277;
    TNode<Smi> tmp278;
    TNode<FixedArrayBase> tmp279;
    ca_.Bind(&block43, &tmp270, &tmp271, &tmp272, &tmp273, &tmp274, &tmp275, &tmp276, &tmp277, &tmp278, &tmp279);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block42.is_used()) {
    ...
    TNode<Int32T> tmp287;
    TNode<Smi> tmp288;
    TNode<FixedArrayBase> tmp289;
    TNode<FixedArray> tmp290;
    ca_.Bind(&block42, &tmp280, &tmp281, &tmp282, &tmp283, &tmp284, &tmp285, &tmp286, &tmp287, &tmp288, &tmp289, &tmp290);
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp290}, TNode<Smi>{tmp285}, TNode<Object>{tmp288});
    ca_.Goto(&block37, tmp280, tmp281, tmp282, tmp283, tmp284, tmp285, tmp286, tmp287);
  }
  ...
  if (block36.is_used()) {
    ...
    TNode<BoolT> tmp297;
    TNode<Int32T> tmp298;
    ca_.Bind(&block36, &tmp291, &tmp292, &tmp293, &tmp294, &tmp295, &tmp296, &tmp297, &tmp298);
    TNode<BoolT> tmp299;
    USE(tmp299);
    tmp299 = CodeStubAssembler(state_).IsDoubleElementsKind(TNode<Int32T>{tmp298});
    ca_.Branch(tmp299, &block44, &block45, tmp291, tmp292, tmp293, tmp294, tmp295, tmp296, tmp297, tmp298);
  }
  ...
  if (block44.is_used()) {
    ...
    TNode<BoolT> tmp306;
    TNode<Int32T> tmp307;
    ca_.Bind(&block44, &tmp300, &tmp301, &tmp302, &tmp303, &tmp304, &tmp305, &tmp306, &tmp307);
    TNode<Number> tmp308;
    USE(tmp308);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp308 = Cast_Number_0(state_, TNode<Object>{tmp303}, &label0);
    ca_.Goto(&block47, tmp300, tmp301, tmp302, tmp303, tmp304, tmp305, tmp306, tmp307, tmp303, tmp308);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block48, tmp300, tmp301, tmp302, tmp303, tmp304, tmp305, tmp306, tmp307, tmp303);
    }
  }
  ...
  if (block48.is_used()) {
    ...
    TNode<Int32T> tmp316;
    TNode<Object> tmp317;
    ca_.Bind(&block48, &tmp309, &tmp310, &tmp311, &tmp312, &tmp313, &tmp314, &tmp315, &tmp316, &tmp317);
    ca_.Goto(&block2, tmp309, tmp310, tmp311, tmp312);
  }
  ...
  if (block47.is_used()) {
    ...
    TNode<Object> tmp326;
    TNode<Number> tmp327;
    ca_.Bind(&block47, &tmp318, &tmp319, &tmp320, &tmp321, &tmp322, &tmp323, &tmp324, &tmp325, &tmp326, &tmp327);
    TNode<IntPtrT> tmp328;
    USE(tmp328);
    tmp328 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArrayBase>tmp329 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp322, tmp328});
    TNode<FixedDoubleArray> tmp330;
    USE(tmp330);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp330 = Cast_FixedDoubleArray_0(state_, TNode<HeapObject>{tmp329}, &label0);
    ca_.Goto(&block51, tmp318, tmp319, tmp320, tmp321, tmp322, tmp323, tmp324, tmp325, tmp327, tmp329, tmp330);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block52, tmp318, tmp319, tmp320, tmp321, tmp322, tmp323, tmp324, tmp325, tmp327, tmp329);
    }
  }
  ...
  if (block52.is_used()) {
    ...
    TNode<Int32T> tmp338;
    TNode<Number> tmp339;
    TNode<FixedArrayBase> tmp340;
    ca_.Bind(&block52, &tmp331, &tmp332, &tmp333, &tmp334, &tmp335, &tmp336, &tmp337, &tmp338, &tmp339, &tmp340);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block51.is_used()) {
    ...
    TNode<Int32T> tmp348;
    TNode<Number> tmp349;
    TNode<FixedArrayBase> tmp350;
    TNode<FixedDoubleArray> tmp351;
    ca_.Bind(&block51, &tmp341, &tmp342, &tmp343, &tmp344, &tmp345, &tmp346, &tmp347, &tmp348, &tmp349, &tmp350, &tmp351);
    StoreFixedDoubleArrayDirect_0(state_, TNode<FixedDoubleArray>{tmp351}, TNode<Smi>{tmp346}, TNode<Number>{tmp349});
    ca_.Goto(&block46, tmp341, tmp342, tmp343, tmp344, tmp345, tmp346, tmp347, tmp348);
  }
  ...
  if (block45.is_used()) {
    ...
    TNode<BoolT> tmp358;
    TNode<Int32T> tmp359;
    ca_.Bind(&block45, &tmp352, &tmp353, &tmp354, &tmp355, &tmp356, &tmp357, &tmp358, &tmp359);
    TNode<IntPtrT> tmp360;
    USE(tmp360);
    tmp360 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArrayBase>tmp361 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp356, tmp360});
    TNode<FixedArray> tmp362;
    USE(tmp362);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp362 = Cast_FixedArray_0(state_, TNode<HeapObject>{tmp361}, &label0);
    ca_.Goto(&block59, tmp352, tmp353, tmp354, tmp355, tmp356, tmp357, tmp358, tmp359, tmp361, tmp362);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block60, tmp352, tmp353, tmp354, tmp355, tmp356, tmp357, tmp358, tmp359, tmp361);
    }
  }
  ...
  if (block56.is_used()) {
    ...
    TNode<BoolT> tmp369;
    TNode<Int32T> tmp370;
    ca_.Bind(&block56, &tmp363, &tmp364, &tmp365, &tmp366, &tmp367, &tmp368, &tmp369, &tmp370);
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsFastSmiOrTaggedElementsKind(kind)' failed", "src/builtins/base.tq", 1479);
  }
  ...
  if (block55.is_used()) {
    ...
    TNode<BoolT> tmp377;
    TNode<Int32T> tmp378;
    ca_.Bind(&block55, &tmp371, &tmp372, &tmp373, &tmp374, &tmp375, &tmp376, &tmp377, &tmp378);
  }
  ...
  if (block60.is_used()) {
    ...
    TNode<BoolT> tmp385;
    TNode<Int32T> tmp386;
    TNode<FixedArrayBase> tmp387;
    ca_.Bind(&block60, &tmp379, &tmp380, &tmp381, &tmp382, &tmp383, &tmp384, &tmp385, &tmp386, &tmp387);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block59.is_used()) {
    ...
    TNode<BoolT> tmp394;
    TNode<Int32T> tmp395;
    TNode<FixedArrayBase> tmp396;
    TNode<FixedArray> tmp397;
    ca_.Bind(&block59, &tmp388, &tmp389, &tmp390, &tmp391, &tmp392, &tmp393, &tmp394, &tmp395, &tmp396, &tmp397);
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp397}, TNode<Smi>{tmp393}, TNode<Object>{tmp391});
    ca_.Goto(&block46, tmp388, tmp389, tmp390, tmp391, tmp392, tmp393, tmp394, tmp395);
  }
  ...
  if (block46.is_used()) {
    ...
    TNode<BoolT> tmp404;
    TNode<Int32T> tmp405;
    ca_.Bind(&block46, &tmp398, &tmp399, &tmp400, &tmp401, &tmp402, &tmp403, &tmp404, &tmp405);
    ca_.Goto(&block37, tmp398, tmp399, tmp400, tmp401, tmp402, tmp403, tmp404, tmp405);
  }
  ...
  if (block37.is_used()) {
    ...
    TNode<BoolT> tmp412;
    TNode<Int32T> tmp413;
    ca_.Bind(&block37, &tmp406, &tmp407, &tmp408, &tmp409, &tmp410, &tmp411, &tmp412, &tmp413);
    ca_.Goto(&block16, tmp406, tmp407, tmp408, tmp409, tmp410, tmp411, tmp412);
  }
  ...
  if (block16.is_used()) {
    ...
    TNode<Smi> tmp419;
    TNode<BoolT> tmp420;
    ca_.Bind(&block16, &tmp414, &tmp415, &tmp416, &tmp417, &tmp418, &tmp419, &tmp420);
    ca_.Goto(&block1, tmp414, tmp415, tmp416, tmp417);
  }
...
TNode<BoolT> Is_PromiseCapability_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context, PromiseCapability> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp2);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp2 = Cast_PromiseCapability_1(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
    ca_.Goto(&block4, tmp0, tmp1, tmp1, tmp0, tmp2);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp1, tmp0);
...
TNode<BoolT> Is_PromiseReactionJobTask_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context, PromiseReactionJobTask> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp2);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp2 = Cast_PromiseReactionJobTask_1(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
    ca_.Goto(&block4, tmp0, tmp1, tmp1, tmp0, tmp2);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp1, tmp0);
  ...
  if (block4.is_used()) {
    ...
    TNode<Object> tmp10;
    TNode<Context> tmp11;
    TNode<PromiseReactionJobTask> tmp12;
    ca_.Bind(&block4, &tmp8, &tmp9, &tmp10, &tmp11, &tmp12);
    TNode<BoolT> tmp13;
    USE(tmp13);
    tmp13 = FromConstexpr_bool_constexpr_bool_0(state_, true);
...
TNode<BoolT> Is_EmptyFixedArray_OR_FixedDoubleArray_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, Context, FixedArrayBase> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, BoolT> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp2);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp2 = Cast_EmptyFixedArray_OR_FixedDoubleArray_1(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
    ca_.Goto(&block4, tmp0, tmp1, tmp1, tmp0, tmp2);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp1, tmp0);
...
TNode<PromiseCapability> Cast_PromiseCapability_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, HeapObject> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject, PromiseCapability> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, PromiseCapability> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast_PromiseCapability_0(state_, TNode<HeapObject>{tmp9}, &label0);
    ca_.Goto(&block5, tmp6, tmp7, tmp9, tmp10);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block6, tmp6, tmp7, tmp9);
...
TNode<PromiseReactionJobTask> Cast_PromiseReactionJobTask_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, HeapObject> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject, PromiseReactionJobTask> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, PromiseReactionJobTask> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block3.is_used()) {
    ...
    TNode<HeapObject> tmp9;
    ca_.Bind(&block3, &tmp6, &tmp7, &tmp8, &tmp9);
    TNode<PromiseReactionJobTask> tmp10;
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast_PromiseReactionJobTask_0(state_, TNode<HeapObject>{tmp9}, &label0);
    ca_.Goto(&block5, tmp6, tmp7, tmp9, tmp10);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block6, tmp6, tmp7, tmp9);
  ...
  if (block5.is_used()) {
    ...
    TNode<Object> tmp15;
    TNode<HeapObject> tmp16;
    TNode<PromiseReactionJobTask> tmp17;
    ca_.Bind(&block5, &tmp14, &tmp15, &tmp16, &tmp17);
    ca_.Goto(&block7, tmp14, tmp15, tmp17);
  }
...
TNode<FixedArrayBase> Cast_EmptyFixedArray_OR_FixedDoubleArray_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object, HeapObject> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, HeapObject, FixedArrayBase> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, FixedArrayBase> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_o);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast_EmptyFixedArray_OR_FixedDoubleArray_0(state_, TNode<HeapObject>{tmp9}, &label0);
    ca_.Goto(&block5, tmp6, tmp7, tmp9, tmp10);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block6, tmp6, tmp7, tmp9);
