...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  void StoreSmallOrderedHashSetNumberOfBuckets(TNode<SmallOrderedHashSet> p_o, TNode<Uint8T> p_v);
  ...
  void StoreSmallOrderedHashMapNumberOfBuckets(TNode<SmallOrderedHashMap> p_o, TNode<Uint8T> p_v);
  ...
  void StoreSmallOrderedNameDictionaryNumberOfBuckets(TNode<SmallOrderedNameDictionary> p_o, TNode<Uint8T> p_v);
