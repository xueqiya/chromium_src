...
class TorqueGeneratedBreakPoint : public P {
 ...
 public: 
  ...
  inline String condition(const Isolate* isolate) const;
...
class TorqueGeneratedBreakPointInfo : public P {
 ...
 public: 
  using Super = P;
  inline Smi source_position() const;
  inline void set_source_position(Smi value);

  inline HeapObject break_points() const;
  inline HeapObject break_points(const Isolate* isolate) const;
...
class TorqueGeneratedWeakCell : public P {
 ...
 public: 
  ...
  inline Object unregister_token(const Isolate* isolate) const;
...
class TorqueGeneratedCachedTemplateObject : public P {
 ...
 public: 
  using Super = P;
  inline Smi slot_id() const;
  inline void set_slot_id(Smi value);

  inline JSArray template_object() const;
  inline JSArray template_object(const Isolate* isolate) const;
