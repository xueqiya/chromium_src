...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 71) \
      ...
      V(SMI_BOX_TYPE, 106) \
      V(SMI_PAIR_TYPE, 107) \
      V(SORT_STATE_TYPE, 108) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 109) \
      V(STACK_FRAME_INFO_TYPE, 110) \
      V(STACK_TRACE_FRAME_TYPE, 111) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 112) \
      V(TUPLE2_TYPE, 113) \
      V(WASM_CAPI_FUNCTION_DATA_TYPE, 114) \
      V(WASM_DEBUG_INFO_TYPE, 115) \
      V(WASM_EXCEPTION_TAG_TYPE, 116) \
      V(WASM_EXPORTED_FUNCTION_DATA_TYPE, 117) \
      V(WASM_INDIRECT_FUNCTION_TABLE_TYPE, 118) \
      V(WASM_JS_FUNCTION_DATA_TYPE, 119) \
    V(LAST_STRUCT_TYPE, 119) \
    V(FIRST_FIXED_ARRAY_BASE_TYPE, 120) \
      V(FIRST_FIXED_ARRAY_TYPE, 120) \
        V(FIXED_ARRAY_TYPE, 120) \
        V(FIRST_HASH_TABLE_TYPE, 121) \
          V(HASH_TABLE_TYPE, 121) \
          V(EPHEMERON_HASH_TABLE_TYPE, 122) \
          V(GLOBAL_DICTIONARY_TYPE, 123) \
          V(NAME_DICTIONARY_TYPE, 124) \
          V(NUMBER_DICTIONARY_TYPE, 125) \
          V(ORDERED_HASH_MAP_TYPE, 126) \
          V(ORDERED_HASH_SET_TYPE, 127) \
          V(ORDERED_NAME_DICTIONARY_TYPE, 128) \
          V(SIMPLE_NUMBER_DICTIONARY_TYPE, 129) \
          V(STRING_TABLE_TYPE, 130) \
        V(LAST_HASH_TABLE_TYPE, 130) \
        V(CLOSURE_FEEDBACK_CELL_ARRAY_TYPE, 131) \
        V(OBJECT_BOILERPLATE_DESCRIPTION_TYPE, 132) \
        V(SCOPE_INFO_TYPE, 133) \
        V(SCRIPT_CONTEXT_TABLE_TYPE, 134) \
      V(LAST_FIXED_ARRAY_TYPE, 134) \
      V(BYTE_ARRAY_TYPE, 135) \
      V(BYTECODE_ARRAY_TYPE, 136) \
      V(FIXED_DOUBLE_ARRAY_TYPE, 137) \
    V(LAST_FIXED_ARRAY_BASE_TYPE, 137) \
    V(FIRST_CONTEXT_TYPE, 138) \
      V(AWAIT_CONTEXT_TYPE, 138) \
      V(BLOCK_CONTEXT_TYPE, 139) \
      V(CATCH_CONTEXT_TYPE, 140) \
      V(DEBUG_EVALUATE_CONTEXT_TYPE, 141) \
      V(EVAL_CONTEXT_TYPE, 142) \
      V(FUNCTION_CONTEXT_TYPE, 143) \
      V(MODULE_CONTEXT_TYPE, 144) \
      V(NATIVE_CONTEXT_TYPE, 145) \
      V(SCRIPT_CONTEXT_TYPE, 146) \
      V(WITH_CONTEXT_TYPE, 147) \
    V(LAST_CONTEXT_TYPE, 147) \
    ...
    V(FIRST_UNCOMPILED_DATA_TYPE, 151) \
      V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 151) \
      V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 152) \
    V(LAST_UNCOMPILED_DATA_TYPE, 152) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 153) \
      V(WEAK_FIXED_ARRAY_TYPE, 153) \
      V(TRANSITION_ARRAY_TYPE, 154) \
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 154) \
    V(CELL_TYPE, 155) \
    V(CODE_TYPE, 156) \
    V(CODE_DATA_CONTAINER_TYPE, 157) \
    V(DESCRIPTOR_ARRAY_TYPE, 158) \
    V(EMBEDDER_DATA_ARRAY_TYPE, 159) \
    V(FEEDBACK_METADATA_TYPE, 160) \
    V(FEEDBACK_VECTOR_TYPE, 161) \
    V(FILLER_TYPE, 162) \
    V(FREE_SPACE_TYPE, 163) \
    V(MAP_TYPE, 164) \
    V(PREPARSE_DATA_TYPE, 165) \
    V(PROPERTY_ARRAY_TYPE, 166) \
    V(PROPERTY_CELL_TYPE, 167) \
    V(SHARED_FUNCTION_INFO_TYPE, 168) \
    V(WEAK_ARRAY_LIST_TYPE, 169) \
    V(WEAK_CELL_TYPE, 170) \
    V(FIRST_JS_RECEIVER_TYPE, 171) \
      V(JS_PROXY_TYPE, 171) \
      V(FIRST_JS_OBJECT_TYPE, 172) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 172) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 172) \
            V(JS_GLOBAL_OBJECT_TYPE, 172) \
            V(JS_GLOBAL_PROXY_TYPE, 173) \
            V(JS_MODULE_NAMESPACE_TYPE, 174) \
