...
public final class R {
    ...
    private static void onResourcesLoadedDimen (
        ...
        dimen.subtitle_corner_radius ^= packageIdTransform;
        dimen.subtitle_outline_width ^= packageIdTransform;
        dimen.subtitle_shadow_offset ^= packageIdTransform;
        dimen.subtitle_shadow_radius ^= packageIdTransform;
    }
    ...
    private static void onResourcesLoadedStyle (
        ...
        style.TextAppearance_Compat_Notification_Info_Media ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Line2 ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Line2_Media ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Media ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Time ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Time_Media ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Title ^= packageIdTransform;
        style.TextAppearance_Compat_Notification_Title_Media ^= packageIdTransform;
