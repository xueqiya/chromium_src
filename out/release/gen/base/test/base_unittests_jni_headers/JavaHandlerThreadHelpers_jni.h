...
JNI_REGISTRATION_EXPORT std::atomic<jclass>
    g_org_chromium_base_JavaHandlerThreadHelpers_clazz(nullptr);
...
static std::atomic<jmethodID>
    g_org_chromium_base_JavaHandlerThreadHelpers_testAndGetJavaHandlerThread(nullptr);
static base::android::ScopedJavaLocalRef<jobject>
    Java_JavaHandlerThreadHelpers_testAndGetJavaHandlerThread(JNIEnv* env) {
  jclass clazz = org_chromium_base_JavaHandlerThreadHelpers_clazz(env);
...
static std::atomic<jmethodID> g_org_chromium_base_JavaHandlerThreadHelpers_throwException(nullptr);
...
static std::atomic<jmethodID>
    g_org_chromium_base_JavaHandlerThreadHelpers_isExceptionTestException(nullptr);
static jboolean Java_JavaHandlerThreadHelpers_isExceptionTestException(JNIEnv* env, const
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(clazz,
          call_context.base.method_id, exception.obj());
  return ret;
}
