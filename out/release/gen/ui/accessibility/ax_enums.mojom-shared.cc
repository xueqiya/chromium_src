...
std::ostream& operator<<(std::ostream& os, Event value) {
  switch(value) {
    ...
    case Event::kControlsChanged:
      return os << "Event::kControlsChanged";
    ...
    case Event::kFocusAfterMenuClose:
      return os << "Event::kFocusAfterMenuClose";
...
std::ostream& operator<<(std::ostream& os, Role value) {
  switch(value) {
    ...
    case Role::kFooterAsNonLandmark:
      return os << "Role::kFooterAsNonLandmark";
    case Role::kForm:
    ...
    case Role::kHeader:
      return os << "Role::kHeader";
    case Role::kHeaderAsNonLandmark:
      return os << "Role::kHeaderAsNonLandmark";
    case Role::kHeading:
    ...
    case Role::kPdfActionableHighlight:
      return os << "Role::kPdfActionableHighlight";
    case Role::kPluginObject:
      return os << "Role::kPluginObject";
    case Role::kPopUpButton:
      return os << "Role::kPopUpButton";
    case Role::kPortal:
      return os << "Role::kPortal";
    case Role::kPre:
      return os << "Role::kPre";
    ...
    case Role::kStrong:
      return os << "Role::kStrong";
    case Role::kSuggestion:
      return os << "Role::kSuggestion";
    case Role::kSvgRoot:
...
std::ostream& operator<<(std::ostream& os, ScrollAlignment value) {
  switch(value) {
    case ScrollAlignment::kNone:
      return os << "ScrollAlignment::kNone";
    case ScrollAlignment::kScrollAlignmentCenter:
      return os << "ScrollAlignment::kScrollAlignmentCenter";
    case ScrollAlignment::kScrollAlignmentTop:
      return os << "ScrollAlignment::kScrollAlignmentTop";
    case ScrollAlignment::kScrollAlignmentBottom:
      return os << "ScrollAlignment::kScrollAlignmentBottom";
    case ScrollAlignment::kScrollAlignmentLeft:
      return os << "ScrollAlignment::kScrollAlignmentLeft";
    case ScrollAlignment::kScrollAlignmentRight:
      return os << "ScrollAlignment::kScrollAlignmentRight";
    case ScrollAlignment::kScrollAlignmentClosestEdge:
      return os << "ScrollAlignment::kScrollAlignmentClosestEdge";
    default:
      return os << "Unknown ScrollAlignment value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, ScrollBehavior value) {
  switch(value) {
    case ScrollBehavior::kNone:
      return os << "ScrollBehavior::kNone";
    case ScrollBehavior::kDoNotScrollIfVisible:
      return os << "ScrollBehavior::kDoNotScrollIfVisible";
    case ScrollBehavior::kScrollIfVisible:
      return os << "ScrollBehavior::kScrollIfVisible";
    default:
      return os << "Unknown ScrollBehavior value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, StringAttribute value) {
  switch(value) {
    ...
    case StringAttribute::kInputType:
      return os << "StringAttribute::kInputType";
...
std::ostream& operator<<(std::ostream& os, IntAttribute value) {
  switch(value) {
    ...
    case IntAttribute::kAriaCellColumnSpan:
      return os << "IntAttribute::kAriaCellColumnSpan";
    ...
    case IntAttribute::kAriaCellRowSpan:
      return os << "IntAttribute::kAriaCellRowSpan";
    ...
    case IntAttribute::kDropeffect:
      return os << "IntAttribute::kDropeffect";
    case IntAttribute::kDOMNodeId:
      return os << "IntAttribute::kDOMNodeId";
    default:
...
std::ostream& operator<<(std::ostream& os, BoolAttribute value) {
  switch(value) {
    ...
    case BoolAttribute::kGrabbed:
      return os << "BoolAttribute::kGrabbed";
    case BoolAttribute::kIsLineBreakingObject:
      return os << "BoolAttribute::kIsLineBreakingObject";
    case BoolAttribute::kIsPageBreakingObject:
      return os << "BoolAttribute::kIsPageBreakingObject";
    case BoolAttribute::kHasAriaAttribute:
      return os << "BoolAttribute::kHasAriaAttribute";
    default:
...
std::ostream& operator<<(std::ostream& os, IntListAttribute value) {
  switch(value) {
    ...
    case IntListAttribute::kDetailsIds:
      return os << "IntListAttribute::kDetailsIds";
...
std::ostream& operator<<(std::ostream& os, DescriptionFrom value) {
  switch(value) {
    ...
    case DescriptionFrom::kTitle:
      return os << "DescriptionFrom::kTitle";
    default:
...
std::ostream& operator<<(std::ostream& os, ImageAnnotationStatus value) {
  switch(value) {
    ...
    case ImageAnnotationStatus::kSilentlyEligibleForAnnotation:
      return os << "ImageAnnotationStatus::kSilentlyEligibleForAnnotation";
...
std::ostream& operator<<(std::ostream& os, Dropeffect value) {
  switch(value) {
    case Dropeffect::kNone:
      return os << "Dropeffect::kNone";
    case Dropeffect::kCopy:
      return os << "Dropeffect::kCopy";
    case Dropeffect::kExecute:
      return os << "Dropeffect::kExecute";
    case Dropeffect::kLink:
      return os << "Dropeffect::kLink";
    case Dropeffect::kMove:
      return os << "Dropeffect::kMove";
    case Dropeffect::kPopup:
      return os << "Dropeffect::kPopup";
    default:
      return os << "Unknown Dropeffect value: " << static_cast<int32_t>(value);
  }
}
