...
template <>
struct DefaultHash<::ax::mojom::ScrollAlignment> {
  using Hash = ax_mojom_internal_ScrollAlignment_DataHashFn;
};
}  // namespace WTF
...
template <>
struct DefaultHash<::ax::mojom::ScrollBehavior> {
  using Hash = ax_mojom_internal_ScrollBehavior_DataHashFn;
};
}  // namespace WTF
...
template <>
struct DefaultHash<::ax::mojom::Dropeffect> {
  using Hash = ax_mojom_internal_Dropeffect_DataHashFn;
};
}  // namespace WTF
...
using ScrollAlignment = ScrollAlignment;  // Alias for definition in the parent namespace.
using ScrollBehavior = ScrollBehavior;  // Alias for definition in the parent namespace.
...
using Dropeffect = Dropeffect;  // Alias for definition in the parent namespace.
