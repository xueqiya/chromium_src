...
struct HashTraits<::ax::mojom::ScrollAlignment>
  ...
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::ax::mojom::ScrollAlignment& value) {
    return value == static_cast<::ax::mojom::ScrollAlignment>(-1000000);
  }
...
struct HashTraits<::ax::mojom::ScrollBehavior>
  ...
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::ax::mojom::ScrollBehavior& value) {
    return value == static_cast<::ax::mojom::ScrollBehavior>(-1000000);
  }
...
struct HashTraits<::ax::mojom::Dropeffect>
  ...
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::ax::mojom::Dropeffect& value) {
    return value == static_cast<::ax::mojom::Dropeffect>(-1000000);
  }
