 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(Quaternion_Data));
      new (data()) Quaternion_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    Quaternion_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<Quaternion_Data>(index_);
    }
    Quaternion_Data* operator->() { return data(); }
...
struct Quaternion_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    Quaternion_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
