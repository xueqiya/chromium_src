...
class GpuMemoryBufferPlatformHandleDataView {
 public:
  ...
  bool is_android_hardware_buffer_handle() const { return data_->tag == Tag::ANDROID_HARDWARE_BUFFER_HANDLE; }
  ...
  WARN_UNUSED_RESULT bool ReadAndroidHardwareBufferHandle(UserType* output) {
    DCHECK(is_android_hardware_buffer_handle());
    return mojo::internal::Deserialize<::gfx::mojom::AHardwareBufferHandleDataView>(
        data_->data.f_android_hardware_buffer_handle.Get(), output, context_);
  }
...
struct Serializer<::gfx::mojom::GpuMemoryBufferPlatformHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    switch (result->tag) {
      ...
      case ::gfx::mojom::GpuMemoryBufferPlatformHandleDataView::Tag::ANDROID_HARDWARE_BUFFER_HANDLE: {
        ...
        typename decltype(result->data.f_android_hardware_buffer_handle)::BaseType::BufferWriter
            value_writer;
        mojo::internal::Serialize<::gfx::mojom::AHardwareBufferHandleDataView>(
            in_android_hardware_buffer_handle, buffer, &value_writer, context);
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            value_writer.is_null(),
            mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
            "null android_hardware_buffer_handle in GpuMemoryBufferPlatformHandle union");
        result->data.f_android_hardware_buffer_handle.Set(
            value_writer.is_null() ? nullptr : value_writer.data());
        break;
      }
    }
...
inline void GpuMemoryBufferPlatformHandleDataView::GetAndroidHardwareBufferHandleDataView(
    AHardwareBufferHandleDataView* output) {
  DCHECK(is_android_hardware_buffer_handle());
  *output = AHardwareBufferHandleDataView(data_->data.f_android_hardware_buffer_handle.Get(), context_);
}
