...
struct  StructTraits<::gfx::mojom::blink::DisplayColorSpaces::DataView,
  ...
  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::srgb)& srgb(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
    return input->srgb;
  }

  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::wcg_opaque)& wcg_opaque(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
    return input->wcg_opaque;
  }

  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::wcg_transparent)& wcg_transparent(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
    return input->wcg_transparent;
  }

  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::hdr_opaque)& hdr_opaque(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
    return input->hdr_opaque;
  }

  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::hdr_transparent)& hdr_transparent(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
