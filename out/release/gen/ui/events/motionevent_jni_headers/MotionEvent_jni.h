...
static std::atomic<jmethodID> g_android_view_MotionEvent_getClassification(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_getActionButton(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_getRawXF(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_getRawYF(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_getRawXF_I(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_getRawYF_I(nullptr);
...
static std::atomic<jmethodID> g_android_view_MotionEvent_isButtonPressed(nullptr);
