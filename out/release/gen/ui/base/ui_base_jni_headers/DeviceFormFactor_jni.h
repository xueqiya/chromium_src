...
JNI_REGISTRATION_EXPORT std::atomic<jclass> g_org_chromium_ui_base_DeviceFormFactor_clazz(nullptr);
...
static std::atomic<jmethodID> g_org_chromium_ui_base_DeviceFormFactor_isTablet(nullptr);
static jboolean Java_DeviceFormFactor_isTablet(JNIEnv* env) {
  jclass clazz = org_chromium_ui_base_DeviceFormFactor_clazz(env);
