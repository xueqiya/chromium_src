// ui/base/mojom/cursor.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
std::ostream& operator<<(std::ostream& os, CursorType value) {
  switch(value) {
    ...
    case CursorType::kMiddlePanningVertical:
      return os << "CursorType::kMiddlePanningVertical";
    case CursorType::kMiddlePanningHorizontal:
      return os << "CursorType::kMiddlePanningHorizontal";
