...
struct ui_mojom_internal_ImeTextSpanUnderlineStyle_DataHashFn {
  ...
  static bool Equal(const ::ui::mojom::ImeTextSpanUnderlineStyle& left, const ::ui::mojom::ImeTextSpanUnderlineStyle& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::ui::mojom::ImeTextSpanUnderlineStyle>
    : public GenericHashTraits<::ui::mojom::ImeTextSpanUnderlineStyle> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::ui::mojom::ImeTextSpanUnderlineStyle& value) {
    return value == static_cast<::ui::mojom::ImeTextSpanUnderlineStyle>(-1000000);
  }
  static void ConstructDeletedValue(::ui::mojom::ImeTextSpanUnderlineStyle& slot, bool) {
    slot = static_cast<::ui::mojom::ImeTextSpanUnderlineStyle>(-1000001);
  }
  static bool IsDeletedValue(const ::ui::mojom::ImeTextSpanUnderlineStyle& value) {
    return value == static_cast<::ui::mojom::ImeTextSpanUnderlineStyle>(-1000001);
  }
};
}  // namespace WTF
