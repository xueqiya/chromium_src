...
class DisplaySnapshotDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPrivacyScreenState(UserType* output) const {
  ...
  ::display::mojom::PrivacyScreenState privacy_screen_state() const {
    return static_cast<::display::mojom::PrivacyScreenState>(data_->privacy_screen_state);
  }
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPanelOrientation(UserType* output) const {
  ...
  ::display::mojom::PanelOrientation panel_orientation() const {
    return static_cast<::display::mojom::PanelOrientation>(data_->panel_orientation);
  }
...
struct Serializer<::display::mojom::DisplaySnapshotDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::display::mojom::PrivacyScreenState>(
        Traits::privacy_screen_state(input), &(*output)->privacy_screen_state);
    ...
    mojo::internal::Serialize<::display::mojom::PanelOrientation>(
        Traits::panel_orientation(input), &(*output)->panel_orientation);
