...
bool DisplaySnapshot_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->color_space, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->display_name, 12, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->sys_path, 13, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->modes, 14, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->edid, 16, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->maximum_cursor_size, 23, validation_context)) {
    return false;
  }
