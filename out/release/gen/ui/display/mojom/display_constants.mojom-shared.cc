...
std::ostream& operator<<(std::ostream& os, PanelOrientation value) {
  switch(value) {
    case PanelOrientation::NORMAL:
      return os << "PanelOrientation::NORMAL";
    case PanelOrientation::BOTTOM_UP:
      return os << "PanelOrientation::BOTTOM_UP";
    case PanelOrientation::LEFT_UP:
      return os << "PanelOrientation::LEFT_UP";
    case PanelOrientation::RIGHT_UP:
      return os << "PanelOrientation::RIGHT_UP";
    default:
      return os << "Unknown PanelOrientation value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, PrivacyScreenState value) {
  switch(value) {
    case PrivacyScreenState::DISABLED:
      return os << "PrivacyScreenState::DISABLED";
    case PrivacyScreenState::ENABLED:
      return os << "PrivacyScreenState::ENABLED";
    case PrivacyScreenState::NOT_SUPPORTED:
      return os << "PrivacyScreenState::NOT_SUPPORTED";
    default:
      return os << "Unknown PrivacyScreenState value: " << static_cast<int32_t>(value);
  }
}
