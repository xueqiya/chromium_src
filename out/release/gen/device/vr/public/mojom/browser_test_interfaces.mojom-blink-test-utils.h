// device/vr/public/mojom/browser_test_interfaces.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef DEVICE_VR_PUBLIC_MOJOM_BROWSER_TEST_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_
#define DEVICE_VR_PUBLIC_MOJOM_BROWSER_TEST_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_
...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRTestHookInterceptorForTesting : public XRTestHook {
...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRTestHookAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRServiceTestHookInterceptorForTesting : public XRServiceTestHook {
...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRServiceTestHookAsyncWaiter {
 public:
...
#endif  // DEVICE_VR_PUBLIC_MOJOM_BROWSER_TEST_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_