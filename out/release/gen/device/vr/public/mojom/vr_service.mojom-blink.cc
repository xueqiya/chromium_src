...
VRStageParameters::VRStageParameters(
    ...
    base::Optional<WTF::Vector<::gfx::Point3F>> bounds_in)
...
size_t XRNativeOriginInformation::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::INPUT_SOURCE_ID:
      return mojo::internal::WTFHash(seed, data_.input_source_id);
    case Tag::PLANE_ID:
      return mojo::internal::WTFHash(seed, data_.plane_id);
    case Tag::ANCHOR_ID:
      return mojo::internal::WTFHash(seed, data_.anchor_id);
    case Tag::REFERENCE_SPACE_CATEGORY:
      return mojo::internal::WTFHash(seed, data_.reference_space_category);
    default:
      NOTREACHED();
      return seed;
  }
...
bool UnionTraits<::device::mojom::blink::XRNativeOriginInformation::DataView, ::device::mojom::blink::XRNativeOriginInformationPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::REFERENCE_SPACE_CATEGORY: {
      ::device::mojom::blink::XRReferenceSpaceCategory result_reference_space_category;
