...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRSessionMetricsRecorderInterceptorForTesting : public XRSessionMetricsRecorder {
  virtual XRSessionMetricsRecorder* GetForwardingInterface() = 0;
  void ReportFeatureUsed(XRSessionFeature feature) override;
};
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRSessionMetricsRecorderAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XREnvironmentIntegrationProviderInterceptorForTesting : public XREnvironmentIntegrationProvider {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XREnvironmentIntegrationProviderAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRInputSourceButtonListenerInterceptorForTesting : public XRInputSourceButtonListener {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRInputSourceButtonListenerAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRFrameDataProviderInterceptorForTesting : public XRFrameDataProvider {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRFrameDataProviderAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRPresentationProviderInterceptorForTesting : public XRPresentationProvider {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRPresentationProviderAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRPresentationClientInterceptorForTesting : public XRPresentationClient {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRPresentationClientAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRSessionClientInterceptorForTesting : public XRSessionClient {
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS) XRSessionClientAsyncWaiter {
 public:
