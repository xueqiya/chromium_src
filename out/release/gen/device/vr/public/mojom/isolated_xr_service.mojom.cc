...
void ImmersiveOverlayProxy::SubmitOverlayTexture(
    int16_t in_frame_id, mojo::ScopedHandle in_texture, const ::gfx::RectF& in_left_bounds, const ::gfx::RectF& in_right_bounds, SubmitOverlayTextureCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class ImmersiveOverlay_RequestNextOverlayPose_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::device::mojom::XRFrameDataPtr in_pose);
...
bool ImmersiveOverlay_RequestNextOverlayPose_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  ::device::mojom::XRFrameDataPtr p_pose{};
...
void IsolatedXRRuntimeProviderClientProxy::OnDeviceAdded(
    mojo::PendingRemote<XRRuntime> in_runtime, mojo::PendingRemote<XRCompositorHost> in_compositor_host, ::device::mojom::XRDeviceId in_device_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
