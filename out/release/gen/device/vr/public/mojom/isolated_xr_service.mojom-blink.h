// device/vr/public/mojom/isolated_xr_service.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRRuntimeEventListener
 ...
 public:
  ...
  virtual void OnVisibilityStateChanged(::device::mojom::blink::XRVisibilityState visibility_state) = 0;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRRuntime
 ...
 public:
  ...
  using RequestSessionCallback = base::OnceCallback<void(::device::mojom::blink::XRSessionPtr, mojo::PendingRemote<XRSessionController>)>;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) IsolatedXRRuntimeProviderClient
 ...
 public:
  ...
  virtual void OnDeviceAdded(mojo::PendingRemote<XRRuntime> runtime, mojo::PendingRemote<XRCompositorHost> compositor_host, ::device::mojom::blink::XRDeviceId device_id) = 0;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRDeviceService
 ...
 public:
  ...
  virtual void BindTestHook(mojo::PendingReceiver<::device_test::mojom::blink::XRServiceTestHook> receiver) = 0;
};
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRRuntimeEventListenerProxy
 ...
 public:
  ...
  void OnVisibilityStateChanged(::device::mojom::blink::XRVisibilityState visibility_state) final;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) IsolatedXRRuntimeProviderClientProxy
 ...
 public:
  ...
  void OnDeviceAdded(mojo::PendingRemote<XRRuntime> runtime, mojo::PendingRemote<XRCompositorHost> compositor_host, ::device::mojom::blink::XRDeviceId device_id) final;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRDeviceServiceProxy
 ...
 public:
  ...
  void BindTestHook(mojo::PendingReceiver<::device_test::mojom::blink::XRServiceTestHook> receiver) final;
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRDeviceServiceStubDispatch {
 public:
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRDeviceServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) XRRuntimeSessionOptions {
 public:
  ...
  XRRuntimeSessionOptions(
      ...
      WTF::Vector<::device::mojom::blink::XRSessionFeature> enabled_features,
...
struct COMPONENT_EXPORT(DEVICE_VR_MOJO_BINDINGS_BLINK) StructTraits<::device::mojom::blink::XRRuntimeSessionOptions::DataView,
  ...
  static decltype(::device::mojom::blink::XRRuntimeSessionOptions::mode) mode(
      const ::device::mojom::blink::XRRuntimeSessionOptionsPtr& input) {
    return input->mode;
  }

  static const decltype(::device::mojom::blink::XRRuntimeSessionOptions::enabled_features)& enabled_features(
      const ::device::mojom::blink::XRRuntimeSessionOptionsPtr& input) {
