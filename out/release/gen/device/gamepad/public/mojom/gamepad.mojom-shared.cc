...
std::ostream& operator<<(std::ostream& os, GamepadMapping value) {
  switch(value) {
    case GamepadMapping::GamepadMappingNone:
      return os << "GamepadMapping::GamepadMappingNone";
    case GamepadMapping::GamepadMappingStandard:
      return os << "GamepadMapping::GamepadMappingStandard";
    case GamepadMapping::GamepadMappingXRStandard:
      return os << "GamepadMapping::GamepadMappingXRStandard";
    default:
      return os << "Unknown GamepadMapping value: " << static_cast<int32_t>(value);
  }
}
