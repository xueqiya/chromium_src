...
struct device_mojom_internal_GamepadMapping_DataHashFn {
  static unsigned GetHash(const ::device::mojom::GamepadMapping& value) {
    using utype = std::underlying_type<::device::mojom::GamepadMapping>::type;
    return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
  }
  static bool Equal(const ::device::mojom::GamepadMapping& left, const ::device::mojom::GamepadMapping& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::device::mojom::GamepadMapping>
    : public GenericHashTraits<::device::mojom::GamepadMapping> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::device::mojom::GamepadMapping& value) {
    return value == static_cast<::device::mojom::GamepadMapping>(-1000000);
  }
  static void ConstructDeletedValue(::device::mojom::GamepadMapping& slot, bool) {
    slot = static_cast<::device::mojom::GamepadMapping>(-1000001);
  }
  static bool IsDeletedValue(const ::device::mojom::GamepadMapping& value) {
    return value == static_cast<::device::mojom::GamepadMapping>(-1000001);
  }
};
}  // namespace WTF
