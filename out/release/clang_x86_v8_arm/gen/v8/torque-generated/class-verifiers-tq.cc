...
void TorqueGeneratedClassVerifiers::BreakPointVerify(BreakPoint o, Isolate* isolate) {
  ...
  {
    Object id__value = TaggedField<Object, BreakPoint::kIdOffset>::load(o, 0);
    Object::VerifyPointer(isolate, id__value);
    CHECK(id__value.IsSmi());
  }
  {
    Object condition__value = TaggedField<Object, BreakPoint::kConditionOffset>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::BreakPointInfoVerify(BreakPointInfo o, Isolate* isolate) {
  ...
  {
    Object source_position__value = TaggedField<Object, BreakPointInfo::kSourcePositionOffset>::load(o, 0);
    Object::VerifyPointer(isolate, source_position__value);
    CHECK(source_position__value.IsSmi());
  }
  {
    Object break_points__value = TaggedField<Object, BreakPointInfo::kBreakPointsOffset>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::WeakCellVerify(WeakCell o, Isolate* isolate) {
  ...
  {
    Object unregister_token__value = TaggedField<Object, WeakCell::kUnregisterTokenOffset>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::PropertyDescriptorObjectVerify(PropertyDescriptorObject o, Isolate* isolate) {
  ...
  {
    Object flags__value = TaggedField<Object, PropertyDescriptorObject::kFlagsOffset>::load(o, 0);
    Object::VerifyPointer(isolate, flags__value);
    CHECK(flags__value.IsSmi());
  }
  {
    Object value__value = TaggedField<Object, PropertyDescriptorObject::kValueOffset>::load(o, 0);
    Object::VerifyPointer(isolate, value__value);
  ...
  {
    Object get__value = TaggedField<Object, PropertyDescriptorObject::kGetOffset>::load(o, 0);
  ...
  {
    Object set__value = TaggedField<Object, PropertyDescriptorObject::kSetOffset>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::PrototypeInfoVerify(PrototypeInfo o, Isolate* isolate) {
  ...
  {
    Object prototype_chain_enum_cache__value = TaggedField<Object, PrototypeInfo::kPrototypeChainEnumCacheOffset>::load(o, 0);
...
void TorqueGeneratedClassVerifiers::CachedTemplateObjectVerify(CachedTemplateObject o, Isolate* isolate) {
  ...
  {
    Object slot_id__value = TaggedField<Object, CachedTemplateObject::kSlotIdOffset>::load(o, 0);
    Object::VerifyPointer(isolate, slot_id__value);
    CHECK(slot_id__value.IsSmi());
  }
  {
    Object template_object__value = TaggedField<Object, CachedTemplateObject::kTemplateObjectOffset>::load(o, 0);
    Object::VerifyPointer(isolate, template_object__value);
    CHECK(template_object__value.IsJSArray());
  }
  {
    Object next__value = TaggedField<Object, CachedTemplateObject::kNextOffset>::load(o, 0);
    Object::VerifyPointer(isolate, next__value);
