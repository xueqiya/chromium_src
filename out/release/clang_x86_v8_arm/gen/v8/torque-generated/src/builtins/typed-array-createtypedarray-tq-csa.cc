...
TNode<JSTypedArray> AllocateTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_isOnHeap, TNode<Map> p_map, TNode<JSArrayBuffer> p_buffer, TNode<UintPtrT> p_byteOffset, TNode<UintPtrT> p_byteLength, TNode<UintPtrT> p_length) {
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp80, tmp81}, tmp78);
    TNode<IntPtrT> tmp82;
    USE(tmp82);
    tmp82 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    CodeStubAssembler(state_).StoreReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp80, tmp82}, tmp74);
    TNode<IntPtrT> tmp83;
    USE(tmp83);
    tmp83 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    CodeStubAssembler(state_).StoreReference<UintPtrT>(CodeStubAssembler::Reference{tmp80, tmp83}, tmp75);
    TNode<IntPtrT> tmp84;
    USE(tmp84);
    tmp84 = FromConstexpr_intptr_constexpr_int31_0(state_, 20);
    CodeStubAssembler(state_).StoreReference<UintPtrT>(CodeStubAssembler::Reference{tmp80, tmp84}, tmp76);
    TNode<IntPtrT> tmp85;
    USE(tmp85);
    tmp85 = FromConstexpr_intptr_constexpr_int31_0(state_, 24);
    CodeStubAssembler(state_).StoreReference<UintPtrT>(CodeStubAssembler::Reference{tmp80, tmp85}, tmp77);
    if ((p_isOnHeap)) {
...
TNode<JSTypedArray> TypedArrayInitialize_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_initialize, TNode<Map> p_map, TNode<UintPtrT> p_length, TorqueStructTypedArrayElementsInfo p_elementsInfo, TNode<JSReceiver> p_bufferConstructor, compiler::CodeAssemblerLabel* label_IfRangeError) {
  ...
  if (block20.is_used()) {
    ...
    TNode<Object> tmp164;
    USE(tmp164);
    tmp164 = CodeStubAssembler(state_).Call(TNode<Context>{tmp152}, TNode<Object>{tmp162}, TNode<Object>{tmp163}, TNode<Object>{tmp159});
...
TNode<JSTypedArray> ConstructByArrayLike_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Map> p_map, TNode<HeapObject> p_arrayLike, TNode<UintPtrT> p_length, TorqueStructTypedArrayElementsInfo p_elementsInfo, TNode<JSReceiver> p_bufferConstructor) {
  ...
  if (block16.is_used()) {
    ...
    USE(tmp108);
    tmp108 = FromConstexpr_intptr_constexpr_int31_0(state_, 20);
...
TNode<JSTypedArray> TypedArrayCreateByLength_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_constructor, TNode<Number> p_length, const char* p_methodName) {
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsSafeInteger(length)' failed", "src/builtins/typed-array-createtypedarray.tq", 293);
  }
...
TF_BUILTIN(CreateTypedArray, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsConstructor(target)' failed", "src/builtins/typed-array-createtypedarray.tq", 352);
  }
...
TNode<JSTypedArray> TypedArraySpeciesCreate_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, const char* p_methodName, int31_t p_numArgs, TNode<JSTypedArray> p_exemplar, TNode<Object> p_arg0, TNode<Object> p_arg1, TNode<Object> p_arg2) {
  ...
  if (block11.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert '!IsDetachedBuffer(typedArray.buffer)' failed", "src/builtins/typed-array-createtypedarray.tq", 407);
  }
  ...
  if (block22.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'numArgs == 3' failed", "src/builtins/typed-array-createtypedarray.tq", 422);
  }
