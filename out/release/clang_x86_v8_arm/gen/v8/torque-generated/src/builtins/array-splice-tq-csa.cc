...
TNode<FixedArray> Extract_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_elements, TNode<Smi> p_first, TNode<Smi> p_count, TNode<Smi> p_capacity) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, Smi, Smi, Smi, FixedArray> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp8);
    tmp8 = ExtractFixedArray_0(state_, TNode<FixedArray>{tmp1}, TNode<IntPtrT>{tmp5}, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp7});
  ...
  return TNode<FixedArray>{tmp14};
}

TNode<FixedArrayBase> Extract_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_first, TNode<Smi> p_count, TNode<Smi> p_capacity) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi, FixedArrayBase, FixedArrayBase> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi, FixedArrayBase, FixedArrayBase, FixedArray> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi, FixedArrayBase> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi, FixedArrayBase> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_elements, p_first, p_count, p_capacity);
  ...
  if (block0.is_used()) {
    ...
    tmp5 = Cast_EmptyFixedArray_1(state_, TNode<HeapObject>{tmp1}, &label0);
    ca_.Goto(&block4, tmp0, tmp1, tmp2, tmp3, tmp4, tmp1, tmp1, tmp5);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp2, tmp3, tmp4, tmp1, tmp1);
    }
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<IntPtrT> tmp13;
    USE(tmp13);
    tmp13 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp8});
    TNode<IntPtrT> tmp14;
    USE(tmp14);
    tmp14 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp9});
    TNode<IntPtrT> tmp15;
    USE(tmp15);
    tmp15 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp10});
    TNode<FixedArrayBase> tmp16;
    USE(tmp16);
    tmp16 = ExtractFixedDoubleArray_0(state_, TNode<FixedDoubleArray>{ca_.UncheckedCast<FixedDoubleArray>(tmp11)}, TNode<IntPtrT>{tmp13}, TNode<IntPtrT>{tmp14}, TNode<IntPtrT>{tmp15});
    ca_.Goto(&block1, tmp6, tmp7, tmp8, tmp9, tmp10, tmp16);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Bind(&block4, &tmp17, &tmp18, &tmp19, &tmp20, &tmp21, &tmp22, &tmp23, &tmp24);
    TNode<IntPtrT> tmp25;
    USE(tmp25);
    tmp25 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp21});
    TNode<FixedDoubleArray> tmp26;
    USE(tmp26);
    tmp26 = CodeStubAssembler(state_).AllocateZeroedFixedDoubleArray(TNode<IntPtrT>{tmp25});
    ca_.Goto(&block1, tmp17, tmp18, tmp19, tmp20, tmp21, tmp26);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp27, &tmp28, &tmp29, &tmp30, &tmp31, &tmp32);
    ca_.Goto(&block6, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32);
  }
  ...
  return TNode<FixedArrayBase>{tmp38};
}
...
TNode<Object> FastArraySplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block39.is_used()) {
    ...
    USE(tmp647);
    tmp647 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
  ...
  if (block44.is_used()) {
    ...
    USE(tmp751);
    tmp751 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArray> tmp752;
    USE(tmp752);
    tmp752 = kEmptyFixedArray_0(state_);
    CodeStubAssembler(state_).StoreReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp745, tmp751}, tmp752);
    TNode<IntPtrT> tmp753;
    USE(tmp753);
    tmp753 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    TNode<Number> tmp754;
    USE(tmp754);
    tmp754 = FromConstexpr_Number_constexpr_int31_0(state_, 0);
    CodeStubAssembler(state_).StoreReference<Number>(CodeStubAssembler::Reference{tmp745, tmp753}, tmp754);
...
void HandleForwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block6.is_used()) {
    ...
    TNode<Smi> tmp49;
    USE(tmp49);
    tmp49 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    TNode<Oddball> tmp50;
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi> tmp89;
    USE(tmp89);
    tmp89 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    TNode<Oddball> tmp90;
...
void HandleBackwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block6.is_used()) {
    ...
    TNode<Smi> tmp53;
    USE(tmp53);
    tmp53 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    TNode<Oddball> tmp54;
...
void FastSplice_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi, Smi, FixedArray> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi, Smi, FixedArray> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArray, Smi, Smi, Smi> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp23);
    tmp23 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp11}, TNode<Object>{tmp22});
    TNode<Smi> tmp24;
    USE(tmp24);
    tmp24 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp18}, TNode<Smi>{tmp19});
    TNode<Smi> tmp25;
    USE(tmp25);
    tmp25 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp18}, TNode<Smi>{tmp20});
    TNode<Smi> tmp26;
    USE(tmp26);
    tmp26 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp16}, TNode<Smi>{tmp20});
    TNode<Smi> tmp27;
    USE(tmp27);
    tmp27 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp26}, TNode<Smi>{tmp18});
    TNode<BoolT> tmp28;
    USE(tmp28);
    tmp28 = CodeStubAssembler(state_).SmiLessThan(TNode<Smi>{tmp19}, TNode<Smi>{tmp20});
    ca_.Branch(tmp28, &block4, &block5, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp23, tmp24, tmp25, tmp27);
  }
  ...
  if (block4.is_used()) {
    ...
    USE(tmp43);
    tmp43 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp29}, TNode<Object>{tmp39});
    DoMoveElements_FixedArray_0(state_, TNode<FixedArray>{tmp43}, TNode<Smi>{tmp40}, TNode<Smi>{tmp41}, TNode<Smi>{tmp42});
    TNode<FixedArray> tmp44;
    USE(tmp44);
    tmp44 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp29}, TNode<Object>{tmp39});
    StoreHoles_FixedArray_0(state_, TNode<FixedArray>{tmp44}, TNode<Smi>{tmp35}, TNode<Smi>{tmp34});
    ca_.Goto(&block6, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41, tmp42);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<Smi> tmp57;
    TNode<Smi> tmp58;
    ca_.Bind(&block5, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58);
    TNode<BoolT> tmp59;
    USE(tmp59);
    tmp59 = CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp53}, TNode<Smi>{tmp54});
    ca_.Branch(tmp59, &block7, &block8, tmp45, tmp46, tmp47, tmp48, tmp49, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp56, tmp57, tmp58);
  }
  ...
  if (block7.is_used()) {
    ...
    TNode<Smi> tmp72;
    TNode<Smi> tmp73;
    ca_.Bind(&block7, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73);
    TNode<IntPtrT> tmp74;
    USE(tmp74);
    tmp74 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp75 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp70, tmp74});
    TNode<BoolT> tmp76;
    USE(tmp76);
    tmp76 = CodeStubAssembler(state_).SmiLessThanOrEqual(TNode<Smi>{tmp66}, TNode<Smi>{tmp75});
    ca_.Branch(tmp76, &block9, &block10, tmp60, tmp61, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp71, tmp72, tmp73);
  }
  ...
  if (block9.is_used()) {
    ...
    TNode<Smi> tmp89;
    TNode<Smi> tmp90;
    ca_.Bind(&block9, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90);
    TNode<FixedArray> tmp91;
    USE(tmp91);
    tmp91 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp77}, TNode<Object>{tmp87});
    DoMoveElements_FixedArray_0(state_, TNode<FixedArray>{tmp91}, TNode<Smi>{tmp88}, TNode<Smi>{tmp89}, TNode<Smi>{tmp90});
  ...
  if (block10.is_used()) {
    ...
    TNode<Smi> tmp106;
    USE(tmp106);
    tmp106 = CodeStubAssembler(state_).CalculateNewElementsCapacity(TNode<Smi>{tmp98});
    TNode<Smi> tmp107;
    USE(tmp107);
    tmp107 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    TNode<FixedArray> tmp108;
    USE(tmp108);
    tmp108 = Extract_0(state_, TNode<Context>{tmp92}, TNode<FixedArray>{tmp102}, TNode<Smi>{tmp107}, TNode<Smi>{tmp99}, TNode<Smi>{tmp106});
    TNode<FixedArray> tmp109;
    USE(tmp109);
    tmp109 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp92}, TNode<Object>{tmp108});
    TNode<IntPtrT> tmp110;
    USE(tmp110);
    tmp110 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    CodeStubAssembler(state_).StoreReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp96, tmp110}, tmp109);
    TNode<IntPtrT> tmp111;
    USE(tmp111);
    tmp111 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp112 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp102, tmp111});
    TNode<Smi> tmp113;
    USE(tmp113);
    tmp113 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    TNode<BoolT> tmp114;
    USE(tmp114);
    tmp114 = CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp112}, TNode<Smi>{tmp113});
    ca_.Branch(tmp114, &block12, &block13, tmp92, tmp93, tmp94, tmp95, tmp96, tmp97, tmp98, tmp99, tmp100, tmp101, tmp102, tmp103, tmp104, tmp105, tmp106, tmp109);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130);
    TNode<FixedArray> tmp131;
    USE(tmp131);
    tmp131 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp115}, TNode<Object>{tmp125});
    DoCopyElements_FixedArray_0(state_, TNode<FixedArray>{tmp130}, TNode<Smi>{tmp126}, TNode<FixedArray>{tmp131}, TNode<Smi>{tmp127}, TNode<Smi>{tmp128});
    ca_.Goto(&block13, tmp115, tmp116, tmp117, tmp118, tmp119, tmp120, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128, tmp129, tmp130);
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.Goto(&block11, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139, tmp140, tmp141, tmp142, tmp143, tmp144, tmp145);
  }
  ...
  if (block11.is_used()) {
    ...
    TNode<Smi> tmp160;
    TNode<Smi> tmp161;
    ca_.Bind(&block11, &tmp148, &tmp149, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157, &tmp158, &tmp159, &tmp160, &tmp161);
    ca_.Goto(&block8, tmp148, tmp149, tmp150, tmp151, tmp152, tmp153, tmp154, tmp155, tmp156, tmp157, tmp158, tmp159, tmp160, tmp161);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi> tmp174;
    TNode<Smi> tmp175;
    ca_.Bind(&block8, &tmp162, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174, &tmp175);
    ca_.Goto(&block6, tmp162, tmp163, tmp164, tmp165, tmp166, tmp167, tmp168, tmp169, tmp170, tmp171, tmp172, tmp173, tmp174, tmp175);
  }
  ...
  if (block6.is_used()) {
    ...
    TNode<Smi> tmp188;
    TNode<Smi> tmp189;
    ca_.Bind(&block6, &tmp176, &tmp177, &tmp178, &tmp179, &tmp180, &tmp181, &tmp182, &tmp183, &tmp184, &tmp185, &tmp186, &tmp187, &tmp188, &tmp189);
    ca_.Goto(&block3, tmp176, tmp177, tmp178, tmp179, tmp180, tmp181, tmp182, tmp183, tmp184, tmp185);
  }
  ...
  if (block3.is_used()) {
    ...
    TNode<Smi> tmp198;
    TNode<Smi> tmp199;
    ca_.Bind(&block3, &tmp190, &tmp191, &tmp192, &tmp193, &tmp194, &tmp195, &tmp196, &tmp197, &tmp198, &tmp199);
    TNode<Smi> tmp200;
    USE(tmp200);
    tmp200 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    TNode<BoolT> tmp201;
    USE(tmp201);
    tmp201 = CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp198}, TNode<Smi>{tmp200});
    ca_.Branch(tmp201, &block14, &block15, tmp190, tmp191, tmp192, tmp193, tmp194, tmp195, tmp196, tmp197, tmp198, tmp199, tmp197);
  }
  ...
  if (block14.is_used()) {
    ...
    TNode<Smi> tmp211;
    TNode<Smi> tmp212;
    ca_.Bind(&block14, &tmp202, &tmp203, &tmp204, &tmp205, &tmp206, &tmp207, &tmp208, &tmp209, &tmp210, &tmp211, &tmp212);
    TNode<IntPtrT> tmp213;
    USE(tmp213);
    tmp213 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArrayBase>tmp214 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp206, tmp213});
    TNode<FixedArray> tmp215;
    USE(tmp215);
    tmp215 = UnsafeCast_FixedArray_0(state_, TNode<Context>{tmp202}, TNode<Object>{tmp214});
    TNode<IntPtrT> tmp216;
    USE(tmp216);
    tmp216 = FromConstexpr_intptr_constexpr_int31_0(state_, 2);
    ca_.Goto(&block18, tmp202, tmp203, tmp204, tmp205, tmp206, tmp207, tmp208, tmp209, tmp210, tmp211, tmp212, tmp215, tmp216);
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Bind(&block18, &tmp217, &tmp218, &tmp219, &tmp220, &tmp221, &tmp222, &tmp223, &tmp224, &tmp225, &tmp226, &tmp227, &tmp228, &tmp229);
    TNode<BoolT> tmp230;
    USE(tmp230);
    tmp230 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{tmp229}, TNode<IntPtrT>{tmp220});
    ca_.Branch(tmp230, &block16, &block17, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225, tmp226, tmp227, tmp228, tmp229);
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Bind(&block16, &tmp231, &tmp232, &tmp233, &tmp234, &tmp235, &tmp236, &tmp237, &tmp238, &tmp239, &tmp240, &tmp241, &tmp242, &tmp243);
    TNode<Object> tmp244;
    USE(tmp244);
    tmp244 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{tmp232}, TNode<RawPtrT>{tmp233}, TNode<IntPtrT>{tmp234}}, TNode<IntPtrT>{tmp243});
    TNode<Smi> tmp245;
    USE(tmp245);
    tmp245 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
    TNode<Smi> tmp246;
    USE(tmp246);
    tmp246 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp241}, TNode<Smi>{tmp245});
    TNode<Object> tmp247;
    USE(tmp247);
    tmp247 = UnsafeCast_JSAny_0(state_, TNode<Context>{tmp231}, TNode<Object>{tmp244});
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp242}, TNode<Smi>{tmp241}, TNode<Object>{tmp247});
    TNode<IntPtrT> tmp248;
    USE(tmp248);
    tmp248 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    TNode<IntPtrT> tmp249;
    USE(tmp249);
    tmp249 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp243}, TNode<IntPtrT>{tmp248});
    ca_.Goto(&block18, tmp231, tmp232, tmp233, tmp234, tmp235, tmp236, tmp237, tmp238, tmp239, tmp240, tmp246, tmp242, tmp249);
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Bind(&block17, &tmp250, &tmp251, &tmp252, &tmp253, &tmp254, &tmp255, &tmp256, &tmp257, &tmp258, &tmp259, &tmp260, &tmp261, &tmp262);
    ca_.Goto(&block15, tmp250, tmp251, tmp252, tmp253, tmp254, tmp255, tmp256, tmp257, tmp258, tmp259, tmp260);
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<Smi> tmp272;
    TNode<Smi> tmp273;
    ca_.Bind(&block15, &tmp263, &tmp264, &tmp265, &tmp266, &tmp267, &tmp268, &tmp269, &tmp270, &tmp271, &tmp272, &tmp273);
    TNode<IntPtrT> tmp274;
    USE(tmp274);
    tmp274 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    CodeStubAssembler(state_).StoreReference<Number>(CodeStubAssembler::Reference{tmp267, tmp274}, tmp269);
    ca_.Goto(&block20, tmp263, tmp264, tmp265, tmp266, tmp267, tmp268, tmp269, tmp270, tmp271, tmp272);
  }
    ...
    TNode<Smi> tmp283;
    TNode<Smi> tmp284;
    ca_.Bind(&block20, &tmp275, &tmp276, &tmp277, &tmp278, &tmp279, &tmp280, &tmp281, &tmp282, &tmp283, &tmp284);
}
...
void FastSplice_FixedDoubleArray_Number_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    TNode<FixedArrayBase> tmp23;
    USE(tmp23);
    tmp23 = UnsafeCast_EmptyFixedArray_OR_FixedDoubleArray_0(state_, TNode<Context>{tmp11}, TNode<Object>{tmp22});
    TNode<Smi> tmp24;
    USE(tmp24);
    tmp24 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp18}, TNode<Smi>{tmp19});
    TNode<Smi> tmp25;
  ...
  if (block4.is_used()) {
    ...
    USE(tmp43);
    tmp43 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp29}, TNode<Object>{tmp39});
    DoMoveElements_FixedDoubleArray_0(state_, TNode<FixedDoubleArray>{tmp43}, TNode<Smi>{tmp40}, TNode<Smi>{tmp41}, TNode<Smi>{tmp42});
    TNode<FixedDoubleArray> tmp44;
    USE(tmp44);
    tmp44 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp29}, TNode<Object>{tmp39});
    StoreHoles_FixedDoubleArray_0(state_, TNode<FixedDoubleArray>{tmp44}, TNode<Smi>{tmp35}, TNode<Smi>{tmp34});
    ca_.Goto(&block6, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41, tmp42);
  }
  ...
  if (block9.is_used()) {
    ...
    TNode<Smi> tmp90;
    ca_.Bind(&block9, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90);
    TNode<FixedDoubleArray> tmp91;
    USE(tmp91);
    tmp91 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp77}, TNode<Object>{tmp87});
    DoMoveElements_FixedDoubleArray_0(state_, TNode<FixedDoubleArray>{tmp91}, TNode<Smi>{tmp88}, TNode<Smi>{tmp89}, TNode<Smi>{tmp90});
    ca_.Goto(&block11, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84, tmp85, tmp86, tmp87, tmp88, tmp89, tmp90);
  }
  ...
  if (block10.is_used()) {
    ...
    USE(tmp108);
    tmp108 = Extract_1(state_, TNode<Context>{tmp92}, TNode<FixedArrayBase>{tmp102}, TNode<Smi>{tmp107}, TNode<Smi>{tmp99}, TNode<Smi>{tmp106});
    TNode<FixedDoubleArray> tmp109;
    USE(tmp109);
    tmp109 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp92}, TNode<Object>{tmp108});
    TNode<IntPtrT> tmp110;
    USE(tmp110);
    tmp110 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    CodeStubAssembler(state_).StoreReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp96, tmp110}, tmp109);
  ...
  if (block12.is_used()) {
    ...
    TNode<Smi> tmp128;
    TNode<Smi> tmp129;
    TNode<FixedDoubleArray> tmp130;
    ca_.Bind(&block12, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130);
    TNode<FixedDoubleArray> tmp131;
    USE(tmp131);
    tmp131 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp115}, TNode<Object>{tmp125});
    DoCopyElements_FixedDoubleArray_0(state_, TNode<FixedDoubleArray>{tmp130}, TNode<Smi>{tmp126}, TNode<FixedDoubleArray>{tmp131}, TNode<Smi>{tmp127}, TNode<Smi>{tmp128});
    ca_.Goto(&block13, tmp115, tmp116, tmp117, tmp118, tmp119, tmp120, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128, tmp129, tmp130);
  }
  ...
  if (block14.is_used()) {
    ...
    USE(tmp215);
    tmp215 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{tmp202}, TNode<Object>{tmp214});
    TNode<IntPtrT> tmp216;
    USE(tmp216);
    tmp216 = FromConstexpr_intptr_constexpr_int31_0(state_, 2);
    ca_.Goto(&block18, tmp202, tmp203, tmp204, tmp205, tmp206, tmp207, tmp208, tmp209, tmp210, tmp211, tmp212, tmp215, tmp216);
  ...
  if (block16.is_used()) {
    ...
    TNode<Number> tmp247;
    USE(tmp247);
    tmp247 = UnsafeCast_Number_0(state_, TNode<Context>{tmp231}, TNode<Object>{tmp244});
    StoreFixedDoubleArrayDirect_0(state_, TNode<FixedDoubleArray>{tmp242}, TNode<Smi>{tmp241}, TNode<Number>{tmp247});
    TNode<IntPtrT> tmp248;
    USE(tmp248);
    tmp248 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    TNode<IntPtrT> tmp249;
...
TNode<FixedArrayBase> UnsafeCast_EmptyFixedArray_OR_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, FixedArrayBase> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  return TNode<FixedArrayBase>{tmp9};
}
