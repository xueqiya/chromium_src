...
TF_BUILTIN(ProxySetProperty, CodeStubAssembler) {
  ...
  if (block24.is_used()) {
    ...
    USE(tmp100);
    tmp100 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
  ...
  if (block28.is_used()) {
    ...
    TNode<Object> tmp126;
    USE(tmp126);
    tmp126 = CodeStubAssembler(state_).Call(TNode<Context>{tmp115}, TNode<Object>{tmp125}, TNode<Object>{tmp121}, TNode<Object>{tmp122}, TNode<Object>{tmp120}, TNode<Object>{tmp118}, TNode<Object>{tmp119});
    TNode<BoolT> tmp127;
    USE(tmp127);
