...
TNode<JSStringIterator> NewJSStringIterator_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TNode<Smi> p_nextIndex) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<String>(CodeStubAssembler::Reference{tmp7, tmp11}, tmp1);
    TNode<IntPtrT> tmp12;
    USE(tmp12);
    tmp12 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp7, tmp12}, tmp2);
    TNode<JSStringIterator> tmp13;
    USE(tmp13);
  ...
  return TNode<JSStringIterator>{tmp17};
}
...
USE(parameter1);
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp31, tmp37}, tmp40);
    TNode<Oddball> tmp41;
    USE(tmp41);
