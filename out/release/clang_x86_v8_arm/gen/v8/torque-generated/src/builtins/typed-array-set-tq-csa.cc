...
void TypedArrayPrototypeSetArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<JSTypedArray> p_target, TNode<Object> p_arrayArg, TNode<UintPtrT> p_targetOffset, TNode<BoolT> p_targetOffsetOverflowed, compiler::CodeAssemblerLabel* label_IfOffsetOutOfBounds, compiler::CodeAssemblerLabel* label_IfDetached) {
  ...
  if (block22.is_used()) {
    ...
    TNode<BoolT> tmp163;
    USE(tmp163);
    tmp163 = CodeStubAssembler(state_).IsElementsKindInRange(TNode<Int32T>{tmp162}, ElementsKind::PACKED_SMI_ELEMENTS, ElementsKind::HOLEY_SMI_ELEMENTS);
  ...
  if (block27.is_used()) {
    ...
    TNode<BoolT> tmp191;
    USE(tmp191);
    tmp191 = CodeStubAssembler(state_).IsElementsKindInRange(TNode<Int32T>{tmp189}, ElementsKind::PACKED_DOUBLE_ELEMENTS, ElementsKind::HOLEY_DOUBLE_ELEMENTS);
...
void TypedArrayPrototypeSetTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<JSTypedArray> p_target, TNode<JSTypedArray> p_typedArray, TNode<UintPtrT> p_targetOffset, TNode<BoolT> p_targetOffsetOverflowed, compiler::CodeAssemblerLabel* label_IfOffsetOutOfBounds) {
  ...
  if (block35.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'countBytes <= target.byte_length - startOffset' failed", "src/builtins/typed-array-set.tq", 278);
  }
  ...
  if (block39.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'countBytes <= typedArray.byte_length' failed", "src/builtins/typed-array-set.tq", 279);
  }
