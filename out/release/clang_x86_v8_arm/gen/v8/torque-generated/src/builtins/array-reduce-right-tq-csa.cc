...
TF_BUILTIN(ArrayReduceRightLoopContinuation, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ...
    TNode<Object> tmp56;
    USE(tmp56);
    tmp56 = CodeStubAssembler(state_).Call(TNode<Context>{tmp42}, TNode<Object>{tmp44}, TNode<Object>{tmp55}, TNode<Object>{ca_.UncheckedCast<Object>(tmp53)}, TNode<Object>{tmp52}, TNode<Object>{tmp50}, TNode<Object>{tmp46});
...
TNode<Object> FastArrayReduceRight_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block21.is_used()) {
    ...
    USE(tmp136);
    tmp136 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
  ...
  if (block38.is_used()) {
    ...
    TNode<Object> tmp345;
    USE(tmp345);
    tmp345 = CodeStubAssembler(state_).Call(TNode<Context>{tmp328}, TNode<Object>{tmp331}, TNode<Object>{tmp344}, TNode<Object>{ca_.UncheckedCast<Object>(tmp342)}, TNode<Object>{tmp341}, TNode<Object>{tmp340}, TNode<Object>{tmp337});
