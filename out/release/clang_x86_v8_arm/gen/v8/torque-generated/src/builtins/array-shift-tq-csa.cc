...
TNode<Object> TryFastArrayShift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow, compiler::CodeAssemblerLabel* label_Runtime) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block62(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block63(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedArrayBase> block68(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedArrayBase, FixedArray> block67(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block73(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSArray, JSArray, JSArray, Map, BoolT, BoolT, BoolT, Smi, Object, Smi, Smi, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, Smi, Smi, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block74(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block76(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block30.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.arrayIsPushable' failed", "src/objects/js-array.tq", 192);
  }
  ...
  if (block35.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.arrayIsPushable' failed", "src/objects/js-array.tq", 215);
  }
  ...
  if (block36.is_used()) {
    ...
    USE(tmp361);
    tmp361 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
  ...
  if (block37.is_used()) {
    ...
    USE(tmp412);
    tmp412 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
  ...
  if (block51.is_used()) {
    ...
    USE(tmp524);
    tmp524 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
  ...
  if (block56.is_used()) {
    ...
    USE(tmp556);
    tmp556 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<IntPtrT> tmp557;
    USE(tmp557);
    tmp557 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<IntPtrT> tmp558;
    USE(tmp558);
    tmp558 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp559 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp555, tmp558});
    TNode<IntPtrT> tmp560;
    USE(tmp560);
    tmp560 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp559});
    TNode<IntPtrT> tmp561;
    USE(tmp561);
    tmp561 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp553});
    TNode<UintPtrT> tmp562;
    USE(tmp562);
    tmp562 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp561});
    TNode<UintPtrT> tmp563;
    USE(tmp563);
    tmp563 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp560});
    TNode<BoolT> tmp564;
    USE(tmp564);
    tmp564 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp562}, TNode<UintPtrT>{tmp563});
    ca_.Branch(tmp564, &block62, &block63, tmp541, tmp542, tmp543, tmp544, tmp545, tmp546, tmp547, tmp548, tmp549, tmp550, tmp551, tmp552, tmp553, tmp555, tmp555, tmp555, tmp556, tmp560, tmp553, tmp553, tmp561, tmp555, tmp556, tmp560, tmp561, tmp561);
  }
  ...
  if (block62.is_used()) {
    ...
    TNode<JSArray> tmp568;
    TNode<JSArray> tmp569;
    TNode<Map> tmp570;
    TNode<BoolT> tmp571;
    TNode<BoolT> tmp572;
    TNode<BoolT> tmp573;
    ...
    TNode<Smi> tmp576;
    TNode<Smi> tmp577;
    TNode<FixedDoubleArray> tmp578;
    TNode<FixedDoubleArray> tmp579;
    TNode<FixedDoubleArray> tmp580;
    ...
    ca_.Bind(&block62, &tmp565, &tmp566, &tmp567, &tmp568, &tmp569, &tmp570, &tmp571, &tmp572, &tmp573, &tmp574, &tmp575, &tmp576, &tmp577, &tmp578, &tmp579, &tmp580, &tmp581, &tmp582, &tmp583, &tmp584, &tmp585, &tmp586, &tmp587, &tmp588, &tmp589, &tmp590);
    TNode<IntPtrT> tmp591;
    USE(tmp591);
    tmp591 = FromConstexpr_intptr_constexpr_int31_0(state_, kDoubleSize);
    TNode<IntPtrT> tmp592;
    USE(tmp592);
    tmp592 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp590}, TNode<IntPtrT>{tmp591});
    TNode<IntPtrT> tmp593;
    USE(tmp593);
    tmp593 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp587}, TNode<IntPtrT>{tmp592});
    TNode<HeapObject> tmp594;
    USE(tmp594);
    TNode<IntPtrT> tmp595;
    USE(tmp595);
    std::tie(tmp594, tmp595) = UnsafeNewReference_float64_or_hole_0(state_, TNode<HeapObject>{tmp586}, TNode<IntPtrT>{tmp593}).Flatten();
    TNode<BoolT> tmp596;
    USE(tmp596);
    TNode<Float64T> tmp597;
    USE(tmp597);
    std::tie(tmp596, tmp597) = kDoubleHole_0(state_).Flatten();
    StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0{TNode<HeapObject>{tmp594}, TNode<IntPtrT>{tmp595}, TorqueStructUnsafe_0{}}, TorqueStructfloat64_or_hole_0{TNode<BoolT>{tmp596}, TNode<Float64T>{tmp597}});
    ca_.Goto(&block53, tmp565, tmp566, tmp567, tmp568, tmp569, tmp570, tmp571, tmp572, tmp573, tmp574, tmp575, tmp576, tmp577);
  }
  ...
  if (block63.is_used()) {
    ...
    TNode<Smi> tmp609;
    TNode<Smi> tmp610;
    TNode<FixedDoubleArray> tmp611;
    TNode<FixedDoubleArray> tmp612;
    TNode<FixedDoubleArray> tmp613;
    ...
    ca_.Bind(&block63, &tmp598, &tmp599, &tmp600, &tmp601, &tmp602, &tmp603, &tmp604, &tmp605, &tmp606, &tmp607, &tmp608, &tmp609, &tmp610, &tmp611, &tmp612, &tmp613, &tmp614, &tmp615, &tmp616, &tmp617, &tmp618, &tmp619, &tmp620, &tmp621, &tmp622, &tmp623);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block52.is_used()) {
    ...
    TNode<Smi> tmp635;
    TNode<Smi> tmp636;
    ca_.Bind(&block52, &tmp624, &tmp625, &tmp626, &tmp627, &tmp628, &tmp629, &tmp630, &tmp631, &tmp632, &tmp633, &tmp634, &tmp635, &tmp636);
    TNode<IntPtrT> tmp637;
    USE(tmp637);
    tmp637 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<FixedArrayBase>tmp638 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp628, tmp637});
    TNode<FixedArray> tmp639;
    USE(tmp639);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp639 = Cast_FixedArray_0(state_, TNode<HeapObject>{tmp638}, &label0);
    ca_.Goto(&block67, tmp624, tmp625, tmp626, tmp627, tmp628, tmp629, tmp630, tmp631, tmp632, tmp633, tmp634, tmp635, tmp636, tmp638, tmp639);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block68, tmp624, tmp625, tmp626, tmp627, tmp628, tmp629, tmp630, tmp631, tmp632, tmp633, tmp634, tmp635, tmp636, tmp638);
    }
  }
  ...
  if (block68.is_used()) {
    ...
    TNode<Smi> tmp651;
    TNode<Smi> tmp652;
    TNode<FixedArrayBase> tmp653;
    ca_.Bind(&block68, &tmp640, &tmp641, &tmp642, &tmp643, &tmp644, &tmp645, &tmp646, &tmp647, &tmp648, &tmp649, &tmp650, &tmp651, &tmp652, &tmp653);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block67.is_used()) {
    ...
    TNode<JSArray> tmp657;
    TNode<JSArray> tmp658;
    TNode<Map> tmp659;
    TNode<BoolT> tmp660;
    TNode<BoolT> tmp661;
    TNode<BoolT> tmp662;
    ...
    TNode<Smi> tmp665;
    TNode<Smi> tmp666;
    TNode<FixedArrayBase> tmp667;
    TNode<FixedArray> tmp668;
    ca_.Bind(&block67, &tmp654, &tmp655, &tmp656, &tmp657, &tmp658, &tmp659, &tmp660, &tmp661, &tmp662, &tmp663, &tmp664, &tmp665, &tmp666, &tmp667, &tmp668);
    TNode<IntPtrT> tmp669;
    USE(tmp669);
    tmp669 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<IntPtrT> tmp670;
    USE(tmp670);
    tmp670 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<IntPtrT> tmp671;
    USE(tmp671);
    tmp671 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp672 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp668, tmp671});
    TNode<IntPtrT> tmp673;
    USE(tmp673);
    tmp673 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp672});
    TNode<IntPtrT> tmp674;
    USE(tmp674);
    tmp674 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp666});
    TNode<UintPtrT> tmp675;
    USE(tmp675);
    tmp675 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp674});
    TNode<UintPtrT> tmp676;
    USE(tmp676);
    tmp676 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp673});
    TNode<BoolT> tmp677;
    USE(tmp677);
    tmp677 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp675}, TNode<UintPtrT>{tmp676});
    ca_.Branch(tmp677, &block73, &block74, tmp654, tmp655, tmp656, tmp657, tmp658, tmp659, tmp660, tmp661, tmp662, tmp663, tmp664, tmp665, tmp666, tmp668, tmp668, tmp668, tmp669, tmp673, tmp666, tmp666, tmp674, tmp668, tmp669, tmp673, tmp674, tmp674);
  }
  ...
  if (block73.is_used()) {
    ...
    TNode<HeapObject> tmp699;
    TNode<IntPtrT> tmp700;
    TNode<IntPtrT> tmp701;
    TNode<IntPtrT> tmp702;
    TNode<IntPtrT> tmp703;
    ca_.Bind(&block73, &tmp678, &tmp679, &tmp680, &tmp681, &tmp682, &tmp683, &tmp684, &tmp685, &tmp686, &tmp687, &tmp688, &tmp689, &tmp690, &tmp691, &tmp692, &tmp693, &tmp694, &tmp695, &tmp696, &tmp697, &tmp698, &tmp699, &tmp700, &tmp701, &tmp702, &tmp703);
    TNode<IntPtrT> tmp704;
    USE(tmp704);
    tmp704 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp705;
    USE(tmp705);
    tmp705 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp703}, TNode<IntPtrT>{tmp704});
    TNode<IntPtrT> tmp706;
    USE(tmp706);
    tmp706 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp700}, TNode<IntPtrT>{tmp705});
    TNode<HeapObject> tmp707;
    USE(tmp707);
    TNode<IntPtrT> tmp708;
    USE(tmp708);
    std::tie(tmp707, tmp708) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp699}, TNode<IntPtrT>{tmp706}).Flatten();
    TNode<Oddball> tmp709;
    USE(tmp709);
    tmp709 = TheHole_0(state_);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp707, tmp708}, tmp709);
    ca_.Goto(&block53, tmp678, tmp679, tmp680, tmp681, tmp682, tmp683, tmp684, tmp685, tmp686, tmp687, tmp688, tmp689, tmp690);
  }

  if (block74.is_used()) {
    TNode<Context> tmp710;
    TNode<Object> tmp711;
    ...
    TNode<HeapObject> tmp731;
    TNode<IntPtrT> tmp732;
    TNode<IntPtrT> tmp733;
    TNode<IntPtrT> tmp734;
    TNode<IntPtrT> tmp735;
    ca_.Bind(&block74, &tmp710, &tmp711, &tmp712, &tmp713, &tmp714, &tmp715, &tmp716, &tmp717, &tmp718, &tmp719, &tmp720, &tmp721, &tmp722, &tmp723, &tmp724, &tmp725, &tmp726, &tmp727, &tmp728, &tmp729, &tmp730, &tmp731, &tmp732, &tmp733, &tmp734, &tmp735);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block53.is_used()) {
    ...
    TNode<Smi> tmp747;
    TNode<Smi> tmp748;
    ca_.Bind(&block53, &tmp736, &tmp737, &tmp738, &tmp739, &tmp740, &tmp741, &tmp742, &tmp743, &tmp744, &tmp745, &tmp746, &tmp747, &tmp748);
    ca_.Goto(&block3, tmp736, tmp737, tmp746);
  }
  ...
  if (block3.is_used()) {
    ...
    TNode<Object> tmp750;
    TNode<Object> tmp751;
    ca_.Bind(&block3, &tmp749, &tmp750, &tmp751);
    ca_.Goto(&block76, tmp749, tmp750, tmp751);
  }
  ...
  if (block2.is_used()) {
    ...
    TNode<Object> tmp753;
    TNode<Object> tmp754;
    ca_.Bind(&block76, &tmp752, &tmp753, &tmp754);
  return TNode<Object>{tmp754};
}
...
TNode<Object> GenericArrayShift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver) {
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi> tmp59;
    USE(tmp59);
    tmp59 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    TNode<Oddball> tmp60;
  ...
  if (block5.is_used()) {
    ...
    TNode<Smi> tmp80;
    USE(tmp80);
    tmp80 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    TNode<Oddball> tmp81;
