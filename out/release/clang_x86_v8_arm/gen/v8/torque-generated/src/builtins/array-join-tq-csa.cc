...
TF_BUILTIN(LoadJoinElement_FastSmiOrObjectElements_0, CodeStubAssembler) {
  ...
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi>tmp10 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp6, tmp9});
    TNode<IntPtrT> tmp11;
    USE(tmp11);
    tmp11 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp10});
    TNode<IntPtrT> tmp12;
    USE(tmp12);
    tmp12 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{tmp2});
    ...
    ca_.Branch(tmp15, &block5, &block6, tmp0, tmp1, tmp2, tmp3, tmp6, tmp6, tmp6, tmp7, tmp11, tmp2, tmp2, tmp6, tmp7, tmp11, tmp12, tmp12);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<BoolT> tmp39;
    USE(tmp39);
    tmp39 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp37}, TNode<HeapObject>{tmp38});
    ca_.Branch(tmp39, &block8, &block9, tmp16, tmp17, tmp18, tmp19, tmp20, tmp37);
  }
  ...
  if (block9.is_used()) {
    ...
    TNode<Object> tmp68;
    ca_.Bind(&block9, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68);
    TNode<Object> tmp69;
    USE(tmp69);
    tmp69 = UnsafeCast_JSAny_0(state_, TNode<Context>{tmp63}, TNode<Object>{tmp68});
    ca_.Goto(&block10, tmp63, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69);
  }
...
TF_BUILTIN(LoadJoinElement_FastDoubleElements_0, CodeStubAssembler) {
  ...
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, BoolT, Float64T> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, UintPtrT, JSArray, FixedDoubleArray, FixedDoubleArray, FixedDoubleArray, IntPtrT, IntPtrT, UintPtrT, UintPtrT, HeapObject, IntPtrT, BoolT, Float64T> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, parameter0, parameter1, parameter2);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp15);
    tmp15 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp13}, TNode<UintPtrT>{tmp14});
    ca_.Branch(tmp15, &block7, &block8, tmp0, tmp1, tmp2, tmp3, tmp6, tmp6, tmp6, tmp7, tmp11, tmp2, tmp2, tmp6, tmp7, tmp11, tmp12, tmp12);
  }
  ...
  if (block7.is_used()) {
    ...
    TNode<IntPtrT> tmp32;
    USE(tmp32);
    tmp32 = FromConstexpr_intptr_constexpr_int31_0(state_, kDoubleSize);
    TNode<IntPtrT> tmp33;
    USE(tmp33);
    tmp33 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp31}, TNode<IntPtrT>{tmp32});
    TNode<IntPtrT> tmp34;
    ...
    TNode<IntPtrT> tmp36;
    USE(tmp36);
    std::tie(tmp35, tmp36) = UnsafeNewReference_float64_or_hole_0(state_, TNode<HeapObject>{tmp27}, TNode<IntPtrT>{tmp34}).Flatten();
    TNode<BoolT> tmp37;
    USE(tmp37);
    TNode<Float64T> tmp38;
    USE(tmp38);
    std::tie(tmp37, tmp38) = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0{TNode<HeapObject>{tmp35}, TNode<IntPtrT>{tmp36}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Branch(tmp37, &block11, &block12, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp35, tmp36, tmp37, tmp38);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<IntPtrT> tmp53;
    TNode<IntPtrT> tmp54;
    ca_.Bind(&block8, &tmp39, &tmp40, &tmp41, &tmp42, &tmp43, &tmp44, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Bind(&block11, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69);
    TNode<String> tmp70;
    USE(tmp70);
    tmp70 = kEmptyString_0(state_);
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85);
    TNode<HeapNumber> tmp86;
    USE(tmp86);
    tmp86 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp85});
...
TF_BUILTIN(ConvertToLocaleString, CodeStubAssembler) {
  ...
  if (block7.is_used()) {
    ...
    TNode<Object> tmp40;
    USE(tmp40);
    tmp40 = CodeStubAssembler(state_).Call(TNode<Context>{tmp33}, TNode<Object>{tmp38}, TNode<Object>{tmp34});
  ...
  if (block10.is_used()) {
    ...
    TNode<Object> tmp56;
    USE(tmp56);
    tmp56 = CodeStubAssembler(state_).Call(TNode<Context>{tmp49}, TNode<Object>{tmp54}, TNode<Object>{tmp50}, TNode<Object>{tmp51});
  ...
  if (block11.is_used()) {
    ...
    TNode<Object> tmp64;
    USE(tmp64);
    tmp64 = CodeStubAssembler(state_).Call(TNode<Context>{tmp57}, TNode<Object>{tmp62}, TNode<Object>{tmp58}, TNode<Object>{tmp59}, TNode<Object>{tmp60});
...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, IntPtrT, BoolT, String, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, IntPtrT, IntPtrT, BoolT, String, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi>tmp44 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp36, tmp43});
    TNode<IntPtrT> tmp45;
    USE(tmp45);
    tmp45 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp44});
    TNode<IntPtrT> tmp46;
    USE(tmp46);
    tmp46 = Convert_intptr_constexpr_int31_0(state_, 0);
    ...
    ca_.Branch(tmp49, &block14, &block15, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp36, tmp36, tmp36, tmp41, tmp45, tmp46, tmp36, tmp41, tmp45, tmp46, tmp46);
  }
  ...
  if (block14.is_used()) {
    ...
    TNode<IntPtrT> tmp65;
    TNode<IntPtrT> tmp66;
    ca_.Bind(&block14, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66);
    TNode<IntPtrT> tmp67;
    USE(tmp67);
    tmp67 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp68;
    USE(tmp68);
    tmp68 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp66}, TNode<IntPtrT>{tmp67});
    TNode<IntPtrT> tmp69;
    USE(tmp69);
    ...
    TNode<IntPtrT> tmp71;
    USE(tmp71);
    std::tie(tmp70, tmp71) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp62}, TNode<IntPtrT>{tmp69}).Flatten();
    TNode<Object>tmp72 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp70, tmp71});
    TNode<String> tmp73;
    USE(tmp73);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp73 = Cast_String_1(state_, TNode<Context>{tmp50}, TNode<Object>{tmp72}, &label0);
    ca_.Goto(&block19, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp56, tmp72, tmp72, tmp50, tmp73);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block20, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp56, tmp72, tmp72, tmp50);
    }
  }
  ...
  if (block20.is_used()) {
    ...
    ca_.Bind(&block20, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100);
    TNode<Number> tmp101;
    USE(tmp101);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp101 = Cast_Number_0(state_, TNode<Object>{ca_.UncheckedCast<Object>(tmp98)}, &label0);
    ca_.Goto(&block23, tmp91, tmp92, tmp93, tmp94, tmp95, tmp96, tmp97, tmp98, ca_.UncheckedCast<Object>(tmp98), tmp101);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block24, tmp91, tmp92, tmp93, tmp94, tmp95, tmp96, tmp97, tmp98, ca_.UncheckedCast<Object>(tmp98));
    }
  }
  ...
  if (block19.is_used()) {
    ...
    TNode<String> tmp112;
    ca_.Bind(&block19, &tmp102, &tmp103, &tmp104, &tmp105, &tmp106, &tmp107, &tmp108, &tmp109, &tmp110, &tmp111, &tmp112);
    ca_.Goto(&block1, tmp102, tmp103, tmp104, tmp105, tmp106, tmp107, tmp112);
  }
  ...
  if (block24.is_used()) {
    ...
    TNode<Object> tmp120;
    TNode<Object> tmp121;
    ca_.Bind(&block24, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block23.is_used()) {
    ...
    TNode<Object> tmp130;
    TNode<Number> tmp131;
    ca_.Bind(&block23, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130, &tmp131);
    TNode<String> tmp132;
    tmp132 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kStringRepeat, tmp122, tmp127, tmp131));
    USE(tmp132);
    ca_.Goto(&block1, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp132);
  }
  ...
  if (block9.is_used()) {
    ...
    TNode<BoolT> tmp137;
    TNode<String> tmp138;
    ca_.Bind(&block9, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138);
    TNode<UintPtrT> tmp139;
    USE(tmp139);
    tmp139 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{tmp136});
    TNode<Uint32T> tmp140;
    USE(tmp140);
    tmp140 = Convert_uint32_uintptr_0(state_, TNode<UintPtrT>{tmp139});
    ca_.Branch(tmp137, &block25, &block26, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp140);
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Bind(&block25, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147);
    TNode<String> tmp148;
    USE(tmp148);
    tmp148 = AllocateSeqOneByteString_0(state_, TNode<Uint32T>{tmp147});
    ca_.Goto(&block27, tmp141, tmp142, tmp143, tmp144, tmp145, tmp146, tmp147, tmp148);
  }
  ...
  if (block26.is_used()) {
    ...
    TNode<String> tmp156;
    USE(tmp156);
    tmp156 = AllocateSeqTwoByteString_0(state_, TNode<Uint32T>{tmp155});
    ca_.Goto(&block27, tmp149, tmp150, tmp151, tmp152, tmp153, tmp154, tmp155, tmp156);
  }
  ...
  if (block27.is_used()) {
    ...
    TNode<BoolT> tmp161;
    TNode<String> tmp162;
    TNode<Uint32T> tmp163;
    TNode<String> tmp164;
    ca_.Bind(&block27, &tmp157, &tmp158, &tmp159, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164);
    TNode<String> tmp165;
    USE(tmp165);
    tmp165 = ArrayBuiltinsAssembler(state_).CallJSArrayArrayJoinConcatToSequentialString(TNode<FixedArray>{tmp158}, TNode<IntPtrT>{tmp159}, TNode<String>{tmp162}, TNode<String>{tmp164});
    ca_.Goto(&block1, tmp157, tmp158, tmp159, tmp160, tmp161, tmp162, tmp165);
  }
  ...
  if (block1.is_used()) {
    ...
    TNode<String> tmp171;
    TNode<String> tmp172;
    ca_.Bind(&block1, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172);
    ca_.Goto(&block29, tmp166, tmp167, tmp168, tmp169, tmp170, tmp171, tmp172);
  }
    ...
    TNode<String> tmp178;
    TNode<String> tmp179;
    ca_.Bind(&block29, &tmp173, &tmp174, &tmp175, &tmp176, &tmp177, &tmp178, &tmp179);
  return TNode<String>{tmp179};
}
...
TNode<Object> ArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block11.is_used()) {
    ...
    TNode<BoolT> tmp97;
    USE(tmp97);
    tmp97 = CodeStubAssembler(state_).IsElementsKindLessThanOrEqual(TNode<Int32T>{tmp94}, ElementsKind::HOLEY_ELEMENTS);
  ...
  if (block13.is_used()) {
    ...
    TNode<BoolT> tmp118;
    USE(tmp118);
    tmp118 = CodeStubAssembler(state_).IsElementsKindLessThanOrEqual(TNode<Int32T>{tmp115}, ElementsKind::HOLEY_DOUBLE_ELEMENTS);
  ...
  if (block16.is_used()) {
    ...
    TNode<Int32T> tmp139;
    USE(tmp139);
    tmp139 = FromConstexpr_ElementsKind_constexpr_DICTIONARY_ELEMENTS_0(state_, ElementsKind::DICTIONARY_ELEMENTS);
    TNode<BoolT> tmp140;
    USE(tmp140);
...
TNode<Object> ArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block0.is_used()) {
    ...
    TNode<BoolT> tmp9;
    USE(tmp9);
    tmp9 = CodeStubAssembler(state_).IsElementsKindGreaterThan(TNode<Int32T>{tmp8}, ElementsKind::UINT32_ELEMENTS);
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp19;
    USE(tmp19);
    tmp19 = FromConstexpr_ElementsKind_constexpr_INT32_ELEMENTS_0(state_, ElementsKind::INT32_ELEMENTS);
    TNode<BoolT> tmp20;
    USE(tmp20);
  ...
  if (block6.is_used()) {
    ...
    TNode<Int32T> tmp39;
    USE(tmp39);
    tmp39 = FromConstexpr_ElementsKind_constexpr_FLOAT32_ELEMENTS_0(state_, ElementsKind::FLOAT32_ELEMENTS);
    TNode<BoolT> tmp40;
    USE(tmp40);
  ...
  if (block9.is_used()) {
    ...
    TNode<Int32T> tmp59;
    USE(tmp59);
    tmp59 = FromConstexpr_ElementsKind_constexpr_FLOAT64_ELEMENTS_0(state_, ElementsKind::FLOAT64_ELEMENTS);
    TNode<BoolT> tmp60;
    USE(tmp60);
  ...
  if (block12.is_used()) {
    ...
    TNode<Int32T> tmp79;
    USE(tmp79);
    tmp79 = FromConstexpr_ElementsKind_constexpr_UINT8_CLAMPED_ELEMENTS_0(state_, ElementsKind::UINT8_CLAMPED_ELEMENTS);
    TNode<BoolT> tmp80;
    USE(tmp80);
  ...
  if (block15.is_used()) {
    ...
    TNode<Int32T> tmp99;
    USE(tmp99);
    tmp99 = FromConstexpr_ElementsKind_constexpr_BIGUINT64_ELEMENTS_0(state_, ElementsKind::BIGUINT64_ELEMENTS);
    TNode<BoolT> tmp100;
    USE(tmp100);
  ...
  if (block18.is_used()) {
    ...
    TNode<Int32T> tmp119;
    USE(tmp119);
    tmp119 = FromConstexpr_ElementsKind_constexpr_BIGINT64_ELEMENTS_0(state_, ElementsKind::BIGINT64_ELEMENTS);
    TNode<BoolT> tmp120;
    USE(tmp120);
  ...
  if (block3.is_used()) {
    ...
    TNode<Int32T> tmp193;
    USE(tmp193);
    tmp193 = FromConstexpr_ElementsKind_constexpr_UINT8_ELEMENTS_0(state_, ElementsKind::UINT8_ELEMENTS);
    TNode<BoolT> tmp194;
    USE(tmp194);
  ...
  if (block24.is_used()) {
    ...
    TNode<Int32T> tmp213;
    USE(tmp213);
    tmp213 = FromConstexpr_ElementsKind_constexpr_INT8_ELEMENTS_0(state_, ElementsKind::INT8_ELEMENTS);
    TNode<BoolT> tmp214;
    USE(tmp214);
  ...
  if (block27.is_used()) {
    ...
    TNode<Int32T> tmp233;
    USE(tmp233);
    tmp233 = FromConstexpr_ElementsKind_constexpr_UINT16_ELEMENTS_0(state_, ElementsKind::UINT16_ELEMENTS);
    TNode<BoolT> tmp234;
    USE(tmp234);
  ...
  if (block30.is_used()) {
    ...
    TNode<Int32T> tmp253;
    USE(tmp253);
    tmp253 = FromConstexpr_ElementsKind_constexpr_INT16_ELEMENTS_0(state_, ElementsKind::INT16_ELEMENTS);
    TNode<BoolT> tmp254;
    USE(tmp254);
  ...
  if (block33.is_used()) {
    ...
    TNode<Int32T> tmp273;
    USE(tmp273);
    tmp273 = FromConstexpr_ElementsKind_constexpr_UINT32_ELEMENTS_0(state_, ElementsKind::UINT32_ELEMENTS);
    TNode<BoolT> tmp274;
    USE(tmp274);
...
TNode<FixedArray> LoadJoinStack_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, compiler::CodeAssemblerLabel* label_IfUninitialized) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_JOIN_STACK_INDEX_0(state_, Context::Field::ARRAY_JOIN_STACK_INDEX);
    TNode<Object> tmp3;
    USE(tmp3);
  ...
  if (block8.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsFixedArray(stack)' failed", "src/builtins/array-join.tq", 428);
  }
...
void SetJoinStack_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_stack) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp3;
    USE(tmp3);
    tmp3 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_JOIN_STACK_INDEX_0(state_, Context::Field::ARRAY_JOIN_STACK_INDEX);
...
TF_BUILTIN(JoinStackPush, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, Object, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, Object, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block1.is_used()) {
    ...
    TNode<Smi>tmp19 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp12, tmp18});
    TNode<IntPtrT> tmp20;
    USE(tmp20);
    tmp20 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp19});
    TNode<UintPtrT> tmp21;
    USE(tmp21);
    tmp21 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp15});
    ...
    ca_.Branch(tmp23, &block9, &block10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp12, tmp12, tmp16, tmp20, tmp15, tmp15, tmp12, tmp16, tmp20, tmp15, tmp15);
  }
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(tmp47, &block12, &block13, tmp24, tmp25, tmp26, tmp27, tmp28, tmp45);
  }
  ...
  if (block10.is_used()) {
    ...
    TNode<IntPtrT> tmp62;
    TNode<IntPtrT> tmp63;
    ca_.Bind(&block10, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ...
    TNode<IntPtrT> tmp68;
    TNode<Object> tmp69;
    ca_.Bind(&block12, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69);
    TNode<IntPtrT> tmp70;
    USE(tmp70);
    ...
    TNode<Smi>tmp73 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp65, tmp72});
    TNode<IntPtrT> tmp74;
    USE(tmp74);
    tmp74 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp73});
    TNode<UintPtrT> tmp75;
    USE(tmp75);
    tmp75 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp68});
    ...
    ca_.Branch(tmp77, &block18, &block19, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp65, tmp65, tmp70, tmp74, tmp68, tmp68, tmp65, tmp70, tmp74, tmp68, tmp68);
  }
  ...
  if (block18.is_used()) {
    ...
    TNode<IntPtrT> tmp93;
    TNode<IntPtrT> tmp94;
    ca_.Bind(&block18, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94);
    TNode<IntPtrT> tmp95;
    USE(tmp95);
    tmp95 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp96;
    USE(tmp96);
    tmp96 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp94}, TNode<IntPtrT>{tmp95});
    TNode<IntPtrT> tmp97;
    USE(tmp97);
    tmp97 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp91}, TNode<IntPtrT>{tmp96});
    TNode<HeapObject> tmp98;
    USE(tmp98);
    TNode<IntPtrT> tmp99;
    USE(tmp99);
    std::tie(tmp98, tmp99) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp90}, TNode<IntPtrT>{tmp97}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp98, tmp99}, tmp80);
    TNode<Oddball> tmp100;
    USE(tmp100);
    tmp100 = True_0(state_);
    CodeStubAssembler(state_).Return(tmp100);
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Bind(&block19, &tmp101, &tmp102, &tmp103, &tmp104, &tmp105, &tmp106, &tmp107, &tmp108, &tmp109, &tmp110, &tmp111, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block13.is_used()) {
    ...
    TNode<Object> tmp123;
    ca_.Bind(&block13, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123);
    TNode<BoolT> tmp124;
    USE(tmp124);
    tmp124 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp120}, TNode<Object>{tmp123});
    ca_.Branch(tmp124, &block21, &block22, tmp118, tmp119, tmp120, tmp121, tmp122, tmp123);
  }
  ...
  if (block21.is_used()) {
    ...
    TNode<Object> tmp130;
    ca_.Bind(&block21, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130);
  ...
  if (block22.is_used()) {
    ...
    TNode<IntPtrT> tmp136;
    TNode<Object> tmp137;
    ca_.Bind(&block22, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137);
    TNode<IntPtrT> tmp138;
    USE(tmp138);
    tmp138 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    TNode<IntPtrT> tmp139;
    USE(tmp139);
    tmp139 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp136}, TNode<IntPtrT>{tmp138});
    ca_.Goto(&block3, tmp132, tmp133, tmp134, tmp135, tmp139);
  }
  ...
  if (block2.is_used()) {
    ...
    USE(tmp145);
    tmp145 = StoreAndGrowFixedArray_JSReceiver_0(state_, TNode<FixedArray>{tmp141}, TNode<IntPtrT>{tmp143}, TNode<JSReceiver>{tmp142});
    SetJoinStack_0(state_, TNode<Context>{tmp140}, TNode<FixedArray>{tmp145});
    TNode<Oddball> tmp146;
    USE(tmp146);
    tmp146 = True_0(state_);
...
TNode<BoolT> JoinStackPushInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block29(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block30(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp7);
    tmp7 = CodeStubAssembler(state_).AllocateFixedArrayWithHoles(TNode<IntPtrT>{tmp6}, CodeStubAssembler::AllocationFlag::kNone);
    TNode<IntPtrT> tmp8;
    USE(tmp8);
    ...
    TNode<Smi>tmp11 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp7, tmp10});
    TNode<IntPtrT> tmp12;
    USE(tmp12);
    tmp12 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp11});
    TNode<IntPtrT> tmp13;
    USE(tmp13);
    tmp13 = Convert_intptr_constexpr_int31_0(state_, 0);
    TNode<UintPtrT> tmp14;
    USE(tmp14);
    ...
    ca_.Branch(tmp16, &block29, &block30, tmp3, tmp4, tmp7, tmp7, tmp7, tmp8, tmp12, tmp13, tmp7, tmp8, tmp12, tmp13, tmp13);
  }
  ...
  if (block4.is_used()) {
    ...
    TNode<Smi>tmp24 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp20, tmp23});
    TNode<IntPtrT> tmp25;
    USE(tmp25);
    tmp25 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp24});
    TNode<IntPtrT> tmp26;
    USE(tmp26);
    tmp26 = Convert_intptr_constexpr_int31_0(state_, 0);
    ...
    ca_.Branch(tmp29, &block12, &block13, tmp17, tmp18, tmp20, tmp20, tmp20, tmp21, tmp25, tmp26, tmp20, tmp21, tmp25, tmp26, tmp26);
  }
  ...
  if (block12.is_used()) {
    ...
    TNode<IntPtrT> tmp41;
    TNode<IntPtrT> tmp42;
    ca_.Bind(&block12, &tmp30, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38, &tmp39, &tmp40, &tmp41, &tmp42);
    TNode<IntPtrT> tmp43;
    USE(tmp43);
    tmp43 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp44;
    USE(tmp44);
    tmp44 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp42}, TNode<IntPtrT>{tmp43});
    TNode<IntPtrT> tmp45;
    USE(tmp45);
    tmp45 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp39}, TNode<IntPtrT>{tmp44});
    TNode<HeapObject> tmp46;
    USE(tmp46);
    TNode<IntPtrT> tmp47;
    USE(tmp47);
    std::tie(tmp46, tmp47) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp38}, TNode<IntPtrT>{tmp45}).Flatten();
    TNode<Object>tmp48 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp46, tmp47});
    TNode<Oddball> tmp49;
    USE(tmp49);
    tmp49 = TheHole_0(state_);
    TNode<BoolT> tmp50;
    USE(tmp50);
    tmp50 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp48}, TNode<HeapObject>{tmp49});
    ca_.Branch(tmp50, &block6, &block7, tmp30, tmp31, tmp32);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Bind(&block6, &tmp64, &tmp65, &tmp66);
    TNode<IntPtrT> tmp67;
    USE(tmp67);
    ...
    TNode<Smi>tmp70 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp66, tmp69});
    TNode<IntPtrT> tmp71;
    USE(tmp71);
    tmp71 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp70});
    TNode<IntPtrT> tmp72;
    USE(tmp72);
    tmp72 = Convert_intptr_constexpr_int31_0(state_, 0);
    TNode<UintPtrT> tmp73;
    USE(tmp73);
    ...
    ca_.Branch(tmp75, &block20, &block21, tmp64, tmp65, tmp66, tmp66, tmp66, tmp67, tmp71, tmp72, tmp66, tmp67, tmp71, tmp72, tmp72);
  }
  ...
  if (block20.is_used()) {
    ...
    TNode<IntPtrT> tmp87;
    TNode<IntPtrT> tmp88;
    ca_.Bind(&block20, &tmp76, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88);
    TNode<IntPtrT> tmp89;
    USE(tmp89);
    tmp89 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp90;
    USE(tmp90);
    tmp90 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp88}, TNode<IntPtrT>{tmp89});
    TNode<IntPtrT> tmp91;
    USE(tmp91);
    tmp91 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp85}, TNode<IntPtrT>{tmp90});
    TNode<HeapObject> tmp92;
    USE(tmp92);
    TNode<IntPtrT> tmp93;
    USE(tmp93);
    std::tie(tmp92, tmp93) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp84}, TNode<IntPtrT>{tmp91}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp92, tmp93}, tmp77);
    ca_.Goto(&block15, tmp76, tmp77, tmp78);
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Bind(&block21, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100, &tmp101, &tmp102, &tmp103, &tmp104, &tmp105, &tmp106);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block7, &tmp107, &tmp108, &tmp109);
    TNode<Oddball> tmp110;
    tmp110 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPush, tmp107, tmp109, tmp108));
    USE(tmp110);
    TNode<Oddball> tmp111;
    USE(tmp111);
    tmp111 = False_0(state_);
    TNode<BoolT> tmp112;
    USE(tmp112);
    tmp112 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp110}, TNode<HeapObject>{tmp111});
    ca_.Branch(tmp112, &block23, &block24, tmp107, tmp108, tmp109);
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Bind(&block23, &tmp113, &tmp114, &tmp115);
    TNode<BoolT> tmp116;
    USE(tmp116);
    tmp116 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block1, tmp113, tmp114, tmp116);
  }
  ...
  if (block24.is_used()) {
    ...
    TNode<FixedArray> tmp119;
    ca_.Bind(&block24, &tmp117, &tmp118, &tmp119);
    ca_.Goto(&block15, tmp117, tmp118, tmp119);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp120, &tmp121, &tmp122);
    ca_.Goto(&block2, tmp120, tmp121);
  }
  ...
  if (block29.is_used()) {
    ...
    TNode<IntPtrT> tmp135;
    ca_.Bind(&block29, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135);
    TNode<IntPtrT> tmp136;
    USE(tmp136);
    tmp136 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    ...
    USE(tmp140);
    std::tie(tmp139, tmp140) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp131}, TNode<IntPtrT>{tmp138}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp139, tmp140}, tmp124);
    SetJoinStack_0(state_, TNode<Context>{tmp123}, TNode<FixedArray>{tmp125});
    ca_.Goto(&block2, tmp123, tmp124);
  }
  ...
  if (block30.is_used()) {
    ...
    ca_.Bind(&block30, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149, &tmp150, &tmp151, &tmp152, &tmp153);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Bind(&block2, &tmp154, &tmp155);
    TNode<BoolT> tmp156;
    USE(tmp156);
    tmp156 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Goto(&block1, tmp154, tmp155, tmp156);
  }
  ...
  if (block1.is_used()) {
    ...
    TNode<JSReceiver> tmp158;
    TNode<BoolT> tmp159;
    ca_.Bind(&block1, &tmp157, &tmp158, &tmp159);
    ca_.Goto(&block32, tmp157, tmp158, tmp159);
  }

    TNode<Context> tmp160;
    TNode<JSReceiver> tmp161;
    TNode<BoolT> tmp162;
    ca_.Bind(&block32, &tmp160, &tmp161, &tmp162);
  return TNode<BoolT>{tmp162};
}
...
TF_BUILTIN(JoinStackPop, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArray, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp23);
    tmp23 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp21}, TNode<UintPtrT>{tmp22});
    ca_.Branch(tmp23, &block11, &block12, tmp11, tmp12, tmp13, tmp14, tmp15, tmp12, tmp12, tmp16, tmp20, tmp15, tmp15, tmp12, tmp16, tmp20, tmp15, tmp15);
  }
  ...
  if (block11.is_used()) {
    ...
    TNode<BoolT> tmp46;
    USE(tmp46);
    tmp46 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp45}, TNode<HeapObject>{tmp26});
    ca_.Branch(tmp46, &block5, &block6, tmp24, tmp25, tmp26, tmp27, tmp28);
  }
  ...
  if (block5.is_used()) {
    ...
    TNode<BoolT> tmp69;
    USE(tmp69);
    tmp69 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp67}, TNode<IntPtrT>{tmp68});
    ca_.Branch(tmp69, &block16, &block17, tmp63, tmp64, tmp65, tmp66, tmp67, tmp69);
  }
  ...
  if (block16.is_used()) {
    ...
    TNode<IntPtrT> tmp76;
    USE(tmp76);
    tmp76 = FromConstexpr_intptr_constexpr_int31_0(state_, JSArray::kMinJoinStackSize);
    TNode<BoolT> tmp77;
    USE(tmp77);
    tmp77 = CodeStubAssembler(state_).IntPtrGreaterThan(TNode<IntPtrT>{tmp73}, TNode<IntPtrT>{tmp76});
    ca_.Goto(&block18, tmp70, tmp71, tmp72, tmp73, tmp74, tmp75, tmp77);
  }
  ...
  if (block17.is_used()) {
    ...
    TNode<IntPtrT> tmp82;
    TNode<BoolT> tmp83;
    ca_.Bind(&block17, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83);
    TNode<BoolT> tmp84;
    USE(tmp84);
    tmp84 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block18, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84);
  }
  ...
  if (block18.is_used()) {
    ...
    TNode<BoolT> tmp90;
    TNode<BoolT> tmp91;
    ca_.Bind(&block18, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91);
    ca_.Branch(tmp91, &block14, &block15, tmp85, tmp86, tmp87, tmp88, tmp89);
  }
  ...
  if (block14.is_used()) {
    ...
    TNode<IntPtrT> tmp95;
    TNode<IntPtrT> tmp96;
    ca_.Bind(&block14, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96);
    TNode<IntPtrT> tmp97;
    USE(tmp97);
    tmp97 = FromConstexpr_intptr_constexpr_int31_0(state_, JSArray::kMinJoinStackSize);
    TNode<FixedArray> tmp98;
    USE(tmp98);
    tmp98 = CodeStubAssembler(state_).AllocateFixedArrayWithHoles(TNode<IntPtrT>{tmp97}, CodeStubAssembler::AllocationFlag::kNone);
    SetJoinStack_0(state_, TNode<Context>{tmp92}, TNode<FixedArray>{tmp98});
    ca_.Goto(&block19, tmp92, tmp93, tmp94, tmp95, tmp96);
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<IntPtrT> tmp105;
    USE(tmp105);
    tmp105 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<IntPtrT> tmp106;
    USE(tmp106);
    tmp106 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    TNode<Smi>tmp107 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp100, tmp106});
    TNode<IntPtrT> tmp108;
    USE(tmp108);
    tmp108 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp107});
    TNode<UintPtrT> tmp109;
    USE(tmp109);
    tmp109 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp103});
    TNode<UintPtrT> tmp110;
    USE(tmp110);
    tmp110 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp108});
    TNode<BoolT> tmp111;
    USE(tmp111);
    tmp111 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp109}, TNode<UintPtrT>{tmp110});
    ca_.Branch(tmp111, &block24, &block25, tmp99, tmp100, tmp101, tmp102, tmp103, tmp100, tmp100, tmp104, tmp108, tmp103, tmp103, tmp100, tmp104, tmp108, tmp103, tmp103);
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.Bind(&block24, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127);
    TNode<IntPtrT> tmp128;
    USE(tmp128);
    ...
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp131, tmp132}, tmp133);
    ca_.Goto(&block19, tmp112, tmp113, tmp114, tmp115, tmp116);
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Bind(&block25, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139, &tmp140, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Bind(&block19, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154);
  ...
  if (block6.is_used()) {
    ...
    TNode<IntPtrT> tmp159;
    TNode<IntPtrT> tmp160;
    ca_.Bind(&block6, &tmp156, &tmp157, &tmp158, &tmp159, &tmp160);
    TNode<IntPtrT> tmp161;
    USE(tmp161);
    tmp161 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    TNode<IntPtrT> tmp162;
    USE(tmp162);
    tmp162 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp160}, TNode<IntPtrT>{tmp161});
    ca_.Goto(&block3, tmp156, tmp157, tmp158, tmp159, tmp162);
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Bind(&block2, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
void JoinStackPopInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Context> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, Context, FixedArray> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSReceiver, FixedArray, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block4.is_used()) {
    ...
    TNode<Smi>tmp14 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp9, tmp13});
    TNode<IntPtrT> tmp15;
    USE(tmp15);
    tmp15 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp14});
    TNode<IntPtrT> tmp16;
    USE(tmp16);
    tmp16 = Convert_intptr_constexpr_int31_0(state_, 0);
    ...
    ca_.Branch(tmp19, &block12, &block13, tmp6, tmp7, tmp9, tmp10, tmp9, tmp9, tmp11, tmp15, tmp16, tmp9, tmp11, tmp15, tmp16, tmp16);
  }
  ...
  if (block12.is_used()) {
    ...
    TNode<BoolT> tmp40;
    USE(tmp40);
    tmp40 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp39}, TNode<HeapObject>{tmp21});
    ca_.Branch(tmp40, &block15, &block16, tmp20, tmp21, tmp22, tmp23, tmp40);
  }
  ...
  if (block13.is_used()) {
    ...
    TNode<IntPtrT> tmp53;
    TNode<IntPtrT> tmp54;
    ca_.Bind(&block13, &tmp41, &tmp42, &tmp43, &tmp44, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block15.is_used()) {
    ...
    TNode<IntPtrT> tmp58;
    TNode<BoolT> tmp59;
    ca_.Bind(&block15, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59);
    TNode<IntPtrT> tmp60;
    USE(tmp60);
    tmp60 = FromConstexpr_intptr_constexpr_int31_0(state_, JSArray::kMinJoinStackSize);
    TNode<BoolT> tmp61;
    USE(tmp61);
    tmp61 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp58}, TNode<IntPtrT>{tmp60});
    ca_.Goto(&block17, tmp55, tmp56, tmp57, tmp58, tmp59, tmp61);
  }
  ...
  if (block16.is_used()) {
    ...
    TNode<IntPtrT> tmp65;
    TNode<BoolT> tmp66;
    ca_.Bind(&block16, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66);
    TNode<BoolT> tmp67;
    USE(tmp67);
    tmp67 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block17, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67);
  }
  ...
  if (block17.is_used()) {
    ...
    TNode<BoolT> tmp72;
    TNode<BoolT> tmp73;
    ca_.Bind(&block17, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73);
    ca_.Branch(tmp73, &block6, &block7, tmp68, tmp69, tmp70, tmp71);
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreFixedArrayElement(TNode<FixedArray>{tmp76}, 0, TNode<Object>{tmp78}, SKIP_WRITE_BARRIER);
  ...
  if (block7.is_used()) {
    ...
    TNode<FixedArray> tmp81;
    TNode<IntPtrT> tmp82;
    ca_.Bind(&block7, &tmp79, &tmp80, &tmp81, &tmp82);
    TNode<Object> tmp83;
    tmp83 = CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPop, tmp79, tmp81, tmp80);
    USE(tmp83);
    ca_.Goto(&block18, tmp79, tmp80, tmp81, tmp82);
  }
  ...
  if (block18.is_used()) {
    ...
    TNode<FixedArray> tmp86;
    TNode<IntPtrT> tmp87;
    ca_.Bind(&block18, &tmp84, &tmp85, &tmp86, &tmp87);
    ca_.Goto(&block19, tmp84, tmp85);
  }

    TNode<Context> tmp88;
    TNode<JSReceiver> tmp89;
    ca_.Bind(&block19, &tmp88, &tmp89);
}
...
USE(parameter1);
  ...
  if (block3.is_used()) {
    ...
    TNode<Object> tmp29;
    USE(tmp29);
    tmp29 = CodeStubAssembler(state_).Call(TNode<Context>{tmp22}, TNode<Object>{tmp28}, TNode<Object>{tmp24});
    arguments.PopAndReturn(tmp29);
  }
}
...
TNode<FixedArray> StoreAndGrowFixedArray_JSReceiver_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<JSReceiver> p_element) {
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, JSReceiver, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, JSReceiver, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, JSReceiver, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block6.is_used()) {
    ...
    TNode<Smi>tmp20 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp13, tmp19});
    TNode<IntPtrT> tmp21;
    USE(tmp21);
    tmp21 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp20});
    TNode<UintPtrT> tmp22;
    USE(tmp22);
    tmp22 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp14});
    ...
    ca_.Branch(tmp24, &block13, &block14, tmp13, tmp14, tmp15, tmp16, tmp13, tmp13, tmp17, tmp21, tmp14, tmp14, tmp13, tmp17, tmp21, tmp14, tmp14);
  }
  ...
  if (block13.is_used()) {
    ...
    TNode<IntPtrT> tmp38;
    TNode<IntPtrT> tmp39;
    ca_.Bind(&block13, &tmp25, &tmp26, &tmp27, &tmp28, &tmp29, &tmp30, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38, &tmp39);
    TNode<IntPtrT> tmp40;
    USE(tmp40);
    tmp40 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    TNode<IntPtrT> tmp41;
    ...
    USE(tmp44);
    std::tie(tmp43, tmp44) = UnsafeNewReference_Object_0(state_, TNode<HeapObject>{tmp35}, TNode<IntPtrT>{tmp42}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp43, tmp44}, tmp27);
    ca_.Goto(&block1, tmp25, tmp26, tmp27, tmp25);
  }
  ...
  if (block14.is_used()) {
    ...
    TNode<IntPtrT> tmp58;
    TNode<IntPtrT> tmp59;
    ca_.Bind(&block14, &tmp45, &tmp46, &tmp47, &tmp48, &tmp49, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block7.is_used()) {
    ...
    TNode<IntPtrT> tmp64;
    USE(tmp64);
    tmp64 = CodeStubAssembler(state_).CalculateNewElementsCapacity(TNode<IntPtrT>{tmp63});
    TNode<IntPtrT> tmp65;
    USE(tmp65);
    tmp65 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    TNode<FixedArray> tmp66;
    USE(tmp66);
    tmp66 = ExtractFixedArray_0(state_, TNode<FixedArray>{tmp60}, TNode<IntPtrT>{tmp65}, TNode<IntPtrT>{tmp63}, TNode<IntPtrT>{tmp64});
    TNode<IntPtrT> tmp67;
    USE(tmp67);
    tmp67 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    TNode<IntPtrT> tmp68;
    ...
    TNode<UintPtrT> tmp72;
    USE(tmp72);
    tmp72 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp61});
    TNode<UintPtrT> tmp73;
    USE(tmp73);
    tmp73 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp71});
    TNode<BoolT> tmp74;
    USE(tmp74);
    tmp74 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp72}, TNode<UintPtrT>{tmp73});
    ca_.Branch(tmp74, &block24, &block25, tmp60, tmp61, tmp62, tmp63, tmp64, tmp66, tmp66, tmp66, tmp67, tmp71, tmp61, tmp61, tmp66, tmp67, tmp71, tmp61, tmp61);
  }
  ...
  if (block19.is_used()) {
    ...
    TNode<IntPtrT> tmp78;
    TNode<IntPtrT> tmp79;
    ca_.Bind(&block19, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79);
  ...
  if (block18.is_used()) {
    ...
    TNode<IntPtrT> tmp83;
    TNode<IntPtrT> tmp84;
    ca_.Bind(&block18, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84);
  }
  ...
  if (block24.is_used()) {
    ...
    TNode<IntPtrT> tmp100;
    TNode<IntPtrT> tmp101;
    ca_.Bind(&block24, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100, &tmp101);
    TNode<IntPtrT> tmp102;
    USE(tmp102);
    ...
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp105, tmp106}, tmp87);
    ca_.Goto(&block1, tmp85, tmp86, tmp87, tmp90);
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Bind(&block25, &tmp107, &tmp108, &tmp109, &tmp110, &tmp111, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block1.is_used()) {
    ...
    TNode<FixedArray> tmp127;
    ca_.Bind(&block1, &tmp124, &tmp125, &tmp126, &tmp127);
    ca_.Goto(&block27, tmp124, tmp125, tmp126, tmp127);
  }
    ...
    ca_.Bind(&block27, &tmp128, &tmp129, &tmp130, &tmp131);
  return TNode<FixedArray>{tmp131};
}
...
TNode<FixedArray> StoreAndGrowFixedArray_Smi_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<Smi> p_element) {
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, Smi, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, Smi, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, Smi, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, Smi, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<FixedArray> StoreAndGrowFixedArray_String_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<String> p_element) {
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, String, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, String, IntPtrT, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, String, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, String, IntPtrT, IntPtrT, FixedArray, FixedArray, FixedArray, IntPtrT, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
