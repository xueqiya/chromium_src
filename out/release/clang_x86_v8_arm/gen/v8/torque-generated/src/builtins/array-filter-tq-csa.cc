...
TF_BUILTIN(ArrayFilterLoopContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    TNode<Object> tmp48;
    USE(tmp48);
    tmp48 = CodeStubAssembler(state_).Call(TNode<Context>{tmp35}, TNode<Object>{tmp37}, TNode<Object>{tmp38}, TNode<Object>{tmp47}, TNode<Object>{tmp45}, TNode<Object>{tmp40});
    TNode<BoolT> tmp49;
    USE(tmp49);
...
void FastArrayFilter_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, TNode<JSArray> p_output, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_1) {
  ...
  if (block24.is_used()) {
    ...
    TNode<Object> tmp444;
    USE(tmp444);
    tmp444 = CodeStubAssembler(state_).Call(TNode<Context>{tmp419}, TNode<Object>{tmp422}, TNode<Object>{tmp423}, TNode<Object>{tmp443}, TNode<Object>{tmp425}, TNode<Object>{tmp428});
    TNode<BoolT> tmp445;
    USE(tmp445);
  ...
  if (block33.is_used()) {
    ...
    USE(tmp488);
    tmp488 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
  ...
  if (block49.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.arrayIsPushable' failed", "src/objects/js-array.tq", 197);
  }
  ...
  if (block50.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_DOUBLE_ELEMENTS, TNode<JSArray>{tmp690}, TNode<Object>{tmp698}, &label0);
  ...
  if (block55.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_SMI_ELEMENTS, TNode<JSArray>{tmp790}, TNode<Object>{tmp798}, &label0);
  ...
  if (block56.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_ELEMENTS, TNode<JSArray>{tmp866}, TNode<Object>{tmp874}, &label0);
  ...
  if (block65.is_used()) {
    ...
    TNode<Int32T> tmp927;
    USE(tmp927);
    tmp927 = FromConstexpr_ElementsKind_constexpr_PACKED_ELEMENTS_0(state_, ElementsKind::PACKED_ELEMENTS);
    TNode<BoolT> tmp928;
    USE(tmp928);
  ...
  if (block63.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.map.elements_kind == ElementsKind::HOLEY_ELEMENTS || this.map.elements_kind == ElementsKind::PACKED_ELEMENTS' failed", "src/objects/js-array.tq", 206);
  }
...
TNode<JSReceiver> FastFilterSpeciesCreate_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block5.is_used()) {
    ...
    TNode<JSArray> tmp27;
    USE(tmp27);
    tmp27 = CodeStubAssembler(state_).AllocateJSArray(ElementsKind::PACKED_SMI_ELEMENTS, TNode<Map>{tmp26}, TNode<Smi>{tmp18}, TNode<Smi>{tmp18});
