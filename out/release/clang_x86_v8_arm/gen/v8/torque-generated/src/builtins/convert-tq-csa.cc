...
TNode<IntPtrT> Convert_intptr_uint8_0(compiler::CodeAssemblerState* state_, TNode<Uint8T> p_ui) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint8T, IntPtrT> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_ui);
...
TNode<Uint8T> Convert_uint8_intptr_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_i) {
  ...
  compiler::CodeAssemblerParameterizedLabel<IntPtrT, Uint8T> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_i);
  ...
  if (block0.is_used()) {
    ...
    TNode<Uint32T> tmp3;
    USE(tmp3);
    tmp3 = FromConstexpr_uint32_constexpr_int31_0(state_, 255);
    TNode<Uint32T> tmp4;
    USE(tmp4);
    tmp4 = CodeStubAssembler(state_).Word32And(TNode<Uint32T>{tmp2}, TNode<Uint32T>{tmp3});
    TNode<Uint8T> tmp5;
    USE(tmp5);
...
TNode<IntPtrT> Convert_intptr_uintptr_0(compiler::CodeAssemblerState* state_, TNode<UintPtrT> p_ui) {
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'i >= 0' failed", "src/builtins/convert.tq", 173);
  }
...
TNode<Smi> Convert_PositiveSmi_intptr_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_i) {
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'IsValidPositiveSmi(i)' failed", "src/builtins/convert.tq", 177);
  }
...
TorqueStructfloat64_or_hole_0 Convert_float64_or_hole_float64_0(compiler::CodeAssemblerState* state_, TNode<Float64T> p_f) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Float64T, BoolT, Float64T> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_f);
  ...
  if (block0.is_used()) {
    ...
    ca_.Goto(&block2, tmp0, tmp1, tmp0);
  }
  ...
  return TorqueStructfloat64_or_hole_0{TNode<BoolT>{tmp3}, TNode<Float64T>{tmp4}};
}

TorqueStructfloat64_or_hole_0 Convert_float64_or_hole_Number_0(compiler::CodeAssemblerState* state_, TNode<Number> p_n) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Number> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Number, BoolT, Float64T> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_n);
  ...
  if (block0.is_used()) {
    ...
    TNode<Float64T> tmp3;
    USE(tmp3);
    std::tie(tmp2, tmp3) = Convert_float64_or_hole_float64_0(state_, TNode<Float64T>{tmp1}).Flatten();
    ca_.Goto(&block2, tmp0, tmp2, tmp3);
  }
  ...
  return TorqueStructfloat64_or_hole_0{TNode<BoolT>{tmp5}, TNode<Float64T>{tmp6}};
}
...
TNode<Number> Convert_Number_intptr_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_i) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<IntPtrT> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<IntPtrT, Number> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_i);
  ...
  if (block0.is_used()) {
    ...
    TNode<Number> tmp2;
    USE(tmp2);
    tmp2 = CodeStubAssembler(state_).ChangeUintPtrToTagged(TNode<UintPtrT>{tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }
...
TNode<IntPtrT> Convert_intptr_Number_0(compiler::CodeAssemblerState* state_, TNode<Number> p_n) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Number> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Number, IntPtrT> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_n);
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2;
    USE(tmp2);
    tmp2 = CodeStubAssembler(state_).ChangeFloat64ToIntPtr(TNode<Float64T>{tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }
...
TNode<IntPtrT> Convert_intptr_bint_0(compiler::CodeAssemblerState* state_, TNode<BInt> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<BInt> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BInt, IntPtrT> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_v);
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp1;
    USE(tmp1);
    tmp1 = CodeStubAssembler(state_).BIntToIntPtr(TNode<BInt>{tmp0});
    ca_.Goto(&block2, tmp0, tmp1);
  }
...
TNode<Smi> Convert_Smi_bint_0(compiler::CodeAssemblerState* state_, TNode<BInt> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<BInt> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BInt, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_v);
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi> tmp1;
    USE(tmp1);
    tmp1 = CodeStubAssembler(state_).BIntToSmi(TNode<BInt>{tmp0});
    ca_.Goto(&block2, tmp0, tmp1);
  }
...
TNode<Uint32T> Convert_ScopeFlags_Smi_0(compiler::CodeAssemblerState* state_, TNode<Smi> p_s) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Uint32T> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_s);
