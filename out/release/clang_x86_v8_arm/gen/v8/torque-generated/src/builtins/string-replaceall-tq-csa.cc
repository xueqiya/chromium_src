...
USE(parameter1);
  ...
  if (block10.is_used()) {
    ...
    TNode<Object> tmp56;
    USE(tmp56);
    tmp56 = CodeStubAssembler(state_).Call(TNode<Context>{tmp48}, TNode<Object>{tmp55}, TNode<Object>{tmp50}, TNode<Object>{tmp49}, TNode<Object>{tmp51});
  ...
  if (block17.is_used()) {
    ...
    TNode<Object> tmp133;
    USE(tmp133);
    tmp133 = CodeStubAssembler(state_).Call(TNode<Context>{tmp117}, TNode<Object>{tmp131}, TNode<Object>{tmp132}, TNode<Object>{tmp122}, TNode<Object>{tmp129}, TNode<Object>{tmp121});
    TNode<String> tmp134;
    USE(tmp134);
