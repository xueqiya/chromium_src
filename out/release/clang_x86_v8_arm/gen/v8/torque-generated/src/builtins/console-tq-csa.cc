...
USE(parameter3);
  ...
  compiler::CodeAssemblerParameterizedLabel<RawPtrT, RawPtrT, IntPtrT, NativeContext, Object, Object, JSFunction> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<RawPtrT, RawPtrT, IntPtrT, NativeContext, Object, Object, JSFunction> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    TNode<Int32T> tmp25;
    USE(tmp25);
    tmp25 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{tmp20});
   CodeStubAssembler(state_).TailCallBuiltin(Builtins::kConsoleAssert, tmp21, tmp24, tmp23, tmp25);
  }
}
