...
TNode<Uint32T> LoadScopeInfoFlags_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<ScopeInfo> p_scopeInfo) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, ScopeInfo, ScopeInfo, ScopeInfo, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, ScopeInfo, ScopeInfo, ScopeInfo, IntPtrT, IntPtrT, IntPtrT, HeapObject, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, ScopeInfo, Uint32T> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_context, p_scopeInfo);
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr_intptr_constexpr_int32_0(state_, ScopeInfo::Fields::kFlags);
    TNode<UintPtrT> tmp8;
    USE(tmp8);
  ...
  if (block6.is_used()) {
    TNode<Context> tmp11;
    TNode<ScopeInfo> tmp12;
    TNode<ScopeInfo> tmp13;
    TNode<ScopeInfo> tmp14;
    TNode<IntPtrT> tmp15;
    TNode<IntPtrT> tmp16;
    TNode<IntPtrT> tmp17;
    ...
    TNode<Smi> tmp29;
    USE(tmp29);
    tmp29 = UnsafeCast_Smi_0(state_, TNode<Context>{tmp11}, TNode<Object>{tmp28});
    TNode<Uint32T> tmp30;
    USE(tmp30);
    tmp30 = Convert_ScopeFlags_Smi_0(state_, TNode<Smi>{tmp29});
    ca_.Goto(&block9, tmp11, tmp12, tmp30);
  }

  if (block7.is_used()) {
    TNode<Context> tmp31;
    TNode<ScopeInfo> tmp32;
    TNode<ScopeInfo> tmp33;
    TNode<ScopeInfo> tmp34;
    TNode<IntPtrT> tmp35;
    TNode<IntPtrT> tmp36;
    TNode<IntPtrT> tmp37;
    ...
    TNode<IntPtrT> tmp41;
    TNode<IntPtrT> tmp42;
    ca_.Bind(&block7, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38, &tmp39, &tmp40, &tmp41, &tmp42);
    CodeStubAssembler(state_).Unreachable();
  }

    TNode<Context> tmp43;
    TNode<ScopeInfo> tmp44;
    TNode<Uint32T> tmp45;
    ca_.Bind(&block9, &tmp43, &tmp44, &tmp45);
  return TNode<Uint32T>{tmp45};
}
