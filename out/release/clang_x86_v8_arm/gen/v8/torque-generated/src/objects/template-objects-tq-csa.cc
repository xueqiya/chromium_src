...
TNode<Smi> LoadCachedTemplateObjectSlotId_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o);
  ...
  if (block0.is_used()) {
    ...
    TNode<CachedTemplateObject> tmp3;
    TNode<Smi> tmp4;
...
void StoreCachedTemplateObjectSlotId_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o, TNode<Smi> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSArray> LoadCachedTemplateObjectTemplateObject_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, JSArray> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o);
  ...
  if (block0.is_used()) {
    ...
    TNode<JSArray>tmp2 = CodeStubAssembler(state_).LoadReference<JSArray>(CodeStubAssembler::Reference{tmp0, tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }
...
void StoreCachedTemplateObjectTemplateObject_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o, TNode<JSArray> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, JSArray> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, JSArray> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o, p_v);
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<JSArray>(CodeStubAssembler::Reference{tmp0, tmp2}, tmp1);
    ca_.Goto(&block2, tmp0, tmp1);
  }
...
TNode<HeapObject> LoadCachedTemplateObjectNext_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, HeapObject> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o);
...
void StoreCachedTemplateObjectNext_0(compiler::CodeAssemblerState* state_, TNode<CachedTemplateObject> p_o, TNode<HeapObject> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, HeapObject> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<CachedTemplateObject, HeapObject> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o, p_v);
