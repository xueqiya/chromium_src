...
TNode<JSReceiver> LoadJSRegExpStringIteratorIteratingRegExp_0(compiler::CodeAssemblerState* state_, TNode<JSRegExpStringIterator> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSRegExpStringIterator, JSReceiver> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0, p_o);
...
void StoreJSRegExpStringIteratorIteratingRegExp_0(compiler::CodeAssemblerState* state_, TNode<JSRegExpStringIterator> p_o, TNode<JSReceiver> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<JSRegExpStringIterator, JSReceiver> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSRegExpStringIterator, JSReceiver> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
